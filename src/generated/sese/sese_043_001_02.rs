...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.043.001.02")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.043.001.02")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.043.001.02")]
pub struct Conversion6 {
    #[yaserde(rename = "OrgnlScty")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlScty"))]
    pub orgnl_scty: FinancialInstrumentIdentification7,
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.043.001.02")]
pub struct Document {
    #[yaserde(rename = "PrtflTrfCmpltn")]
    #[cfg_attr(feature = "serde", serde(rename = "PrtflTrfCmpltn"))]
    pub prtfl_trf_cmpltn: PortfolioTransferCompletionV02,
}
...
pub enum FinancialInstrument103ChoiceChoice {
...
impl Default for FinancialInstrument103ChoiceChoice {
    fn default() -> FinancialInstrument103ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for FinancialInstrument103ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.043.001.02")]
pub struct FinancialInstrument103Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub financial_instrument_103_choice_choice: FinancialInstrument103ChoiceChoice,
}

impl Validate for FinancialInstrument103Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.043.001.02")]
pub struct FinancialInstrument112 {
    ...
    pub instrm: FinancialInstrument103Choice,
    ...
    pub pmt_dtls: PaymentInstrument21,
...
impl Validate for FinancialInstrument112 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.043.001.02")]
pub struct PaymentInstrument21 {
    #[yaserde(rename = "Ref")]
    #[cfg_attr(feature = "serde", serde(rename = "Ref"))]
    pub _ref: Max35Text,
...
impl Validate for PaymentInstrument21 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.043.001.02")]
pub struct PortfolioTransfer18 {
    ...
    #[yaserde(rename = "TrfCmpltnId")]
    #[cfg_attr(feature = "serde", serde(rename = "TrfCmpltnId"))]
    pub trf_cmpltn_id: Max35Text,
    ...
    pub fin_instrm_asst_for_trf: Vec<FinancialInstrument112>,
...
impl Validate for PortfolioTransfer18 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.043.001.02")]
pub struct PortfolioTransferCompletionV02 {
    ...
    pub pdct_trf: Vec<PortfolioTransfer18>,
...
impl Validate for PortfolioTransferCompletionV02 {}
...
pub enum TransferType2ChoiceChoice {
    Cd(TransferType4Code),
    Prtry(GenericIdentification36),
    __Unknown__(String),
}

impl Default for TransferType2ChoiceChoice {
    fn default() -> TransferType2ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for TransferType2ChoiceChoice {}
...
pub struct TransferType2Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub transfer_type_2_choice_choice: TransferType2ChoiceChoice,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "sese.043.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:sese.043.001.02";
}
