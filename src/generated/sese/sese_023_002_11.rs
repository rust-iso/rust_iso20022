...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.023.002.11")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.023.002.11")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.023.002.11")]
pub struct Document {
    #[yaserde(rename = "SctiesSttlmTxInstr")]
    #[cfg_attr(feature = "serde", serde(rename = "SctiesSttlmTxInstr"))]
    pub scties_sttlm_tx_instr: SecuritiesSettlementTransactionInstruction002V11,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.023.002.11")]
pub struct SecuritiesSettlementTransactionInstruction002V11 {
    #[yaserde(rename = "TxId")]
    ...
    pub sttlm_tp_and_addtl_params: SettlementTypeAndAdditionalParameters22,
    ...
    pub trad_dtls: SecuritiesTradeDetails131,
    ...
    pub sttlm_params: SettlementDetails207,
...
impl Validate for SecuritiesSettlementTransactionInstruction002V11 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.023.002.11")]
pub struct SecuritiesTradeDetails131 {
...
impl Validate for SecuritiesTradeDetails131 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.023.002.11")]

pub enum SecuritiesTransactionType23Code {
    #[yaserde(rename = "BSBK")]
...
impl Default for SecuritiesTransactionType23Code {
    fn default() -> SecuritiesTransactionType23Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for SecuritiesTransactionType23Code {}
...
pub enum SecuritiesTransactionType53ChoiceChoice {
    Cd(SecuritiesTransactionType23Code),
    Prtry(GenericIdentification47),
    __Unknown__(String),
}

impl Default for SecuritiesTransactionType53ChoiceChoice {
    fn default() -> SecuritiesTransactionType53ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for SecuritiesTransactionType53ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.023.002.11")]
pub struct SecuritiesTransactionType53Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub securities_transaction_type_53_choice_choice: SecuritiesTransactionType53ChoiceChoice,
}

impl Validate for SecuritiesTransactionType53Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.023.002.11")]
pub struct SettlementDetails207 {
    ...
    pub scties_tx_tp: SecuritiesTransactionType53Choice,

    #[yaserde(rename = "SttlmTxCond")]
    #[cfg_attr(feature = "serde", serde(rename = "SttlmTxCond"))]
    pub sttlm_tx_cond: Vec<SettlementTransactionCondition39Choice>,
    ...
    #[yaserde(rename = "DlvrgSctiesSubBalTp")]
    #[cfg_attr(feature = "serde", serde(rename = "DlvrgSctiesSubBalTp"))]
    pub dlvrg_scties_sub_bal_tp: GenericIdentification30,

    #[yaserde(rename = "RcvgSctiesSubBalTp")]
    #[cfg_attr(feature = "serde", serde(rename = "RcvgSctiesSubBalTp"))]
    pub rcvg_scties_sub_bal_tp: GenericIdentification30,
...
impl Validate for SettlementDetails207 {}
...
pub enum SettlementTransactionCondition14Code {
    #[yaserde(rename = "ADEA")]
...
impl Default for SettlementTransactionCondition14Code {
    fn default() -> SettlementTransactionCondition14Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for SettlementTransactionCondition14Code {}
...
pub enum SettlementTransactionCondition39ChoiceChoice {
    Cd(SettlementTransactionCondition14Code),
    Prtry(GenericIdentification47),
    __Unknown__(String),
}

impl Default for SettlementTransactionCondition39ChoiceChoice {
    fn default() -> SettlementTransactionCondition39ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for SettlementTransactionCondition39ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.023.002.11")]
pub struct SettlementTransactionCondition39Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub settlement_transaction_condition_39_choice_choice: SettlementTransactionCondition39ChoiceChoice,
}

impl Validate for SettlementTransactionCondition39Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.023.002.11")]
pub struct SettlementTypeAndAdditionalParameters22 {
...
impl Validate for SettlementTypeAndAdditionalParameters22 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "sese.023.002.11";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:sese.023.002.11";
}
