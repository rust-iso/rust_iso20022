...
pub struct SettlementTransactionCondition42Choice {
    #[yaserde(rename = "Cd")]
    #[cfg_attr(feature = "serde", serde(rename = "Cd"))]
    pub cd: Option<SettlementTransactionCondition17Code>,
    #[yaserde(rename = "Prtry")]
    #[cfg_attr(feature = "serde", serde(rename = "Prtry"))]
    pub prtry: Option<GenericIdentification30>,
}
...
pub struct UpdateType40Choice {
    ...
    pub addtn: Option<SecuritiesSettlementTransactionDetails59>,
    #[yaserde(rename = "Deltn")]
    #[cfg_attr(feature = "serde", serde(rename = "Deltn"))]
    pub deltn: Option<SecuritiesSettlementTransactionDetails60>,
    #[yaserde(rename = "Mod")]
    #[cfg_attr(feature = "serde", serde(rename = "Mod"))]
    pub r#mod: Option<SecuritiesSettlementTransactionDetails61>,
}
