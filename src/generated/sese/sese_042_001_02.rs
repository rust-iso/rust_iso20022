...
pub enum AcknowledgedAcceptedStatus33ChoiceChoice {
    NoSpcfdRsn(NoReasonCode),
    Rsn(Vec<AcknowledgementReason21>),
    __Unknown__(String),
}

impl Default for AcknowledgedAcceptedStatus33ChoiceChoice {
    fn default() -> AcknowledgedAcceptedStatus33ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for AcknowledgedAcceptedStatus33ChoiceChoice {}
...
pub struct AcknowledgedAcceptedStatus33Choice {
    ...
    pub acknowledged_accepted_status_33_choice_choice: AcknowledgedAcceptedStatus33ChoiceChoice,
}
...
pub enum AcknowledgementReason24ChoiceChoice {
    Cd(AcknowledgementReason10Code),
    Prtry(GenericIdentification30),
    __Unknown__(String),
}

impl Default for AcknowledgementReason24ChoiceChoice {
    fn default() -> AcknowledgementReason24ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for AcknowledgementReason24ChoiceChoice {}
...
pub struct AcknowledgementReason24Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub acknowledgement_reason_24_choice_choice: AcknowledgementReason24ChoiceChoice,
}
...
pub enum ProcessingStatus79ChoiceChoice {
    AckdAccptd(AcknowledgedAcceptedStatus33Choice),
    Rjctd(RejectionOrRepairStatus31Choice),
    __Unknown__(String),
}

impl Default for ProcessingStatus79ChoiceChoice {
    fn default() -> ProcessingStatus79ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ProcessingStatus79ChoiceChoice {}
...
pub struct ProcessingStatus79Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub processing_status_79_choice_choice: ProcessingStatus79ChoiceChoice,
}
...
pub enum RejectionAndRepairReason25ChoiceChoice {
    Cd(RejectionReason27Code),
    Prtry(GenericIdentification30),
    __Unknown__(String),
}

impl Default for RejectionAndRepairReason25ChoiceChoice {
    fn default() -> RejectionAndRepairReason25ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for RejectionAndRepairReason25ChoiceChoice {}
...
pub struct RejectionAndRepairReason25Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub rejection_and_repair_reason_25_choice_choice: RejectionAndRepairReason25ChoiceChoice,
}
...
pub enum RejectionOrRepairStatus31ChoiceChoice {
    NoSpcfdRsn(NoReasonCode),
    Rsn(Vec<RejectionOrRepairReason25>),
    __Unknown__(String),
}

impl Default for RejectionOrRepairStatus31ChoiceChoice {
    fn default() -> RejectionOrRepairStatus31ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for RejectionOrRepairStatus31ChoiceChoice {}
...
pub struct RejectionOrRepairStatus31Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub rejection_or_repair_status_31_choice_choice: RejectionOrRepairStatus31ChoiceChoice,
}
