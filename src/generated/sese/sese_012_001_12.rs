...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.012.001.12")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.012.001.12")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.012.001.12")]
pub struct Document {
    #[yaserde(rename = "PrtflTrfInstr")]
    #[cfg_attr(feature = "serde", serde(rename = "PrtflTrfInstr"))]
    pub prtfl_trf_instr: PortfolioTransferInstructionV12,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.012.001.12")]
pub struct FinancialInstrument108 {
...
impl Validate for FinancialInstrument108 {}
...
pub enum FundPortfolio8ChoiceChoice {
    TaxEffcntPdct(TaxEfficientProduct6),
    GnlInvstmt(GeneralInvestment2),
    Pnsn(Pension6),
    __Unknown__(String),
}

impl Default for FundPortfolio8ChoiceChoice {
    fn default() -> FundPortfolio8ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for FundPortfolio8ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.012.001.12")]
pub struct FundPortfolio8Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub fund_portfolio_8_choice_choice: FundPortfolio8ChoiceChoice,
}

impl Validate for FundPortfolio8Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.012.001.12")]
pub struct PortfolioTransfer14 {
    ...
    pub prtfl: FundPortfolio8Choice,
    ...
    pub fin_instrm_asst_for_trf: Vec<FinancialInstrument108>,
...
impl Validate for PortfolioTransfer14 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.012.001.12")]
pub struct PortfolioTransferInstructionV12 {
    ...
    pub pdct_trf: Vec<PortfolioTransfer14>,
...
impl Validate for PortfolioTransferInstructionV12 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.012.001.12")]
pub struct TaxEfficientProduct6 {
...
impl Validate for TaxEfficientProduct6 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "sese.012.001.12";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:sese.012.001.12";
}
