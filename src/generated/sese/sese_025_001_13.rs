...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.025.001.13")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.025.001.13")]
pub struct AdditionalParameters29 {
...
impl Validate for AdditionalParameters29 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.025.001.13")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.025.001.13")]
pub struct Document {
    #[yaserde(rename = "SctiesSttlmTxConf")]
    #[cfg_attr(feature = "serde", serde(rename = "SctiesSttlmTxConf"))]
    pub scties_sttlm_tx_conf: SecuritiesSettlementTransactionConfirmationV13,
}
...
pub struct OtherAmounts46 {
    ...
    pub coll_mntr_amt: AmountAndDirection44,
...
impl Validate for OtherAmounts46 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.025.001.13")]
pub struct QuantityAndAccount115 {
    ...
    pub prevsly_sttld_amt: AmountAndDirection52,

    #[yaserde(rename = "RmngToBeSttldAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "RmngToBeSttldAmt"))]
    pub rmng_to_be_sttld_amt: AmountAndDirection52,
    ...
    pub qty_brkdwn: Vec<QuantityBreakdown63>,
...
impl Validate for QuantityAndAccount115 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.025.001.13")]
pub struct QuantityBreakdown63 {
...
impl Validate for QuantityBreakdown63 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.025.001.13")]
pub struct SecuritiesSettlementTransactionConfirmationV13 {
    ...
    pub addtl_params: AdditionalParameters29,

    #[yaserde(rename = "TradDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "TradDtls"))]
    pub trad_dtls: SecuritiesTradeDetails150,
    ...
    pub qty_and_acct_dtls: QuantityAndAccount115,

    #[yaserde(rename = "SttlmParams")]
    #[cfg_attr(feature = "serde", serde(rename = "SttlmParams"))]
    pub sttlm_params: SettlementDetails221,
...
impl Validate for SecuritiesSettlementTransactionConfirmationV13 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.025.001.13")]
pub struct SecuritiesTradeDetails150 {
...
impl Validate for SecuritiesTradeDetails150 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.025.001.13")]

pub enum SecuritiesTransactionType25Code {
    #[yaserde(rename = "BSBK")]
...
impl Default for SecuritiesTransactionType25Code {
    fn default() -> SecuritiesTransactionType25Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for SecuritiesTransactionType25Code {}
...
pub enum SecuritiesTransactionType43ChoiceChoice {
    Cd(SecuritiesTransactionType25Code),
    Prtry(GenericIdentification30),
    __Unknown__(String),
}

impl Default for SecuritiesTransactionType43ChoiceChoice {
    fn default() -> SecuritiesTransactionType43ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for SecuritiesTransactionType43ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.025.001.13")]
pub struct SecuritiesTransactionType43Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub securities_transaction_type_43_choice_choice: SecuritiesTransactionType43ChoiceChoice,
}

impl Validate for SecuritiesTransactionType43Choice {}
...
pub enum SettlementDate18ChoiceChoice {
    Dt(DateAndDateTime2Choice),
    DtCd(GenericIdentification30),
    __Unknown__(String),
}

impl Default for SettlementDate18ChoiceChoice {
    fn default() -> SettlementDate18ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for SettlementDate18ChoiceChoice {}
...
pub struct SettlementDate18Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub settlement_date_18_choice_choice: SettlementDate18ChoiceChoice,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.025.001.13")]
pub struct SettlementDetails221 {
    #[yaserde(rename = "Prty")]
    ...
    pub scties_tx_tp: SecuritiesTransactionType43Choice,
...
impl Validate for SettlementDetails221 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "sese.025.001.13";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:sese.025.001.13";
}
