...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.026.001.12")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.026.001.12")]
pub struct AdditionalParameters30 {
...
impl Validate for AdditionalParameters30 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.026.001.12")]
...
impl Validate for CashParties42 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.026.001.12")]
pub struct Document {
    #[yaserde(rename = "SctiesSttlmTxRvslAdvc")]
    #[cfg_attr(feature = "serde", serde(rename = "SctiesSttlmTxRvslAdvc"))]
    pub scties_sttlm_tx_rvsl_advc: SecuritiesSettlementTransactionReversalAdviceV12,
}
...
pub struct SecuritiesSettlementTransactionReversalAdviceV12 {
    ...
    pub sttlm_params: SettlementDetails223,
...
impl Validate for SecuritiesSettlementTransactionReversalAdviceV12 {}
...
impl Default for SecuritiesTransactionType22Code {
    fn default() -> SecuritiesTransactionType22Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for SecuritiesTransactionType22Code {}
...
pub enum SecuritiesTransactionType46ChoiceChoice {
    Cd(SecuritiesTransactionType22Code),
    Prtry(GenericIdentification30),
    __Unknown__(String),
}

impl Default for SecuritiesTransactionType46ChoiceChoice {
    fn default() -> SecuritiesTransactionType46ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for SecuritiesTransactionType46ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.026.001.12")]
pub struct SecuritiesTransactionType46Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub securities_transaction_type_46_choice_choice: SecuritiesTransactionType46ChoiceChoice,
}

impl Validate for SecuritiesTransactionType46Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.026.001.12")]
pub struct SettlementDetails223 {
    #[yaserde(rename = "Prty")]
    ...
    pub scties_tx_tp: SecuritiesTransactionType46Choice,
...
impl Validate for SettlementDetails223 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "sese.026.001.12";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:sese.026.001.12";
}
