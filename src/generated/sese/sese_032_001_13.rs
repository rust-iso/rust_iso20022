...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.032.001.13")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.032.001.13")]
...
pub struct Document {
    ...
    pub scties_sttlm_tx_gnrtn_ntfctn: SecuritiesSettlementTransactionGenerationNotificationV13,
}
...
pub enum ProcessingStatus104ChoiceChoice {
...
impl Default for ProcessingStatus104ChoiceChoice {
    fn default() -> ProcessingStatus104ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ProcessingStatus104ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.032.001.13")]
pub struct ProcessingStatus104Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub processing_status_104_choice_choice: ProcessingStatus104ChoiceChoice,
}

impl Validate for ProcessingStatus104Choice {}
...
pub enum References86ChoiceChoice {
...
impl Default for References86ChoiceChoice {
    fn default() -> References86ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for References86ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.032.001.13")]
pub struct References86Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub references_86_choice_choice: References86ChoiceChoice,
}

impl Validate for References86Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.032.001.13")]
pub struct SecuritiesSettlementTransactionGenerationNotificationV13 {
    #[yaserde(rename = "TxIdDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "TxIdDtls"))]
    pub tx_id_dtls: SettlementTypeAndIdentification29,
    ...
    pub qty_and_acct_dtls: Vec<QuantityAndAccount117>,

    #[yaserde(rename = "SttlmParams")]
    #[cfg_attr(feature = "serde", serde(rename = "SttlmParams"))]
    pub sttlm_params: SettlementDetails225,
    ...
    pub sttlm_amt: AmountAndDirection94,
    ...
    pub sts_and_rsn: StatusAndReason50,
...
impl Validate for SecuritiesSettlementTransactionGenerationNotificationV13 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.032.001.13")]
pub struct SecuritiesTradeDetails153 {
...
impl Validate for SecuritiesTradeDetails153 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.032.001.13")]
pub struct SettlementDetails225 {
    ...
    pub sttlm_tx_cond: Vec<SettlementTransactionCondition44Choice>,
...
impl Validate for SettlementDetails225 {}
...
pub enum SettlementTransactionCondition19Code {
    #[yaserde(rename = "ADEA")]
    #[cfg_attr(feature = "serde", serde(rename = "ADEA"))]
    Adea,
    #[yaserde(rename = "ASGN")]
...
impl Default for SettlementTransactionCondition19Code {
    fn default() -> SettlementTransactionCondition19Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for SettlementTransactionCondition19Code {}
...
pub enum SettlementTransactionCondition44ChoiceChoice {
    Cd(SettlementTransactionCondition19Code),
    Prtry(GenericIdentification30),
    __Unknown__(String),
}

impl Default for SettlementTransactionCondition44ChoiceChoice {
    fn default() -> SettlementTransactionCondition44ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for SettlementTransactionCondition44ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.032.001.13")]
pub struct SettlementTransactionCondition44Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub settlement_transaction_condition_44_choice_choice: SettlementTransactionCondition44ChoiceChoice,
}

impl Validate for SettlementTransactionCondition44Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.032.001.13")]
pub struct SettlementTypeAndIdentification29 {
...
impl Validate for SettlementTypeAndIdentification29 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.032.001.13")]
pub struct StatusAndReason50 {
    #[yaserde(rename = "PrcgSts")]
    #[cfg_attr(feature = "serde", serde(rename = "PrcgSts"))]
    pub prcg_sts: ProcessingStatus104Choice,
...
impl Validate for StatusAndReason50 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "sese.032.001.13";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:sese.032.001.13";
}
