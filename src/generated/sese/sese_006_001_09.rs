...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.006.001.09")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.006.001.09")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.006.001.09")]
pub struct Document {
    #[yaserde(rename = "TrfInCxlReq")]
    #[cfg_attr(feature = "serde", serde(rename = "TrfInCxlReq"))]
    pub trf_in_cxl_req: TransferInCancellationRequestV09,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.006.001.09")]
pub struct TransferInCancellationRequestV09 {
    ...
    #[yaserde(rename = "TrfRefs")]
    #[cfg_attr(feature = "serde", serde(rename = "TrfRefs"))]
    pub trf_refs: Vec<TransferReference15>,
...
impl Validate for TransferInCancellationRequestV09 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.006.001.09")]
pub struct TransferReference15 {
    ...
    pub cxl_rsn: Max35Text,
}

impl Validate for TransferReference15 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "sese.006.001.09";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:sese.006.001.09";
}
