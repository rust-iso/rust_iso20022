...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.018.001.10")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.018.001.10")]
pub struct AccountHoldingInformationV10 {
    ...
    pub pdct_trf: Vec<PortfolioTransfer16>,
...
impl Validate for AccountHoldingInformationV10 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.018.001.10")]
...
pub enum DateQuarter1ChoiceChoice {
    Dt(Isodate),
    Prd(Max35Text),
    __Unknown__(String),
}

impl Default for DateQuarter1ChoiceChoice {
    fn default() -> DateQuarter1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for DateQuarter1ChoiceChoice {}
...
pub struct DateQuarter1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub date_quarter_1_choice_choice: DateQuarter1ChoiceChoice,
}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.018.001.10")]
pub struct Document {
    #[yaserde(rename = "AcctHldgInf")]
    #[cfg_attr(feature = "serde", serde(rename = "AcctHldgInf"))]
    pub acct_hldg_inf: AccountHoldingInformationV10,
}
...
pub enum DrawdownStatus1ChoiceChoice {
    Cd(DrawdownStatus1Code),
    Prtry(GenericIdentification36),
    __Unknown__(String),
}

impl Default for DrawdownStatus1ChoiceChoice {
    fn default() -> DrawdownStatus1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for DrawdownStatus1ChoiceChoice {}
...
pub struct DrawdownStatus1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub drawdown_status_1_choice_choice: DrawdownStatus1ChoiceChoice,
}
...
pub enum FinancialInstrument102ChoiceChoice {
    Scty(FinancialInstrumentIdentification8),
    CshAsst(CashAsset2),
    OthrAsst(OtherAsset2),
    __Unknown__(String),
}

impl Default for FinancialInstrument102ChoiceChoice {
    fn default() -> FinancialInstrument102ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for FinancialInstrument102ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.018.001.10")]
pub struct FinancialInstrument102Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub financial_instrument_102_choice_choice: FinancialInstrument102ChoiceChoice,
}

impl Validate for FinancialInstrument102Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.018.001.10")]
pub struct FinancialInstrument110 {
    ...
    pub instrm: FinancialInstrument102Choice,
    ...
    pub avrg_acqstn_pric: ActiveOrHistoricCurrencyAndAmount,
    ...
    pub sttlm_pties_dtls: Vec<FundSettlementParameters24>,
...
impl Validate for FinancialInstrument110 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.018.001.10")]
pub struct FinancialInstrumentIdentification8 {
    #[yaserde(rename = "Id")]
    #[cfg_attr(feature = "serde", serde(rename = "Id"))]
    ...
    #[yaserde(rename = "AltrnScty")]
    #[cfg_attr(feature = "serde", serde(rename = "AltrnScty"))]
    pub altrn_scty: Vec<FinancialInstrumentIdentification9>,
}

impl Validate for FinancialInstrumentIdentification8 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.018.001.10")]
pub struct FinancialInstrumentIdentification9 {
    #[yaserde(rename = "Id")]
    #[cfg_attr(feature = "serde", serde(rename = "Id"))]
    pub id: SecurityIdentification46Choice,
    ...
    #[yaserde(rename = "AltrnSctyTp")]
    #[cfg_attr(feature = "serde", serde(rename = "AltrnSctyTp"))]
    pub altrn_scty_tp: GenericIdentification1,
}

impl Validate for FinancialInstrumentIdentification9 {}
...
pub enum FundPortfolio7ChoiceChoice {
    TaxEffcntPdct(TaxEfficientProduct7),
    GnlInvstmt(GeneralInvestment2),
    Pnsn(Pension5),
    __Unknown__(String),
}

impl Default for FundPortfolio7ChoiceChoice {
    fn default() -> FundPortfolio7ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for FundPortfolio7ChoiceChoice {}
...
pub struct FundPortfolio7Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub fund_portfolio_7_choice_choice: FundPortfolio7ChoiceChoice,
}
...
pub enum LumpSumType1ChoiceChoice {
    Cd(LumpSumType1Code),
    Prtry(GenericIdentification36),
    __Unknown__(String),
}

impl Default for LumpSumType1ChoiceChoice {
    fn default() -> LumpSumType1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for LumpSumType1ChoiceChoice {}
...
pub struct LumpSumType1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub lump_sum_type_1_choice_choice: LumpSumType1ChoiceChoice,
}
...
pub enum PensionOrderType1ChoiceChoice {
    Cd(PensionOrderType1Code),
    Prtry(GenericIdentification36),
    __Unknown__(String),
}

impl Default for PensionOrderType1ChoiceChoice {
    fn default() -> PensionOrderType1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for PensionOrderType1ChoiceChoice {}
...
pub struct PensionOrderType1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub pension_order_type_1_choice_choice: PensionOrderType1ChoiceChoice,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.018.001.10")]
pub struct PortfolioTransfer16 {
    ...
    #[yaserde(rename = "PrtlDscvry")]
    #[cfg_attr(feature = "serde", serde(rename = "PrtlDscvry"))]
    pub prtl_dscvry: YesNoIndicator,
    ...
    pub fin_instrm_asst_for_trf: Vec<FinancialInstrument110>,
...
impl Validate for PortfolioTransfer16 {}
...
pub enum PreviousYear1ChoiceChoice {
    AllPrvsYrs(PreviousAll),
    SpcfcPrvsYrs(Vec<Isoyear>),
    __Unknown__(String),
}

impl Default for PreviousYear1ChoiceChoice {
    fn default() -> PreviousYear1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for PreviousYear1ChoiceChoice {}
...
pub struct PreviousYear1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub previous_year_1_choice_choice: PreviousYear1ChoiceChoice,
}
...
pub struct ResidualCash1 {
    #[yaserde(rename = "RsdlCshInd")]
    #[cfg_attr(feature = "serde", serde(rename = "RsdlCshInd"))]
...
impl Validate for ResidualCash1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.018.001.10")]

pub enum Role4ChoiceChoice {
    Cd(InvestmentFundRole2Code),
    Prtry(GenericIdentification47),
    __Unknown__(String),
}

impl Default for Role4ChoiceChoice {
    fn default() -> Role4ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for Role4ChoiceChoice {}
...
pub struct Role4Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub role_4_choice_choice: Role4ChoiceChoice,
}
...
pub enum TypeOfAmount1ChoiceChoice {
    Cd(TaxWrapperAmountType1Code),
    Prtry(GenericIdentification36),
    __Unknown__(String),
}

impl Default for TypeOfAmount1ChoiceChoice {
    fn default() -> TypeOfAmount1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for TypeOfAmount1ChoiceChoice {}
...
pub struct TypeOfAmount1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub type_of_amount_1_choice_choice: TypeOfAmount1ChoiceChoice,
}
...
pub enum WithdrawalReason1ChoiceChoice {
    Cd(PortfolioWithdrawalReason1Code),
    Prtry(GenericIdentification36),
    __Unknown__(String),
}

impl Default for WithdrawalReason1ChoiceChoice {
    fn default() -> WithdrawalReason1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for WithdrawalReason1ChoiceChoice {}
...
pub struct WithdrawalReason1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub withdrawal_reason_1_choice_choice: WithdrawalReason1ChoiceChoice,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "sese.018.001.10";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:sese.018.001.10";
}
