...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.014.001.09")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.014.001.09")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.014.001.09")]
pub struct Document {
    #[yaserde(rename = "PrtflTrfCxlReq")]
    #[cfg_attr(feature = "serde", serde(rename = "PrtflTrfCxlReq"))]
    pub prtfl_trf_cxl_req: PortfolioTransferCancellationRequestV09,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.014.001.09")]
pub struct PortfolioTransferCancellationRequestV09 {
    ...
    pub trf_refs: TransferReference14,
...
impl Validate for PortfolioTransferCancellationRequestV09 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:sese.014.001.09")]
pub struct TransferReference14 {
...
impl Validate for TransferReference14 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "sese.014.001.09";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:sese.014.001.09";
}
