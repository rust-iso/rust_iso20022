...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.012.001.04")]
...
impl Validate for AccountAdditionalInformationRequestV04 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.012.001.04")]
...
pub struct Document {
    ...
    pub acct_addtl_inf_req: AccountAdditionalInformationRequestV04,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "acmt.012.001.04";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:acmt.012.001.04";
}
