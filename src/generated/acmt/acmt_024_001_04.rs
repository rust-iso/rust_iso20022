...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.024.001.04")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.024.001.04")]
...
pub struct Document {
    ...
    pub id_vrfctn_rpt: IdentificationVerificationReportV04,
}
...
pub struct IdentificationAssignment4 {
    ...
    pub frst_agt: BranchAndFinancialInstitutionIdentification8,
...
impl Validate for IdentificationAssignment4 {}
...
impl Validate for IdentificationInformation5 {}
...
pub struct IdentificationVerificationReportV04 {
    ...
    pub orgnl_assgnmt: MessageIdentification8,
...
impl Validate for IdentificationVerificationReportV04 {}
...
impl Validate for MessageIdentification8 {}
...
pub struct VerificationReport5 {
    ...
    pub orgnl_pty_and_acct_id: IdentificationInformation5,
...
impl Validate for VerificationReport5 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "acmt.024.001.04";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:acmt.024.001.04";
}
