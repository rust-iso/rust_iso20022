...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.019.001.03")]
pub struct AccountClosingRequestV03 {
    #[yaserde(rename = "Refs")]
    ...
    pub ctrct_dts: AccountContract4,
...
impl Validate for AccountClosingRequestV03 {}
...
impl Validate for AccountContract4 {}
...
impl Validate for AccountForAction2 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.019.001.03")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.019.001.03")]
pub struct Document {
    #[yaserde(rename = "AcctClsgReq")]
    #[cfg_attr(feature = "serde", serde(rename = "AcctClsgReq"))]
    pub acct_clsg_req: AccountClosingRequestV03,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "acmt.019.001.03";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:acmt.019.001.03";
}
