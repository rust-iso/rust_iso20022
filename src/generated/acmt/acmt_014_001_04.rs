...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.014.001.04")]
pub struct AccountContract3 {
    ...
    #[yaserde(rename = "GoLiveDt")]
    #[cfg_attr(feature = "serde", serde(rename = "GoLiveDt"))]
    pub go_live_dt: Isodate,
    ...
    #[yaserde(rename = "RmvlInd")]
    #[cfg_attr(feature = "serde", serde(rename = "RmvlInd"))]
    pub rmvl_ind: YesNoIndicator,
}

impl Validate for AccountContract3 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.014.001.04")]
...
pub struct AccountReport28 {
    ...
    pub ctrct_dts: AccountContract3,
    ...
    #[yaserde(rename = "BalTrfAcct")]
    #[cfg_attr(feature = "serde", serde(rename = "BalTrfAcct"))]
    pub bal_trf_acct: AccountForAction1,

    #[yaserde(rename = "TrfAcctSvcrId")]
    #[cfg_attr(feature = "serde", serde(rename = "TrfAcctSvcrId"))]
    pub trf_acct_svcr_id: BranchAndFinancialInstitutionIdentification6,
}

impl Validate for AccountReport28 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.014.001.04")]
pub struct AccountReportV04 {
    #[yaserde(rename = "Refs")]
...
impl Validate for AccountReportV04 {}
...
pub enum CommunicationFormat1ChoiceChoice {
    Cd(ExternalCommunicationFormat1Code),
    Prtry(Max35Text),
    __Unknown__(String),
}

impl Default for CommunicationFormat1ChoiceChoice {
    fn default() -> CommunicationFormat1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for CommunicationFormat1ChoiceChoice {}
...
pub struct CommunicationFormat1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub communication_format_1_choice_choice: CommunicationFormat1ChoiceChoice,
}
...
pub enum CommunicationMethod2ChoiceChoice {
    Cd(CommunicationMethod2Code),
    Prtry(Max35Text),
    __Unknown__(String),
}

impl Default for CommunicationMethod2ChoiceChoice {
    fn default() -> CommunicationMethod2ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for CommunicationMethod2ChoiceChoice {}
...
pub struct CommunicationMethod2Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub communication_method_2_choice_choice: CommunicationMethod2ChoiceChoice,
}
...
impl Validate for CustomerAccount5 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "acmt.014.001.04";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:acmt.014.001.04";
}
