...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.021.001.03")]
pub struct AccountClosingAdditionalInformationRequestV03 {
    #[yaserde(rename = "Refs")]
...
impl Validate for AccountClosingAdditionalInformationRequestV03 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.021.001.03")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.021.001.03")]
pub struct Document {
    #[yaserde(rename = "AcctClsgAddtlInfReq")]
    #[cfg_attr(feature = "serde", serde(rename = "AcctClsgAddtlInfReq"))]
    pub acct_clsg_addtl_inf_req: AccountClosingAdditionalInformationRequestV03,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "acmt.021.001.03";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:acmt.021.001.03";
}
