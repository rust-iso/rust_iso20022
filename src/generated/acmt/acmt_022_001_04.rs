...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.022.001.04")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.022.001.04")]
...
pub struct Document {
    ...
    pub id_mod_advc: IdentificationModificationAdviceV04,
}
...
impl Validate for IdentificationModification5 {}
...
pub struct IdentificationModificationAdviceV04 {
    ...
    pub orgnl_tx_ref: OriginalTransactionReference43,

    #[yaserde(rename = "Mod")]
    #[cfg_attr(feature = "serde", serde(rename = "Mod"))]
    pub _mod: Vec<IdentificationModification5>,
...
impl Validate for IdentificationModificationAdviceV04 {}
...
pub struct OriginalTransactionReference43 {
    ...
    pub orgnl_tx: Vec<PaymentIdentification15>,
}

impl Validate for OriginalTransactionReference43 {}
...
impl Validate for PaymentIdentification15 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "acmt.022.001.04";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:acmt.022.001.04";
}
