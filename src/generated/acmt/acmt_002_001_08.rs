...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08")]
...
pub struct AccountDetailsConfirmationV08 {
    ...
    pub rltd_ref: AdditionalReference13,

    #[yaserde(rename = "ConfDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "ConfDtls"))]
    pub conf_dtls: AccountManagementConfirmation5,

    #[yaserde(rename = "InvstmtAcct")]
    #[cfg_attr(feature = "serde", serde(rename = "InvstmtAcct"))]
    pub invstmt_acct: InvestmentAccount74,
...
impl Validate for AccountDetailsConfirmationV08 {}
...
impl Validate for AccountManagementConfirmation5 {}
...
impl Default for AccountManagementType2Code {
    fn default() -> AccountManagementType2Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for AccountManagementType2Code {}
...
pub enum ConfirmationType1ChoiceChoice {
    Cd(AccountManagementType2Code),
    Prtry(GenericIdentification47),
    __Unknown__(String),
}

impl Default for ConfirmationType1ChoiceChoice {
    fn default() -> ConfirmationType1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ConfirmationType1ChoiceChoice {}
...
pub struct ConfirmationType1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub confirmation_type_1_choice_choice: ConfirmationType1ChoiceChoice,
}

impl Validate for ConfirmationType1Choice {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08")]
pub struct Document {
    #[yaserde(rename = "AcctDtlsConf")]
    #[cfg_attr(feature = "serde", serde(rename = "AcctDtlsConf"))]
    pub acct_dtls_conf: AccountDetailsConfirmationV08,
}
...
pub struct InvestmentAccount74 {
    ...
    pub sts_dt: DateAndDateTime1Choice,
...
impl Validate for InvestmentAccount74 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "acmt.002.001.08";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:acmt.002.001.08";
}
