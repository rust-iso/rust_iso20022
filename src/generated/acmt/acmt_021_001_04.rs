...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.021.001.04")]
pub struct AccountClosingAdditionalInformationRequestV04 {
    #[yaserde(rename = "Refs")]
...
impl Validate for AccountClosingAdditionalInformationRequestV04 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.021.001.04")]
...
pub struct Document {
    ...
    pub acct_clsg_addtl_inf_req: AccountClosingAdditionalInformationRequestV04,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "acmt.021.001.04";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:acmt.021.001.04";
}
