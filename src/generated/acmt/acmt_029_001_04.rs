...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.029.001.04")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.029.001.04")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.029.001.04")]
pub struct AccountSwitchCancelExistingPaymentV04 {
    ...
    #[yaserde(rename = "PmtInstr")]
    #[cfg_attr(feature = "serde", serde(rename = "PmtInstr"))]
    pub pmt_instr: Vec<PaymentInstruction38>,

    #[yaserde(rename = "DrctDbtInstr")]
    #[cfg_attr(feature = "serde", serde(rename = "DrctDbtInstr"))]
...
impl Validate for AccountSwitchCancelExistingPaymentV04 {}
...
pub struct DirectDebitInstructionDetails2 {
    ...
    #[yaserde(rename = "AutomtdDrctDbtInstrInd")]
    #[cfg_attr(feature = "serde", serde(rename = "AutomtdDrctDbtInstrInd"))]
    pub automtd_drct_dbt_instr_ind: YesNoIndicator,

    #[yaserde(rename = "DrctDbtTrfblInd")]
    #[cfg_attr(feature = "serde", serde(rename = "DrctDbtTrfblInd"))]
    pub drct_dbt_trfbl_ind: YesNoIndicator,

    #[yaserde(rename = "Cdtr")]
    #[cfg_attr(feature = "serde", serde(rename = "Cdtr"))]
    pub cdtr: PartyIdentification135,

    #[yaserde(rename = "LastColltnCcyAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "LastColltnCcyAmt"))]
    pub last_colltn_ccy_amt: ActiveOrHistoricCurrencyAndAmount,

    #[yaserde(rename = "LastColltnDt")]
    #[cfg_attr(feature = "serde", serde(rename = "LastColltnDt"))]
    pub last_colltn_dt: Isodate,
...
impl Validate for DirectDebitInstructionDetails2 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.029.001.04")]
pub struct Document {
    #[yaserde(rename = "AcctSwtchCclExstgPmt")]
    #[cfg_attr(feature = "serde", serde(rename = "AcctSwtchCclExstgPmt"))]
    pub acct_swtch_ccl_exstg_pmt: AccountSwitchCancelExistingPaymentV04,
}
...
impl Validate for PaymentInstruction38 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "acmt.029.001.04";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:acmt.029.001.04";
}
