...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.015.001.05")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.015.001.05")]
pub struct AccountExcludedMandateMaintenanceRequestV05 {
    #[yaserde(rename = "Refs")]
...
impl Validate for AccountExcludedMandateMaintenanceRequestV05 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.015.001.05")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.015.001.05")]
...
impl Validate for AddressModification3 {}
...
pub struct Document {
    ...
    pub acct_excld_mndt_mntnc_req: AccountExcludedMandateMaintenanceRequestV05,
}
...
pub struct OrganisationModification3 {
    ...
    pub oprl_adr: AddressModification3,

    #[yaserde(rename = "BizAdr")]
    #[cfg_attr(feature = "serde", serde(rename = "BizAdr"))]
    pub biz_adr: AddressModification3,
    ...
    pub bllg_adr: AddressModification3,
...
impl Validate for PartyModification3 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "acmt.015.001.05";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:acmt.015.001.05";
}
