...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.027.001.04")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.027.001.04")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.027.001.04")]
pub struct AccountSwitchInformationRequestV04 {
...
impl Validate for AccountSwitchInformationRequestV04 {}
...
pub struct Document {
    ...
    pub acct_swtch_inf_req: AccountSwitchInformationRequestV04,
}
...
pub struct IndividualPerson36 {
    ...
    #[yaserde(rename = "PstlAdr")]
    #[cfg_attr(feature = "serde", serde(rename = "PstlAdr"))]
    pub pstl_adr: Vec<PostalAddress24>,
...
impl Validate for IndividualPerson36 {}
...
pub struct NewAccount3 {
    ...
    pub acct_pty: Vec<IndividualPerson36>,

    #[yaserde(rename = "Org")]
    #[cfg_attr(feature = "serde", serde(rename = "Org"))]
    pub org: Organisation35,
}

impl Validate for NewAccount3 {}
...
pub struct Organisation35 {
    ...
    pub rprtv_offcr: Vec<PartyIdentification135>,

    #[yaserde(rename = "TrsrMgr")]
    #[cfg_attr(feature = "serde", serde(rename = "TrsrMgr"))]
    pub trsr_mgr: PartyIdentification135,

    #[yaserde(rename = "MainMndtHldr")]
    #[cfg_attr(feature = "serde", serde(rename = "MainMndtHldr"))]
    pub main_mndt_hldr: Vec<PartyIdentification135>,

    #[yaserde(rename = "Sndr")]
    #[cfg_attr(feature = "serde", serde(rename = "Sndr"))]
    pub sndr: Vec<PartyIdentification135>,
}

impl Validate for Organisation35 {}
...
pub enum OtherIdentification1ChoiceChoice {
    Cd(PersonIdentificationType5Code),
    Prtry(GenericIdentification47),
    __Unknown__(String),
}

impl Default for OtherIdentification1ChoiceChoice {
    fn default() -> OtherIdentification1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for OtherIdentification1ChoiceChoice {}
...
pub struct OtherIdentification1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub other_identification_1_choice_choice: OtherIdentification1ChoiceChoice,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "acmt.027.001.04";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:acmt.027.001.04";
}
