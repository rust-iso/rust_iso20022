...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.036.001.01")]
...
impl Validate for AccountSwitchTerminationSwitchV01 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.036.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.036.001.01")]
pub struct Document {
    #[yaserde(rename = "AcctSwtchTermntnSwtch")]
    #[cfg_attr(feature = "serde", serde(rename = "AcctSwtchTermntnSwtch"))]
    pub acct_swtch_termntn_swtch: AccountSwitchTerminationSwitchV01,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "acmt.036.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:acmt.036.001.01";
}
