...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.029.001.06")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.029.001.06")]
pub struct AccountSwitchCancelExistingPaymentV06 {
    ...
    pub pmt_instr: Vec<PaymentInstruction49>,

    #[yaserde(rename = "DrctDbtInstr")]
    #[cfg_attr(feature = "serde", serde(rename = "DrctDbtInstr"))]
    pub drct_dbt_instr: Vec<DirectDebitInstructionDetails3>,
...
impl Validate for AccountSwitchCancelExistingPaymentV06 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.029.001.06")]
...
impl Validate for DirectDebitInstructionDetails3 {}
...
pub struct Document {
    ...
    pub acct_swtch_ccl_exstg_pmt: AccountSwitchCancelExistingPaymentV06,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.029.001.06")]
pub struct PaymentInstruction49 {
    ...
    pub cdt_trf_tx_inf: Vec<CreditTransferTransaction78>,
}

impl Validate for PaymentInstruction49 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "acmt.029.001.06";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:acmt.029.001.06";
}
