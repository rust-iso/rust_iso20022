...
pub struct AccountParties13Choice {
    ...
    pub trstee: Vec<InvestmentAccountOwnershipInformation17>,
    ...
    pub jnt_ownr: Vec<InvestmentAccountOwnershipInformation17>,
}
...
pub struct AccountSelection3Choice {
    ...
    #[yaserde(rename = "OthrAcctSelctnData")]
    #[cfg_attr(feature = "serde", serde(rename = "OthrAcctSelctnData"))]
...
pub struct AccountStatusUpdateInstructionReason1Choice {
    ...
    pub rsn: Vec<AccountStatusUpdateInstructionReason1>,
}
