...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08")]
...
pub struct AccountModificationInstructionV08 {
    ...
    pub instr_dtls: InvestmentAccountModification4,

    #[yaserde(rename = "InvstmtAcctSelctn")]
    #[cfg_attr(feature = "serde", serde(rename = "InvstmtAcctSelctn"))]
    pub invstmt_acct_selctn: AccountSelection3Choice,

    #[yaserde(rename = "ModfdInvstmtAcct")]
    #[cfg_attr(feature = "serde", serde(rename = "ModfdInvstmtAcct"))]
    pub modfd_invstmt_acct: InvestmentAccount75,

    #[yaserde(rename = "ModfdAcctPties")]
    #[cfg_attr(feature = "serde", serde(rename = "ModfdAcctPties"))]
    pub modfd_acct_pties: Vec<AccountParties18>,

    #[yaserde(rename = "ModfdIntrmies")]
    #[cfg_attr(feature = "serde", serde(rename = "ModfdIntrmies"))]
    pub modfd_intrmies: Vec<ModificationScope40>,

    #[yaserde(rename = "ModfdPlcmnt")]
    #[cfg_attr(feature = "serde", serde(rename = "ModfdPlcmnt"))]
    pub modfd_plcmnt: ModificationScope43,

    #[yaserde(rename = "ModfdIsseAllcn")]
    #[cfg_attr(feature = "serde", serde(rename = "ModfdIsseAllcn"))]
    pub modfd_isse_allcn: ModificationScope21,

    #[yaserde(rename = "ModfdSvgsInvstmtPlan")]
    #[cfg_attr(feature = "serde", serde(rename = "ModfdSvgsInvstmtPlan"))]
    pub modfd_svgs_invstmt_plan: Vec<ModificationScope41>,

    #[yaserde(rename = "ModfdWdrwlInvstmtPlan")]
    #[cfg_attr(feature = "serde", serde(rename = "ModfdWdrwlInvstmtPlan"))]
    pub modfd_wdrwl_invstmt_plan: Vec<ModificationScope41>,

    #[yaserde(rename = "ModfdCshSttlm")]
    #[cfg_attr(feature = "serde", serde(rename = "ModfdCshSttlm"))]
    pub modfd_csh_sttlm: Vec<CashSettlement4>,

    #[yaserde(rename = "ModfdSvcLvlAgrmt")]
    #[cfg_attr(feature = "serde", serde(rename = "ModfdSvcLvlAgrmt"))]
    pub modfd_svc_lvl_agrmt: Vec<ModificationScope44>,

    #[yaserde(rename = "ModfdAddtlInf")]
    #[cfg_attr(feature = "serde", serde(rename = "ModfdAddtlInf"))]
...
impl Validate for AccountModificationInstructionV08 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08")]

pub enum AccountOwner3ChoiceChoice {
    IndvOwnrId(IndividualPersonIdentification3Choice),
    OrgOwnrId(PartyIdentification220),
    __Unknown__(String),
}

impl Default for AccountOwner3ChoiceChoice {
    fn default() -> AccountOwner3ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for AccountOwner3ChoiceChoice {}
...
pub struct AccountOwner3Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub account_owner_3_choice_choice: AccountOwner3ChoiceChoice,
}

impl Validate for AccountOwner3Choice {}
...
pub enum AccountParties13ChoiceChoice {
    PmryOwnr(InvestmentAccountOwnershipInformation17),
    Trstee(Vec<InvestmentAccountOwnershipInformation17>),
    Nmnee(InvestmentAccountOwnershipInformation17),
    JntOwnr(Vec<InvestmentAccountOwnershipInformation17>),
    __Unknown__(String),
}

impl Default for AccountParties13ChoiceChoice {
    fn default() -> AccountParties13ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for AccountParties13ChoiceChoice {}
...
pub struct AccountParties13Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub account_parties_13_choice_choice: AccountParties13ChoiceChoice,
}

impl Validate for AccountParties13Choice {}
...
pub struct AccountParties18 {
    #[yaserde(rename = "ModScpIndctn")]
    #[cfg_attr(feature = "serde", serde(rename = "ModScpIndctn"))]
    pub mod_scp_indctn: DataModification1Code,

    #[yaserde(rename = "PrncplAcctPty")]
    #[cfg_attr(feature = "serde", serde(rename = "PrncplAcctPty"))]
    pub prncpl_acct_pty: AccountParties13Choice,
...
impl Validate for AccountParties18 {}
...
pub enum AccountSelection3ChoiceChoice {
    AcctId(Max35Text),
    OthrAcctSelctnData(InvestmentAccount76),
    __Unknown__(String),
}

impl Default for AccountSelection3ChoiceChoice {
    fn default() -> AccountSelection3ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for AccountSelection3ChoiceChoice {}
...
pub struct AccountSelection3Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub account_selection_3_choice_choice: AccountSelection3ChoiceChoice,
}

impl Validate for AccountSelection3Choice {}
...
pub struct AccountStatusUpdateInstruction1 {
    #[yaserde(rename = "UpdInstr")]
    #[cfg_attr(feature = "serde", serde(rename = "UpdInstr"))]
    pub upd_instr: AccountStatusUpdateInstruction1Choice,

    #[yaserde(rename = "UpdInstrRsn")]
    #[cfg_attr(feature = "serde", serde(rename = "UpdInstrRsn"))]
    pub upd_instr_rsn: AccountStatusUpdateInstructionReason1Choice,
}

impl Validate for AccountStatusUpdateInstruction1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08")]

pub enum AccountStatusUpdateInstruction1ChoiceChoice {
    Cd(AccountStatusUpdateInstruction1Code),
    Prtry(GenericIdentification36),
    __Unknown__(String),
}

impl Default for AccountStatusUpdateInstruction1ChoiceChoice {
    fn default() -> AccountStatusUpdateInstruction1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for AccountStatusUpdateInstruction1ChoiceChoice {}
...
pub struct AccountStatusUpdateInstruction1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub account_status_update_instruction_1_choice_choice: AccountStatusUpdateInstruction1ChoiceChoice,
}

impl Validate for AccountStatusUpdateInstruction1Choice {}
...
impl Default for AccountStatusUpdateInstruction1Code {
    fn default() -> AccountStatusUpdateInstruction1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for AccountStatusUpdateInstruction1Code {}
...
pub struct AccountStatusUpdateInstructionReason1 {
    ...
    pub cd: AccountStatusUpdateInstructionReason2Choice,
...
impl Validate for AccountStatusUpdateInstructionReason1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08")]

pub enum AccountStatusUpdateInstructionReason1ChoiceChoice {
    NoSpcfdRsn(NoReasonCode),
    Rsn(Vec<AccountStatusUpdateInstructionReason1>),
    __Unknown__(String),
}

impl Default for AccountStatusUpdateInstructionReason1ChoiceChoice {
    fn default() -> AccountStatusUpdateInstructionReason1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for AccountStatusUpdateInstructionReason1ChoiceChoice {}
...
pub struct AccountStatusUpdateInstructionReason1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub account_status_update_instruction_reason_1_choice_choice: AccountStatusUpdateInstructionReason1ChoiceChoice,
}

impl Validate for AccountStatusUpdateInstructionReason1Choice {}
...
pub enum AccountStatusUpdateInstructionReason2ChoiceChoice {
    Cd(AccountStatusUpdateRequestReason1Code),
    Prtry(GenericIdentification36),
    __Unknown__(String),
}

impl Default for AccountStatusUpdateInstructionReason2ChoiceChoice {
    fn default() -> AccountStatusUpdateInstructionReason2ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for AccountStatusUpdateInstructionReason2ChoiceChoice {}
...
pub struct AccountStatusUpdateInstructionReason2Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub account_status_update_instruction_reason_2_choice_choice: AccountStatusUpdateInstructionReason2ChoiceChoice,
}

impl Validate for AccountStatusUpdateInstructionReason2Choice {}
...
pub enum AccountStatusUpdateRequestReason1Code {
    #[yaserde(rename = "CLOE")]
    #[cfg_attr(feature = "serde", serde(rename = "CLOE"))]
    Cloe,
    __Unknown__(String),
}

impl Default for AccountStatusUpdateRequestReason1Code {
    fn default() -> AccountStatusUpdateRequestReason1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for AccountStatusUpdateRequestReason1Code {}
...
impl Validate for CashSettlement4 {}
...
impl Default for DataModification2Code {
    fn default() -> DataModification2Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for DataModification2Code {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08")]
pub struct Document {
    #[yaserde(rename = "AcctModInstr")]
    #[cfg_attr(feature = "serde", serde(rename = "AcctModInstr"))]
...
impl Validate for ExtendedParty15 {}
...
impl Validate for FinancialInstrument55 {}
...
impl Validate for IndividualPerson35 {}
...
pub struct IndividualPerson38 {
    ...
    #[yaserde(rename = "ModfdPstlAdr")]
    #[cfg_attr(feature = "serde", serde(rename = "ModfdPstlAdr"))]
    pub modfd_pstl_adr: Vec<ModificationScope34>,

    #[yaserde(rename = "ModfdCtznsh")]
    #[cfg_attr(feature = "serde", serde(rename = "ModfdCtznsh"))]
...
impl Validate for IndividualPerson38 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08")]

pub enum IndividualPersonIdentification3ChoiceChoice {
    IdNb(GenericIdentification81),
    PrsnNm(IndividualPerson35),
    __Unknown__(String),
}

impl Default for IndividualPersonIdentification3ChoiceChoice {
    fn default() -> IndividualPersonIdentification3ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for IndividualPersonIdentification3ChoiceChoice {}
...
pub struct IndividualPersonIdentification3Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub individual_person_identification_3_choice_choice: IndividualPersonIdentification3ChoiceChoice,
}

impl Validate for IndividualPersonIdentification3Choice {}
...
impl Validate for Intermediary47 {}
...
pub struct InvestmentAccount75 {
    #[yaserde(rename = "AcctStsUpdInstr")]
    #[cfg_attr(feature = "serde", serde(rename = "AcctStsUpdInstr"))]
    pub acct_sts_upd_instr: AccountStatusUpdateInstruction1,
    ...
    #[yaserde(rename = "ModfdFinInstrmDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "ModfdFinInstrmDtls"))]
    ...
    #[yaserde(rename = "ModfdInvstrPrfl")]
    #[cfg_attr(feature = "serde", serde(rename = "ModfdInvstrPrfl"))]
...
impl Validate for InvestmentAccount75 {}
...
pub struct InvestmentAccount76 {
    ...
    #[yaserde(rename = "FndTp")]
    #[cfg_attr(feature = "serde", serde(rename = "FndTp"))]
    pub fnd_tp: Max35Text,
    ...
    pub scty_dtls: FinancialInstrument55,

    #[yaserde(rename = "AcctOwnr")]
    #[cfg_attr(feature = "serde", serde(rename = "AcctOwnr"))]
    pub acct_ownr: AccountOwner3Choice,
...
impl Validate for InvestmentAccount76 {}
...
pub struct InvestmentAccountModification4 {
    #[yaserde(rename = "ModRsn")]
    #[cfg_attr(feature = "serde", serde(rename = "ModRsn"))]
    pub mod_rsn: Max350Text,
...
impl Validate for InvestmentAccountModification4 {}
...
pub struct InvestmentAccountOwnershipInformation17 {
    ...
    #[yaserde(rename = "ModfdInvstrPrflVldtn")]
    #[cfg_attr(feature = "serde", serde(rename = "ModfdInvstrPrflVldtn"))]
...
impl Validate for InvestmentAccountOwnershipInformation17 {}
...
impl Validate for InvestmentPlan16 {}
...
pub struct ModificationScope21 {
    ...
    #[yaserde(rename = "IsseAllcn")]
    #[cfg_attr(feature = "serde", serde(rename = "IsseAllcn"))]
    pub isse_allcn: NewIssueAllocation2,
}

impl Validate for ModificationScope21 {}
...
impl Validate for ModificationScope27 {}
...
impl Validate for ModificationScope34 {}
...
impl Validate for ModificationScope39 {}
...
impl Validate for ModificationScope40 {}
...
pub struct ModificationScope41 {
    ...
    #[yaserde(rename = "InvstmtPlan")]
    #[cfg_attr(feature = "serde", serde(rename = "InvstmtPlan"))]
    pub invstmt_plan: InvestmentPlan16,
}

impl Validate for ModificationScope41 {}
...
impl Validate for ModificationScope42 {}
...
impl Validate for ModificationScope43 {}
...
impl Validate for ModificationScope44 {}
...
impl Validate for ModificationScope45 {}
...
impl Validate for ModificationScope46 {}
...
impl Validate for NameAndAddress15 {}
...
impl Validate for Organisation40 {}
...
pub enum Party48ChoiceChoice {
    Org(Organisation40),
    IndvPrsn(IndividualPerson38),
    __Unknown__(String),
}

impl Default for Party48ChoiceChoice {
    fn default() -> Party48ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for Party48ChoiceChoice {}
...
pub struct Party48Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub party_48_choice_choice: Party48ChoiceChoice,
}

impl Validate for Party48Choice {}
...
pub enum PartyIdentification182ChoiceChoice {
    AnyBIC(AnyBICDec2014Identifier),
    PrtryId(GenericIdentification1),
    NmAndAdr(NameAndAddress15),
    TaxIdNb(Max35Text),
    NtlRegnNb(Max35Text),
    __Unknown__(String),
}

impl Default for PartyIdentification182ChoiceChoice {
    fn default() -> PartyIdentification182ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for PartyIdentification182ChoiceChoice {}
...
pub struct PartyIdentification182Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub party_identification_182_choice_choice: PartyIdentification182ChoiceChoice,
}

impl Validate for PartyIdentification182Choice {}
...
pub struct PartyIdentification220 {
    #[yaserde(rename = "Id")]
    #[cfg_attr(feature = "serde", serde(rename = "Id"))]
    pub id: PartyIdentification182Choice,
...
impl Validate for PartyIdentification220 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "acmt.003.001.08";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:acmt.003.001.08";
}
