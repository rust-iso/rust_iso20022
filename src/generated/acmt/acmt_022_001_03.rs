...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.022.001.03")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.022.001.03")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.022.001.03")]
pub struct Document {
    #[yaserde(rename = "IdModAdvc")]
    #[cfg_attr(feature = "serde", serde(rename = "IdModAdvc"))]
    pub id_mod_advc: IdentificationModificationAdviceV03,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.022.001.03")]
pub struct IdentificationModification4 {
    #[yaserde(rename = "Id")]
    #[cfg_attr(feature = "serde", serde(rename = "Id"))]
    pub id: Max35Text,
...
impl Validate for IdentificationModification4 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.022.001.03")]
pub struct IdentificationModificationAdviceV03 {
    ...
    pub orgnl_tx_ref: OriginalTransactionReference30,

    #[yaserde(rename = "Mod")]
    #[cfg_attr(feature = "serde", serde(rename = "Mod"))]
    pub _mod: Vec<IdentificationModification4>,
...
impl Validate for IdentificationModificationAdviceV03 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.022.001.03")]
pub struct OriginalTransactionReference30 {
    #[yaserde(rename = "MsgId")]
    #[cfg_attr(feature = "serde", serde(rename = "MsgId"))]
    pub msg_id: Max35Text,
    ...
    pub orgnl_tx: Vec<PaymentIdentification5>,
}

impl Validate for OriginalTransactionReference30 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.022.001.03")]
pub struct PaymentIdentification5 {
...
impl Validate for PaymentIdentification5 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "acmt.022.001.03";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:acmt.022.001.03";
}
