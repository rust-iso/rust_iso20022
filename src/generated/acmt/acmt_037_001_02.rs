...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.037.001.02")]
...
impl Validate for AccountSwitchTechnicalRejectionV02 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.037.001.02")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.037.001.02")]
pub struct Document {
    #[yaserde(rename = "AcctSwtchTechRjctn")]
    #[cfg_attr(feature = "serde", serde(rename = "AcctSwtchTechRjctn"))]
    pub acct_swtch_tech_rjctn: AccountSwitchTechnicalRejectionV02,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "acmt.037.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:acmt.037.001.02";
}
