...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.024.001.03")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.024.001.03")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.024.001.03")]
pub struct Document {
    #[yaserde(rename = "IdVrfctnRpt")]
    #[cfg_attr(feature = "serde", serde(rename = "IdVrfctnRpt"))]
    pub id_vrfctn_rpt: IdentificationVerificationReportV03,
}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct ExternalVerificationReason1Code (pub String);
crate::simple_type!(ExternalVerificationReason1Code);

impl Validate for ExternalVerificationReason1Code {
    fn validate(&self) -> Result<(), String> { 
        #[allow(clippy::len_zero)]
        if self.0.len() < 1 {
            return Err(format!("MinLength validation error. \nExpected: 0 length >= 1 \nActual: 0 length == {}", self.0.len()));
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.024.001.03")]
pub struct IdentificationAssignment3 {
    ...
    pub frst_agt: BranchAndFinancialInstitutionIdentification6,
...
impl Validate for IdentificationAssignment3 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.024.001.03")]
pub struct IdentificationInformation4 {
    #[yaserde(rename = "Pty")]
...
impl Validate for IdentificationInformation4 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct IdentificationVerificationIndicator (pub bool);
crate::simple_type!(IdentificationVerificationIndicator);

impl Validate for IdentificationVerificationIndicator {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.024.001.03")]
pub struct IdentificationVerificationReportV03 {
    #[yaserde(rename = "Assgnmt")]
    #[cfg_attr(feature = "serde", serde(rename = "Assgnmt"))]
    pub assgnmt: IdentificationAssignment3,

    #[yaserde(rename = "OrgnlAssgnmt")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlAssgnmt"))]
    pub orgnl_assgnmt: MessageIdentification7,

    #[yaserde(rename = "Rpt")]
    #[cfg_attr(feature = "serde", serde(rename = "Rpt"))]
    pub rpt: Vec<VerificationReport4>,
...
impl Validate for IdentificationVerificationReportV03 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.024.001.03")]
pub struct MessageIdentification7 {
    #[yaserde(rename = "MsgId")]
    #[cfg_attr(feature = "serde", serde(rename = "MsgId"))]
    pub msg_id: Max35Text,
...
impl Validate for MessageIdentification7 {}
...
pub enum VerificationReason1ChoiceChoice {
    Cd(ExternalVerificationReason1Code),
    Prtry(Max35Text),
    __Unknown__(String),
}

impl Default for VerificationReason1ChoiceChoice {
    fn default() -> VerificationReason1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for VerificationReason1ChoiceChoice {}
...
pub struct VerificationReason1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub verification_reason_1_choice_choice: VerificationReason1ChoiceChoice,
}

impl Validate for VerificationReason1Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:acmt.024.001.03")]
pub struct VerificationReport4 {
    ...
    pub vrfctn: IdentificationVerificationIndicator,

    #[yaserde(rename = "Rsn")]
    #[cfg_attr(feature = "serde", serde(rename = "Rsn"))]
    pub rsn: VerificationReason1Choice,

    #[yaserde(rename = "OrgnlPtyAndAcctId")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlPtyAndAcctId"))]
    pub orgnl_pty_and_acct_id: IdentificationInformation4,

    #[yaserde(rename = "UpdtdPtyAndAcctId")]
    #[cfg_attr(feature = "serde", serde(rename = "UpdtdPtyAndAcctId"))]
    pub updtd_pty_and_acct_id: IdentificationInformation4,
}

impl Validate for VerificationReport4 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "acmt.024.001.03";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:acmt.024.001.03";
}
