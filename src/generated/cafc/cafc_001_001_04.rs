...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cafc.001.001.04")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cafc.001.001.04")]
...
impl Validate for AcceptorData4 {}
...
pub struct Document {
    ...
    pub fee_colltn_initn: FeeCollectionInitiationV04,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cafc.001.001.04")]
pub struct FeeCollectionInitiationV04 {
    #[yaserde(rename = "Hdr")]
    ...
    pub tx_chrtcs: TransactionCharacteristics7,
    ...
    #[yaserde(rename = "FeeColltnRef")]
    #[cfg_attr(feature = "serde", serde(rename = "FeeColltnRef"))]
    pub fee_colltn_ref: Vec<FeeCollectionReference3>,
...
impl Validate for FeeCollectionInitiationV04 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cafc.001.001.04")]
pub struct FeeCollectionReference3 {
    #[yaserde(rename = "AssgnrNtty")]
    #[cfg_attr(feature = "serde", serde(rename = "AssgnrNtty"))]
    pub assgnr_ntty: AticapartyType1Code,
...
impl Validate for FeeCollectionReference3 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cafc.001.001.04")]
pub struct TransactionCharacteristics7 {
    #[yaserde(rename = "TxTp")]
    #[cfg_attr(feature = "serde", serde(rename = "TxTp"))]
    pub tx_tp: Iso8583TransactionTypeCode,
    ...
    #[yaserde(rename = "FeeColltnCycl")]
    #[cfg_attr(feature = "serde", serde(rename = "FeeColltnCycl"))]
    pub fee_colltn_cycl: Exact1NumericText,
...
impl Validate for TransactionCharacteristics7 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "cafc.001.001.04";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:cafc.001.001.04";
}
