...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsmt.008.001.03")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsmt.008.001.03")]
pub struct AmendmentRejectionNotificationV03 {
    ...
    #[yaserde(rename = "DltaRptRef")]
    #[cfg_attr(feature = "serde", serde(rename = "DltaRptRef"))]
    pub dlta_rpt_ref: MessageIdentification1,

    #[yaserde(rename = "RjctdAmdmntNb")]
    #[cfg_attr(feature = "serde", serde(rename = "RjctdAmdmntNb"))]
...
impl Validate for AmendmentRejectionNotificationV03 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsmt.008.001.03")]
pub struct Document {
    #[yaserde(rename = "AmdmntRjctnNtfctn")]
    #[cfg_attr(feature = "serde", serde(rename = "AmdmntRjctnNtfctn"))]
    pub amdmnt_rjctn_ntfctn: AmendmentRejectionNotificationV03,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "tsmt.008.001.03";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:tsmt.008.001.03";
}
