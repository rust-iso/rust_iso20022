...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsmt.023.001.03")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsmt.023.001.03")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsmt.023.001.03")]
pub struct Document {
    #[yaserde(rename = "MisMtchRjctnNtfctn")]
    #[cfg_attr(feature = "serde", serde(rename = "MisMtchRjctnNtfctn"))]
...
impl Validate for MisMatchRejectionNotificationV03 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "tsmt.023.001.03";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:tsmt.023.001.03";
}
