...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsmt.013.001.03")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsmt.013.001.03")]
...
impl Validate for DataSetMatchReportV03 {}
...
pub enum DataSetType2Code {
    ...
    Base,
    #[yaserde(rename = "TRDS")]
    #[cfg_attr(feature = "serde", serde(rename = "TRDS"))]
    Trds,
    #[yaserde(rename = "CODS")]
    #[cfg_attr(feature = "serde", serde(rename = "CODS"))]
    Cods,
    #[yaserde(rename = "INDS")]
    #[cfg_attr(feature = "serde", serde(rename = "INDS"))]
    Inds,
    #[yaserde(rename = "CEDS")]
    #[cfg_attr(feature = "serde", serde(rename = "CEDS"))]
    Ceds,
    #[yaserde(rename = "OCDS")]
    #[cfg_attr(feature = "serde", serde(rename = "OCDS"))]
    Ocds,
    __Unknown__(String),
}

impl Default for DataSetType2Code {
    fn default() -> DataSetType2Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for DataSetType2Code {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsmt.013.001.03")]
pub struct Document {
    #[yaserde(rename = "DataSetMtchRpt")]
    #[cfg_attr(feature = "serde", serde(rename = "DataSetMtchRpt"))]
...
impl Validate for DocumentIdentification10 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "tsmt.013.001.03";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:tsmt.013.001.03";
}
