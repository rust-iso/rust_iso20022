...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsmt.029.001.02")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsmt.029.001.02")]
pub struct Document {
    #[yaserde(rename = "StsChngReqRjctn")]
    #[cfg_attr(feature = "serde", serde(rename = "StsChngReqRjctn"))]
    pub sts_chng_req_rjctn: StatusChangeRequestRejectionV02,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsmt.029.001.02")]
pub struct StatusChangeRequestRejectionV02 {
...
impl Validate for StatusChangeRequestRejectionV02 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "tsmt.029.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:tsmt.029.001.02";
}
