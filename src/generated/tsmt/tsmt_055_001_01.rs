...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsmt.055.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsmt.055.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsmt.055.001.01")]
pub struct Document {
    #[yaserde(rename = "PtyEvtAdvc")]
    #[cfg_attr(feature = "serde", serde(rename = "PtyEvtAdvc"))]
    pub pty_evt_advc: PartyEventAdviceV01,
}
...
pub struct EventDescription1 {
    ...
    #[yaserde(rename = "RltdLttr")]
    #[cfg_attr(feature = "serde", serde(rename = "RltdLttr"))]
    pub rltd_lttr: Vec<String>,

    #[yaserde(rename = "RltdMsg")]
    #[cfg_attr(feature = "serde", serde(rename = "RltdMsg"))]
    pub rltd_msg: Vec<String>,
...
impl Validate for EventDescription1 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsmt.055.001.01")]
pub struct PartyEventAdviceV01 {
    #[yaserde(rename = "Hdr")]
    #[cfg_attr(feature = "serde", serde(rename = "Hdr"))]
    pub hdr: BusinessLetter1,

    #[yaserde(rename = "EvtNtce")]
    #[cfg_attr(feature = "serde", serde(rename = "EvtNtce"))]
    pub evt_ntce: Vec<EventDescription1>,

    #[yaserde(rename = "EvtCnt")]
    #[cfg_attr(feature = "serde", serde(rename = "EvtCnt"))]
    pub evt_cnt: Max15NumericText,
...
impl Validate for PartyEventAdviceV01 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "tsmt.055.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:tsmt.055.001.01";
}
