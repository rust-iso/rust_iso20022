...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.05")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.05")]
...
pub enum BankContactPerson1ChoiceChoice {
    BuyrBkCtctPrsn(Vec<ContactIdentification1>),
    SellrBkCtctPrsn(Vec<ContactIdentification1>),
    __Unknown__(String),
}

impl Default for BankContactPerson1ChoiceChoice {
    fn default() -> BankContactPerson1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for BankContactPerson1ChoiceChoice {}
...
pub struct BankContactPerson1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub bank_contact_person_1_choice_choice: BankContactPerson1ChoiceChoice,
}

impl Validate for BankContactPerson1Choice {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.05")]
pub struct Document {
    #[yaserde(rename = "InitlBaselnSubmissn")]
    #[cfg_attr(feature = "serde", serde(rename = "InitlBaselnSubmissn"))]
...
pub struct InitialBaselineSubmissionV05 {
    ...
    #[yaserde(rename = "BkCtctPrsn")]
    #[cfg_attr(feature = "serde", serde(rename = "BkCtctPrsn"))]
...
impl Validate for InitialBaselineSubmissionV05 {}
...
impl Validate for InstructionType1 {}
...
pub enum InstructionType1Code {
    ...
    Lodg,
    #[yaserde(rename = "FPTR")]
    #[cfg_attr(feature = "serde", serde(rename = "FPTR"))]
    Fptr,
    __Unknown__(String),
}

impl Default for InstructionType1Code {
    fn default() -> InstructionType1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for InstructionType1Code {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "tsmt.019.001.05";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.05";
}
