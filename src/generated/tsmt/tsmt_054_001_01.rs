...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsmt.054.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsmt.054.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsmt.054.001.01")]
pub struct Document {
    #[yaserde(rename = "InvcPmtRcncltnSts")]
    #[cfg_attr(feature = "serde", serde(rename = "InvcPmtRcncltnSts"))]
    pub invc_pmt_rcncltn_sts: InvoicePaymentReconciliationStatusV01,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsmt.054.001.01")]
pub struct InvoicePaymentReconciliationStatusV01 {
    #[yaserde(rename = "Hdr")]
    #[cfg_attr(feature = "serde", serde(rename = "Hdr"))]
    pub hdr: BusinessLetter1,

    #[yaserde(rename = "RcncltnList")]
    #[cfg_attr(feature = "serde", serde(rename = "RcncltnList"))]
    pub rcncltn_list: Vec<ReconciliationList1>,

    #[yaserde(rename = "RcncltnCnt")]
    #[cfg_attr(feature = "serde", serde(rename = "RcncltnCnt"))]
    pub rcncltn_cnt: Max15NumericText,
...
impl Validate for InvoicePaymentReconciliationStatusV01 {}
...
impl Validate for PaymentPeriod1 {}
...
pub struct PaymentTerms6 {
    ...
    #[yaserde(rename = "PmtPrd")]
    #[cfg_attr(feature = "serde", serde(rename = "PmtPrd"))]
    pub pmt_prd: PaymentPeriod1,

    #[yaserde(rename = "Desc")]
    #[cfg_attr(feature = "serde", serde(rename = "Desc"))]
    pub desc: Vec<Max140Text>,

    #[yaserde(rename = "PrtlPmtPct")]
    #[cfg_attr(feature = "serde", serde(rename = "PrtlPmtPct"))]
    pub prtl_pmt_pct: PercentageRate,

    #[yaserde(rename = "DrctDbtMndtId")]
    #[cfg_attr(feature = "serde", serde(rename = "DrctDbtMndtId"))]
    pub drct_dbt_mndt_id: Vec<Max35Text>,

    #[yaserde(rename = "BsisAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "BsisAmt"))]
    pub bsis_amt: CurrencyAndAmount,

    #[yaserde(rename = "DscntAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "DscntAmt"))]
    pub dscnt_amt: CurrencyAndAmount,

    #[yaserde(rename = "DscntPctRate")]
    #[cfg_attr(feature = "serde", serde(rename = "DscntPctRate"))]
    pub dscnt_pct_rate: PercentageRate,

    #[yaserde(rename = "PnltyAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "PnltyAmt"))]
    pub pnlty_amt: CurrencyAndAmount,

    #[yaserde(rename = "PnltyPctRate")]
    #[cfg_attr(feature = "serde", serde(rename = "PnltyPctRate"))]
    pub pnlty_pct_rate: PercentageRate,
}

impl Validate for PaymentTerms6 {}
...
impl Default for PaymentTime1Code {
    fn default() -> PaymentTime1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for PaymentTime1Code {}
...
pub struct ReconciliationList1 {
    ...
    #[yaserde(rename = "Advsr")]
    #[cfg_attr(feature = "serde", serde(rename = "Advsr"))]
    pub advsr: String,
    ...
    #[yaserde(rename = "PmtMeans")]
    #[cfg_attr(feature = "serde", serde(rename = "PmtMeans"))]
...
impl Validate for ReconciliationList1 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "tsmt.054.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:tsmt.054.001.01";
}
