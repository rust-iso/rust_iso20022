...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsmt.024.001.03")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsmt.024.001.03")]
pub struct ActionReminderV03 {
    #[yaserde(rename = "RmndrId")]
    #[cfg_attr(feature = "serde", serde(rename = "RmndrId"))]
    ...
    #[yaserde(rename = "MsgReqrngActn")]
    #[cfg_attr(feature = "serde", serde(rename = "MsgReqrngActn"))]
...
impl Validate for ActionReminderV03 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsmt.024.001.03")]
pub struct Document {
    #[yaserde(rename = "ActnRmndr")]
    #[cfg_attr(feature = "serde", serde(rename = "ActnRmndr"))]
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "tsmt.024.001.03";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:tsmt.024.001.03";
}
