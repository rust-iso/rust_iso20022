...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:secl.003.001.03")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:secl.003.001.03")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:secl.003.001.03")]
pub struct Document {
    #[yaserde(rename = "TradLegStmt")]
    #[cfg_attr(feature = "serde", serde(rename = "TradLegStmt"))]
    pub trad_leg_stmt: TradeLegStatementV03,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:secl.003.001.03")]
pub struct Statement31 {
    #[yaserde(rename = "StmtId")]
    #[cfg_attr(feature = "serde", serde(rename = "StmtId"))]
    pub stmt_id: Max35Text,

    #[yaserde(rename = "StmtDtAndTm")]
    #[cfg_attr(feature = "serde", serde(rename = "StmtDtAndTm"))]
    pub stmt_dt_and_tm: DateAndDateTimeChoice,
...
impl Validate for TradeLeg9 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:secl.003.001.03")]
pub struct TradeLegStatement3 {
    #[yaserde(rename = "ClrAcct")]
    #[cfg_attr(feature = "serde", serde(rename = "ClrAcct"))]
    pub clr_acct: SecuritiesAccount18,
    ...
    #[yaserde(rename = "TradLegsDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "TradLegsDtls"))]
    pub trad_legs_dtls: Vec<TradeLeg9>,
}

impl Validate for TradeLegStatement3 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:secl.003.001.03")]
pub struct TradeLegStatementV03 {
    #[yaserde(rename = "StmtParams")]
    #[cfg_attr(feature = "serde", serde(rename = "StmtParams"))]
    pub stmt_params: Statement31,
    ...
    pub stmt_dtls: Vec<TradeLegStatement3>,
...
impl Validate for TradeLegStatementV03 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "secl.003.001.03";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:secl.003.001.03";
}
