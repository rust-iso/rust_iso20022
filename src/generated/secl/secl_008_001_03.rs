...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:secl.008.001.03")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:secl.008.001.03")]
...
pub struct BuyIn3 {
    ...
    #[yaserde(rename = "ReqForDelyInd")]
    #[cfg_attr(feature = "serde", serde(rename = "ReqForDelyInd"))]
    pub req_for_dely_ind: YesNoIndicator,
    ...
    pub initl_qty: FinancialInstrumentQuantity1Choice,

    #[yaserde(rename = "CvrdQty")]
    #[cfg_attr(feature = "serde", serde(rename = "CvrdQty"))]
    pub cvrd_qty: FinancialInstrumentQuantity1Choice,

    #[yaserde(rename = "UcvrdQty")]
    #[cfg_attr(feature = "serde", serde(rename = "UcvrdQty"))]
    pub ucvrd_qty: FinancialInstrumentQuantity1Choice,
}

impl Validate for BuyIn3 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:secl.008.001.03")]
pub struct BuyInResponseV03 {
    #[yaserde(rename = "TxId")]
    #[cfg_attr(feature = "serde", serde(rename = "TxId"))]
    pub tx_id: Max35Text,

    #[yaserde(rename = "BuyInRspnDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "BuyInRspnDtls"))]
    pub buy_in_rspn_dtls: BuyIn3,

    #[yaserde(rename = "OrgnlSttlmOblgtnDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlSttlmOblgtnDtls"))]
    pub orgnl_sttlm_oblgtn_dtls: SettlementObligation7,
...
impl Validate for BuyInResponseV03 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:secl.008.001.03")]
pub struct Document {
    #[yaserde(rename = "BuyInRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "BuyInRspn"))]
    pub buy_in_rspn: BuyInResponseV03,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "secl.008.001.03";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:secl.008.001.03";
}
