...
pub enum DateFormat11ChoiceChoice {
    Dt(DateAndDateTimeChoice),
    DtCd(DateCode3Choice),
    __Unknown__(String),
}

impl Default for DateFormat11ChoiceChoice {
    fn default() -> DateFormat11ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for DateFormat11ChoiceChoice {}
...
pub struct DateFormat11Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub date_format_11_choice_choice: DateFormat11ChoiceChoice,
}
...
pub enum ObligationType1ChoiceChoice {
    Cd(ObligationType1Code),
    Prtry(GenericIdentification30),
    __Unknown__(String),
}

impl Default for ObligationType1ChoiceChoice {
    fn default() -> ObligationType1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ObligationType1ChoiceChoice {}
...
pub struct ObligationType1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub obligation_type_1_choice_choice: ObligationType1ChoiceChoice,
}
...
pub enum SettlementParties2ChoiceChoice {
    DlvrgSttlmPties(DeliveringPartiesAndAccount7),
    RcvgSttlmPties(ReceivingPartiesAndAccount7),
    __Unknown__(String),
}

impl Default for SettlementParties2ChoiceChoice {
    fn default() -> SettlementParties2ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for SettlementParties2ChoiceChoice {}
...
pub struct SettlementParties2Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub settlement_parties_2_choice_choice: SettlementParties2ChoiceChoice,
}
...
pub enum SettlementParties4ChoiceChoice {
    DlvrgSttlmPties(DeliveringPartiesAndAccount11),
    RcvgSttlmPties(ReceivingPartiesAndAccount11),
    __Unknown__(String),
}

impl Default for SettlementParties4ChoiceChoice {
    fn default() -> SettlementParties4ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for SettlementParties4ChoiceChoice {}
...
pub struct SettlementParties4Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub settlement_parties_4_choice_choice: SettlementParties4ChoiceChoice,
}
...
pub enum TradeDate3ChoiceChoice {
    Dt(Isodate),
    DtCd(DateType1Code),
    __Unknown__(String),
}

impl Default for TradeDate3ChoiceChoice {
    fn default() -> TradeDate3ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for TradeDate3ChoiceChoice {}
...
pub struct TradeDate3Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub trade_date_3_choice_choice: TradeDate3ChoiceChoice,
}
