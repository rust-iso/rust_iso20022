...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:secl.003.001.05")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:secl.003.001.05")]
...
pub struct Document {
    ...
    pub trad_leg_stmt: TradeLegStatementV05,
}
...
pub struct Statement86 {
    ...
    pub stmt_dt_and_tm: DateAndDateTime2Choice,
...
impl Validate for TradeLeg15 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:secl.003.001.05")]
pub struct TradeLegStatement5 {
    #[yaserde(rename = "ClrAcct")]
    #[cfg_attr(feature = "serde", serde(rename = "ClrAcct"))]
    pub clr_acct: SecuritiesAccount18,
    ...
    pub trad_legs_dtls: Vec<TradeLeg15>,
}

impl Validate for TradeLegStatement5 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:secl.003.001.05")]
pub struct TradeLegStatementV05 {
    #[yaserde(rename = "StmtParams")]
    #[cfg_attr(feature = "serde", serde(rename = "StmtParams"))]
    pub stmt_params: Statement86,
    ...
    pub stmt_dtls: Vec<TradeLegStatement5>,
...
impl Validate for TradeLegStatementV05 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "secl.003.001.05";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:secl.003.001.05";
}
