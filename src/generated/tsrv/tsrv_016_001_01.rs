...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsrv.016.001.01")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsrv.016.001.01")]
...
pub struct DemandRefusal1 {
    ...
    pub sts: Refused7Text,

    #[yaserde(rename = "Dscrpncy")]
    #[cfg_attr(feature = "serde", serde(rename = "Dscrpncy"))]
    pub dscrpncy: Vec<Discrepancy1>,

    #[yaserde(rename = "DspstnOfDocs")]
    #[cfg_attr(feature = "serde", serde(rename = "DspstnOfDocs"))]
    pub dspstn_of_docs: Vec<Max2000Text>,
...
impl Validate for DemandRefusal1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsrv.016.001.01")]
pub struct DemandRefusalNotificationV01 {
    #[yaserde(rename = "DmndRfslNtfctnDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "DmndRfslNtfctnDtls"))]
    pub dmnd_rfsl_ntfctn_dtls: Vec<DemandRefusal1>,
...
impl Validate for DemandRefusalNotificationV01 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsrv.016.001.01")]
pub struct Discrepancy1 {
    #[yaserde(rename = "Id")]
    #[cfg_attr(feature = "serde", serde(rename = "Id"))]
    pub id: Max35Text,
    ...
    pub nrrtv: Max20000Text,
}

impl Validate for Discrepancy1 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsrv.016.001.01")]
pub struct Document {
    #[yaserde(rename = "DmndRfslNtfctn")]
    #[cfg_attr(feature = "serde", serde(rename = "DmndRfslNtfctn"))]
    pub dmnd_rfsl_ntfctn: DemandRefusalNotificationV01,
}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct Refused7Text (pub String);
crate::simple_type!(Refused7Text);

impl Validate for Refused7Text {
    fn validate(&self) -> Result<(), String> { 
        if self.0.len() != 7 {
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "tsrv.016.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:tsrv.016.001.01";
}
