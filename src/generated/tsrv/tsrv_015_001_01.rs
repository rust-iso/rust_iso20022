...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsrv.015.001.01")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsrv.015.001.01")]
...
impl Default for DemandStatus1Code {
    fn default() -> DemandStatus1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for DemandStatus1Code {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsrv.015.001.01")]
pub struct Document {
    #[yaserde(rename = "XtndOrPayRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "XtndOrPayRspn"))]
    pub xtnd_or_pay_rspn: ExtendOrPayResponseV01,
}
...
impl Validate for ExtendOrPayQuery2 {}
...
pub struct ExtendOrPayResponseV01 {
    #[yaserde(rename = "XtndOrPayRspnDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "XtndOrPayRspnDtls"))]
...
impl Validate for ExtendOrPayResponseV01 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "tsrv.015.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:tsrv.015.001.01";
}
