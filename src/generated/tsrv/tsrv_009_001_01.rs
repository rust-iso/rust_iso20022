...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsrv.009.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsrv.009.001.01")]
pub struct Amendment7 {
    #[yaserde(rename = "AmdmntId")]
    #[cfg_attr(feature = "serde", serde(rename = "AmdmntId"))]
    pub amdmnt_id: Amendment8,

    #[yaserde(rename = "AmdmntSts")]
    #[cfg_attr(feature = "serde", serde(rename = "AmdmntSts"))]
    pub amdmnt_sts: UndertakingStatus2Code,
}

impl Validate for Amendment7 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsrv.009.001.01")]
pub struct Amendment8 {
    #[yaserde(rename = "Id")]
...
impl Validate for Amendment8 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsrv.009.001.01")]
pub struct Amendment9 {
    #[yaserde(rename = "UdrtkgAmdmntRspnMsg")]
    #[cfg_attr(feature = "serde", serde(rename = "UdrtkgAmdmntRspnMsg"))]
    pub udrtkg_amdmnt_rspn_msg: UndertakingAmendmentResponseMessage1,
}

impl Validate for Amendment9 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsrv.009.001.01")]
pub struct Document {
    #[yaserde(rename = "UdrtkgAmdmntRspnNtfctn")]
    #[cfg_attr(feature = "serde", serde(rename = "UdrtkgAmdmntRspnNtfctn"))]
    pub udrtkg_amdmnt_rspn_ntfctn: UndertakingAmendmentResponseNotificationV01,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsrv.009.001.01")]
pub struct UndertakingAmendmentResponseMessage1 {
    #[yaserde(rename = "UdrtkgAmdmntRspnDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "UdrtkgAmdmntRspnDtls"))]
    pub udrtkg_amdmnt_rspn_dtls: Amendment7,
...
impl Validate for UndertakingAmendmentResponseMessage1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsrv.009.001.01")]
pub struct UndertakingAmendmentResponseNotificationV01 {
    #[yaserde(rename = "UdrtkgAmdmntRspnNtfctnDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "UdrtkgAmdmntRspnNtfctnDtls"))]
    pub udrtkg_amdmnt_rspn_ntfctn_dtls: Amendment9,
...
impl Validate for UndertakingAmendmentResponseNotificationV01 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsrv.009.001.01")]

pub enum UndertakingStatus2Code {
    #[yaserde(rename = "ACCP")]
...
impl Default for UndertakingStatus2Code {
    fn default() -> UndertakingStatus2Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for UndertakingStatus2Code {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "tsrv.009.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:tsrv.009.001.01";
}
