...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsrv.014.001.01")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsrv.014.001.01")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsrv.014.001.01")]
pub struct BankInstructions1 {
    #[yaserde(rename = "Txt")]
    #[cfg_attr(feature = "serde", serde(rename = "Txt"))]
    pub txt: Vec<Max2000Text>,

    #[yaserde(rename = "LastDtForRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "LastDtForRspn"))]
    pub last_dt_for_rspn: Isodate,
}

impl Validate for BankInstructions1 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsrv.014.001.01")]
pub struct Document {
    #[yaserde(rename = "XtndOrPayReq")]
    #[cfg_attr(feature = "serde", serde(rename = "XtndOrPayReq"))]
    pub xtnd_or_pay_req: ExtendOrPayRequestV01,
}
...
pub struct ExtendOrPayQuery1 {
    ...
    pub dmnd_dtls: Demand2,

    #[yaserde(rename = "ReqdXpryDt")]
    #[cfg_attr(feature = "serde", serde(rename = "ReqdXpryDt"))]
    pub reqd_xpry_dt: Isodate,

    #[yaserde(rename = "BkInstrs")]
    #[cfg_attr(feature = "serde", serde(rename = "BkInstrs"))]
    pub bk_instrs: BankInstructions1,

    #[yaserde(rename = "BkCtct")]
    #[cfg_attr(feature = "serde", serde(rename = "BkCtct"))]
    pub bk_ctct: Vec<Contacts3>,
...
impl Validate for ExtendOrPayQuery1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:tsrv.014.001.01")]
pub struct ExtendOrPayRequestV01 {
    #[yaserde(rename = "XtndOrPayReqDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "XtndOrPayReqDtls"))]
    pub xtnd_or_pay_req_dtls: ExtendOrPayQuery1,
...
impl Validate for ExtendOrPayRequestV01 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "tsrv.014.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:tsrv.014.001.01";
}
