...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:canm.001.001.05")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:canm.001.001.05")]
...
pub struct Document {
    ...
    pub ntwk_mgmt_initn: NetworkManagementInitiationV05,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:canm.001.001.05")]
pub struct NetworkManagementInitiationV05 {
    #[yaserde(rename = "Hdr")]
...
impl Validate for NetworkManagementInitiationV05 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "canm.001.001.05";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:canm.001.001.05";
}
