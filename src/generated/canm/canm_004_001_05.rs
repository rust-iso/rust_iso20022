...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:canm.004.001.05")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:canm.004.001.05")]
...
pub struct Document {
    ...
    pub key_xchg_rspn: KeyExchangeResponseV05,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:canm.004.001.05")]
pub struct KeyExchangeResponseV05 {
    #[yaserde(rename = "Hdr")]
...
impl Validate for KeyExchangeResponseV05 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "canm.004.001.05";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:canm.004.001.05";
}
