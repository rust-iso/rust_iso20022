...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:canm.003.001.05")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:canm.003.001.05")]
...
impl Default for CardServiceType7Code {
    fn default() -> CardServiceType7Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for CardServiceType7Code {}
...
pub struct Document {
    ...
    pub key_xchg_initn: KeyExchangeInitiationV05,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:canm.003.001.05")]
pub struct KeyExchangeInitiationV05 {
    #[yaserde(rename = "Hdr")]
    ...
    pub key_xchg_fctn: CardServiceType7Code,
...
impl Validate for KeyExchangeInitiationV05 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:canm.003.001.05")]

pub enum KeyType2Code {
    #[yaserde(rename = "PTKA")]
...
impl Default for KeyType2Code {
    fn default() -> KeyType2Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for KeyType2Code {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "canm.003.001.05";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:canm.003.001.05";
}
