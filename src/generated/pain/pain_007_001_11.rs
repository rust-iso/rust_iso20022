...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.007.001.11")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.007.001.11")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.007.001.11")]
pub struct CustomerPaymentReversalV11 {
    ...
    #[yaserde(rename = "OrgnlPmtInfAndRvsl")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlPmtInfAndRvsl"))]
    pub orgnl_pmt_inf_and_rvsl: Vec<OriginalPaymentInstruction41>,
...
impl Validate for CustomerPaymentReversalV11 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.007.001.11")]
pub struct Document {
    #[yaserde(rename = "CstmrPmtRvsl")]
    #[cfg_attr(feature = "serde", serde(rename = "CstmrPmtRvsl"))]
    pub cstmr_pmt_rvsl: CustomerPaymentReversalV11,
}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct ExternalReversalReason1Code (pub String);
crate::simple_type!(ExternalReversalReason1Code);

impl Validate for ExternalReversalReason1Code {
    fn validate(&self) -> Result<(), String> { 
        #[allow(clippy::len_zero)]
        if self.0.len() < 1 {
            return Err(format!("MinLength validation error. \nExpected: 0 length >= 1 \nActual: 0 length == {}", self.0.len()));
...
pub struct GroupHeader88 {
    ...
    #[yaserde(rename = "GrpRvsl")]
    #[cfg_attr(feature = "serde", serde(rename = "GrpRvsl"))]
    pub grp_rvsl: TrueFalseIndicator,
...
impl Validate for GroupHeader88 {}
...
pub struct OriginalGroupHeader16 {
    ...
    #[yaserde(rename = "RvslRsnInf")]
    #[cfg_attr(feature = "serde", serde(rename = "RvslRsnInf"))]
    pub rvsl_rsn_inf: Vec<PaymentReversalReason9>,
}

impl Validate for OriginalGroupHeader16 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.007.001.11")]
pub struct OriginalPaymentInstruction41 {
    #[yaserde(rename = "RvslPmtInfId")]
    #[cfg_attr(feature = "serde", serde(rename = "RvslPmtInfId"))]
    pub rvsl_pmt_inf_id: Max35Text,
    ...
    #[yaserde(rename = "PmtInfRvsl")]
    #[cfg_attr(feature = "serde", serde(rename = "PmtInfRvsl"))]
    pub pmt_inf_rvsl: TrueFalseIndicator,
    ...
    pub tx_inf: Vec<PaymentTransaction134>,
}

impl Validate for OriginalPaymentInstruction41 {}
...
impl Validate for PaymentReversalReason9 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.007.001.11")]
pub struct PaymentTransaction134 {
    #[yaserde(rename = "RvslId")]
    #[cfg_attr(feature = "serde", serde(rename = "RvslId"))]
    pub rvsl_id: Max35Text,
    ...
    #[yaserde(rename = "RvsdInstdAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "RvsdInstdAmt"))]
    pub rvsd_instd_amt: ActiveOrHistoricCurrencyAndAmount,
...
impl Validate for PaymentTransaction134 {}
...
pub enum ReversalReason4ChoiceChoice {
    Cd(ExternalReversalReason1Code),
    Prtry(Max35Text),
    __Unknown__(String),
}

impl Default for ReversalReason4ChoiceChoice {
    fn default() -> ReversalReason4ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ReversalReason4ChoiceChoice {}
...
pub struct ReversalReason4Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub reversal_reason_4_choice_choice: ReversalReason4ChoiceChoice,
}

impl Validate for ReversalReason4Choice {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "pain.007.001.11";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:pain.007.001.11";
}
