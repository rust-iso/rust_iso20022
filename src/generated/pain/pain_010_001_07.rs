...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.010.001.07")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.010.001.07")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.010.001.07")]
pub struct Document {
    #[yaserde(rename = "MndtAmdmntReq")]
    #[cfg_attr(feature = "serde", serde(rename = "MndtAmdmntReq"))]
    pub mndt_amdmnt_req: MandateAmendmentRequestV07,
}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct ExternalMandateReason1Code (pub String);
crate::simple_type!(ExternalMandateReason1Code);

impl Validate for ExternalMandateReason1Code {
    fn validate(&self) -> Result<(), String> { 
        #[allow(clippy::len_zero)]
        if self.0.len() < 1 {
            return Err(format!("MinLength validation error. \nExpected: 0 length >= 1 \nActual: 0 length == {}", self.0.len()));
...
pub struct MandateAmendment7 {
    ...
    pub amdmnt_rsn: MandateAmendmentReason2,
...
impl Validate for MandateAmendment7 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.010.001.07")]
pub struct MandateAmendmentReason2 {
...
impl Validate for MandateAmendmentReason2 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.010.001.07")]
pub struct MandateAmendmentRequestV07 {
    #[yaserde(rename = "GrpHdr")]
    #[cfg_attr(feature = "serde", serde(rename = "GrpHdr"))]
    pub grp_hdr: GroupHeader80,

    #[yaserde(rename = "UndrlygAmdmntDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "UndrlygAmdmntDtls"))]
    pub undrlyg_amdmnt_dtls: Vec<MandateAmendment7>,
...
impl Validate for MandateAmendmentRequestV07 {}
...
pub enum MandateReason1ChoiceChoice {
    Cd(ExternalMandateReason1Code),
    Prtry(Max35Text),
    __Unknown__(String),
}

impl Default for MandateReason1ChoiceChoice {
    fn default() -> MandateReason1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for MandateReason1ChoiceChoice {}
...
pub struct MandateReason1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub mandate_reason_1_choice_choice: MandateReason1ChoiceChoice,
}

impl Validate for MandateReason1Choice {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "pain.010.001.07";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:pain.010.001.07";
}
