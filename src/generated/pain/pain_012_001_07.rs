...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.012.001.07")]
pub struct AcceptanceResult6 {
    #[yaserde(rename = "Accptd")]
    #[cfg_attr(feature = "serde", serde(rename = "Accptd"))]
    pub accptd: YesNoIndicator,

    #[yaserde(rename = "RjctRsn")]
    #[cfg_attr(feature = "serde", serde(rename = "RjctRsn"))]
    pub rjct_rsn: MandateReason1Choice,

    #[yaserde(rename = "AddtlRjctRsnInf")]
    #[cfg_attr(feature = "serde", serde(rename = "AddtlRjctRsnInf"))]
    pub addtl_rjct_rsn_inf: Vec<Max105Text>,
}

impl Validate for AcceptanceResult6 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.012.001.07")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.012.001.07")]
pub struct Document {
    #[yaserde(rename = "MndtAccptncRpt")]
    #[cfg_attr(feature = "serde", serde(rename = "MndtAccptncRpt"))]
    pub mndt_accptnc_rpt: MandateAcceptanceReportV07,
}
...
impl Validate for MandateAcceptance7 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.012.001.07")]
pub struct MandateAcceptanceReportV07 {
    #[yaserde(rename = "GrpHdr")]
    #[cfg_attr(feature = "serde", serde(rename = "GrpHdr"))]
    pub grp_hdr: GroupHeader80,

    #[yaserde(rename = "UndrlygAccptncDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "UndrlygAccptncDtls"))]
    pub undrlyg_accptnc_dtls: Vec<MandateAcceptance7>,
...
impl Validate for MandateAcceptanceReportV07 {}
...
pub enum OriginalMandate8ChoiceChoice {
    OrgnlMndtId(Max35Text),
    OrgnlMndt(Mandate16),
    __Unknown__(String),
}

impl Default for OriginalMandate8ChoiceChoice {
    fn default() -> OriginalMandate8ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for OriginalMandate8ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.012.001.07")]
pub struct OriginalMandate8Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub original_mandate_8_choice_choice: OriginalMandate8ChoiceChoice,
}

impl Validate for OriginalMandate8Choice {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "pain.012.001.07";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:pain.012.001.07";
}
