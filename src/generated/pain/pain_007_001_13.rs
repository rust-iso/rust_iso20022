...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.007.001.13")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.007.001.13")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.007.001.13")]
pub struct CustomerPaymentReversalV13 {
    #[yaserde(rename = "GrpHdr")]
    #[cfg_attr(feature = "serde", serde(rename = "GrpHdr"))]
    pub grp_hdr: GroupHeader124,
    ...
    pub orgnl_pmt_inf_and_rvsl: Vec<OriginalPaymentInstruction53>,
...
impl Validate for CustomerPaymentReversalV13 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.007.001.13")]
...
pub struct Document {
    ...
    pub cstmr_pmt_rvsl: CustomerPaymentReversalV13,
}
...
impl Validate for GroupHeader124 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.007.001.13")]
pub struct OriginalPaymentInstruction53 {
    ...
    pub tx_inf: Vec<PaymentTransaction174>,
}

impl Validate for OriginalPaymentInstruction53 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.007.001.13")]
pub struct PaymentTransaction174 {
...
impl Validate for PaymentTransaction174 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "pain.007.001.13";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:pain.007.001.13";
}
