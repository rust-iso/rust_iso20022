...
pub enum AdviceType1ChoiceChoice {
    Cd(AdviceType1Code),
    Prtry(Max35Text),
    __Unknown__(String),
}

impl Default for AdviceType1ChoiceChoice {
    fn default() -> AdviceType1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for AdviceType1ChoiceChoice {}
...
pub struct AdviceType1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub advice_type_1_choice_choice: AdviceType1ChoiceChoice,
}
