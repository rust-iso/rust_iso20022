...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.017.001.03")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.017.001.03")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.017.001.03")]
pub struct Document {
    #[yaserde(rename = "MndtCpyReq")]
    #[cfg_attr(feature = "serde", serde(rename = "MndtCpyReq"))]
    pub mndt_cpy_req: MandateCopyRequestV03,
}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct ExternalMandateStatus1Code (pub String);
crate::simple_type!(ExternalMandateStatus1Code);

impl Validate for ExternalMandateStatus1Code {
    fn validate(&self) -> Result<(), String> { 
        #[allow(clippy::len_zero)]
        if self.0.len() < 1 {
            return Err(format!("MinLength validation error. \nExpected: 0 length >= 1 \nActual: 0 length == {}", self.0.len()));
...
pub struct MandateCopy3 {
    ...
    #[yaserde(rename = "MndtSts")]
    #[cfg_attr(feature = "serde", serde(rename = "MndtSts"))]
    pub mndt_sts: MandateStatus1Choice,
...
impl Validate for MandateCopy3 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.017.001.03")]
pub struct MandateCopyRequestV03 {
    #[yaserde(rename = "GrpHdr")]
    #[cfg_attr(feature = "serde", serde(rename = "GrpHdr"))]
    pub grp_hdr: GroupHeader80,

    #[yaserde(rename = "UndrlygCpyReqDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "UndrlygCpyReqDtls"))]
    pub undrlyg_cpy_req_dtls: Vec<MandateCopy3>,
...
impl Validate for MandateCopyRequestV03 {}
...
pub enum MandateStatus1ChoiceChoice {
    Cd(ExternalMandateStatus1Code),
    Prtry(Max35Text),
    __Unknown__(String),
}

impl Default for MandateStatus1ChoiceChoice {
    fn default() -> MandateStatus1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for MandateStatus1ChoiceChoice {}
...
pub struct MandateStatus1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub mandate_status_1_choice_choice: MandateStatus1ChoiceChoice,
}

impl Validate for MandateStatus1Choice {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "pain.017.001.03";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:pain.017.001.03";
}
