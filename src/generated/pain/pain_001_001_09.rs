...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.001.001.09")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.001.001.09")]
...
impl Validate for CreditTransferTransaction34 {}
...
pub struct Document {
    ...
    pub cstmr_cdt_trf_initn: CustomerCreditTransferInitiationV09,
}
...
impl Validate for GroupHeader85 {}
...
pub struct PaymentInstruction30 {
    ...
    pub cdt_trf_tx_inf: Vec<CreditTransferTransaction34>,
}

impl Validate for PaymentInstruction30 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "pain.001.001.09";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.09";
}
