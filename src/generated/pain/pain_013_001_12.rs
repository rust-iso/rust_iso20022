...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.013.001.12")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.013.001.12")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.013.001.12")]
pub struct CreditTransferTransaction74 {
...
impl Validate for CreditTransferTransaction74 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.013.001.12")]
pub struct CreditorPaymentActivationRequestV12 {
    #[yaserde(rename = "GrpHdr")]
    #[cfg_attr(feature = "serde", serde(rename = "GrpHdr"))]
    pub grp_hdr: GroupHeader112,

    #[yaserde(rename = "PmtInf")]
    #[cfg_attr(feature = "serde", serde(rename = "PmtInf"))]
    pub pmt_inf: Vec<PaymentInstruction48>,
...
impl Validate for CreditorPaymentActivationRequestV12 {}
...
pub struct Document {
    ...
    pub cdtr_pmt_actvtn_req: CreditorPaymentActivationRequestV12,
}
...
impl Validate for GroupHeader112 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.013.001.12")]
pub struct PaymentInstruction48 {
    ...
    pub cdt_trf_tx: Vec<CreditTransferTransaction74>,
}

impl Validate for PaymentInstruction48 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "pain.013.001.12";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:pain.013.001.12";
}
