...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.014.001.09")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.014.001.09")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.014.001.09")]
pub struct CreditorPaymentActivationRequestStatusReportV09 {
    ...
    pub orgnl_pmt_inf_and_sts: Vec<OriginalPaymentInstruction42>,
...
impl Validate for CreditorPaymentActivationRequestStatusReportV09 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.014.001.09")]
pub struct Document {
    #[yaserde(rename = "CdtrPmtActvtnReqStsRpt")]
    #[cfg_attr(feature = "serde", serde(rename = "CdtrPmtActvtnReqStsRpt"))]
    pub cdtr_pmt_actvtn_req_sts_rpt: CreditorPaymentActivationRequestStatusReportV09,
}
...
pub enum DocumentType1ChoiceChoice {
    Cd(ExternalDocumentType1Code),
    Prtry(GenericIdentification1),
    __Unknown__(String),
}

impl Default for DocumentType1ChoiceChoice {
    fn default() -> DocumentType1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for DocumentType1ChoiceChoice {}
...
pub struct DocumentType1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub document_type_1_choice_choice: DocumentType1ChoiceChoice,
}
...
impl Validate for GroupHeader87 {}
...
impl Validate for OriginalGroupInformation30 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.014.001.09")]
pub struct OriginalPaymentInstruction42 {
    ...
    #[yaserde(rename = "PmtInfSts")]
    #[cfg_attr(feature = "serde", serde(rename = "PmtInfSts"))]
    pub pmt_inf_sts: ExternalPaymentGroupStatus1Code,
    ...
    pub tx_inf_and_sts: Vec<PaymentTransaction136>,
}

impl Validate for OriginalPaymentInstruction42 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.014.001.09")]
pub struct OriginalTransactionReference37 {
    #[yaserde(rename = "Amt")]
    #[cfg_attr(feature = "serde", serde(rename = "Amt"))]
...
impl Validate for OriginalTransactionReference37 {}
...
pub struct PaymentConditionStatus1 {
    ...
    pub accptd_amt: ActiveCurrencyAndAmount,

    #[yaserde(rename = "GrntedPmt")]
    #[cfg_attr(feature = "serde", serde(rename = "GrntedPmt"))]
    pub grnted_pmt: TrueFalseIndicator,

    #[yaserde(rename = "EarlyPmt")]
    #[cfg_attr(feature = "serde", serde(rename = "EarlyPmt"))]
    pub early_pmt: TrueFalseIndicator,
}

impl Validate for PaymentConditionStatus1 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.014.001.09")]
pub struct PaymentTransaction136 {
    ...
    #[yaserde(rename = "PmtCondSts")]
    #[cfg_attr(feature = "serde", serde(rename = "PmtCondSts"))]
    pub pmt_cond_sts: PaymentConditionStatus1,

    #[yaserde(rename = "ChrgsInf")]
    #[cfg_attr(feature = "serde", serde(rename = "ChrgsInf"))]
    pub chrgs_inf: Vec<Charges7>,

    #[yaserde(rename = "DbtrDcsnDtTm")]
    #[cfg_attr(feature = "serde", serde(rename = "DbtrDcsnDtTm"))]
    pub dbtr_dcsn_dt_tm: IsodateTime,
    ...
    pub orgnl_tx_ref: OriginalTransactionReference37,
...
impl Validate for PaymentTransaction136 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "pain.014.001.09";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:pain.014.001.09";
}
