...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.008.001.10")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.008.001.10")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.008.001.10")]
pub struct CustomerDirectDebitInitiationV10 {
    ...
    pub pmt_inf: Vec<PaymentInstruction39>,
...
impl Validate for CustomerDirectDebitInitiationV10 {}
...
pub struct DirectDebitTransaction11 {
    ...
    pub mndt_rltd_inf: MandateRelatedInformation15,

    #[yaserde(rename = "CdtrSchmeId")]
    #[cfg_attr(feature = "serde", serde(rename = "CdtrSchmeId"))]
    pub cdtr_schme_id: PartyIdentification135,

    #[yaserde(rename = "PreNtfctnId")]
    #[cfg_attr(feature = "serde", serde(rename = "PreNtfctnId"))]
    pub pre_ntfctn_id: Max35Text,

    #[yaserde(rename = "PreNtfctnDt")]
    #[cfg_attr(feature = "serde", serde(rename = "PreNtfctnDt"))]
    pub pre_ntfctn_dt: Isodate,
}

impl Validate for DirectDebitTransaction11 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.008.001.10")]
pub struct DirectDebitTransactionInformation28 {
    ...
    pub pmt_tp_inf: PaymentTypeInformation29,
    ...
    #[yaserde(rename = "DrctDbtTx")]
    #[cfg_attr(feature = "serde", serde(rename = "DrctDbtTx"))]
    pub drct_dbt_tx: DirectDebitTransaction11,
    ...
    pub instr_for_cdtr_agt: Max140Text,
...
impl Validate for DirectDebitTransactionInformation28 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.008.001.10")]
pub struct Document {
    #[yaserde(rename = "CstmrDrctDbtInitn")]
    #[cfg_attr(feature = "serde", serde(rename = "CstmrDrctDbtInitn"))]
    pub cstmr_drct_dbt_initn: CustomerDirectDebitInitiationV10,
}
...
impl Validate for GroupHeader83 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pain.008.001.10")]
pub struct PaymentInstruction39 {
    ...
    pub drct_dbt_tx_inf: Vec<DirectDebitTransactionInformation28>,
}

impl Validate for PaymentInstruction39 {}
...
impl Default for PaymentMethod2Code {
    fn default() -> PaymentMethod2Code {
        Self::__Unknown__("No valid variants".into())
    }
}
...
impl Validate for PaymentTypeInformation29 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "pain.008.001.10";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.10";
}
