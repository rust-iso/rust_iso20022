...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:admi.005.001.02")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:admi.005.001.02")]
...
pub struct Document {
    ...
    pub rpt_qry_req: ReportQueryRequestV02,
}
...
impl Validate for ReportQueryCriteria3 {}
...
pub struct ReportQueryRequestV02 {
    ...
    pub rpt_qry_crit: Vec<ReportQueryCriteria3>,
...
impl Validate for ReportQueryRequestV02 {}
...
impl Validate for ReportQuerySearchCriteria3 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:admi.005.001.02")]
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "admi.005.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:admi.005.001.02";
}
