...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:admi.017.001.02")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:admi.017.001.02")]
...
pub struct Document {
    ...
    pub prcg_req: ProcessingRequestV02,
}
...
impl Validate for ProcessingRequestV02 {}
...
pub struct RequestDetails30 {
    ...
    pub rqstr_id: PartyIdentification242Choice,
...
impl Validate for RequestDetails30 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "admi.017.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:admi.017.001.02";
}
