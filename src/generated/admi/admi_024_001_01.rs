...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:admi.024.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:admi.024.001.01")]
...
pub struct CorrespondenceNotification1 {
    #[yaserde(rename = "SndrNtfctnId")]
    #[cfg_attr(feature = "serde", serde(rename = "SndrNtfctnId"))]
    ...
    #[yaserde(rename = "NtfctnSubTp")]
    #[cfg_attr(feature = "serde", serde(rename = "NtfctnSubTp"))]
    pub ntfctn_sub_tp: NotificationSubType1Choice,

    #[yaserde(rename = "NtfctnNrrtv")]
    #[cfg_attr(feature = "serde", serde(rename = "NtfctnNrrtv"))]
    pub ntfctn_nrrtv: Vec<Max2000Text>,

    #[yaserde(rename = "NclsdFile")]
    #[cfg_attr(feature = "serde", serde(rename = "NclsdFile"))]
    pub nclsd_file: Vec<Document15>,

    #[yaserde(rename = "RltdNtfctnData")]
    #[cfg_attr(feature = "serde", serde(rename = "RltdNtfctnData"))]
    pub rltd_ntfctn_data: Vec<RelatedNotificationData1>,
}

impl Validate for CorrespondenceNotification1 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:admi.024.001.01")]
pub struct Document {
    #[yaserde(rename = "NtfctnOfCrspdc")]
    #[cfg_attr(feature = "serde", serde(rename = "NtfctnOfCrspdc"))]
    pub ntfctn_of_crspdc: NotificationOfCorrespondenceV01,
}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct ExternalNotificationSubType1Code (pub String);
crate::simple_type!(ExternalNotificationSubType1Code);

impl Validate for ExternalNotificationSubType1Code {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct ExternalNotificationType1Code (pub String);
crate::simple_type!(ExternalNotificationType1Code);

impl Validate for ExternalNotificationType1Code {
    fn validate(&self) -> Result<(), String> { 
        #[allow(clippy::len_zero)]
        if self.0.len() < 1 {
            return Err(format!("MinLength validation error. \nExpected: 0 length >= 1 \nActual: 0 length == {}", self.0.len()));
...
impl Validate for GroupHeader129 {}
...
impl Validate for NotificationLocationData1 {}
...
pub struct NotificationOfCorrespondenceV01 {
    ...
    pub grp_hdr: GroupHeader129,

    #[yaserde(rename = "NtfctnData")]
    #[cfg_attr(feature = "serde", serde(rename = "NtfctnData"))]
...
pub struct NotificationSubType1Choice {
    #[yaserde(rename = "Cd")]
    #[cfg_attr(feature = "serde", serde(rename = "Cd"))]
    pub cd: Option<ExternalNotificationSubType1Code>,
    #[yaserde(rename = "Prtry")]
    #[cfg_attr(feature = "serde", serde(rename = "Prtry"))]
    pub prtry: Option<Max35Text>,
}

impl Validate for NotificationSubType1Choice {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:admi.024.001.01")]
...
impl Validate for NotificationType1Choice {}
...
pub struct RelatedNotificationData1 {
    ...
    pub lctn: Vec<NotificationLocationData1>,
}

impl Validate for RelatedNotificationData1 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "admi.024.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:admi.024.001.01";
}
