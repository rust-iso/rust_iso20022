...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:admi.007.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:admi.007.001.01")]
pub struct Document {
    #[yaserde(rename = "RctAck")]
    #[cfg_attr(feature = "serde", serde(rename = "RctAck"))]
    pub rct_ack: ReceiptAcknowledgementV01,
}
...
impl Validate for MessageHeader10 {}
...
impl Validate for MessageReference1 {}
...
impl Validate for ReceiptAcknowledgementReport2 {}
...
impl Validate for ReceiptAcknowledgementV01 {}
...
impl Validate for RequestHandling2 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "admi.007.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:admi.007.001.01";
}
