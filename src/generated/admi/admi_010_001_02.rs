...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:admi.010.001.02")]
pub struct Document {
    #[yaserde(rename = "StatcDataRpt")]
    #[cfg_attr(feature = "serde", serde(rename = "StatcDataRpt"))]
    pub statc_data_rpt: StaticDataReportV02,
}
...
impl Validate for ReportParameter1 {}
...
pub struct RequestDetails4 {
    ...
    pub rpt_data: Vec<ReportParameter1>,
}

impl Validate for RequestDetails4 {}
...
pub struct RequestDetails5 {
    ...
    #[yaserde(rename = "RptKey")]
    #[cfg_attr(feature = "serde", serde(rename = "RptKey"))]
    pub rpt_key: Vec<RequestDetails4>,
}

impl Validate for RequestDetails5 {}
...
impl Validate for StaticDataReportV02 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "admi.010.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:admi.010.001.02";
}
