...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:admi.006.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:admi.006.001.01")]
pub struct Document {
    #[yaserde(rename = "RsndReq")]
    #[cfg_attr(feature = "serde", serde(rename = "RsndReq"))]
    pub rsnd_req: ResendRequestV01,
}
...
pub struct ResendRequestV01 {
    ...
    #[yaserde(rename = "RsndSchCrit")]
    #[cfg_attr(feature = "serde", serde(rename = "RsndSchCrit"))]
...
impl Validate for ResendRequestV01 {}
...
pub struct ResendSearchCriteria2 {
    #[yaserde(rename = "BizDt")]
    #[cfg_attr(feature = "serde", serde(rename = "BizDt"))]
    pub biz_dt: Isodate,
    ...
    #[yaserde(rename = "SeqRg")]
    #[cfg_attr(feature = "serde", serde(rename = "SeqRg"))]
    ...
    #[yaserde(rename = "FileRef")]
    #[cfg_attr(feature = "serde", serde(rename = "FileRef"))]
    pub file_ref: Max35Text,
...
impl Validate for ResendSearchCriteria2 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "admi.006.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:admi.006.001.01";
}
