...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:admi.009.001.02")]
pub struct Document {
    #[yaserde(rename = "StatcDataReq")]
    #[cfg_attr(feature = "serde", serde(rename = "StatcDataReq"))]
    pub statc_data_req: StaticDataRequestV02,
}
...
impl Validate for RequestDetails3 {}
...
pub struct StaticDataRequestV02 {
    ...
    #[yaserde(rename = "DataReqDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "DataReqDtls"))]
...
impl Validate for StaticDataRequestV02 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "admi.009.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:admi.009.001.02";
}
