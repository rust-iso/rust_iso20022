...
pub struct CashInOrOut8Choice {
    #[yaserde(rename = "CshInPmtInstrm")]
    #[cfg_attr(feature = "serde", serde(rename = "CshInPmtInstrm"))]
    pub csh_in_pmt_instrm: Option<PaymentInstrument30Choice>,
    #[yaserde(rename = "CshOutPmtInstrm")]
    #[cfg_attr(feature = "serde", serde(rename = "CshOutPmtInstrm"))]
    pub csh_out_pmt_instrm: Option<PaymentInstrument28Choice>,
}
