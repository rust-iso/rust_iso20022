...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.015.001.05")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.015.001.05")]
...
pub enum CashInOrOut8ChoiceChoice {
    CshInPmtInstrm(PaymentInstrument30Choice),
    CshOutPmtInstrm(PaymentInstrument28Choice),
    __Unknown__(String),
}

impl Default for CashInOrOut8ChoiceChoice {
    fn default() -> CashInOrOut8ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for CashInOrOut8ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.015.001.05")]
pub struct CashInOrOut8Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub cash_in_or_out_8_choice_choice: CashInOrOut8ChoiceChoice,
}

impl Validate for CashInOrOut8Choice {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.015.001.05")]
pub struct Document {
    #[yaserde(rename = "SwtchOrdrConf")]
    #[cfg_attr(feature = "serde", serde(rename = "SwtchOrdrConf"))]
    pub swtch_ordr_conf: SwitchOrderConfirmationV05,
}
...
pub enum PaymentInstrument30ChoiceChoice {
...
impl Default for PaymentInstrument30ChoiceChoice {
    fn default() -> PaymentInstrument30ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for PaymentInstrument30ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.015.001.05")]
pub struct PaymentInstrument30Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub payment_instrument_30_choice_choice: PaymentInstrument30ChoiceChoice,
}

impl Validate for PaymentInstrument30Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.015.001.05")]
pub struct PaymentTransaction181 {
    #[yaserde(rename = "CshInOrOut")]
    #[cfg_attr(feature = "serde", serde(rename = "CshInOrOut"))]
    pub csh_in_or_out: CashInOrOut8Choice,
}

impl Validate for PaymentTransaction181 {}
...
pub struct SwitchExecution8 {
    ...
    #[yaserde(rename = "RedLegDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "RedLegDtls"))]
    pub red_leg_dtls: Vec<SwitchRedemptionLegExecution5>,

    #[yaserde(rename = "SbcptLegDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "SbcptLegDtls"))]
    pub sbcpt_leg_dtls: Vec<SwitchSubscriptionLegExecution5>,

    #[yaserde(rename = "CshSttlmDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "CshSttlmDtls"))]
    pub csh_sttlm_dtls: PaymentTransaction181,
...
impl Validate for SwitchExecution8 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.015.001.05")]
pub struct SwitchOrderConfirmationV05 {
    ...
    #[yaserde(rename = "SwtchExctnDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "SwtchExctnDtls"))]
    pub swtch_exctn_dtls: Vec<SwitchExecution8>,
...
impl Validate for SwitchOrderConfirmationV05 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.015.001.05")]
pub struct SwitchRedemptionLegExecution5 {
...
impl Validate for SwitchRedemptionLegExecution5 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.015.001.05")]
pub struct SwitchSubscriptionLegExecution5 {
    #[yaserde(rename = "LegId")]
    #[cfg_attr(feature = "serde", serde(rename = "LegId"))]
    pub leg_id: Max35Text,
...
impl Validate for SwitchSubscriptionLegExecution5 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "setr.015.001.05";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:setr.015.001.05";
}
