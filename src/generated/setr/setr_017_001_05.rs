...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.017.001.05")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.017.001.05")]
...
pub enum CancellationStatus33ChoiceChoice {
    Sts(OrderCancellationStatus2Code),
    Rjctd(RejectedStatus13),
    __Unknown__(String),
}

impl Default for CancellationStatus33ChoiceChoice {
    fn default() -> CancellationStatus33ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for CancellationStatus33ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.017.001.05")]
pub struct CancellationStatus33Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub cancellation_status_33_choice_choice: CancellationStatus33ChoiceChoice,
}

impl Validate for CancellationStatus33Choice {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.017.001.05")]
pub struct Document {
    #[yaserde(rename = "OrdrCxlStsRpt")]
    #[cfg_attr(feature = "serde", serde(rename = "OrdrCxlStsRpt"))]
    pub ordr_cxl_sts_rpt: OrderCancellationStatusReportV05,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.017.001.05")]
pub struct IndividualOrderStatusAndReason10 {
    ...
    pub cxl_sts: CancellationStatus33Choice,
...
impl Validate for IndividualOrderStatusAndReason10 {}
...
pub enum OrderCancellationStatus2Code {
    #[yaserde(rename = "STNP")]
...
impl Default for OrderCancellationStatus2Code {
    fn default() -> OrderCancellationStatus2Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for OrderCancellationStatus2Code {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.017.001.05")]
pub struct OrderCancellationStatusReportV05 {
...
impl Validate for OrderCancellationStatusReportV05 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.017.001.05")]
pub struct OrderStatusAndReason12 {
    #[yaserde(rename = "MstrRef")]
    #[cfg_attr(feature = "serde", serde(rename = "MstrRef"))]
    pub mstr_ref: Max35Text,
...
impl Validate for OrderStatusAndReason12 {}
...
pub enum RejectedReason66ChoiceChoice {
    Cd(RejectedStatusReason14Code),
    Prtry(GenericIdentification1),
    __Unknown__(String),
}

impl Default for RejectedReason66ChoiceChoice {
    fn default() -> RejectedReason66ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for RejectedReason66ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.017.001.05")]
pub struct RejectedReason66Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub rejected_reason_66_choice_choice: RejectedReason66ChoiceChoice,
}

impl Validate for RejectedReason66Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.017.001.05")]
pub struct RejectedStatus13 {
    #[yaserde(rename = "Rsn")]
    #[cfg_attr(feature = "serde", serde(rename = "Rsn"))]
    pub rsn: RejectedReason66Choice,
...
impl Validate for RejectedStatus13 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.017.001.05")]

pub enum RejectedStatusReason14Code {
    #[yaserde(rename = "ULNK")]
    ...
    Cuto,
    #[yaserde(rename = "NALC")]
    #[cfg_attr(feature = "serde", serde(rename = "NALC"))]
    Nalc,
    #[yaserde(rename = "LEGL")]
...
impl Default for RejectedStatusReason14Code {
    fn default() -> RejectedStatusReason14Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for RejectedStatusReason14Code {}
...
pub enum Status42ChoiceChoice {
    CxlStsRpt(OrderStatusAndReason12),
    IndvCxlStsRpt(Vec<IndividualOrderStatusAndReason10>),
    __Unknown__(String),
}

impl Default for Status42ChoiceChoice {
    fn default() -> Status42ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for Status42ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.017.001.05")]
pub struct Status42Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub status_42_choice_choice: Status42ChoiceChoice,
}

impl Validate for Status42Choice {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "setr.017.001.05";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:setr.017.001.05";
}
