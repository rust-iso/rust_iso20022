...
pub struct CancellationStatus33Choice {
    ...
    pub sts: Option<OrderCancellationStatus2Code>,
    #[yaserde(rename = "Rjctd")]
    #[cfg_attr(feature = "serde", serde(rename = "Rjctd"))]
    pub rjctd: Option<RejectedStatus13>,
}
...
pub struct RejectedReason66Choice {
    ...
    pub cd: Option<RejectedStatusReason14Code>,
    #[yaserde(rename = "Prtry")]
    #[cfg_attr(feature = "serde", serde(rename = "Prtry"))]
...
pub struct Status42Choice {
    #[yaserde(rename = "CxlStsRpt")]
    #[cfg_attr(feature = "serde", serde(rename = "CxlStsRpt"))]
    pub cxl_sts_rpt: Option<OrderStatusAndReason12>,
    #[yaserde(rename = "IndvCxlStsRpt")]
    #[cfg_attr(feature = "serde", serde(rename = "IndvCxlStsRpt"))]
    pub indv_cxl_sts_rpt: Vec<IndividualOrderStatusAndReason10>,
}
