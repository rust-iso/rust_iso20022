...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.012.001.06")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.012.001.06")]
...
impl Default for BestExecution1Code {
    fn default() -> BestExecution1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for BestExecution1Code {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.012.001.06")]
pub struct DirectDebitMandate9 {
    #[yaserde(rename = "DbtrAcct")]
    #[cfg_attr(feature = "serde", serde(rename = "DbtrAcct"))]
    pub dbtr_acct: AccountIdentificationAndName8,
...
impl Validate for DirectDebitMandate9 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.012.001.06")]
pub struct Document {
    #[yaserde(rename = "SbcptOrdrConf")]
    #[cfg_attr(feature = "serde", serde(rename = "SbcptOrdrConf"))]
    pub sbcpt_ordr_conf: SubscriptionOrderConfirmationV06,
}
...
pub enum EucapitalGain3ChoiceChoice {
    Cd(EucapitalGain2Code),
    Prtry(GenericIdentification47),
    __Unknown__(String),
}

impl Default for EucapitalGain3ChoiceChoice {
    fn default() -> EucapitalGain3ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for EucapitalGain3ChoiceChoice {}
...
pub struct EucapitalGain3Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub eu_capital_gain_3_choice_choice: EucapitalGain3ChoiceChoice,
}

impl Validate for EucapitalGain3Choice {}
...
pub enum EudividendStatusType2ChoiceChoice {
    Cd(EudividendStatus1Code),
    Prtry(GenericIdentification47),
    __Unknown__(String),
}

impl Default for EudividendStatusType2ChoiceChoice {
    fn default() -> EudividendStatusType2ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for EudividendStatusType2ChoiceChoice {}
...
pub struct EudividendStatusType2Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub eu_dividend_status_type_2_choice_choice: EudividendStatusType2ChoiceChoice,
}

impl Validate for EudividendStatusType2Choice {}
...
pub struct Equalisation4 {
    ...
    #[yaserde(rename = "EqulstnMthdlgyTp")]
    #[cfg_attr(feature = "serde", serde(rename = "EqulstnMthdlgyTp"))]
    pub equlstn_mthdlgy_tp: EqualisationMethodologyType1Code,

    #[yaserde(rename = "CntngntLqdtnPerUnit")]
    #[cfg_attr(feature = "serde", serde(rename = "CntngntLqdtnPerUnit"))]
    pub cntngnt_lqdtn_per_unit: ActiveOrHistoricCurrencyAndAmount,

    #[yaserde(rename = "DprctnDpstPerUnit")]
    #[cfg_attr(feature = "serde", serde(rename = "DprctnDpstPerUnit"))]
    pub dprctn_dpst_per_unit: ActiveOrHistoricCurrencyAndAmount,

    #[yaserde(rename = "EqulstnCdtPerUnit")]
    #[cfg_attr(feature = "serde", serde(rename = "EqulstnCdtPerUnit"))]
    pub equlstn_cdt_per_unit: ActiveOrHistoricCurrencyAndAmount,

    #[yaserde(rename = "HghWtrmrk")]
    #[cfg_attr(feature = "serde", serde(rename = "HghWtrmrk"))]
    pub hgh_wtrmrk: ActiveOrHistoricCurrencyAndAmount,

    #[yaserde(rename = "GrssAsstVal")]
    #[cfg_attr(feature = "serde", serde(rename = "GrssAsstVal"))]
    pub grss_asst_val: ActiveOrHistoricCurrencyAndAmount,
}

impl Validate for Equalisation4 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.012.001.06")]

pub enum EqualisationMethodologyType1Code {
    #[yaserde(rename = "COLI")]
    #[cfg_attr(feature = "serde", serde(rename = "COLI"))]
    Coli,
    #[yaserde(rename = "DDEP")]
    #[cfg_attr(feature = "serde", serde(rename = "DDEP"))]
    Ddep,
    #[yaserde(rename = "EQCR")]
    #[cfg_attr(feature = "serde", serde(rename = "EQCR"))]
    Eqcr,
    __Unknown__(String),
}

impl Default for EqualisationMethodologyType1Code {
    fn default() -> EqualisationMethodologyType1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for EqualisationMethodologyType1Code {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.012.001.06")]
pub struct FundSettlementParameters28 {
...
impl Validate for FundSettlementParameters28 {}
...
pub struct InformativeTax2 {
    ...
    pub indv_tax: Vec<Tax40>,
}

impl Validate for InformativeTax2 {}
...
pub enum LateReport1Code {
    #[yaserde(rename = "LAT1")]
    #[cfg_attr(feature = "serde", serde(rename = "LAT1"))]
    Lat1,
    #[yaserde(rename = "LAT2")]
    #[cfg_attr(feature = "serde", serde(rename = "LAT2"))]
    Lat2,
    __Unknown__(String),
}

impl Default for LateReport1Code {
    fn default() -> LateReport1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for LateReport1Code {}
...
pub struct PaymentCard34 {
    ...
    pub card_issr_id: PartyIdentification139,
...
impl Validate for PaymentCard34 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.012.001.06")]

pub enum PaymentInstrument29ChoiceChoice {
    PmtCardDtls(PaymentCard34),
    CdtTrfDtls(CreditTransfer12),
    DrctDbtDtls(DirectDebitMandate9),
    ChqDtls(Cheque10),
...
impl Default for PaymentInstrument29ChoiceChoice {
    fn default() -> PaymentInstrument29ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for PaymentInstrument29ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.012.001.06")]
pub struct PaymentInstrument29Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub payment_instrument_29_choice_choice: PaymentInstrument29ChoiceChoice,
}

impl Validate for PaymentInstrument29Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.012.001.06")]
pub struct PaymentTransaction180 {
    #[yaserde(rename = "PmtInstrm")]
    #[cfg_attr(feature = "serde", serde(rename = "PmtInstrm"))]
    pub pmt_instrm: PaymentInstrument29Choice,
}

impl Validate for PaymentTransaction180 {}
...
pub enum ProfitAndLoss2ChoiceChoice {
    Prft(ActiveCurrencyAndAmount),
    Loss(ActiveCurrencyAndAmount),
    __Unknown__(String),
}

impl Default for ProfitAndLoss2ChoiceChoice {
    fn default() -> ProfitAndLoss2ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ProfitAndLoss2ChoiceChoice {}
...
pub struct ProfitAndLoss2Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub profit_and_loss_2_choice_choice: ProfitAndLoss2ChoiceChoice,
}

impl Validate for ProfitAndLoss2Choice {}
...
pub enum SourceOfCash1ChoiceChoice {
    Cd(SourceOfCash1Code),
    Prtry(GenericIdentification47),
    __Unknown__(String),
}

impl Default for SourceOfCash1ChoiceChoice {
    fn default() -> SourceOfCash1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for SourceOfCash1ChoiceChoice {}
...
pub struct SourceOfCash1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub source_of_cash_1_choice_choice: SourceOfCash1ChoiceChoice,
}

impl Validate for SourceOfCash1Choice {}
...
pub enum SourceOfCash1Code {
    #[yaserde(rename = "ALMY")]
    #[cfg_attr(feature = "serde", serde(rename = "ALMY"))]
    Almy,
    #[yaserde(rename = "CASH")]
    #[cfg_attr(feature = "serde", serde(rename = "CASH"))]
    Cash,
    ...
    Gift,
    #[yaserde(rename = "INHE")]
    #[cfg_attr(feature = "serde", serde(rename = "INHE"))]
    Inhe,
    #[yaserde(rename = "INLQ")]
    #[cfg_attr(feature = "serde", serde(rename = "INLQ"))]
    Inlq,
    #[yaserde(rename = "REST")]
    ...
    Redm,
    #[yaserde(rename = "REPY")]
    #[cfg_attr(feature = "serde", serde(rename = "REPY"))]
    Repy,
    #[yaserde(rename = "SEAQ")]
    #[cfg_attr(feature = "serde", serde(rename = "SEAQ"))]
    Seaq,
    #[yaserde(rename = "SALE")]
    ...
    _Self,
    #[yaserde(rename = "WINS")]
    #[cfg_attr(feature = "serde", serde(rename = "WINS"))]
    Wins,
    __Unknown__(String),
}

impl Default for SourceOfCash1Code {
    fn default() -> SourceOfCash1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for SourceOfCash1Code {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.012.001.06")]
pub struct SubscriptionExecution16 {
    ...
    #[yaserde(rename = "SubAcctForHldg")]
    #[cfg_attr(feature = "serde", serde(rename = "SubAcctForHldg"))]
    pub sub_acct_for_hldg: SubAccount6,
    ...
    pub trad_dt_tm: DateAndDateTime2Choice,

    #[yaserde(rename = "DealgPricDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "DealgPricDtls"))]
    pub dealg_pric_dtls: UnitPrice22,

    #[yaserde(rename = "InftvPricDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "InftvPricDtls"))]
    ...
    #[yaserde(rename = "BestExctn")]
    #[cfg_attr(feature = "serde", serde(rename = "BestExctn"))]
    pub best_exctn: BestExecution1Code,

    #[yaserde(rename = "CumDvddInd")]
    #[cfg_attr(feature = "serde", serde(rename = "CumDvddInd"))]
    pub cum_dvdd_ind: YesNoIndicator,

    #[yaserde(rename = "IntrmPrftAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "IntrmPrftAmt"))]
    pub intrm_prft_amt: ProfitAndLoss2Choice,
    ...
    pub tx_ovrhd: TotalFeesAndTaxes45,

    #[yaserde(rename = "InftvTaxDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "InftvTaxDtls"))]
    pub inftv_tax_dtls: InformativeTax2,

    #[yaserde(rename = "SttlmAndCtdyDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "SttlmAndCtdyDtls"))]
    pub sttlm_and_ctdy_dtls: FundSettlementParameters28,
    ...
    pub rfnd: ActiveCurrencyAndAmount,

    #[yaserde(rename = "SbcptIntrst")]
    #[cfg_attr(feature = "serde", serde(rename = "SbcptIntrst"))]
    pub sbcpt_intrst: ActiveCurrencyAndAmount,

    #[yaserde(rename = "CshSttlmDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "CshSttlmDtls"))]
    pub csh_sttlm_dtls: PaymentTransaction180,
    ...
    #[yaserde(rename = "PrtlSttlmOfUnits")]
    #[cfg_attr(feature = "serde", serde(rename = "PrtlSttlmOfUnits"))]
    pub prtl_sttlm_of_units: PercentageRate,

    #[yaserde(rename = "PrtlSttlmOfCsh")]
    #[cfg_attr(feature = "serde", serde(rename = "PrtlSttlmOfCsh"))]
    pub prtl_sttlm_of_csh: PercentageRate,
    ...
    #[yaserde(rename = "LateRpt")]
    #[cfg_attr(feature = "serde", serde(rename = "LateRpt"))]
    pub late_rpt: LateReport1Code,
    ...
    pub equlstn: Equalisation4,

    #[yaserde(rename = "SrcOfCsh")]
    #[cfg_attr(feature = "serde", serde(rename = "SrcOfCsh"))]
...
impl Validate for SubscriptionExecution16 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.012.001.06")]
pub struct SubscriptionMultipleExecution7 {
    ...
    #[yaserde(rename = "RcvdDtTm")]
    #[cfg_attr(feature = "serde", serde(rename = "RcvdDtTm"))]
    pub rcvd_dt_tm: IsodateTime,
    ...
    #[yaserde(rename = "IndvExctnDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "IndvExctnDtls"))]
    pub indv_exctn_dtls: Vec<SubscriptionExecution16>,
    ...
    pub blk_csh_sttlm_dtls: PaymentTransaction180,
}

impl Validate for SubscriptionMultipleExecution7 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.012.001.06")]
pub struct SubscriptionOrderConfirmationV06 {
    ...
    #[yaserde(rename = "MltplExctnDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "MltplExctnDtls"))]
    pub mltpl_exctn_dtls: SubscriptionMultipleExecution7,
...
impl Validate for SubscriptionOrderConfirmationV06 {}
...
pub struct Tax40 {
    ...
    #[yaserde(rename = "InftvAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "InftvAmt"))]
    pub inftv_amt: ActiveCurrencyAndAmount,

    #[yaserde(rename = "InftvRate")]
    #[cfg_attr(feature = "serde", serde(rename = "InftvRate"))]
    pub inftv_rate: PercentageRate,
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.012.001.06")]
pub struct TotalFeesAndTaxes45 {
...
impl Validate for TotalFeesAndTaxes45 {}
...
pub struct UnitPrice22 {
    ...
    #[yaserde(rename = "PricDiffRsn")]
    #[cfg_attr(feature = "serde", serde(rename = "PricDiffRsn"))]
    pub pric_diff_rsn: Max350Text,
}

impl Validate for UnitPrice22 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "setr.012.001.06";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:setr.012.001.06";
}
