...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.007.001.05")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.007.001.05")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.007.001.05")]
pub struct Document {
    #[yaserde(rename = "SbcptBlkOrdr")]
    #[cfg_attr(feature = "serde", serde(rename = "SbcptBlkOrdr"))]
    pub sbcpt_blk_ordr: SubscriptionBulkOrderV05,
}
...
pub enum FinancialInstrumentQuantity49ChoiceChoice {
...
impl Default for FinancialInstrumentQuantity49ChoiceChoice {
    fn default() -> FinancialInstrumentQuantity49ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for FinancialInstrumentQuantity49ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.007.001.05")]
pub struct FinancialInstrumentQuantity49Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub financial_instrument_quantity_49_choice_choice: FinancialInstrumentQuantity49ChoiceChoice,
}

impl Validate for FinancialInstrumentQuantity49Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.007.001.05")]
pub struct SubscriptionBulkOrder06 {
    ...
    pub indv_ordr_dtls: Vec<SubscriptionOrder16>,
...
impl Validate for SubscriptionBulkOrder06 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.007.001.05")]
pub struct SubscriptionBulkOrderV05 {
    ...
    pub blk_ordr_dtls: SubscriptionBulkOrder06,
...
impl Validate for SubscriptionBulkOrderV05 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.007.001.05")]
pub struct SubscriptionOrder16 {
    ...
    #[yaserde(rename = "AmtOrUnits")]
    #[cfg_attr(feature = "serde", serde(rename = "AmtOrUnits"))]
    pub amt_or_units: FinancialInstrumentQuantity49Choice,
    ...
    pub phys_dlvry_dtls: NameAndAddress4,
...
impl Validate for SubscriptionOrder16 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "setr.007.001.05";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:setr.007.001.05";
}
