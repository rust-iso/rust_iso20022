...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.008.001.05")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.008.001.05")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.008.001.05")]
pub struct Document {
    #[yaserde(rename = "SbcptBlkOrdrCxlReq")]
    #[cfg_attr(feature = "serde", serde(rename = "SbcptBlkOrdrCxlReq"))]
    pub sbcpt_blk_ordr_cxl_req: SubscriptionBulkOrderCancellationRequestV05,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.008.001.05")]
pub struct SubscriptionBulkOrderCancellationRequestV05 {
...
impl Validate for SubscriptionBulkOrderCancellationRequestV05 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "setr.008.001.05";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:setr.008.001.05";
}
