...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.013.001.05")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.013.001.05")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.013.001.05")]
pub struct Document {
    #[yaserde(rename = "SwtchOrdr")]
    #[cfg_attr(feature = "serde", serde(rename = "SwtchOrdr"))]
    pub swtch_ordr: SwitchOrderV05,
}
...
pub enum FinancialInstrumentQuantity50ChoiceChoice {
    UnitsNb(DecimalNumber),
    PctgOfTtlSbcptAmt(PercentageRate),
...
impl Default for FinancialInstrumentQuantity50ChoiceChoice {
    fn default() -> FinancialInstrumentQuantity50ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for FinancialInstrumentQuantity50ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.013.001.05")]
pub struct FinancialInstrumentQuantity50Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub financial_instrument_quantity_50_choice_choice: FinancialInstrumentQuantity50ChoiceChoice,
}

impl Validate for FinancialInstrumentQuantity50Choice {}
...
pub enum FinancialInstrumentQuantity51ChoiceChoice {
    UnitsNb(DecimalNumber),
    PctgOfTtlRedAmt(PercentageRate),
    NetAmt(ActiveOrHistoricCurrencyAndAmount),
    GrssAmt(ActiveOrHistoricCurrencyAndAmount),
    DgtlTknUnit(Max30DecimalNumber),
    __Unknown__(String),
...
impl Default for FinancialInstrumentQuantity51ChoiceChoice {
    fn default() -> FinancialInstrumentQuantity51ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for FinancialInstrumentQuantity51ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.013.001.05")]
pub struct FinancialInstrumentQuantity51Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub financial_instrument_quantity_51_choice_choice: FinancialInstrumentQuantity51ChoiceChoice,
}

impl Validate for FinancialInstrumentQuantity51Choice {}
...
pub struct SwitchOrder8 {
    ...
    pub red_leg_dtls: Vec<SwitchRedemptionLegOrder7>,

    #[yaserde(rename = "SbcptLegDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "SbcptLegDtls"))]
    pub sbcpt_leg_dtls: Vec<SwitchSubscriptionLegOrder7>,
...
impl Validate for SwitchOrder8 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.013.001.05")]
pub struct SwitchOrderV05 {
    ...
    #[yaserde(rename = "SwtchOrdrDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "SwtchOrdrDtls"))]
    pub swtch_ordr_dtls: Vec<SwitchOrder8>,
...
impl Validate for SwitchOrderV05 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.013.001.05")]
pub struct SwitchRedemptionLegOrder7 {
    ...
    #[yaserde(rename = "FinInstrmQtyChc")]
    #[cfg_attr(feature = "serde", serde(rename = "FinInstrmQtyChc"))]
    pub fin_instrm_qty_chc: FinancialInstrumentQuantity50Choice,
...
impl Validate for SwitchRedemptionLegOrder7 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:setr.013.001.05")]
pub struct SwitchSubscriptionLegOrder7 {
    #[yaserde(rename = "LegId")]
    #[cfg_attr(feature = "serde", serde(rename = "LegId"))]
    pub leg_id: Max35Text,
    ...
    #[yaserde(rename = "FinInstrmQtyChc")]
    #[cfg_attr(feature = "serde", serde(rename = "FinInstrmQtyChc"))]
    pub fin_instrm_qty_chc: FinancialInstrumentQuantity51Choice,
...
impl Validate for SwitchSubscriptionLegOrder7 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "setr.013.001.05";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:setr.013.001.05";
}
