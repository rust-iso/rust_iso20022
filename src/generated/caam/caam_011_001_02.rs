...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.011.001.02")]
...
pub struct Atmcontext25 {
    ...
    pub svc: Atmservice27,
}

impl Validate for Atmcontext25 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.011.001.02")]
...
impl Validate for Atmenvironment20 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.011.001.02")]
pub struct AtmexceptionAdvice2 {
    #[yaserde(rename = "Envt")]
    #[cfg_attr(feature = "serde", serde(rename = "Envt"))]
    pub envt: Atmenvironment20,

    #[yaserde(rename = "Cntxt")]
    #[cfg_attr(feature = "serde", serde(rename = "Cntxt"))]
    pub cntxt: Atmcontext25,

    #[yaserde(rename = "Tx")]
    #[cfg_attr(feature = "serde", serde(rename = "Tx"))]
    pub tx: Atmtransaction40,
}

impl Validate for AtmexceptionAdvice2 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.011.001.02")]
pub struct AtmexceptionAdviceV02 {
    #[yaserde(rename = "Hdr")]
    #[cfg_attr(feature = "serde", serde(rename = "Hdr"))]
    pub hdr: Header32,

    #[yaserde(rename = "PrtctdATMXcptnAdvc")]
    #[cfg_attr(feature = "serde", serde(rename = "PrtctdATMXcptnAdvc"))]
    pub prtctd_atm_xcptn_advc: ContentInformationType10,

    #[yaserde(rename = "ATMXcptnAdvc")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMXcptnAdvc"))]
    pub atm_xcptn_advc: AtmexceptionAdvice2,
...
impl Validate for AtmexceptionAdviceV02 {}
...
pub struct Atmservice27 {
    ...
    pub svc_tp: AtmserviceType11Code,
...
impl Validate for Atmservice27 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.011.001.02")]

pub enum AtmserviceType11Code {
    #[yaserde(rename = "TRFC")]
...
impl Default for AtmserviceType11Code {
    fn default() -> AtmserviceType11Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for AtmserviceType11Code {}
...
pub struct Atmtransaction40 {
    ...
    #[yaserde(rename = "XcptnDtl")]
    #[cfg_attr(feature = "serde", serde(rename = "XcptnDtl"))]
...
impl Validate for Atmtransaction40 {}
...
pub struct Document {
    #[yaserde(rename = "ATMXcptnAdvc")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMXcptnAdvc"))]
    pub atm_xcptn_advc: AtmexceptionAdviceV02,
}
...
impl Default for FailureReason8Code {
    fn default() -> FailureReason8Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for FailureReason8Code {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "caam.011.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:caam.011.001.02";
}
