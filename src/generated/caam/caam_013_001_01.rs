...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.013.001.01")]
pub struct AtmconfigurationReportComponent1 {
    #[yaserde(rename = "Envt")]
    #[cfg_attr(feature = "serde", serde(rename = "Envt"))]
    pub envt: Atmenvironment7,

    #[yaserde(rename = "ActvVrsn")]
    #[cfg_attr(feature = "serde", serde(rename = "ActvVrsn"))]
    pub actv_vrsn: Max35Text,

    #[yaserde(rename = "NonActvVrsn")]
    #[cfg_attr(feature = "serde", serde(rename = "NonActvVrsn"))]
    pub non_actv_vrsn: Vec<AtmversionReport1>,
}

impl Validate for AtmconfigurationReportComponent1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.013.001.01")]
pub struct AtmconfigurationReportV01 {
    #[yaserde(rename = "Hdr")]
    #[cfg_attr(feature = "serde", serde(rename = "Hdr"))]
    pub hdr: Header31,

    #[yaserde(rename = "PrtctdATMCfgtnRpt")]
    #[cfg_attr(feature = "serde", serde(rename = "PrtctdATMCfgtnRpt"))]
    pub prtctd_atm_cfgtn_rpt: ContentInformationType10,

    #[yaserde(rename = "ATMCfgtnRpt")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMCfgtnRpt"))]
    pub atm_cfgtn_rpt: AtmconfigurationReportComponent1,
...
impl Validate for AtmconfigurationReportV01 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.013.001.01")]
pub struct AtmversionReport1 {
    #[yaserde(rename = "CfgtnVrsn")]
    #[cfg_attr(feature = "serde", serde(rename = "CfgtnVrsn"))]
    pub cfgtn_vrsn: Max35Text,

    #[yaserde(rename = "CfgtnSts")]
    #[cfg_attr(feature = "serde", serde(rename = "CfgtnSts"))]
    pub cfgtn_sts: ActivationStatus2Code,

    #[yaserde(rename = "FailRsn")]
    #[cfg_attr(feature = "serde", serde(rename = "FailRsn"))]
    pub fail_rsn: Max70Text,
}

impl Validate for AtmversionReport1 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.013.001.01")]

pub enum ActivationStatus2Code {
    #[yaserde(rename = "WACT")]
...
impl Default for ActivationStatus2Code {
    fn default() -> ActivationStatus2Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ActivationStatus2Code {}
...
pub struct Document {
    #[yaserde(rename = "ATMCfgtnRpt")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMCfgtnRpt"))]
    pub atm_cfgtn_rpt: AtmconfigurationReportV01,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "caam.013.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:caam.013.001.01";
}
