...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.011.001.01")]
...
impl Validate for Atmcontext20 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.011.001.01")]
...
impl Validate for Atmenvironment16 {}
...
impl Validate for AtmexceptionAdvice1 {}
...
pub struct AtmexceptionAdviceV01 {
    ...
    pub atm_xcptn_advc: AtmexceptionAdvice1,
...
impl Validate for AtmexceptionAdviceV01 {}
...
impl Validate for Atmservice24 {}
...
impl Default for AtmserviceType10Code {
    fn default() -> AtmserviceType10Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for AtmserviceType10Code {}
...
impl Validate for Atmtransaction27 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "caam.011.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:caam.011.001.01";
}
