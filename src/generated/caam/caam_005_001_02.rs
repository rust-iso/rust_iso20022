...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.005.001.02")]
pub struct AtmdiagnosticRequest2 {
    #[yaserde(rename = "Envt")]
...
impl Validate for AtmdiagnosticRequest2 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.005.001.02")]
pub struct AtmdiagnosticRequestV02 {
    #[yaserde(rename = "Hdr")]
    ...
    pub atm_dgnstc_req: AtmdiagnosticRequest2,
...
impl Validate for AtmdiagnosticRequestV02 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.005.001.02")]
...
pub struct Document {
    #[yaserde(rename = "ATMDgnstcReq")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMDgnstcReq"))]
    pub atm_dgnstc_req: AtmdiagnosticRequestV02,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "caam.005.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:caam.005.001.02";
}
