...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.002.001.04")]
pub struct Atmcommand14 {
    #[yaserde(rename = "Tp")]
    ...
    pub rsn: AtmcommandReason1Code,

    #[yaserde(rename = "TracRsn")]
    #[cfg_attr(feature = "serde", serde(rename = "TracRsn"))]
    pub trac_rsn: Vec<AtmcommandReason1Code>,

    #[yaserde(rename = "AddtlRsnInf")]
    #[cfg_attr(feature = "serde", serde(rename = "AddtlRsnInf"))]
    pub addtl_rsn_inf: Max70Text,

    #[yaserde(rename = "CmdParams")]
    #[cfg_attr(feature = "serde", serde(rename = "CmdParams"))]
    pub cmd_params: AtmcommandParameters3Choice,
}

impl Validate for Atmcommand14 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.002.001.04")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.002.001.04")]
pub struct AtmcommandParameters1 {
    #[yaserde(rename = "SrlNb")]
    #[cfg_attr(feature = "serde", serde(rename = "SrlNb"))]
    pub srl_nb: Max35Text,

    #[yaserde(rename = "ReqrdCfgtn")]
    #[cfg_attr(feature = "serde", serde(rename = "ReqrdCfgtn"))]
    pub reqrd_cfgtn: AtmsecurityConfiguration1,

    #[yaserde(rename = "ReqrdSts")]
    #[cfg_attr(feature = "serde", serde(rename = "ReqrdSts"))]
    pub reqrd_sts: Atmstatus2Code,
}
...
pub enum AtmcommandReason1Code {
    #[yaserde(rename = "DIAG")]
    #[cfg_attr(feature = "serde", serde(rename = "DIAG"))]
    Diag,
    #[yaserde(rename = "MONI")]
    #[cfg_attr(feature = "serde", serde(rename = "MONI"))]
    Moni,
    #[yaserde(rename = "SECU")]
...
impl Default for AtmcommandReason1Code {
    fn default() -> AtmcommandReason1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for AtmcommandReason1Code {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.002.001.04")]
pub struct AtmconfigurationParameter2 {
    #[yaserde(rename = "KeyCtgy")]
    #[cfg_attr(feature = "serde", serde(rename = "KeyCtgy"))]
    pub key_ctgy: CryptographicKeyType4Code,
    ...
    #[yaserde(rename = "KeyProps")]
    #[cfg_attr(feature = "serde", serde(rename = "KeyProps"))]
    pub key_props: Vec<Kekidentifier4>,
}

impl Validate for AtmconfigurationParameter2 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.002.001.04")]
pub struct AtmdeviceControl3 {
    #[yaserde(rename = "Envt")]
    ...
    pub cmd: Vec<Atmcommand14>,
}

impl Validate for AtmdeviceControl3 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.002.001.04")]
pub struct AtmdeviceControlV04 {
    #[yaserde(rename = "Hdr")]
    #[cfg_attr(feature = "serde", serde(rename = "Hdr"))]
    pub hdr: Header31,

    #[yaserde(rename = "PrtctdATMDvcCtrl")]
    #[cfg_attr(feature = "serde", serde(rename = "PrtctdATMDvcCtrl"))]
    pub prtctd_atm_dvc_ctrl: ContentInformationType10,

    #[yaserde(rename = "ATMDvcCtrl")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMDvcCtrl"))]
    pub atm_dvc_ctrl: AtmdeviceControl3,
...
impl Validate for AtmdeviceControlV04 {}
...
pub enum CryptographicKeyType4Code {
    #[yaserde(rename = "APPL")]
    ...
    Data,
    #[yaserde(rename = "DYNC")]
    #[cfg_attr(feature = "serde", serde(rename = "DYNC"))]
    Dync,
    #[yaserde(rename = "KENC")]
    #[cfg_attr(feature = "serde", serde(rename = "KENC"))]
    Kenc,
    #[yaserde(rename = "MACK")]
    ...
    Pink,
    #[yaserde(rename = "WRKG")]
    #[cfg_attr(feature = "serde", serde(rename = "WRKG"))]
    Wrkg,
    __Unknown__(String),
}

impl Default for CryptographicKeyType4Code {
    fn default() -> CryptographicKeyType4Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for CryptographicKeyType4Code {}
...
pub struct Document {
    #[yaserde(rename = "ATMDvcCtrl")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMDvcCtrl"))]
    pub atm_dvc_ctrl: AtmdeviceControlV04,
}
...
impl Validate for Kekidentifier4 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "caam.002.001.04";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:caam.002.001.04";
}
