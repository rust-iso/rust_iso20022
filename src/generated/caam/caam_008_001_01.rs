...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.008.001.01")]
...
// Algorithm11Code
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.008.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.008.001.01")]
pub struct Document {
    #[yaserde(rename = "HstToATMAck")]
    #[cfg_attr(feature = "serde", serde(rename = "HstToATMAck"))]
    pub hst_to_atm_ack: HostToATMAcknowledgementV01,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.008.001.01")]
pub struct HostToATMAcknowledgement1 {
    // Environment
    #[yaserde(rename = "Envt")]
...
impl Validate for HostToATMAcknowledgement1 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.008.001.01")]
pub struct HostToATMAcknowledgementV01 {
    // Header
    #[yaserde(rename = "Hdr")]
    #[cfg_attr(feature = "serde", serde(rename = "Hdr"))]
    pub hdr: Header20,

    // ProtectedHostToATMAcknowledgement
    #[yaserde(rename = "PrtctdHstToATMAck")]
    #[cfg_attr(feature = "serde", serde(rename = "PrtctdHstToATMAck"))]
    pub prtctd_hst_to_atm_ack: ContentInformationType10,

    // HostToATMAcknowledgement
    #[yaserde(rename = "HstToATMAck")]
    #[cfg_attr(feature = "serde", serde(rename = "HstToATMAck"))]
    pub hst_to_atm_ack: HostToATMAcknowledgement1,
...
impl Validate for HostToATMAcknowledgementV01 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "caam.008.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:caam.008.001.01";
}
