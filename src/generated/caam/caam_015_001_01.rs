...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.015.001.01")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.015.001.01")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.015.001.01")]
pub struct AtmreconciliationRequestComponent1 {
    #[yaserde(rename = "Envt")]
    ...
    pub tx: Atmtransaction30,
}

impl Validate for AtmreconciliationRequestComponent1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.015.001.01")]
pub struct AtmreconciliationRequestV01 {
    #[yaserde(rename = "Hdr")]
    #[cfg_attr(feature = "serde", serde(rename = "Hdr"))]
    pub hdr: Header31,

    #[yaserde(rename = "PrtctdATMRcncltnReq")]
    #[cfg_attr(feature = "serde", serde(rename = "PrtctdATMRcncltnReq"))]
    pub prtctd_atm_rcncltn_req: ContentInformationType10,

    #[yaserde(rename = "ATMRcncltnReq")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMRcncltnReq"))]
    pub atm_rcncltn_req: AtmreconciliationRequestComponent1,
...
impl Validate for AtmreconciliationRequestV01 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.015.001.01")]
pub struct Atmtransaction30 {
...
impl Validate for Atmtransaction30 {}
...
pub struct Document {
    #[yaserde(rename = "ATMRcncltnReq")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMRcncltnReq"))]
    pub atm_rcncltn_req: AtmreconciliationRequestV01,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "caam.015.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:caam.015.001.01";
}
