...
impl Validate for Atmcommand10 {}
...
pub struct AtmdeviceControl2 {
    ...
    pub cmd: Vec<Atmcommand10>,
}

impl Validate for AtmdeviceControl2 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.002.001.03")]
pub struct AtmdeviceControlV03 {
    #[yaserde(rename = "Hdr")]
    ...
    pub atm_dvc_ctrl: AtmdeviceControl2,
...
impl Validate for AtmdeviceControlV03 {}
...
pub struct Document {
    #[yaserde(rename = "ATMDvcCtrl")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMDvcCtrl"))]
    pub atm_dvc_ctrl: AtmdeviceControlV03,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "caam.002.001.03";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:caam.002.001.03";
}
