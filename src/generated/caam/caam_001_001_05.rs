...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.001.001.05")]
pub struct Atmcommand15 {
    #[yaserde(rename = "Tp")]
    #[cfg_attr(feature = "serde", serde(rename = "Tp"))]
    pub tp: Atmcommand7Code,
...
impl Validate for Atmcommand15 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.001.001.05")]
pub struct Atmcommand16 {
    #[yaserde(rename = "Tp")]
    #[cfg_attr(feature = "serde", serde(rename = "Tp"))]
    pub tp: Atmcommand7Code,
...
impl Validate for Atmcommand16 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.001.001.05")]

pub enum Atmcommand7Code {
    #[yaserde(rename = "ABAL")]
    ...
    Kchg,
    #[yaserde(rename = "RREQ")]
    #[cfg_attr(feature = "serde", serde(rename = "RREQ"))]
    Rreq,
    __Unknown__(String),
}

impl Default for Atmcommand7Code {
    fn default() -> Atmcommand7Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for Atmcommand7Code {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.001.001.05")]
pub struct AtmdeviceReport5 {
    #[yaserde(rename = "Envt")]
    #[cfg_attr(feature = "serde", serde(rename = "Envt"))]
    pub envt: Atmenvironment6,

    #[yaserde(rename = "ATMGblSts")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMGblSts"))]
    pub atm_gbl_sts: Atmstatus2,

    #[yaserde(rename = "CmdRslt")]
    #[cfg_attr(feature = "serde", serde(rename = "CmdRslt"))]
    pub cmd_rslt: Vec<Atmcommand15>,

    #[yaserde(rename = "CmdCntxt")]
    #[cfg_attr(feature = "serde", serde(rename = "CmdCntxt"))]
    pub cmd_cntxt: Atmcommand16,

    #[yaserde(rename = "ATMSctyCntxt")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMSctyCntxt"))]
    pub atm_scty_cntxt: AtmsecurityContext6,
}

impl Validate for AtmdeviceReport5 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.001.001.05")]
pub struct AtmdeviceReportV05 {
    #[yaserde(rename = "Hdr")]
    #[cfg_attr(feature = "serde", serde(rename = "Hdr"))]
    pub hdr: Header31,

    #[yaserde(rename = "PrtctdATMDvcRpt")]
    #[cfg_attr(feature = "serde", serde(rename = "PrtctdATMDvcRpt"))]
    pub prtctd_atm_dvc_rpt: ContentInformationType10,

    #[yaserde(rename = "ATMDvcRpt")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMDvcRpt"))]
    pub atm_dvc_rpt: AtmdeviceReport5,
...
impl Validate for AtmdeviceReportV05 {}
...
impl Validate for Atmequipment2 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.001.001.05")]
pub struct AtmsecurityContext6 {
    #[yaserde(rename = "CurSctySchme")]
    #[cfg_attr(feature = "serde", serde(rename = "CurSctySchme"))]
    pub cur_scty_schme: AtmsecurityScheme3Code,

    #[yaserde(rename = "SctySchmeCpblties")]
    #[cfg_attr(feature = "serde", serde(rename = "SctySchmeCpblties"))]
    pub scty_schme_cpblties: Vec<AtmsecurityScheme4Code>,

    #[yaserde(rename = "SctyDvc")]
    #[cfg_attr(feature = "serde", serde(rename = "SctyDvc"))]
    pub scty_dvc: AtmsecurityDevice2,

    #[yaserde(rename = "Key")]
    #[cfg_attr(feature = "serde", serde(rename = "Key"))]
    pub key: Vec<CryptographicKey20>,
...
impl Validate for AtmsecurityContext6 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.001.001.05")]
pub struct AtmsecurityDevice2 {
    #[yaserde(rename = "DvcPrprty")]
    #[cfg_attr(feature = "serde", serde(rename = "DvcPrprty"))]
    pub dvc_prprty: Atmequipment2,

    #[yaserde(rename = "CurCfgtn")]
    #[cfg_attr(feature = "serde", serde(rename = "CurCfgtn"))]
    pub cur_cfgtn: AtmsecurityConfiguration1,

    #[yaserde(rename = "SpprtdCfgtn")]
    #[cfg_attr(feature = "serde", serde(rename = "SpprtdCfgtn"))]
    pub spprtd_cfgtn: AtmsecurityConfiguration1,

    #[yaserde(rename = "CurSts")]
    #[cfg_attr(feature = "serde", serde(rename = "CurSts"))]
    pub cur_sts: Atmstatus2Code,

    #[yaserde(rename = "Incdnt")]
    #[cfg_attr(feature = "serde", serde(rename = "Incdnt"))]
    pub incdnt: FailureReason5Code,

    #[yaserde(rename = "BndgStat")]
    #[cfg_attr(feature = "serde", serde(rename = "BndgStat"))]
    pub bndg_stat: Tr34Status1Code,
}

impl Validate for AtmsecurityDevice2 {}
...
pub enum AtmsecurityScheme4Code {
    #[yaserde(rename = "APPK")]
    #[cfg_attr(feature = "serde", serde(rename = "APPK"))]
    Appk,
    #[yaserde(rename = "CERT")]
...
impl Default for AtmsecurityScheme4Code {
    fn default() -> AtmsecurityScheme4Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for AtmsecurityScheme4Code {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.001.001.05")]
pub struct Atmstatus2 {
    #[yaserde(rename = "CurSts")]
    #[cfg_attr(feature = "serde", serde(rename = "CurSts"))]
    pub cur_sts: Atmstatus1Code,

    #[yaserde(rename = "CurStsRsn")]
    #[cfg_attr(feature = "serde", serde(rename = "CurStsRsn"))]
    pub cur_sts_rsn: Vec<Max35Text>,

    #[yaserde(rename = "DmnddSts")]
    #[cfg_attr(feature = "serde", serde(rename = "DmnddSts"))]
    pub dmndd_sts: Atmstatus1Code,
}

impl Validate for Atmstatus2 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.001.001.05")]

pub enum Atmstatus2Code {
    #[yaserde(rename = "OPER")]
...
impl Default for Atmstatus2Code {
    fn default() -> Atmstatus2Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for Atmstatus2Code {}
...
pub enum Atmstatus3Code {
    ...
    Stop,
    #[yaserde(rename = "WACT")]
    #[cfg_attr(feature = "serde", serde(rename = "WACT"))]
    Wact,
    __Unknown__(String),
}

impl Default for Atmstatus3Code {
    fn default() -> Atmstatus3Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for Atmstatus3Code {}
...
pub struct CryptographicKey20 {
    ...
    #[yaserde(rename = "CurSts")]
    #[cfg_attr(feature = "serde", serde(rename = "CurSts"))]
    pub cur_sts: Atmstatus3Code,

    #[yaserde(rename = "FailrRsn")]
    #[cfg_attr(feature = "serde", serde(rename = "FailrRsn"))]
    pub failr_rsn: FailureReason6Code,
}

impl Validate for CryptographicKey20 {}
...
pub struct Document {
    #[yaserde(rename = "ATMDvcRpt")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMDvcRpt"))]
    pub atm_dvc_rpt: AtmdeviceReportV05,
}
...
impl Default for FailureReason5Code {
    fn default() -> FailureReason5Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for FailureReason5Code {}
...
pub enum FailureReason6Code {
    #[yaserde(rename = "CMPR")]
    #[cfg_attr(feature = "serde", serde(rename = "CMPR"))]
    Cmpr,
    #[yaserde(rename = "EXPR")]
    #[cfg_attr(feature = "serde", serde(rename = "EXPR"))]
    Expr,
    #[yaserde(rename = "KCVE")]
    #[cfg_attr(feature = "serde", serde(rename = "KCVE"))]
    Kcve,
    #[yaserde(rename = "KLOD")]
    #[cfg_attr(feature = "serde", serde(rename = "KLOD"))]
    Klod,
    __Unknown__(String),
}

impl Default for FailureReason6Code {
    fn default() -> FailureReason6Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for FailureReason6Code {}
...
impl Default for Tr34Status1Code {
    fn default() -> Tr34Status1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for Tr34Status1Code {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "caam.001.001.05";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:caam.001.001.05";
}
