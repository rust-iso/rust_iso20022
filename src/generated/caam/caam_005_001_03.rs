...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.005.001.03")]
pub struct AtmdiagnosticRequest3 {
    #[yaserde(rename = "Envt")]
...
impl Validate for AtmdiagnosticRequest3 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.005.001.03")]
pub struct AtmdiagnosticRequestV03 {
    #[yaserde(rename = "Hdr")]
    #[cfg_attr(feature = "serde", serde(rename = "Hdr"))]
    pub hdr: Header31,

    #[yaserde(rename = "PrtctdATMDgnstcReq")]
    #[cfg_attr(feature = "serde", serde(rename = "PrtctdATMDgnstcReq"))]
    pub prtctd_atm_dgnstc_req: ContentInformationType10,

    #[yaserde(rename = "ATMDgnstcReq")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMDgnstcReq"))]
    pub atm_dgnstc_req: AtmdiagnosticRequest3,
...
impl Validate for AtmdiagnosticRequestV03 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.005.001.03")]
...
pub struct Document {
    #[yaserde(rename = "ATMDgnstcReq")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMDgnstcReq"))]
    pub atm_dgnstc_req: AtmdiagnosticRequestV03,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "caam.005.001.03";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:caam.005.001.03";
}
