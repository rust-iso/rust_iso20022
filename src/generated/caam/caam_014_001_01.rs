...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.014.001.01")]

pub enum AtmactionType1Code {
    #[yaserde(rename = "APLY")]
    #[cfg_attr(feature = "serde", serde(rename = "APLY"))]
    Aply,
    #[yaserde(rename = "NONE")]
...
impl Default for AtmactionType1Code {
    fn default() -> AtmactionType1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for AtmactionType1Code {}



#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.014.001.01")]
pub struct AtmconfigurationControlComponent1 {
    #[yaserde(rename = "Envt")]
    #[cfg_attr(feature = "serde", serde(rename = "Envt"))]
    pub envt: Atmenvironment7,

    #[yaserde(rename = "CfgtnVrsn")]
    #[cfg_attr(feature = "serde", serde(rename = "CfgtnVrsn"))]
    pub cfgtn_vrsn: Max35Text,

    #[yaserde(rename = "ActnReqrd")]
    #[cfg_attr(feature = "serde", serde(rename = "ActnReqrd"))]
    pub actn_reqrd: AtmactionType1Code,

    #[yaserde(rename = "Prprty")]
    #[cfg_attr(feature = "serde", serde(rename = "Prprty"))]
    pub prprty: Vec<AtmpropertyComponent1>,
...
impl Validate for AtmconfigurationControlComponent1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.014.001.01")]
pub struct AtmconfigurationControlV01 {
    #[yaserde(rename = "Hdr")]
    #[cfg_attr(feature = "serde", serde(rename = "Hdr"))]
    pub hdr: Header31,

    #[yaserde(rename = "PrtctdATMCfgtnCtrl")]
    #[cfg_attr(feature = "serde", serde(rename = "PrtctdATMCfgtnCtrl"))]
    pub prtctd_atm_cfgtn_ctrl: ContentInformationType10,

    #[yaserde(rename = "ATMCfgtnCtrl")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMCfgtnCtrl"))]
    pub atm_cfgtn_ctrl: AtmconfigurationControlComponent1,
...
impl Validate for AtmconfigurationControlV01 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.014.001.01")]
pub struct AtmpropertyComponent1 {
    #[yaserde(rename = "PrprtyNm")]
    #[cfg_attr(feature = "serde", serde(rename = "PrprtyNm"))]
    pub prprty_nm: Max70Text,

    #[yaserde(rename = "PrprtyTp")]
    #[cfg_attr(feature = "serde", serde(rename = "PrprtyTp"))]
    pub prprty_tp: AtmpropertyType1Code,

    #[yaserde(rename = "PrprtyVal")]
    #[cfg_attr(feature = "serde", serde(rename = "PrprtyVal"))]
    pub prprty_val: Max2000Text,
}

impl Validate for AtmpropertyComponent1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.014.001.01")]

pub enum AtmpropertyType1Code {
    #[yaserde(rename = "STRG")]
    #[cfg_attr(feature = "serde", serde(rename = "STRG"))]
    Strg,
    #[yaserde(rename = "NMBR")]
    #[cfg_attr(feature = "serde", serde(rename = "NMBR"))]
    Nmbr,
    #[yaserde(rename = "BOOL")]
...
impl Default for AtmpropertyType1Code {
    fn default() -> AtmpropertyType1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for AtmpropertyType1Code {}
...
pub struct Document {
    #[yaserde(rename = "ATMCfgtnCtrl")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMCfgtnCtrl"))]
    pub atm_cfgtn_ctrl: AtmconfigurationControlV01,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "caam.014.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:caam.014.001.01";
}
