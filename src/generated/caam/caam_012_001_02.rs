...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.012.001.02")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.012.001.02")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.012.001.02")]
pub struct AtmexceptionAcknowledgement2 {
    #[yaserde(rename = "ATM")]
    ...
    pub tx: Atmtransaction41,
}

impl Validate for AtmexceptionAcknowledgement2 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caam.012.001.02")]
pub struct AtmexceptionAcknowledgementV02 {
    #[yaserde(rename = "Hdr")]
    #[cfg_attr(feature = "serde", serde(rename = "Hdr"))]
    pub hdr: Header32,

    #[yaserde(rename = "PrtctdATMXcptnAck")]
    #[cfg_attr(feature = "serde", serde(rename = "PrtctdATMXcptnAck"))]
    pub prtctd_atm_xcptn_ack: ContentInformationType10,

    #[yaserde(rename = "ATMXcptnAck")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMXcptnAck"))]
    pub atm_xcptn_ack: AtmexceptionAcknowledgement2,
...
impl Validate for AtmexceptionAcknowledgementV02 {}
...
impl Validate for Atmtransaction41 {}
...
pub struct Document {
    #[yaserde(rename = "ATMXcptnAck")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMXcptnAck"))]
    pub atm_xcptn_ack: AtmexceptionAcknowledgementV02,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "caam.012.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:caam.012.001.02";
}
