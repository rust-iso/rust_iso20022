...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.015.001.02")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.015.001.02")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.015.001.02")]
pub struct AtmdepositCompletionAcknowledgement2 {
    #[yaserde(rename = "ATM")]
    ...
    pub tx: Atmtransaction45,
}

impl Validate for AtmdepositCompletionAcknowledgement2 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.015.001.02")]
pub struct AtmdepositCompletionAcknowledgementV02 {
    #[yaserde(rename = "Hdr")]
    #[cfg_attr(feature = "serde", serde(rename = "Hdr"))]
    pub hdr: Header32,

    #[yaserde(rename = "PrtctdATMDpstCmpltnAck")]
    #[cfg_attr(feature = "serde", serde(rename = "PrtctdATMDpstCmpltnAck"))]
    pub prtctd_atm_dpst_cmpltn_ack: ContentInformationType10,

    #[yaserde(rename = "ATMDpstCmpltnAck")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMDpstCmpltnAck"))]
    pub atm_dpst_cmpltn_ack: AtmdepositCompletionAcknowledgement2,
...
impl Validate for AtmdepositCompletionAcknowledgementV02 {}
...
impl Validate for Atmtransaction45 {}
...
pub struct Document {
    #[yaserde(rename = "ATMDpstCmpltnAck")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMDpstCmpltnAck"))]
    pub atm_dpst_cmpltn_ack: AtmdepositCompletionAcknowledgementV02,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "catp.015.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:catp.015.001.02";
}
