...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.009.001.03")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.009.001.03")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.009.001.03")]
pub struct AtmcompletionAcknowledgement3 {
    #[yaserde(rename = "ATM")]
...
impl Validate for AtmcompletionAcknowledgement3 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.009.001.03")]
pub struct AtmcompletionAcknowledgementV03 {
    #[yaserde(rename = "Hdr")]
    #[cfg_attr(feature = "serde", serde(rename = "Hdr"))]
    pub hdr: Header32,

    #[yaserde(rename = "PrtctdATMCmpltnAck")]
    #[cfg_attr(feature = "serde", serde(rename = "PrtctdATMCmpltnAck"))]
    pub prtctd_atm_cmpltn_ack: ContentInformationType10,

    #[yaserde(rename = "ATMCmpltnAck")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMCmpltnAck"))]
    pub atm_cmpltn_ack: AtmcompletionAcknowledgement3,
...
impl Validate for AtmcompletionAcknowledgementV03 {}
...
pub struct Document {
    #[yaserde(rename = "ATMCmpltnAck")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMCmpltnAck"))]
    pub atm_cmpltn_ack: AtmcompletionAcknowledgementV03,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "catp.009.001.03";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:catp.009.001.03";
}
