...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.016.001.02")]
...
pub struct Atmcontext18 {
    ...
    pub svc: Atmservice22,
}

impl Validate for Atmcontext18 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.016.001.02")]
...
impl Validate for Atmservice22 {}
...
impl Validate for Atmtransaction38 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.016.001.02")]
pub struct AtmtransferRequest2 {
    #[yaserde(rename = "Envt")]
    ...
    pub cntxt: Atmcontext18,

    #[yaserde(rename = "Tx")]
    #[cfg_attr(feature = "serde", serde(rename = "Tx"))]
    pub tx: Atmtransaction38,
}

impl Validate for AtmtransferRequest2 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.016.001.02")]
pub struct AtmtransferRequestV02 {
    #[yaserde(rename = "Hdr")]
    #[cfg_attr(feature = "serde", serde(rename = "Hdr"))]
    pub hdr: Header31,

    #[yaserde(rename = "PrtctdATMTrfReq")]
    #[cfg_attr(feature = "serde", serde(rename = "PrtctdATMTrfReq"))]
    pub prtctd_atm_trf_req: ContentInformationType10,

    #[yaserde(rename = "ATMTrfReq")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMTrfReq"))]
    pub atm_trf_req: AtmtransferRequest2,
...
impl Validate for AtmtransferRequestV02 {}
...
pub struct Document {
    #[yaserde(rename = "ATMTrfReq")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMTrfReq"))]
    pub atm_trf_req: AtmtransferRequestV02,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "catp.016.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:catp.016.001.02";
}
