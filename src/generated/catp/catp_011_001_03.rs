...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.011.001.03")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.011.001.03")]
...
pub struct Atmcontext17 {
    ...
    pub svc: Atmservice21,
}

impl Validate for Atmcontext17 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.011.001.03")]
pub struct AtmpinmanagementResponse3 {
    #[yaserde(rename = "Envt")]
    ...
    pub cntxt: Atmcontext17,

    #[yaserde(rename = "Tx")]
    #[cfg_attr(feature = "serde", serde(rename = "Tx"))]
    pub tx: Atmtransaction37,
}

impl Validate for AtmpinmanagementResponse3 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.011.001.03")]
pub struct AtmpinmanagementResponseV03 {
    #[yaserde(rename = "Hdr")]
    #[cfg_attr(feature = "serde", serde(rename = "Hdr"))]
    pub hdr: Header31,

    #[yaserde(rename = "PrtctdATMPINMgmtRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "PrtctdATMPINMgmtRspn"))]
    pub prtctd_atmpin_mgmt_rspn: ContentInformationType10,

    #[yaserde(rename = "ATMPINMgmtRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMPINMgmtRspn"))]
    pub atmpin_mgmt_rspn: AtmpinmanagementResponse3,
...
impl Validate for AtmpinmanagementResponseV03 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.011.001.03")]
pub struct Atmservice21 {
...
impl Validate for Atmservice21 {}
...
impl Validate for Atmtransaction37 {}
...
pub struct Document {
    #[yaserde(rename = "ATMPINMgmtRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMPINMgmtRspn"))]
    pub atmpin_mgmt_rspn: AtmpinmanagementResponseV03,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "catp.011.001.03";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:catp.011.001.03";
}
