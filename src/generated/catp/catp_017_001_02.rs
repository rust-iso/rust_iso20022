...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.017.001.02")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.017.001.02")]
...
impl Validate for Atmtransaction39 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.017.001.02")]
pub struct AtmtransferResponse2 {
    #[yaserde(rename = "Envt")]
    ...
    pub tx: Atmtransaction39,
}

impl Validate for AtmtransferResponse2 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.017.001.02")]
pub struct AtmtransferResponseV02 {
    #[yaserde(rename = "Hdr")]
    ...
    pub atm_trf_rspn: AtmtransferResponse2,
...
impl Validate for AtmtransferResponseV02 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.017.001.02")]
...
pub struct CardAccount19 {
    ...
    pub bal_bfr: AmountAndDirection111,

    #[yaserde(rename = "BalAftr")]
    #[cfg_attr(feature = "serde", serde(rename = "BalAftr"))]
    pub bal_aftr: AmountAndDirection111,
}

impl Validate for CardAccount19 {}
...
pub struct Document {
    #[yaserde(rename = "ATMTrfRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMTrfRspn"))]
    pub atm_trf_rspn: AtmtransferResponseV02,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "catp.017.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:catp.017.001.02";
}
