...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.007.001.03")]
pub struct AtmaccountStatement2 {
    ...
    #[yaserde(rename = "ShrtTxt")]
    #[cfg_attr(feature = "serde", serde(rename = "ShrtTxt"))]
    pub shrt_txt: Max70Text,

    #[yaserde(rename = "CdtTx")]
    #[cfg_attr(feature = "serde", serde(rename = "CdtTx"))]
    pub cdt_tx: TrueFalseIndicator,
    ...
    #[yaserde(rename = "LngTxt")]
    #[cfg_attr(feature = "serde", serde(rename = "LngTxt"))]
    pub lng_txt: Max256Text,
}

impl Validate for AtmaccountStatement2 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.007.001.03")]
pub struct AtmaccountStatement3 {
    ...
    #[yaserde(rename = "AcctStmt")]
    #[cfg_attr(feature = "serde", serde(rename = "AcctStmt"))]
    pub acct_stmt: Vec<AtmaccountStatement2>,
}

impl Validate for AtmaccountStatement3 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.007.001.03")]
...
pub struct Atmcontext27 {
    ...
    pub svc: Atmservice26,
}

impl Validate for Atmcontext27 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.007.001.03")]
pub struct AtmcustomerProfile7 {
    #[yaserde(rename = "PrflRef")]
    #[cfg_attr(feature = "serde", serde(rename = "PrflRef"))]
    pub prfl_ref: Max35Text,
    ...
    #[yaserde(rename = "PrflDesc")]
    #[cfg_attr(feature = "serde", serde(rename = "PrflDesc"))]
    pub prfl_desc: Max70Text,

    #[yaserde(rename = "AllwdSvcs")]
    #[cfg_attr(feature = "serde", serde(rename = "AllwdSvcs"))]
    pub allwd_svcs: Vec<Atmservice28>,
}

impl Validate for AtmcustomerProfile7 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.007.001.03")]
pub struct AtminquiryResponse3 {
    #[yaserde(rename = "Envt")]
    ...
    pub cntxt: Atmcontext27,

    #[yaserde(rename = "Tx")]
    #[cfg_attr(feature = "serde", serde(rename = "Tx"))]
    pub tx: Atmtransaction48,
}

impl Validate for AtminquiryResponse3 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.007.001.03")]
pub struct AtminquiryResponseV03 {
    #[yaserde(rename = "Hdr")]
    #[cfg_attr(feature = "serde", serde(rename = "Hdr"))]
    pub hdr: Header31,

    #[yaserde(rename = "PrtctdATMNqryRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "PrtctdATMNqryRspn"))]
    pub prtctd_atm_nqry_rspn: ContentInformationType10,

    #[yaserde(rename = "ATMNqryRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMNqryRspn"))]
    pub atm_nqry_rspn: AtminquiryResponse3,
...
impl Validate for AtminquiryResponseV03 {}
...
impl Validate for AtmmediaMix2 {}
...
pub struct Atmservice26 {
    ...
    pub svc_tp: AtmserviceType12Code,
...
impl Validate for Atmservice26 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.007.001.03")]
pub struct Atmservice28 {
    #[yaserde(rename = "SvcTp")]
    #[cfg_attr(feature = "serde", serde(rename = "SvcTp"))]
    ...
    #[yaserde(rename = "PrefrdWdrwl")]
    #[cfg_attr(feature = "serde", serde(rename = "PrefrdWdrwl"))]
    pub prefrd_wdrwl: Atmtransaction8,
}

impl Validate for Atmservice28 {}
...
pub enum AtmserviceType12Code {
    #[yaserde(rename = "ASTS")]
    #[cfg_attr(feature = "serde", serde(rename = "ASTS"))]
    Asts,
    #[yaserde(rename = "CDVF")]
    #[cfg_attr(feature = "serde", serde(rename = "CDVF"))]
    Cdvf,
    #[yaserde(rename = "DCCS")]
    #[cfg_attr(feature = "serde", serde(rename = "DCCS"))]
    Dccs,
    #[yaserde(rename = "XRTD")]
    #[cfg_attr(feature = "serde", serde(rename = "XRTD"))]
    Xrtd,
    #[yaserde(rename = "XRTW")]
    #[cfg_attr(feature = "serde", serde(rename = "XRTW"))]
    Xrtw,
    #[yaserde(rename = "EMVS")]
    #[cfg_attr(feature = "serde", serde(rename = "EMVS"))]
    Emvs,
    #[yaserde(rename = "CMPF")]
    #[cfg_attr(feature = "serde", serde(rename = "CMPF"))]
    Cmpf,
    #[yaserde(rename = "BLCQ")]
...
impl Default for AtmserviceType12Code {
    fn default() -> AtmserviceType12Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for AtmserviceType12Code {}
...
pub struct Atmtransaction48 {
    ...
    pub tx_rspn: ResponseType12,

    #[yaserde(rename = "Actn")]
    #[cfg_attr(feature = "serde", serde(rename = "Actn"))]
    pub actn: Vec<Action7>,

    #[yaserde(rename = "CstmrSvcPrfl")]
    #[cfg_attr(feature = "serde", serde(rename = "CstmrSvcPrfl"))]
    pub cstmr_svc_prfl: AtmcustomerProfile7,

    #[yaserde(rename = "CcyConvs")]
    #[cfg_attr(feature = "serde", serde(rename = "CcyConvs"))]
    pub ccy_convs: CurrencyConversion33,

    #[yaserde(rename = "AcctInf")]
    #[cfg_attr(feature = "serde", serde(rename = "AcctInf"))]
    pub acct_inf: Vec<CardAccount18>,

    #[yaserde(rename = "AcctStmtData")]
    #[cfg_attr(feature = "serde", serde(rename = "AcctStmtData"))]
    pub acct_stmt_data: Vec<AtmaccountStatement3>,

    #[yaserde(rename = "CcyXchg")]
    #[cfg_attr(feature = "serde", serde(rename = "CcyXchg"))]
    pub ccy_xchg: CurrencyConversion5,
...
impl Validate for Atmtransaction48 {}
...
pub struct Atmtransaction8 {
    ...
    #[yaserde(rename = "RctFlg")]
    #[cfg_attr(feature = "serde", serde(rename = "RctFlg"))]
    pub rct_flg: TrueFalseIndicator,

    #[yaserde(rename = "BalPrtFlg")]
    #[cfg_attr(feature = "serde", serde(rename = "BalPrtFlg"))]
    pub bal_prt_flg: TrueFalseIndicator,
...
impl Validate for Atmtransaction8 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.007.001.03")]
pub struct CurrencyConversion33 {
    #[yaserde(rename = "Rslt")]
    ...
    pub convs: CurrencyConversion32,
}

impl Validate for CurrencyConversion33 {}
...
pub struct CurrencyConversion5 {
    ...
    #[yaserde(rename = "SrcCcyNmrc")]
    #[cfg_attr(feature = "serde", serde(rename = "SrcCcyNmrc"))]
    ...
    #[yaserde(rename = "TrgtCcyNmrc")]
    #[cfg_attr(feature = "serde", serde(rename = "TrgtCcyNmrc"))]
...
impl Validate for CurrencyConversion5 {}
...
pub enum CurrencyConversionResponse2Code {
    ...
    Ndcc,
    #[yaserde(rename = "IAMG")]
    #[cfg_attr(feature = "serde", serde(rename = "IAMG"))]
    Iamg,
    #[yaserde(rename = "IATM")]
    #[cfg_attr(feature = "serde", serde(rename = "IATM"))]
    Iatm,
    __Unknown__(String),
}

impl Default for CurrencyConversionResponse2Code {
    fn default() -> CurrencyConversionResponse2Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for CurrencyConversionResponse2Code {}
...
pub struct Document {
    #[yaserde(rename = "ATMNqryRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMNqryRspn"))]
    pub atm_nqry_rspn: AtminquiryResponseV03,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "catp.007.001.03";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:catp.007.001.03";
}
