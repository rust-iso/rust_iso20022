...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.015.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.015.001.01")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.015.001.01")]
pub struct AtmdepositCompletionAcknowledgement1 {
    #[yaserde(rename = "ATM")]
...
impl Validate for AtmdepositCompletionAcknowledgement1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.015.001.01")]
pub struct AtmdepositCompletionAcknowledgementV01 {
    #[yaserde(rename = "Hdr")]
    ...
    pub atm_dpst_cmpltn_ack: AtmdepositCompletionAcknowledgement1,
...
impl Validate for AtmdepositCompletionAcknowledgementV01 {}
...
impl Validate for Atmtransaction18 {}
...
pub struct Document {
    #[yaserde(rename = "ATMDpstCmpltnAck")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMDpstCmpltnAck"))]
    pub atm_dpst_cmpltn_ack: AtmdepositCompletionAcknowledgementV01,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "catp.015.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:catp.015.001.01";
}
