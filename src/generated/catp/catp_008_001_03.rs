...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.008.001.03")]
pub struct AtmcompletionAdvice3 {
    #[yaserde(rename = "Envt")]
    ...
    pub cntxt: Atmcontext13,

    #[yaserde(rename = "Tx")]
    #[cfg_attr(feature = "serde", serde(rename = "Tx"))]
    pub tx: Atmtransaction47,
}

impl Validate for AtmcompletionAdvice3 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.008.001.03")]
pub struct AtmcompletionAdviceV03 {
    #[yaserde(rename = "Hdr")]
    #[cfg_attr(feature = "serde", serde(rename = "Hdr"))]
    pub hdr: Header32,

    #[yaserde(rename = "PrtctdATMCmpltnAdvc")]
    #[cfg_attr(feature = "serde", serde(rename = "PrtctdATMCmpltnAdvc"))]
    pub prtctd_atm_cmpltn_advc: ContentInformationType10,

    #[yaserde(rename = "ATMCmpltnAdvc")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMCmpltnAdvc"))]
    pub atm_cmpltn_advc: AtmcompletionAdvice3,
...
impl Validate for AtmcompletionAdviceV03 {}
...
pub struct Atmcontext13 {
    ...
    pub svc: Atmservice14,
}

impl Validate for Atmcontext13 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.008.001.03")]
...
pub struct Atmservice14 {
    ...
    pub svc_tp: AtmserviceType7Code,
...
impl Validate for Atmservice14 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.008.001.03")]

pub enum AtmserviceType7Code {
    #[yaserde(rename = "CHSN")]
...
impl Default for AtmserviceType7Code {
    fn default() -> AtmserviceType7Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for AtmserviceType7Code {}
...
impl Validate for Atmtransaction47 {}
...
pub struct Document {
    #[yaserde(rename = "ATMCmpltnAdvc")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMCmpltnAdvc"))]
    pub atm_cmpltn_advc: AtmcompletionAdviceV03,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "catp.008.001.03";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:catp.008.001.03";
}
