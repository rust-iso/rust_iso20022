...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.016.001.01")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.016.001.01")]
...
impl Validate for Atmtransaction23 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.016.001.01")]
pub struct AtmtransferRequest1 {
    #[yaserde(rename = "Envt")]
    ...
    pub tx: Atmtransaction23,
}

impl Validate for AtmtransferRequest1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.016.001.01")]
pub struct AtmtransferRequestV01 {
    #[yaserde(rename = "Hdr")]
    ...
    pub atm_trf_req: AtmtransferRequest1,
...
impl Validate for AtmtransferRequestV01 {}
...
pub struct Document {
    #[yaserde(rename = "ATMTrfReq")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMTrfReq"))]
    pub atm_trf_req: AtmtransferRequestV01,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "catp.016.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:catp.016.001.01";
}
