...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.013.001.02")]

pub enum AtmaccountUsage1Code {
    #[yaserde(rename = "BOTH")]
    ...
    Dstn,
    #[yaserde(rename = "SRCE")]
    #[cfg_attr(feature = "serde", serde(rename = "SRCE"))]
    Srce,
    __Unknown__(String),
}

impl Default for AtmaccountUsage1Code {
    fn default() -> AtmaccountUsage1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for AtmaccountUsage1Code {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.013.001.02")]
...
pub struct Atmcontext11 {
    ...
    pub svc: Atmservice12,
}

impl Validate for Atmcontext11 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.013.001.02")]
pub struct Atmcustomer9 {
    #[yaserde(rename = "Prfl")]
...
impl Validate for Atmcustomer9 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.013.001.02")]
pub struct AtmdepositResponse2 {
    #[yaserde(rename = "Envt")]
    #[cfg_attr(feature = "serde", serde(rename = "Envt"))]
    pub envt: Atmenvironment21,
    ...
    pub tx: Atmtransaction44,
}

impl Validate for AtmdepositResponse2 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.013.001.02")]
pub struct AtmdepositResponseV02 {
    #[yaserde(rename = "Hdr")]
    #[cfg_attr(feature = "serde", serde(rename = "Hdr"))]
    pub hdr: Header31,

    #[yaserde(rename = "PrtctdATMDpstRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "PrtctdATMDpstRspn"))]
    pub prtctd_atm_dpst_rspn: ContentInformationType10,

    #[yaserde(rename = "ATMDpstRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMDpstRspn"))]
    pub atm_dpst_rspn: AtmdepositResponse2,
...
impl Validate for AtmdepositResponseV02 {}
...
impl Validate for Atmenvironment21 {}
...
impl Validate for Atmservice12 {}
...
impl Validate for Atmservice18 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.013.001.02")]
pub struct Atmservice29 {
    #[yaserde(rename = "SvcTp")]
    #[cfg_attr(feature = "serde", serde(rename = "SvcTp"))]
    pub svc_tp: AtmserviceType13Code,

    #[yaserde(rename = "SvcVarnt")]
    #[cfg_attr(feature = "serde", serde(rename = "SvcVarnt"))]
...
impl Validate for Atmservice29 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.013.001.02")]

pub enum AtmserviceType13Code {
    #[yaserde(rename = "ASTS")]
    #[cfg_attr(feature = "serde", serde(rename = "ASTS"))]
    Asts,
    #[yaserde(rename = "BLCQ")]
    #[cfg_attr(feature = "serde", serde(rename = "BLCQ"))]
    Blcq,
    #[yaserde(rename = "PINC")]
...
impl Default for AtmserviceType13Code {
    fn default() -> AtmserviceType13Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for AtmserviceType13Code {}
...
pub struct Atmtransaction44 {
    ...
    pub ttl_authrsd_amt: Vec<AmountAndCurrency1>,
    ...
    #[yaserde(rename = "AcctInf")]
    #[cfg_attr(feature = "serde", serde(rename = "AcctInf"))]
    pub acct_inf: Vec<CardAccount18>,
...
impl Validate for Atmtransaction44 {}
...
pub struct CardAccount18 {
    ...
    #[yaserde(rename = "AcctUsgCd")]
    #[cfg_attr(feature = "serde", serde(rename = "AcctUsgCd"))]
    pub acct_usg_cd: AtmaccountUsage1Code,
    ...
    pub bal: Vec<AmountAndDirection111>,
    ...
    #[yaserde(rename = "AllwdSvc")]
    #[cfg_attr(feature = "serde", serde(rename = "AllwdSvc"))]
    pub allwd_svc: Vec<Atmservice29>,
}

impl Validate for CardAccount18 {}
...
pub struct Document {
    #[yaserde(rename = "ATMDpstRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMDpstRspn"))]
    pub atm_dpst_rspn: AtmdepositResponseV02,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "catp.013.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:catp.013.001.02";
}
