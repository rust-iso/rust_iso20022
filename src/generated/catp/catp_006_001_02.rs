...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.006.001.02")]
...
pub struct Atmcontext14 {
    ...
    pub svc: Atmservice15,
}

impl Validate for Atmcontext14 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.006.001.02")]
...
pub struct Atmenvironment14 {
    ...
    pub atm: AutomatedTellerMachine10,
...
impl Validate for Atmenvironment14 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.006.001.02")]
pub struct AtminquiryRequest2 {
    #[yaserde(rename = "Envt")]
    #[cfg_attr(feature = "serde", serde(rename = "Envt"))]
    pub envt: Atmenvironment14,

    #[yaserde(rename = "Cntxt")]
    #[cfg_attr(feature = "serde", serde(rename = "Cntxt"))]
    pub cntxt: Atmcontext14,

    #[yaserde(rename = "Tx")]
    #[cfg_attr(feature = "serde", serde(rename = "Tx"))]
    pub tx: Atmtransaction29,
}

impl Validate for AtminquiryRequest2 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.006.001.02")]
pub struct AtminquiryRequestV02 {
    #[yaserde(rename = "Hdr")]
    ...
    pub atm_nqry_req: AtminquiryRequest2,
...
impl Validate for AtminquiryRequestV02 {}
...
impl Validate for Atmservice15 {}
...
impl Default for AtmserviceType3Code {
    fn default() -> AtmserviceType3Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for AtmserviceType3Code {}
...
impl Validate for Atmtransaction29 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.006.001.02")]
pub struct AutomatedTellerMachine10 {
    #[yaserde(rename = "Id")]
...
impl Validate for AutomatedTellerMachine10 {}
...
impl Validate for CardAccount7 {}
...
pub struct Document {
    #[yaserde(rename = "ATMNqryReq")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMNqryReq"))]
    pub atm_nqry_req: AtminquiryRequestV02,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "catp.006.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:catp.006.001.02";
}
