...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.012.001.01")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.012.001.01")]
...
pub struct AtmdepositRequest1 {
    ...
    pub tx: Atmtransaction15,
}

impl Validate for AtmdepositRequest1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.012.001.01")]
pub struct AtmdepositRequestV01 {
    #[yaserde(rename = "Hdr")]
    ...
    pub atm_dpst_req: AtmdepositRequest1,
...
impl Validate for AtmdepositRequestV01 {}
...
impl Validate for Atmtransaction15 {}
...
impl Validate for CardAccount9 {}
...
pub struct Document {
    #[yaserde(rename = "ATMDpstReq")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMDpstReq"))]
    pub atm_dpst_req: AtmdepositRequestV01,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "catp.012.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:catp.012.001.01";
}
