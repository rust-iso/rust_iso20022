...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.014.001.01")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.014.001.01")]
...
impl Validate for AtmdepositCompletionAdvice1 {}
...
pub struct AtmdepositCompletionAdviceV01 {
    ...
    pub atm_dpst_cmpltn_advc: AtmdepositCompletionAdvice1,
...
impl Validate for AtmdepositCompletionAdviceV01 {}
...
pub struct AtmdepositedMedia1 {
    ...
    #[yaserde(rename = "MdiaItms")]
    #[cfg_attr(feature = "serde", serde(rename = "MdiaItms"))]
    pub mdia_itms: Vec<AtmdepositedMedia2>,
}

impl Validate for AtmdepositedMedia1 {}
...
pub struct AtmdepositedMedia2 {
    ...
    pub cnfdnc_lvl: Percentage,
}

impl Validate for AtmdepositedMedia2 {}
...
impl Validate for AtmdepositedMedia3 {}
...
impl Validate for Atmtransaction19 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "catp.014.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:catp.014.001.01";
}
