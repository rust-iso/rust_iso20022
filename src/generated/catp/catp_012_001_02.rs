...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.012.001.02")]
...
pub struct Atmcontext10 {
    ...
    pub svc: Atmservice11,
}

impl Validate for Atmcontext10 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.012.001.02")]
...
pub struct AtmdepositRequest2 {
    ...
    pub cntxt: Atmcontext10,

    #[yaserde(rename = "Tx")]
    #[cfg_attr(feature = "serde", serde(rename = "Tx"))]
    pub tx: Atmtransaction50,
}

impl Validate for AtmdepositRequest2 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.012.001.02")]
pub struct AtmdepositRequestV02 {
    #[yaserde(rename = "Hdr")]
    #[cfg_attr(feature = "serde", serde(rename = "Hdr"))]
    pub hdr: Header31,

    #[yaserde(rename = "PrtctdATMDpstReq")]
    #[cfg_attr(feature = "serde", serde(rename = "PrtctdATMDpstReq"))]
    pub prtctd_atm_dpst_req: ContentInformationType10,

    #[yaserde(rename = "ATMDpstReq")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMDpstReq"))]
    pub atm_dpst_req: AtmdepositRequest2,
...
impl Validate for AtmdepositRequestV02 {}
...
impl Validate for Atmservice11 {}
...
pub struct Atmtransaction50 {
    ...
    pub ttl_amt: AmountAndCurrency1,
...
impl Validate for Atmtransaction50 {}
...
pub struct Document {
    #[yaserde(rename = "ATMDpstReq")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMDpstReq"))]
    pub atm_dpst_req: AtmdepositRequestV02,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "catp.012.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:catp.012.001.02";
}
