...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.008.001.02")]
pub struct AtmcompletionAdvice2 {
    #[yaserde(rename = "Envt")]
    ...
    pub tx: Atmtransaction20,
}

impl Validate for AtmcompletionAdvice2 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.008.001.02")]
pub struct AtmcompletionAdviceV02 {
    #[yaserde(rename = "Hdr")]
    ...
    pub atm_cmpltn_advc: AtmcompletionAdvice2,
...
impl Validate for AtmcompletionAdviceV02 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.008.001.02")]
...
impl Validate for Atmtransaction20 {}
...
pub struct Document {
    #[yaserde(rename = "ATMCmpltnAdvc")]
    #[cfg_attr(feature = "serde", serde(rename = "ATMCmpltnAdvc"))]
    pub atm_cmpltn_advc: AtmcompletionAdviceV02,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "catp.008.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:catp.008.001.02";
}
