...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.004.001.02")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catp.004.001.02")]
...
impl Validate for AtmwithdrawalCompletionAcknowledgement2 {}
...
pub struct AtmwithdrawalCompletionAcknowledgementV02 {
    ...
    pub atm_wdrwl_cmpltn_ack: AtmwithdrawalCompletionAcknowledgement2,
...
impl Validate for AtmwithdrawalCompletionAcknowledgementV02 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "catp.004.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:catp.004.001.02";
}
