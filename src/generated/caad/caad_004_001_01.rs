...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.004.001.01")]
pub struct BatchTransferResponse1 {
    #[yaserde(rename = "Envt")]
...
impl Validate for BatchTransferResponse1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.004.001.01")]
pub struct BatchTransferResponseV01 {
    #[yaserde(rename = "Hdr")]
    ...
    pub body: BatchTransferResponse1,
...
impl Validate for BatchTransferResponseV01 {}
...
pub struct Document {
    ...
    pub btch_trf_rspn: BatchTransferResponseV01,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "caad.004.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:caad.004.001.01";
}
