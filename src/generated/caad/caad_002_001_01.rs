...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.002.001.01")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.002.001.01")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.002.001.01")]
pub struct BatchManagementResponse1 {
    #[yaserde(rename = "Envt")]
...
impl Validate for BatchManagementResponse1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.002.001.01")]
pub struct BatchManagementResponseV01 {
    #[yaserde(rename = "Hdr")]
    ...
    pub body: BatchManagementResponse1,
...
impl Validate for BatchManagementResponseV01 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.002.001.01")]

pub enum BatchManagementType1Code {
    #[yaserde(rename = "AKRQ")]
    #[cfg_attr(feature = "serde", serde(rename = "AKRQ"))]
    Akrq,
    #[yaserde(rename = "AKRP")]
    #[cfg_attr(feature = "serde", serde(rename = "AKRP"))]
    Akrp,
    #[yaserde(rename = "ENDB")]
    #[cfg_attr(feature = "serde", serde(rename = "ENDB"))]
    Endb,
    #[yaserde(rename = "OTHN")]
    ...
    Othp,
    #[yaserde(rename = "STRT")]
    #[cfg_attr(feature = "serde", serde(rename = "STRT"))]
    Strt,
    __Unknown__(String),
}

impl Default for BatchManagementType1Code {
    fn default() -> BatchManagementType1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for BatchManagementType1Code {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.002.001.01")]
pub struct Document {
    #[yaserde(rename = "BtchMgmtRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "BtchMgmtRspn"))]
    pub btch_mgmt_rspn: BatchManagementResponseV01,
}
...
pub struct Header38 {
    ...
    pub msg_fctn: MessageFunction18Code,
...
pub enum MessageFunction18Code {
    #[yaserde(rename = "BTRQ")]
    #[cfg_attr(feature = "serde", serde(rename = "BTRQ"))]
    Btrq,
    #[yaserde(rename = "BTNF")]
    #[cfg_attr(feature = "serde", serde(rename = "BTNF"))]
    Btnf,
    #[yaserde(rename = "CLNF")]
    #[cfg_attr(feature = "serde", serde(rename = "CLNF"))]
    Clnf,
    #[yaserde(rename = "CLRQ")]
...
impl Default for MessageFunction18Code {
    fn default() -> MessageFunction18Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for MessageFunction18Code {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.002.001.01")]
pub struct Transaction95 {
    #[yaserde(rename = "BtchMgmtTp")]
    #[cfg_attr(feature = "serde", serde(rename = "BtchMgmtTp"))]
    pub btch_mgmt_tp: BatchManagementType1Code,

    #[yaserde(rename = "OthrBtchMgmtTp")]
    #[cfg_attr(feature = "serde", serde(rename = "OthrBtchMgmtTp"))]
    pub othr_btch_mgmt_tp: Max35Text,
    ...
    pub colltn_id: Max70Text,

    #[yaserde(rename = "BtchId")]
    #[cfg_attr(feature = "serde", serde(rename = "BtchId"))]
    pub btch_id: Max70Text,

    #[yaserde(rename = "ColltnSz")]
    #[cfg_attr(feature = "serde", serde(rename = "ColltnSz"))]
    pub colltn_sz: Number,

    #[yaserde(rename = "OrgnlColltnId")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlColltnId"))]
    pub orgnl_colltn_id: Max70Text,

    #[yaserde(rename = "OrgnlBtchId")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlBtchId"))]
    pub orgnl_btch_id: Max70Text,

    #[yaserde(rename = "NbOfBtchsInColltn")]
    #[cfg_attr(feature = "serde", serde(rename = "NbOfBtchsInColltn"))]
    pub nb_of_btchs_in_colltn: Number,

    #[yaserde(rename = "NbOfMsgs")]
    #[cfg_attr(feature = "serde", serde(rename = "NbOfMsgs"))]
    pub nb_of_msgs: Number,

    #[yaserde(rename = "RmngMsgsInColltn")]
    #[cfg_attr(feature = "serde", serde(rename = "RmngMsgsInColltn"))]
    pub rmng_msgs_in_colltn: Number,

    #[yaserde(rename = "MsgSeqNb")]
    #[cfg_attr(feature = "serde", serde(rename = "MsgSeqNb"))]
    pub msg_seq_nb: Max15NumericText,

    #[yaserde(rename = "BtchIdList")]
    #[cfg_attr(feature = "serde", serde(rename = "BtchIdList"))]
    pub btch_id_list: Vec<Max70Text>,

    #[yaserde(rename = "ChckptId")]
    #[cfg_attr(feature = "serde", serde(rename = "ChckptId"))]
    pub chckpt_id: Max70Text,
    ...
    #[yaserde(rename = "MsgsBfrAck")]
    #[cfg_attr(feature = "serde", serde(rename = "MsgsBfrAck"))]
    pub msgs_bfr_ack: Number,

    #[yaserde(rename = "PostvAck")]
    #[cfg_attr(feature = "serde", serde(rename = "PostvAck"))]
    pub postv_ack: TrueFalseIndicator,
...
impl Validate for Transaction95 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "caad.002.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:caad.002.001.01";
}
