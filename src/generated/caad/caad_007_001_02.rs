...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.007.001.02")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.007.001.02")]
...
impl Validate for Error1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.007.001.02")]
pub struct ErrorDetails1 {
    #[yaserde(rename = "MsgErrTp")]
    #[cfg_attr(feature = "serde", serde(rename = "MsgErrTp"))]
    pub msg_err_tp: MessageError1Code,

    #[yaserde(rename = "OthrMsgErrTp")]
    #[cfg_attr(feature = "serde", serde(rename = "OthrMsgErrTp"))]
    pub othr_msg_err_tp: Max35Text,

    #[yaserde(rename = "ErrCd")]
    #[cfg_attr(feature = "serde", serde(rename = "ErrCd"))]
    pub err_cd: Max35Text,

    #[yaserde(rename = "ErrDesc")]
    #[cfg_attr(feature = "serde", serde(rename = "ErrDesc"))]
    pub err_desc: Max500Text,
...
impl Validate for ErrorDetails1 {}
...
pub enum MessageError1Code {
    #[yaserde(rename = "IDEF")]
    #[cfg_attr(feature = "serde", serde(rename = "IDEF"))]
    Idef,
    #[yaserde(rename = "IDEL")]
    #[cfg_attr(feature = "serde", serde(rename = "IDEL"))]
    Idel,
    #[yaserde(rename = "IDEV")]
    #[cfg_attr(feature = "serde", serde(rename = "IDEV"))]
    Idev,
    #[yaserde(rename = "INME")]
    #[cfg_attr(feature = "serde", serde(rename = "INME"))]
    Inme,
    #[yaserde(rename = "INMF")]
    #[cfg_attr(feature = "serde", serde(rename = "INMF"))]
    Inmf,
    #[yaserde(rename = "MEPE")]
    #[cfg_attr(feature = "serde", serde(rename = "MEPE"))]
    Mepe,
    #[yaserde(rename = "OTHP")]
    #[cfg_attr(feature = "serde", serde(rename = "OTHP"))]
    Othp,
    #[yaserde(rename = "PRVE")]
    #[cfg_attr(feature = "serde", serde(rename = "PRVE"))]
    Prve,
    #[yaserde(rename = "RDEM")]
    #[cfg_attr(feature = "serde", serde(rename = "RDEM"))]
    Rdem,
    #[yaserde(rename = "SECU")]
    ...
    Othn,
    #[yaserde(rename = "ITDE")]
    #[cfg_attr(feature = "serde", serde(rename = "ITDE"))]
    Itde,
    #[yaserde(rename = "DUME")]
    #[cfg_attr(feature = "serde", serde(rename = "DUME"))]
    Dume,
    #[yaserde(rename = "IDWM")]
    #[cfg_attr(feature = "serde", serde(rename = "IDWM"))]
    Idwm,
    #[yaserde(rename = "IDRM")]
    #[cfg_attr(feature = "serde", serde(rename = "IDRM"))]
    Idrm,
    #[yaserde(rename = "IBAT")]
    #[cfg_attr(feature = "serde", serde(rename = "IBAT"))]
    Ibat,
    #[yaserde(rename = "ICOL")]
...
impl Default for MessageError1Code {
    fn default() -> MessageError1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for MessageError1Code {}
...
pub enum MessageFunction39Code {
    ...
    Reno,
    #[yaserde(rename = "ERNO")]
    #[cfg_attr(feature = "serde", serde(rename = "ERNO"))]
    Erno,
    __Unknown__(String),
}

impl Default for MessageFunction39Code {
    fn default() -> MessageFunction39Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for MessageFunction39Code {}
...
impl Validate for Transaction101 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "caad.007.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:caad.007.001.02";
}
