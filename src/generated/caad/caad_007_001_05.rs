...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.007.001.05")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.007.001.05")]
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "caad.007.001.05";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:caad.007.001.05";
}
