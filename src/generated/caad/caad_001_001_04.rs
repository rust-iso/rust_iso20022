...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.001.001.04")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.001.001.04")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.001.001.04")]
pub struct BatchManagementInitiationV04 {
    #[yaserde(rename = "Hdr")]
    ...
    pub btch_mgmt_tp: BatchManagementType3Code,
    ...
    #[yaserde(rename = "ColltnIdList")]
    #[cfg_attr(feature = "serde", serde(rename = "ColltnIdList"))]
    pub colltn_id_list: Vec<Max70Text>,
    ...
    #[yaserde(rename = "ColltnChcksm")]
    #[cfg_attr(feature = "serde", serde(rename = "ColltnChcksm"))]
    pub colltn_chcksm: Max35Binary,
    ...
    #[yaserde(rename = "Conttn")]
    #[cfg_attr(feature = "serde", serde(rename = "Conttn"))]
    pub conttn: TrueFalseIndicator,
...
impl Validate for BatchManagementInitiationV04 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.001.001.04")]

pub enum BatchManagementType3Code {
    #[yaserde(rename = "AKRQ")]
    ...
    Endb,
    #[yaserde(rename = "IDNT")]
    #[cfg_attr(feature = "serde", serde(rename = "IDNT"))]
    Idnt,
    #[yaserde(rename = "RERQ")]
    #[cfg_attr(feature = "serde", serde(rename = "RERQ"))]
    Rerq,
    #[yaserde(rename = "STRT")]
...
impl Default for BatchManagementType3Code {
    fn default() -> BatchManagementType3Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for BatchManagementType3Code {}
...
pub struct Document {
    ...
    pub btch_mgmt_initn: BatchManagementInitiationV04,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "caad.001.001.04";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:caad.001.001.04";
}
