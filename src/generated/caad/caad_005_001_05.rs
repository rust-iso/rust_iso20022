...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.005.001.05")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.005.001.05")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.005.001.05")]
pub struct AdditionalFeeReconciliation4 {
    #[yaserde(rename = "Impct")]
    #[cfg_attr(feature = "serde", serde(rename = "Impct"))]
    pub impct: ReconciliationImpact1Code,
...
impl Validate for AdditionalFeeReconciliation4 {}
...
impl Default for CardServiceType6Code {
    fn default() -> CardServiceType6Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for CardServiceType6Code {}
...
pub struct Document {
    ...
    pub rcncltn_initn: ReconciliationInitiationV05,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.005.001.05")]
pub struct FinancialReconciliation4 {
    #[yaserde(rename = "Impct")]
    #[cfg_attr(feature = "serde", serde(rename = "Impct"))]
    pub impct: ReconciliationImpact1Code,
    ...
    #[yaserde(rename = "Tp")]
    #[cfg_attr(feature = "serde", serde(rename = "Tp"))]
    pub tp: ReconciliationCategory2Code,
...
impl Validate for FinancialReconciliation4 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.005.001.05")]
pub struct MessageReconciliation4 {
    #[yaserde(rename = "Tp")]
    #[cfg_attr(feature = "serde", serde(rename = "Tp"))]
    pub tp: ReconciliationMessageType2Code,
...
impl Validate for MessageReconciliation4 {}
...
pub enum ReconciliationActivityType2Code {
    #[yaserde(rename = "ACQG")]
    #[cfg_attr(feature = "serde", serde(rename = "ACQG"))]
    Acqg,
    #[yaserde(rename = "CNSD")]
    #[cfg_attr(feature = "serde", serde(rename = "CNSD"))]
    Cnsd,
    #[yaserde(rename = "ISSG")]
    #[cfg_attr(feature = "serde", serde(rename = "ISSG"))]
    Issg,
    __Unknown__(String),
}

impl Default for ReconciliationActivityType2Code {
    fn default() -> ReconciliationActivityType2Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ReconciliationActivityType2Code {}
...
pub enum ReconciliationCategory2Code {
    #[yaserde(rename = "RVSL")]
...
impl Default for ReconciliationCategory2Code {
    fn default() -> ReconciliationCategory2Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ReconciliationCategory2Code {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.005.001.05")]
pub struct ReconciliationInitiationV05 {
    #[yaserde(rename = "Hdr")]
    ...
    #[yaserde(rename = "RcncltnActvtyTp")]
    #[cfg_attr(feature = "serde", serde(rename = "RcncltnActvtyTp"))]
    pub rcncltn_actvty_tp: ReconciliationActivityType2Code,

    #[yaserde(rename = "RcncltnTp")]
    #[cfg_attr(feature = "serde", serde(rename = "RcncltnTp"))]
    pub rcncltn_tp: CardServiceType6Code,
    ...
    pub rcncltn_ttls: Vec<TransactionTotals15>,
...
impl Validate for ReconciliationInitiationV05 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.005.001.05")]

pub enum ReconciliationMessageType2Code {
    #[yaserde(rename = "BATR")]
    ...
    Addr,
    #[yaserde(rename = "RTVI")]
    #[cfg_attr(feature = "serde", serde(rename = "RTVI"))]
    Rtvi,
    __Unknown__(String),
}

impl Default for ReconciliationMessageType2Code {
    fn default() -> ReconciliationMessageType2Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ReconciliationMessageType2Code {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.005.001.05")]
pub struct TransactionTotals15 {
    #[yaserde(rename = "Id")]
    #[cfg_attr(feature = "serde", serde(rename = "Id"))]
    pub id: Max35Text,
    ...
    #[yaserde(rename = "Fin")]
    #[cfg_attr(feature = "serde", serde(rename = "Fin"))]
    pub fin: Vec<FinancialReconciliation4>,

    #[yaserde(rename = "Msg")]
    #[cfg_attr(feature = "serde", serde(rename = "Msg"))]
    pub msg: Vec<MessageReconciliation4>,

    #[yaserde(rename = "AddtlFeeRcncltn")]
    #[cfg_attr(feature = "serde", serde(rename = "AddtlFeeRcncltn"))]
    pub addtl_fee_rcncltn: Vec<AdditionalFeeReconciliation4>,
...
impl Validate for TransactionTotals15 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "caad.005.001.05";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:caad.005.001.05";
}
