...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.008.001.03")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.008.001.03")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.008.001.03")]
pub struct AdministrativeInitiationV03 {
    #[yaserde(rename = "Hdr")]
    #[cfg_attr(feature = "serde", serde(rename = "Hdr"))]
    pub hdr: Header72,

    #[yaserde(rename = "AdmstvTp")]
    #[cfg_attr(feature = "serde", serde(rename = "AdmstvTp"))]
    pub admstv_tp: Max10Text,
    ...
    #[yaserde(rename = "TxtMsg")]
    #[cfg_attr(feature = "serde", serde(rename = "TxtMsg"))]
    pub txt_msg: Max20KText,

    #[yaserde(rename = "LclData")]
    #[cfg_attr(feature = "serde", serde(rename = "LclData"))]
    pub lcl_data: Vec<LocalData17>,
    ...
    #[yaserde(rename = "TxId")]
    #[cfg_attr(feature = "serde", serde(rename = "TxId"))]
    pub tx_id: TransactionIdentification61,
    ...
    pub orgnl_tx: Vec<OriginalTransaction4>,
...
impl Validate for AdministrativeInitiationV03 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.008.001.03")]
pub struct Document {
    #[yaserde(rename = "AdmstvInitn")]
    #[cfg_attr(feature = "serde", serde(rename = "AdmstvInitn"))]
    pub admstv_initn: AdministrativeInitiationV03,
}
...
pub struct LocalData17 {
    ...
    #[yaserde(rename = "TxtMsg")]
    #[cfg_attr(feature = "serde", serde(rename = "TxtMsg"))]
    pub txt_msg: Max40KText,
}

impl Validate for LocalData17 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct Max40KText (pub String);
crate::simple_type!(Max40KText);

impl Validate for Max40KText {
    fn validate(&self) -> Result<(), String> { 
        #[allow(clippy::len_zero)]
        if self.0.len() < 1 {
            return Err(format!("MinLength validation error. \nExpected: 0 length >= 1 \nActual: 0 length == {}", self.0.len()));
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caad.008.001.03")]
pub struct TransactionIdentification61 {
    #[yaserde(rename = "PurchsIdrTp")]
    #[cfg_attr(feature = "serde", serde(rename = "PurchsIdrTp"))]
    pub purchs_idr_tp: PurchaseIdentifierType3Code,
...
impl Validate for TransactionIdentification61 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "caad.008.001.03";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:caad.008.001.03";
}
