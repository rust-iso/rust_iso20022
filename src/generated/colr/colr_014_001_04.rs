...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.014.001.04")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.014.001.04")]
...
pub enum CollateralPurpose1ChoiceChoice {
    Cd(CollateralPurpose1Code),
    Prtry(GenericIdentification30),
    __Unknown__(String),
}

impl Default for CollateralPurpose1ChoiceChoice {
    fn default() -> CollateralPurpose1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for CollateralPurpose1ChoiceChoice {}
...
pub struct CollateralPurpose1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub collateral_purpose_1_choice_choice: CollateralPurpose1ChoiceChoice,
}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.014.001.04")]
pub struct Document {
    #[yaserde(rename = "IntrstPmtRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "IntrstPmtRspn"))]
    pub intrst_pmt_rspn: InterestPaymentResponseV04,
}
...
pub struct InterestAmount2 {
    ...
    pub val_dt: DateAndDateTimeChoice,
...
impl Validate for InterestAmount2 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.014.001.04")]
pub struct InterestPaymentResponseV04 {
    #[yaserde(rename = "TxId")]
    ...
    pub intrst_due_to_a: InterestAmount2,

    #[yaserde(rename = "IntrstDueToB")]
    #[cfg_attr(feature = "serde", serde(rename = "IntrstDueToB"))]
    pub intrst_due_to_b: InterestAmount2,

    #[yaserde(rename = "IntrstRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "IntrstRspn"))]
    pub intrst_rspn: InterestResponse1,
...
impl Validate for InterestPaymentResponseV04 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.014.001.04")]

pub enum InterestRate1ChoiceChoice {
    FxdIntrstRate(PercentageRate),
    VarblIntrstRate(VariableInterest1Rate),
    __Unknown__(String),
}

impl Default for InterestRate1ChoiceChoice {
    fn default() -> InterestRate1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for InterestRate1ChoiceChoice {}
...
pub struct InterestRate1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub interest_rate_1_choice_choice: InterestRate1ChoiceChoice,
}
...
pub enum InterestRejectionReason1Code {
    #[yaserde(rename = "VADA")]
    #[cfg_attr(feature = "serde", serde(rename = "VADA"))]
    Vada,
    #[yaserde(rename = "DIAM")]
    #[cfg_attr(feature = "serde", serde(rename = "DIAM"))]
    Diam,
    __Unknown__(String),
}

impl Default for InterestRejectionReason1Code {
    fn default() -> InterestRejectionReason1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for InterestRejectionReason1Code {}
...
pub struct InterestResponse1 {
    ...
    pub rjctn_rsn: RejectionReason21FormatChoice,

    #[yaserde(rename = "RjctnRsnInf")]
    #[cfg_attr(feature = "serde", serde(rename = "RjctnRsnInf"))]
    pub rjctn_rsn_inf: Max140Text,
...
impl Validate for InterestResponse1 {}
...
pub enum RejectionReason21FormatChoiceChoice {
    Cd(InterestRejectionReason1Code),
    Prtry(GenericIdentification30),
    __Unknown__(String),
}

impl Default for RejectionReason21FormatChoiceChoice {
    fn default() -> RejectionReason21FormatChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for RejectionReason21FormatChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.014.001.04")]
pub struct RejectionReason21FormatChoice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub rejection_reason_21_format_choice_choice: RejectionReason21FormatChoiceChoice,
}

impl Validate for RejectionReason21FormatChoice {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "colr.014.001.04";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:colr.014.001.04";
}
