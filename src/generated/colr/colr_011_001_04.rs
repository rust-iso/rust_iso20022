...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.011.001.04")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.011.001.04")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.011.001.04")]
pub struct CollateralSubstitutionResponse1 {
...
impl Validate for CollateralSubstitutionResponse1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.011.001.04")]
pub struct CollateralSubstitutionResponse2 {
    #[yaserde(rename = "CollSbstitnReqId")]
    #[cfg_attr(feature = "serde", serde(rename = "CollSbstitnReqId"))]
    pub coll_sbstitn_req_id: Max35Text,

    #[yaserde(rename = "RjctdAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "RjctdAmt"))]
    pub rjctd_amt: ActiveCurrencyAndAmount,
...
impl Validate for CollateralSubstitutionResponse2 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.011.001.04")]
pub struct CollateralSubstitutionResponseV04 {
    #[yaserde(rename = "TxId")]
    ...
    #[yaserde(rename = "SbstitnRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "SbstitnRspn"))]
    pub sbstitn_rspn: SubstitutionResponse1,
...
impl Validate for CollateralSubstitutionResponseV04 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.011.001.04")]
pub struct Document {
    #[yaserde(rename = "CollSbstitnRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "CollSbstitnRspn"))]
    pub coll_sbstitn_rspn: CollateralSubstitutionResponseV04,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.011.001.04")]
pub struct SubstitutionResponse1 {
    #[yaserde(rename = "RspnTp")]
    #[cfg_attr(feature = "serde", serde(rename = "RspnTp"))]
    pub rspn_tp: Status4Code,

    #[yaserde(rename = "CollSbstitnAccptncDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "CollSbstitnAccptncDtls"))]
    pub coll_sbstitn_accptnc_dtls: Vec<CollateralSubstitutionResponse1>,

    #[yaserde(rename = "CollSbstitnRjctnDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "CollSbstitnRjctnDtls"))]
    pub coll_sbstitn_rjctn_dtls: CollateralSubstitutionResponse2,
}

impl Validate for SubstitutionResponse1 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "colr.011.001.04";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:colr.011.001.04";
}
