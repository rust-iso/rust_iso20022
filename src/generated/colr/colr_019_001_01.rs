...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.019.001.01")]
...
pub struct AdditionalInformation24 {
    #[yaserde(rename = "CollInstr")]
    #[cfg_attr(feature = "serde", serde(rename = "CollInstr"))]
    pub coll_instr: Max350Text,
...
impl Validate for AdditionalInformation24 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.019.001.01")]
...
impl Validate for CashMovement8 {}
...
impl Validate for CollateralAmount18 {}
...
pub struct CollateralParameters10 {
    ...
    #[yaserde(rename = "FaildSttlmSlvtn")]
    #[cfg_attr(feature = "serde", serde(rename = "FaildSttlmSlvtn"))]
    pub faild_sttlm_slvtn: YesNoIndicator,

    #[yaserde(rename = "MainTradgAcctCollstn")]
    #[cfg_attr(feature = "serde", serde(rename = "MainTradgAcctCollstn"))]
    pub main_tradg_acct_collstn: YesNoIndicator,
    ...
    pub rspn_sts: ResponseStatus9Choice,

    #[yaserde(rename = "AddtlInf")]
    #[cfg_attr(feature = "serde", serde(rename = "AddtlInf"))]
    pub addtl_inf: AdditionalInformation24,
}

impl Validate for CollateralParameters10 {}
...
pub struct CollateralParties10 {
    ...
    pub clnt_pty_b: PartyIdentificationAndAccount203,
...
impl Validate for CollateralParties10 {}
...
pub struct DealTransactionDetails5 {
    ...
    #[yaserde(rename = "CncntrtnLmt")]
    #[cfg_attr(feature = "serde", serde(rename = "CncntrtnLmt"))]
    pub cncntrtn_lmt: YesNoIndicator,
    ...
    pub deal_dtls_amt: CollateralAmount18,
...
impl Validate for DealTransactionDetails5 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.019.001.01")]
pub struct Document {
    #[yaserde(rename = "TrptyCollTxInstr")]
    #[cfg_attr(feature = "serde", serde(rename = "TrptyCollTxInstr"))]
    pub trpty_coll_tx_instr: TripartyCollateralTransactionInstructionV01,
}
...
pub struct OtherParties38 {
    #[yaserde(rename = "Issr")]
    #[cfg_attr(feature = "serde", serde(rename = "Issr"))]
    pub issr: PartyIdentification136,
...
impl Validate for OtherParties38 {}
...
pub enum References70ChoiceChoice {
    ClntCollInstrId(Max35Text),
    TrptyAgtSvcPrvdrCollInstrId(Max35Text),
    __Unknown__(String),
}

impl Default for References70ChoiceChoice {
    fn default() -> References70ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for References70ChoiceChoice {}
...
pub struct References70Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub references_70_choice_choice: References70ChoiceChoice,
}

impl Validate for References70Choice {}
...
impl Default for ResponseStatus2Code {
    fn default() -> ResponseStatus2Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ResponseStatus2Code {}
...
pub enum ResponseStatus9ChoiceChoice {
    Cd(ResponseStatus2Code),
    Prtry(GenericIdentification30),
    __Unknown__(String),
}

impl Default for ResponseStatus9ChoiceChoice {
    fn default() -> ResponseStatus9ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ResponseStatus9ChoiceChoice {}
...
pub struct ResponseStatus9Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub response_status_9_choice_choice: ResponseStatus9ChoiceChoice,
}

impl Validate for ResponseStatus9Choice {}
...
impl Validate for SecuritiesMovement9 {}
...
impl Validate for TransactionIdentifications45 {}
...
pub struct TripartyCollateralTransactionInstructionV01 {
    ...
    #[yaserde(rename = "OthrPties")]
    #[cfg_attr(feature = "serde", serde(rename = "OthrPties"))]
    pub othr_pties: OtherParties38,
...
impl Validate for TripartyCollateralTransactionInstructionV01 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "colr.019.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:colr.019.001.01";
}
