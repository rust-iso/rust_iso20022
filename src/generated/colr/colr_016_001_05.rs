...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.016.001.05")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.016.001.05")]
...
impl Validate for Collateral53 {}
...
impl Validate for CollateralAndExposureReportV05 {}
...
pub struct CollateralValuation13 {
    ...
    pub scties_coll: SecuritiesCollateral13,
    ...
    pub othr_coll: OtherCollateral10,
}

impl Validate for CollateralValuation13 {}
...
pub struct Document {
    ...
    pub coll_and_xpsr_rpt: CollateralAndExposureReportV05,
}
...
impl Default for ExposureType13Code {
    fn default() -> ExposureType13Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ExposureType13Code {}
...
impl Validate for Obligation11 {}
...
pub struct OtherCollateral10 {
    ...
    pub blckd_qty: FinancialInstrumentQuantity33Choice,
...
impl Validate for OtherCollateral10 {}
...
impl Validate for SecuritiesCollateral13 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "colr.016.001.05";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:colr.016.001.05";
}
