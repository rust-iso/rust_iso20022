...
pub enum CollateralProposalResponse3ChoiceChoice {
    CollPrpsl(CollateralProposalResponse3),
    SgrtdIndpdntAmt(CollateralProposalResponseType3),
    __Unknown__(String),
}

impl Default for CollateralProposalResponse3ChoiceChoice {
    fn default() -> CollateralProposalResponse3ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for CollateralProposalResponse3ChoiceChoice {}
...
pub struct CollateralProposalResponse3Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub collateral_proposal_response_3_choice_choice: CollateralProposalResponse3ChoiceChoice,
}
