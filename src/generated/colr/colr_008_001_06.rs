...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.008.001.06")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.008.001.06")]
pub struct CashCollateralResponse3 {
    ...
    pub rjctn_rsn: RejectionReason68Code,
...
impl Validate for CashCollateralResponse3 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.008.001.06")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.008.001.06")]
pub struct CollateralProposalResponse4 {
    #[yaserde(rename = "VartnMrgn")]
    #[cfg_attr(feature = "serde", serde(rename = "VartnMrgn"))]
    pub vartn_mrgn: CollateralProposalResponseType4,

    #[yaserde(rename = "SgrtdIndpdntAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "SgrtdIndpdntAmt"))]
    pub sgrtd_indpdnt_amt: CollateralProposalResponseType4,
}

impl Validate for CollateralProposalResponse4 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.008.001.06")]
pub struct CollateralProposalResponse4Choice {
    #[yaserde(rename = "CollPrpsl")]
    #[cfg_attr(feature = "serde", serde(rename = "CollPrpsl"))]
    pub coll_prpsl: Option<CollateralProposalResponse4>,
    #[yaserde(rename = "SgrtdIndpdntAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "SgrtdIndpdntAmt"))]
    pub sgrtd_indpdnt_amt: Option<CollateralProposalResponseType4>,
}

impl Validate for CollateralProposalResponse4Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.008.001.06")]
pub struct CollateralProposalResponseType4 {
    ...
    pub rspn: CollateralResponse3,
}

impl Validate for CollateralProposalResponseType4 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.008.001.06")]
pub struct CollateralProposalResponseV06 {
    #[yaserde(rename = "TxId")]
    ...
    pub prpsl_rspn: CollateralProposalResponse4Choice,
...
impl Validate for CollateralProposalResponseV06 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.008.001.06")]
pub struct CollateralResponse3 {
    #[yaserde(rename = "SctiesCollRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "SctiesCollRspn"))]
    pub scties_coll_rspn: Vec<SecuritiesCollateralResponse2>,

    #[yaserde(rename = "CshCollRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "CshCollRspn"))]
    pub csh_coll_rspn: Vec<CashCollateralResponse3>,

    #[yaserde(rename = "OthrCollRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "OthrCollRspn"))]
    pub othr_coll_rspn: Vec<OtherCollateralResponse3>,
}

impl Validate for CollateralResponse3 {}
...
pub struct Document {
    ...
    pub coll_prpsl_rspn: CollateralProposalResponseV06,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.008.001.06")]
pub struct OtherCollateralResponse3 {
    #[yaserde(rename = "RspnTp")]
    #[cfg_attr(feature = "serde", serde(rename = "RspnTp"))]
    pub rspn_tp: Status4Code,
...
impl Validate for OtherCollateralResponse3 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.008.001.06")]
...
pub enum RejectionReason68Code {
    #[yaserde(rename = "DSEC")]
...
impl Default for RejectionReason68Code {
    fn default() -> RejectionReason68Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for RejectionReason68Code {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.008.001.06")]
pub struct SecuritiesCollateralResponse2 {
    #[yaserde(rename = "CollId")]
    #[cfg_attr(feature = "serde", serde(rename = "CollId"))]
    pub coll_id: Max35Text,
...
impl Validate for SecuritiesCollateralResponse2 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "colr.008.001.06";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:colr.008.001.06";
}
