...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.005.001.06")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.005.001.06")]
...
impl Validate for CollateralManagementCancellationRequestV06 {}
...
pub struct Document {
    ...
    pub coll_mgmt_cxl_req: CollateralManagementCancellationRequestV06,
}
...
impl Validate for ExposureType21Choice {}
...
pub struct Obligation8 {
    ...
    pub xpsr_tp: ExposureType21Choice,
    ...
    pub xpsr_amt: ActiveOrHistoricCurrencyAndAmount,
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "colr.005.001.06";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:colr.005.001.06";
}
