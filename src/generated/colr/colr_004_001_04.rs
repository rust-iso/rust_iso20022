...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.004.001.04")]
...
pub struct AgreedAmount1 {
    #[yaserde(rename = "VartnMrgnAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "VartnMrgnAmt"))]
    pub vartn_mrgn_amt: Amount1,

    #[yaserde(rename = "SgrtdIndpdntAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "SgrtdIndpdntAmt"))]
    pub sgrtd_indpdnt_amt: Amount1,
}

impl Validate for AgreedAmount1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.004.001.04")]

pub enum AgreedAmount1ChoiceChoice {
    AgrdAmtDtls(AgreedAmount1),
    SgrtdIndpdntAmt(Amount1),
    __Unknown__(String),
}

impl Default for AgreedAmount1ChoiceChoice {
    fn default() -> AgreedAmount1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for AgreedAmount1ChoiceChoice {}
...
pub struct AgreedAmount1Choice {
    ...
    pub agreed_amount_1_choice_choice: AgreedAmount1ChoiceChoice,
}

impl Validate for AgreedAmount1Choice {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.004.001.04")]
pub struct Document {
    #[yaserde(rename = "MrgnCallRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "MrgnCallRspn"))]
    pub mrgn_call_rspn: MarginCallResponseV04,
}
...
pub enum MarginCallResponse1Code {
    #[yaserde(rename = "NVDA")]
    #[cfg_attr(feature = "serde", serde(rename = "NVDA"))]
    Nvda,
    #[yaserde(rename = "RANT")]
    #[cfg_attr(feature = "serde", serde(rename = "RANT"))]
    Rant,
    __Unknown__(String),
}

impl Default for MarginCallResponse1Code {
    fn default() -> MarginCallResponse1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for MarginCallResponse1Code {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.004.001.04")]
pub struct MarginCallResponseV04 {
    #[yaserde(rename = "TxId")]
    ...
    #[yaserde(rename = "AgrdAmtDueToA")]
    #[cfg_attr(feature = "serde", serde(rename = "AgrdAmtDueToA"))]
    pub agrd_amt_due_to_a: AgreedAmount1Choice,

    #[yaserde(rename = "AgrdAmtDueToB")]
    #[cfg_attr(feature = "serde", serde(rename = "AgrdAmtDueToB"))]
    pub agrd_amt_due_to_b: AgreedAmount1Choice,

    #[yaserde(rename = "RspnDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "RspnDtls"))]
    pub rspn_dtls: Response1,
...
impl Validate for MarginCallResponseV04 {}
...
pub struct Response1 {
    #[yaserde(rename = "RspnTpDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "RspnTpDtls"))]
...
impl Validate for Response1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.004.001.04")]

pub enum ResponseType1ChoiceChoice {
    Cd(MarginCallResponse1Code),
    Prtry(GenericIdentification30),
    __Unknown__(String),
}

impl Default for ResponseType1ChoiceChoice {
    fn default() -> ResponseType1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ResponseType1ChoiceChoice {}
...
pub struct ResponseType1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub response_type_1_choice_choice: ResponseType1ChoiceChoice,
}

impl Validate for ResponseType1Choice {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "colr.004.001.04";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:colr.004.001.04";
}
