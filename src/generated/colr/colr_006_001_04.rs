...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.006.001.04")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.006.001.04")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.006.001.04")]
pub struct CollateralCancellationStatus1 {
    #[yaserde(rename = "CollStsCd")]
    #[cfg_attr(feature = "serde", serde(rename = "CollStsCd"))]
    pub coll_sts_cd: Status4Code,

    #[yaserde(rename = "AddtlInf")]
    #[cfg_attr(feature = "serde", serde(rename = "AddtlInf"))]
    pub addtl_inf: Max35Text,

    #[yaserde(rename = "RjctnDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "RjctnDtls"))]
    pub rjctn_dtls: RejectionStatus2,
}

impl Validate for CollateralCancellationStatus1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.006.001.04")]
pub struct CollateralManagementCancellationStatusV04 {
    #[yaserde(rename = "TxId")]
    ...
    pub cxl_sts: CollateralCancellationStatus1,
...
impl Validate for CollateralManagementCancellationStatusV04 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.006.001.04")]
pub struct Document {
    #[yaserde(rename = "CollMgmtCxlSts")]
    #[cfg_attr(feature = "serde", serde(rename = "CollMgmtCxlSts"))]
    pub coll_mgmt_cxl_sts: CollateralManagementCancellationStatusV04,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.006.001.04")]
pub struct Reference16 {
    #[yaserde(rename = "CollMsgCxlReqId")]
    #[cfg_attr(feature = "serde", serde(rename = "CollMsgCxlReqId"))]
    pub coll_msg_cxl_req_id: Max35Text,
}

impl Validate for Reference16 {}
...
impl Validate for RejectionStatus2 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "colr.006.001.04";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:colr.006.001.04";
}
