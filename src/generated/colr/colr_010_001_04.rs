...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.010.001.04")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.010.001.04")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.010.001.04")]
pub struct CollateralSubstitution4 {
    ...
    pub scties_coll: Vec<SecuritiesCollateral5>,
...
impl Validate for CollateralSubstitution4 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.010.001.04")]
pub struct CollateralSubstitution5 {
    #[yaserde(rename = "CollSbstitnSeq")]
    #[cfg_attr(feature = "serde", serde(rename = "CollSbstitnSeq"))]
    pub coll_sbstitn_seq: CollateralSubstitutionSequence1Code,
    ...
    #[yaserde(rename = "SctiesColl")]
    #[cfg_attr(feature = "serde", serde(rename = "SctiesColl"))]
    pub scties_coll: Vec<SecuritiesCollateral7>,
    ...
    #[yaserde(rename = "OthrColl")]
    #[cfg_attr(feature = "serde", serde(rename = "OthrColl"))]
    pub othr_coll: Vec<OtherCollateral7>,
...
impl Validate for CollateralSubstitution5 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.010.001.04")]
pub struct CollateralSubstitutionRequestV04 {
    #[yaserde(rename = "TxId")]
    ...
    pub coll_sbstitn_rtr: CollateralSubstitution5,

    #[yaserde(rename = "CollSbstitnDlvr")]
    #[cfg_attr(feature = "serde", serde(rename = "CollSbstitnDlvr"))]
    pub coll_sbstitn_dlvr: CollateralSubstitution4,
...
impl Validate for CollateralSubstitutionRequestV04 {}
...
pub struct Document {
    ...
    pub coll_sbstitn_req: CollateralSubstitutionRequestV04,
}
...
impl Validate for OtherCollateral7 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.010.001.04")]
pub struct SecuritiesCollateral5 {
    #[yaserde(rename = "CollId")]
    #[cfg_attr(feature = "serde", serde(rename = "CollId"))]
    pub coll_id: Max35Text,
    ...
    pub sttlm_params: SettlementDetails102,
}

impl Validate for SecuritiesCollateral5 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.010.001.04")]
pub struct SecuritiesCollateral7 {
    #[yaserde(rename = "CollId")]
    #[cfg_attr(feature = "serde", serde(rename = "CollId"))]
    pub coll_id: Max35Text,
...
impl Validate for SecuritiesCollateral7 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.010.001.04")]
pub struct SettlementDetails102 {
    ...
    pub sttlm_pties: SettlementParties5Choice,
...
impl Validate for SettlementDetails102 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.010.001.04")]

pub enum SettlementParties5ChoiceChoice {
    DlvrgSttlmPties(DeliveringPartiesAndAccount15),
    RcvgSttlmPties(ReceivingPartiesAndAccount15),
    __Unknown__(String),
}

impl Default for SettlementParties5ChoiceChoice {
    fn default() -> SettlementParties5ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for SettlementParties5ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.010.001.04")]
pub struct SettlementParties5Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub settlement_parties_5_choice_choice: SettlementParties5ChoiceChoice,
}

impl Validate for SettlementParties5Choice {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "colr.010.001.04";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:colr.010.001.04";
}
