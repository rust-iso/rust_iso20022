...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.004.001.05")]
...
pub struct AgreedAmount1Choice {
    #[yaserde(rename = "AgrdAmtDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "AgrdAmtDtls"))]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.004.001.05")]
...
pub struct Document {
    ...
    pub mrgn_call_rspn: MarginCallResponseV05,
}
...
impl Validate for MarginCallResponseV05 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "colr.004.001.05";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:colr.004.001.05";
}
