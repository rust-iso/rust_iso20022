...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.013.001.05")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.013.001.05")]
...
pub struct Document {
    ...
    pub intrst_pmt_req: InterestPaymentRequestV05,
}
...
impl Validate for InterestAmount4 {}
...
impl Validate for InterestPaymentRequestV05 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.013.001.05")]
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "colr.013.001.05";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:colr.013.001.05";
}
