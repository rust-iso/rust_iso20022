...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.001.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.001.001.01")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.001.001.01")]
pub struct CollateralValueCriteria3 {
    ...
    pub sch_crit: CollateralValueSearchCriteria3,
...
impl Validate for CollateralValueCriteria3 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.001.001.01")]

pub enum CollateralValueCriteriaDefinition3ChoiceChoice {
    QryNm(Max35Text),
    NewCrit(CollateralValueCriteria3),
    __Unknown__(String),
}

impl Default for CollateralValueCriteriaDefinition3ChoiceChoice {
    fn default() -> CollateralValueCriteriaDefinition3ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for CollateralValueCriteriaDefinition3ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.001.001.01")]
pub struct CollateralValueCriteriaDefinition3Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub collateral_value_criteria_definition_3_choice_choice: CollateralValueCriteriaDefinition3ChoiceChoice,
}

impl Validate for CollateralValueCriteriaDefinition3Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.001.001.01")]
pub struct CollateralValueQueryV01 {
    ...
    pub coll_val_qry_def: CollateralValueCriteriaDefinition3Choice,
...
impl Validate for CollateralValueQueryV01 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:colr.001.001.01")]
pub struct CollateralValueSearchCriteria3 {
...
impl Validate for CollateralValueSearchCriteria3 {}
...
pub struct Document {
    ...
    pub coll_val_qry: CollateralValueQueryV01,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "colr.001.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:colr.001.001.01";
}
