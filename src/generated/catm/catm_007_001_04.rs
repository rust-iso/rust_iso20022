...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catm.007.001.04")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catm.007.001.04")]
...
pub enum AttributeType2Code {
    ...
    Emal,
    #[yaserde(rename = "CHLG")]
    #[cfg_attr(feature = "serde", serde(rename = "CHLG"))]
    Chlg,
    __Unknown__(String),
}

impl Default for AttributeType2Code {
    fn default() -> AttributeType2Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for AttributeType2Code {}
...
pub struct CertificateManagementRequest2 {
    ...
    #[yaserde(rename = "SctyDomn")]
    #[cfg_attr(feature = "serde", serde(rename = "SctyDomn"))]
    pub scty_domn: Max70Text,

    #[yaserde(rename = "BinryCertfctnReq")]
    #[cfg_attr(feature = "serde", serde(rename = "BinryCertfctnReq"))]
    pub binry_certfctn_req: Max20000Text,

    #[yaserde(rename = "CertfctnReq")]
    #[cfg_attr(feature = "serde", serde(rename = "CertfctnReq"))]
    pub certfctn_req: CertificationRequest1,

    #[yaserde(rename = "ClntCert")]
    #[cfg_attr(feature = "serde", serde(rename = "ClntCert"))]
    pub clnt_cert: Max10KBinary,

    #[yaserde(rename = "WhtListId")]
    #[cfg_attr(feature = "serde", serde(rename = "WhtListId"))]
    pub wht_list_id: PointOfInteraction6,
}

impl Validate for CertificateManagementRequest2 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catm.007.001.04")]
pub struct CertificateManagementRequestV04 {
    #[yaserde(rename = "Hdr")]
    #[cfg_attr(feature = "serde", serde(rename = "Hdr"))]
    pub hdr: Tmsheader1,

    #[yaserde(rename = "CertMgmtReq")]
    #[cfg_attr(feature = "serde", serde(rename = "CertMgmtReq"))]
...
impl Validate for CertificateManagementRequestV04 {}
...
pub struct CertificationRequest1 {
    #[yaserde(rename = "CertReqInf")]
    #[cfg_attr(feature = "serde", serde(rename = "CertReqInf"))]
...
impl Validate for CertificationRequest1 {}
...
pub struct CertificationRequest2 {
    ...
    #[yaserde(rename = "SbjtNm")]
    #[cfg_attr(feature = "serde", serde(rename = "SbjtNm"))]
    pub sbjt_nm: CertificateIssuer1,

    #[yaserde(rename = "SbjtPblcKeyInf")]
    #[cfg_attr(feature = "serde", serde(rename = "SbjtPblcKeyInf"))]
    pub sbjt_pblc_key_inf: PublicRSAKey2,

    #[yaserde(rename = "Attr")]
    #[cfg_attr(feature = "serde", serde(rename = "Attr"))]
    pub attr: Vec<RelativeDistinguishedName2>,
}

impl Validate for CertificationRequest2 {}
...
pub struct Document {
    #[yaserde(rename = "CertMgmtReq")]
    #[cfg_attr(feature = "serde", serde(rename = "CertMgmtReq"))]
    pub cert_mgmt_req: CertificateManagementRequestV04,
}
...
pub struct PointOfInteraction6 {
    #[yaserde(rename = "ManfctrIdr")]
    #[cfg_attr(feature = "serde", serde(rename = "ManfctrIdr"))]
...
impl Validate for PointOfInteraction6 {}
...
impl Validate for PublicRSAKey2 {}
...
impl Validate for RelativeDistinguishedName2 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "catm.007.001.04";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:catm.007.001.04";
}
