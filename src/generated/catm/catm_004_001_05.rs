...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catm.004.001.05")]
...
impl Validate for AcceptorRejection3 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catm.004.001.05")]
pub struct Document {
    #[yaserde(rename = "TermnlMgmtRjctn")]
    #[cfg_attr(feature = "serde", serde(rename = "TermnlMgmtRjctn"))]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:catm.004.001.05")]
...
impl Default for RejectReason2Code {
    fn default() -> RejectReason2Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for RejectReason2Code {}
...
impl Validate for TerminalManagementRejectionV05 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "catm.004.001.05";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:catm.004.001.05";
}
