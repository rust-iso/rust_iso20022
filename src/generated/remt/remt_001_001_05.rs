...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:remt.001.001.05")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:remt.001.001.05")]
...
pub struct AmountType3Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub amount_type_3_choice_choice: AmountType3ChoiceChoice,
}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:remt.001.001.05")]
pub struct Document {
    #[yaserde(rename = "RmtAdvc")]
    #[cfg_attr(feature = "serde", serde(rename = "RmtAdvc"))]
    pub rmt_advc: RemittanceAdviceV05,
}
...
pub struct GroupHeader79 {
    ...
    pub cpy_ind: CopyDuplicate1Code,
...
impl Validate for GroupHeader79 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:remt.001.001.05")]
pub struct OriginalPaymentInformation9 {
    #[yaserde(rename = "Refs")]
    #[cfg_attr(feature = "serde", serde(rename = "Refs"))]
    pub refs: TransactionReferences5,
...
impl Validate for OriginalPaymentInformation9 {}
...
impl Validate for RemittanceAdviceV05 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:remt.001.001.05")]
pub struct RemittanceInformation20 {
    ...
    #[yaserde(rename = "OrgnlPmtInf")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlPmtInf"))]
    pub orgnl_pmt_inf: OriginalPaymentInformation9,
}

impl Validate for RemittanceInformation20 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:remt.001.001.05")]
pub struct TransactionReferences5 {
...
impl Validate for TransactionReferences5 {}
...
impl crate::MxMessage for Document {
    const BUSINESS_AREA: crate::BusinessArea = crate::BusinessArea::remt;
    const FUNCTIONALITY: &'static str = "001";
    const VARIANT: &'static str = "001";
    const VERSION: &'static str = "05";
    const MESSAGE_NAME: &'static str = "remt.001.001.05";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:remt.001.001.05";
}
