...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cafr.003.001.01")]
...
impl Default for ActionTaken1Code {
    fn default() -> ActionTaken1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ActionTaken1Code {}



#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cafr.003.001.01")]
...
pub struct Document {
    ...
    pub frd_dspstn_initn: FraudDispositionInitiationV01,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cafr.003.001.01")]
pub struct FraudDispositionInitiation1 {
    #[yaserde(rename = "Envt")]
...
impl Validate for FraudDispositionInitiation1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cafr.003.001.01")]
pub struct FraudDispositionInitiationV01 {
    #[yaserde(rename = "Hdr")]
    ...
    pub body: FraudDispositionInitiation1,
...
impl Validate for FraudDispositionInitiationV01 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cafr.003.001.01")]
pub struct FraudDispositionStatus1 {
    #[yaserde(rename = "ActnTaken")]
    #[cfg_attr(feature = "serde", serde(rename = "ActnTaken"))]
    pub actn_taken: ActionTaken1Code,

    #[yaserde(rename = "OthrActnTaken")]
    #[cfg_attr(feature = "serde", serde(rename = "OthrActnTaken"))]
    pub othr_actn_taken: Max35Text,
...
impl Validate for FraudDispositionStatus1 {}
...
impl Default for PartyType25Code {
    fn default() -> PartyType25Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for PartyType25Code {}
...
impl Validate for ReportedFraud2 {}
...
impl Validate for Transaction80 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "cafr.003.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:cafr.003.001.01";
}
