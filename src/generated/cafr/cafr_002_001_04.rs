...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cafr.002.001.04")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cafr.002.001.04")]
...
pub struct Document {
    ...
    pub frd_rptg_rspn: FraudReportingResponseV04,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cafr.002.001.04")]
pub struct FraudReportingResponseV04 {
    #[yaserde(rename = "Hdr")]
...
impl Validate for FraudReportingResponseV04 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "cafr.002.001.04";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:cafr.002.001.04";
}
