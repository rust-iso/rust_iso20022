...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cafr.004.001.01")]
...
pub struct Document {
    ...
    pub frd_dspstn_rspn: FraudDispositionResponseV01,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cafr.004.001.01")]
pub struct FraudDispositionResponse1 {
    #[yaserde(rename = "Envt")]
...
impl Validate for FraudDispositionResponse1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cafr.004.001.01")]
pub struct FraudDispositionResponseV01 {
    #[yaserde(rename = "Hdr")]
    ...
    pub body: FraudDispositionResponse1,
...
impl Validate for FraudDispositionResponseV01 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cafr.004.001.01")]
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "cafr.004.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:cafr.004.001.01";
}
