...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:trck.004.001.04")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:trck.004.001.04")]
...
pub enum AmountConsistencyType1Code {
    #[yaserde(rename = "CONS")]
    #[cfg_attr(feature = "serde", serde(rename = "CONS"))]
    Cons,
    #[yaserde(rename = "ICNS")]
    #[cfg_attr(feature = "serde", serde(rename = "ICNS"))]
    Icns,
    #[yaserde(rename = "ICGA")]
    #[cfg_attr(feature = "serde", serde(rename = "ICGA"))]
    Icga,
    #[yaserde(rename = "ICFA")]
    #[cfg_attr(feature = "serde", serde(rename = "ICFA"))]
    Icfa,
    #[yaserde(rename = "IISA")]
...
impl Default for AmountConsistencyType1Code {
    fn default() -> AmountConsistencyType1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for AmountConsistencyType1Code {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:trck.004.001.04")]
pub struct CreditTransferTransaction46 {
...
impl Validate for CreditTransferTransaction46 {}
...
impl Validate for CurrencyExchange13 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:trck.004.001.04")]
pub struct CurrencyExchange15 {
    #[yaserde(rename = "SrcCcy")]
    #[cfg_attr(feature = "serde", serde(rename = "SrcCcy"))]
    pub src_ccy: ActiveCurrencyCode,
...
impl Validate for CurrencyExchange15 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:trck.004.001.04")]
pub struct Document {
    #[yaserde(rename = "PmtStsCstmrTrckrRpt")]
    #[cfg_attr(feature = "serde", serde(rename = "PmtStsCstmrTrckrRpt"))]
    pub pmt_sts_cstmr_trckr_rpt: PaymentStatusCustomerTrackerReportV04,
}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct ExternalPaymentScenario1Code (pub String);
crate::simple_type!(ExternalPaymentScenario1Code);

impl Validate for ExternalPaymentScenario1Code {
    fn validate(&self) -> Result<(), String> { 
        #[allow(clippy::len_zero)]
        if self.0.len() < 1 {
            return Err(format!("MinLength validation error. \nExpected: 0 length >= 1 \nActual: 0 length == {}", self.0.len()));
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:trck.004.001.04")]
pub struct FinancialInstitutionIdentification21 {
    #[yaserde(rename = "BICFI")]
    #[cfg_attr(feature = "serde", serde(rename = "BICFI"))]
    pub bicfi: Bicfidec2014Identifier,
...
impl Validate for FinancialInstitutionIdentification21 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:trck.004.001.04")]
pub struct OriginalBusinessInstruction4 {
    #[yaserde(rename = "MsgId")]
    #[cfg_attr(feature = "serde", serde(rename = "MsgId"))]
    pub msg_id: Max35Text,
...
impl Validate for OriginalBusinessInstruction4 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:trck.004.001.04")]
pub struct PaymentIdentification10 {
...
impl Validate for PaymentIdentification10 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:trck.004.001.04")]
pub struct PaymentRejectReturnReason1 {
    #[yaserde(rename = "Rsn")]
    #[cfg_attr(feature = "serde", serde(rename = "Rsn"))]
...
impl Validate for PaymentRejectReturnReason1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:trck.004.001.04")]

pub enum PaymentScenario1ChoiceChoice {
    Cd(ExternalPaymentScenario1Code),
    Prtry(Max35Text),
    __Unknown__(String),
}

impl Default for PaymentScenario1ChoiceChoice {
    fn default() -> PaymentScenario1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for PaymentScenario1ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:trck.004.001.04")]
pub struct PaymentScenario1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub payment_scenario_1_choice_choice: PaymentScenario1ChoiceChoice,
}

impl Validate for PaymentScenario1Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:trck.004.001.04")]
pub struct PaymentStatusCustomerTrackerReportV04 {
    #[yaserde(rename = "GrpHdr")]
    #[cfg_attr(feature = "serde", serde(rename = "GrpHdr"))]
    pub grp_hdr: TrackerHeader5,

    #[yaserde(rename = "TrckrStsAndTx")]
    #[cfg_attr(feature = "serde", serde(rename = "TrckrStsAndTx"))]
    pub trckr_sts_and_tx: Vec<TrackerStatusAndTransaction21>,
...
impl Validate for PaymentStatusCustomerTrackerReportV04 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:trck.004.001.04")]
pub struct PaymentStatusReason1 {
    #[yaserde(rename = "Rsn")]
    #[cfg_attr(feature = "serde", serde(rename = "Rsn"))]
...
impl Validate for PaymentStatusReason1 {}
...
pub enum RegulatoryReportingType1ChoiceChoice {
    Cd(ExternalRegulatoryReportingType1Code),
    Prtry(Max35Text),
    __Unknown__(String),
}

impl Default for RegulatoryReportingType1ChoiceChoice {
    fn default() -> RegulatoryReportingType1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for RegulatoryReportingType1ChoiceChoice {}
...
pub struct RegulatoryReportingType1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub regulatory_reporting_type_1_choice_choice: RegulatoryReportingType1ChoiceChoice,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:trck.004.001.04")]
pub struct RelatedTransactionData1 {
    #[yaserde(rename = "MstrUETR")]
    #[cfg_attr(feature = "serde", serde(rename = "MstrUETR"))]
    pub mstr_uetr: Uuidv4Identifier,

    #[yaserde(rename = "SubUETR")]
    #[cfg_attr(feature = "serde", serde(rename = "SubUETR"))]
    pub sub_uetr: Vec<Uuidv4Identifier>,
}

impl Validate for RelatedTransactionData1 {}
...
pub enum ReturnReason5ChoiceChoice {
    Cd(ExternalReturnReason1Code),
    Prtry(Max35Text),
    __Unknown__(String),
}

impl Default for ReturnReason5ChoiceChoice {
    fn default() -> ReturnReason5ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ReturnReason5ChoiceChoice {}
...
pub struct ReturnReason5Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub return_reason_5_choice_choice: ReturnReason5ChoiceChoice,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:trck.004.001.04")]
pub struct SettlementInstruction9 {
...
impl Validate for SettlementInstruction9 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:trck.004.001.04")]
pub struct TrackerData8 {
    #[yaserde(rename = "ConfdDt")]
    #[cfg_attr(feature = "serde", serde(rename = "ConfdDt"))]
    pub confd_dt: DateAndDateTime2Choice,

    #[yaserde(rename = "ConfdAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "ConfdAmt"))]
    pub confd_amt: ActiveCurrencyAndAmount,

    #[yaserde(rename = "RtrdConfdDt")]
    #[cfg_attr(feature = "serde", serde(rename = "RtrdConfdDt"))]
    pub rtrd_confd_dt: DateAndDateTime2Choice,

    #[yaserde(rename = "RtrdConfdAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "RtrdConfdAmt"))]
    pub rtrd_confd_amt: ActiveCurrencyAndAmount,

    #[yaserde(rename = "RmngToBeConfdAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "RmngToBeConfdAmt"))]
    pub rmng_to_be_confd_amt: ActiveCurrencyAndAmount,

    #[yaserde(rename = "PrevslyConfdAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "PrevslyConfdAmt"))]
    pub prevsly_confd_amt: ActiveCurrencyAndAmount,

    #[yaserde(rename = "PrevslyConfdDt")]
    #[cfg_attr(feature = "serde", serde(rename = "PrevslyConfdDt"))]
    pub prevsly_confd_dt: DateAndDateTime2Choice,
}

impl Validate for TrackerData8 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:trck.004.001.04")]
pub struct TrackerHeader5 {
    #[yaserde(rename = "MsgId")]
    #[cfg_attr(feature = "serde", serde(rename = "MsgId"))]
    pub msg_id: Max35Text,
    ...
    #[yaserde(rename = "TrckrInfrmgPty")]
    #[cfg_attr(feature = "serde", serde(rename = "TrckrInfrmgPty"))]
    pub trckr_infrmg_pty: TrackerPartyIdentification2,

    #[yaserde(rename = "TrckrInfrmdPty")]
    #[cfg_attr(feature = "serde", serde(rename = "TrckrInfrmdPty"))]
    pub trckr_infrmd_pty: TrackerPartyIdentification2,

    #[yaserde(rename = "OrgnlTrckrUpd")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlTrckrUpd"))]
    pub orgnl_trckr_upd: OriginalBusinessInstruction1,
...
impl Validate for TrackerHeader5 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:trck.004.001.04")]

pub enum TrackerParty2ChoiceChoice {
    OrgId(OrganisationIdentification29),
    PrvtId(PersonIdentification13),
    FinInstnId(FinancialInstitutionIdentification21),
    __Unknown__(String),
}

impl Default for TrackerParty2ChoiceChoice {
    fn default() -> TrackerParty2ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for TrackerParty2ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:trck.004.001.04")]
pub struct TrackerParty2Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub tracker_party_2_choice_choice: TrackerParty2ChoiceChoice,
}

impl Validate for TrackerParty2Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:trck.004.001.04")]
pub struct TrackerPartyIdentification2 {
    #[yaserde(rename = "Nm")]
    #[cfg_attr(feature = "serde", serde(rename = "Nm"))]
    pub nm: Max140Text,
    ...
    #[yaserde(rename = "Id")]
    #[cfg_attr(feature = "serde", serde(rename = "Id"))]
    pub id: TrackerParty2Choice,
}

impl Validate for TrackerPartyIdentification2 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:trck.004.001.04")]
pub struct TrackerPaymentTransaction15 {
    #[yaserde(rename = "TrckdMsgId")]
    #[cfg_attr(feature = "serde", serde(rename = "TrckdMsgId"))]
    pub trckd_msg_id: OriginalBusinessInstruction4,
    ...
    #[yaserde(rename = "TechSndr")]
    #[cfg_attr(feature = "serde", serde(rename = "TechSndr"))]
    pub tech_sndr: Bicfidec2014Identifier,

    #[yaserde(rename = "TechRcvr")]
    #[cfg_attr(feature = "serde", serde(rename = "TechRcvr"))]
    pub tech_rcvr: Bicfidec2014Identifier,

    #[yaserde(rename = "PmtId")]
    #[cfg_attr(feature = "serde", serde(rename = "PmtId"))]
    pub pmt_id: PaymentIdentification10,

    #[yaserde(rename = "RltdPmtId")]
    #[cfg_attr(feature = "serde", serde(rename = "RltdPmtId"))]
    pub rltd_pmt_id: RelatedTransactionData1,
    ...
    #[yaserde(rename = "PmtScnro")]
    #[cfg_attr(feature = "serde", serde(rename = "PmtScnro"))]
    pub pmt_scnro: PaymentScenario1Choice,

    #[yaserde(rename = "SttlmInf")]
    #[cfg_attr(feature = "serde", serde(rename = "SttlmInf"))]
    pub sttlm_inf: SettlementInstruction9,
    ...
    #[yaserde(rename = "XchgRateData")]
    #[cfg_attr(feature = "serde", serde(rename = "XchgRateData"))]
    pub xchg_rate_data: CurrencyExchange15,

    #[yaserde(rename = "FXAgt")]
    #[cfg_attr(feature = "serde", serde(rename = "FXAgt"))]
    pub fx_agt: BranchAndFinancialInstitutionIdentification6,
    ...
    #[yaserde(rename = "TrckrRcrd")]
    #[cfg_attr(feature = "serde", serde(rename = "TrckrRcrd"))]
    pub trckr_rcrd: Vec<TrackerRecord8>,

    #[yaserde(rename = "TrckrData")]
    #[cfg_attr(feature = "serde", serde(rename = "TrckrData"))]
    pub trckr_data: TrackerData8,

    #[yaserde(rename = "DbtConfURLAdr")]
    #[cfg_attr(feature = "serde", serde(rename = "DbtConfURLAdr"))]
    pub dbt_conf_url_adr: Max2048Text,
    ...
    #[yaserde(rename = "RjctRtrRsn")]
    #[cfg_attr(feature = "serde", serde(rename = "RjctRtrRsn"))]
    pub rjct_rtr_rsn: Vec<PaymentRejectReturnReason1>,
    ...
    pub undrlyg_cstmr_cdt_trf: CreditTransferTransaction46,
}

impl Validate for TrackerPaymentTransaction15 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:trck.004.001.04")]
pub struct TrackerRecord8 {
    #[yaserde(rename = "PtyOrAgtId")]
    #[cfg_attr(feature = "serde", serde(rename = "PtyOrAgtId"))]
    pub pty_or_agt_id: TrackerPartyIdentification2,
    ...
    #[yaserde(rename = "XchgRateData")]
    #[cfg_attr(feature = "serde", serde(rename = "XchgRateData"))]
    pub xchg_rate_data: CurrencyExchange13,

    #[yaserde(rename = "PrcgDtTm")]
    #[cfg_attr(feature = "serde", serde(rename = "PrcgDtTm"))]
    pub prcg_dt_tm: IsodateTime,
}

impl Validate for TrackerRecord8 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:trck.004.001.04")]
pub struct TrackerStatus4 {
    #[yaserde(rename = "Sts")]
    #[cfg_attr(feature = "serde", serde(rename = "Sts"))]
    pub sts: ExternalPaymentTransactionStatus1Code,
    ...
    pub sts_rsn: Vec<PaymentStatusReason1>,

    #[yaserde(rename = "RjctRtrRsn")]
    #[cfg_attr(feature = "serde", serde(rename = "RjctRtrRsn"))]
    pub rjct_rtr_rsn: Vec<PaymentRejectReturnReason1>,

    #[yaserde(rename = "AmtIncnsstncy")]
    #[cfg_attr(feature = "serde", serde(rename = "AmtIncnsstncy"))]
    pub amt_incnsstncy: AmountConsistencyType1Code,
}

impl Validate for TrackerStatus4 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:trck.004.001.04")]
pub struct TrackerStatusAndTransaction21 {
    #[yaserde(rename = "TxSts")]
    #[cfg_attr(feature = "serde", serde(rename = "TxSts"))]
    pub tx_sts: TrackerStatus4,

    #[yaserde(rename = "Tx")]
    #[cfg_attr(feature = "serde", serde(rename = "Tx"))]
    pub tx: Vec<TrackerPaymentTransaction15>,
}

impl Validate for TrackerStatusAndTransaction21 {}
...
impl Validate for TransactionParties8 {}
...
impl crate::MxMessage for Document {
    const BUSINESS_AREA: crate::BusinessArea = crate::BusinessArea::trck;
    const FUNCTIONALITY: &'static str = "004";
    const VARIANT: &'static str = "001";
    const VERSION: &'static str = "04";
    const MESSAGE_NAME: &'static str = "trck.004.001.04";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:trck.004.001.04";
}
