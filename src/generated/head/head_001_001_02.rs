...
// pub type AppHdr = BusinessApplicationHeaderV02;
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:head.001.001.02")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:head.001.001.02")]
...
impl Validate for BusinessApplicationHeader5 {}
...
pub struct BusinessApplicationHeaderV02 {
    ...
    #[yaserde(rename = "MktPrctc")]
    #[cfg_attr(feature = "serde", serde(rename = "MktPrctc"))]
    ...
    #[yaserde(rename = "BizPrcgDt")]
    #[cfg_attr(feature = "serde", serde(rename = "BizPrcgDt"))]
    pub biz_prcg_dt: IsodateTime,
...
pub struct ImplementationSpecification1 {
    #[yaserde(rename = "Regy")]
    #[cfg_attr(feature = "serde", serde(rename = "Regy"))]
    pub regy: Max350Text,
...
impl Default for Party44ChoiceChoice {
    fn default() -> Party44ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for Party44ChoiceChoice {}
...
pub struct Party44Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub party_44_choice_choice: Party44ChoiceChoice,
}

impl Validate for Party44Choice {}
