...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casr.001.001.01")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casr.001.001.01")]
...
pub struct Context6 {
    ...
    pub tx_cntxt: Vec<TransactionContext6>,
}

impl Validate for Context6 {}
...
pub struct Document {
    ...
    pub sttlm_rptg_initn: SettlementReportingInitiationV01,
}
...
pub struct Environment9 {
    ...
    pub sttlm_instn: PartyIdentification197,
    ...
    pub fi: FinancialInstitution5,

    #[yaserde(rename = "OthrInstn")]
    #[cfg_attr(feature = "serde", serde(rename = "OthrInstn"))]
    pub othr_instn: PartyIdentification197,
}

impl Validate for Environment9 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casr.001.001.01")]
pub struct FinancialInstitution5 {
    #[yaserde(rename = "Id")]
    #[cfg_attr(feature = "serde", serde(rename = "Id"))]
...
impl Validate for FinancialInstitution5 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casr.001.001.01")]
pub struct SettlementCategoryTotal1 {
    #[yaserde(rename = "Cnt")]
    ...
    #[yaserde(rename = "PrcgFee")]
    #[cfg_attr(feature = "serde", serde(rename = "PrcgFee"))]
    pub prcg_fee: Amount14,
}

impl Validate for SettlementCategoryTotal1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casr.001.001.01")]

pub enum SettlementReportType1Code {
    #[yaserde(rename = "FIPO")]
...
impl Default for SettlementReportType1Code {
    fn default() -> SettlementReportType1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for SettlementReportType1Code {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casr.001.001.01")]
pub struct SettlementReportingInitiation1 {
    #[yaserde(rename = "Envt")]
    #[cfg_attr(feature = "serde", serde(rename = "Envt"))]
    pub envt: Environment9,
...
impl Validate for SettlementReportingInitiation1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casr.001.001.01")]
pub struct SettlementReportingInitiationV01 {
    #[yaserde(rename = "Hdr")]
    ...
    pub body: SettlementReportingInitiation1,
...
impl Validate for SettlementReportingInitiationV01 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casr.001.001.01")]
pub struct SettlementTotals1 {
    #[yaserde(rename = "AcqrrTtls")]
    #[cfg_attr(feature = "serde", serde(rename = "AcqrrTtls"))]
    pub acqrr_ttls: SettlementCategoryTotal1,

    #[yaserde(rename = "IssrTtls")]
    #[cfg_attr(feature = "serde", serde(rename = "IssrTtls"))]
    pub issr_ttls: SettlementCategoryTotal1,

    #[yaserde(rename = "OthrTtls")]
    #[cfg_attr(feature = "serde", serde(rename = "OthrTtls"))]
    pub othr_ttls: SettlementCategoryTotal1,

    #[yaserde(rename = "TtlSttlmAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "TtlSttlmAmt"))]
    pub ttl_sttlm_amt: SettlementCategoryTotal1,
}

impl Validate for SettlementTotals1 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casr.001.001.01")]
pub struct Transaction104 {
    #[yaserde(rename = "SttlmRptTp")]
    #[cfg_attr(feature = "serde", serde(rename = "SttlmRptTp"))]
    pub sttlm_rpt_tp: SettlementReportType1Code,

    #[yaserde(rename = "OthrSttlmRptTp")]
    #[cfg_attr(feature = "serde", serde(rename = "OthrSttlmRptTp"))]
    pub othr_sttlm_rpt_tp: Max35Text,
    ...
    #[yaserde(rename = "SttlmTtls")]
    #[cfg_attr(feature = "serde", serde(rename = "SttlmTtls"))]
    pub sttlm_ttls: SettlementTotals1,

    #[yaserde(rename = "FndsTrfAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "FndsTrfAmt"))]
    pub fnds_trf_amt: Amount14,
...
impl Validate for Transaction104 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casr.001.001.01")]
pub struct TransactionContext6 {
...
impl Validate for TransactionContext6 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "casr.001.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:casr.001.001.01";
}
