...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casr.002.001.04")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casr.002.001.04")]
...
pub struct Document {
    ...
    pub sttlm_rptg_rspn: SettlementReportingResponseV04,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casr.002.001.04")]
pub struct SettlementReportingResponseV04 {
    #[yaserde(rename = "Hdr")]
...
impl Validate for SettlementReportingResponseV04 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "casr.002.001.04";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:casr.002.001.04";
}
