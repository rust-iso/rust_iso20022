...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:fxtr.016.001.06")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:fxtr.016.001.06")]
...
pub struct Document {
    ...
    pub fx_trad_instr_cxl: ForeignExchangeTradeInstructionCancellationV06,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:fxtr.016.001.06")]
pub struct ForeignExchangeTradeInstructionCancellationV06 {
...
impl Validate for ForeignExchangeTradeInstructionCancellationV06 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "fxtr.016.001.06";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:fxtr.016.001.06";
}
