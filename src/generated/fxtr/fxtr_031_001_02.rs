...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:fxtr.031.001.02")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:fxtr.031.001.02")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:fxtr.031.001.02")]
pub struct AdditionalReferences2 {
    #[yaserde(rename = "Ref")]
    ...
    pub ref_issr: Max35Text,
}

impl Validate for AdditionalReferences2 {}
...
impl Validate for AmountAndCurrency2 {}
...
pub struct Document {
    ...
    pub fx_trad_captr_rpt: ForeignExchangeTradeCaptureReportV02,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:fxtr.031.001.02")]
pub struct ForeignExchangeTradeCaptureReportV02 {
    #[yaserde(rename = "Hdr")]
    ...
    pub last_rpt_reqd: TrueFalseIndicator,
...
impl Validate for ForeignExchangeTradeCaptureReportV02 {}
...
pub struct PremiumQuote1Choice {
    #[yaserde(rename = "PctgOfCallAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "PctgOfCallAmt"))]
    pub pctg_of_call_amt: Option<PercentageRate>,
    #[yaserde(rename = "PctgOfPutAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "PctgOfPutAmt"))]
    pub pctg_of_put_amt: Option<PercentageRate>,
    #[yaserde(rename = "PtsOfCallAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "PtsOfCallAmt"))]
    pub pts_of_call_amt: Option<BaseOneRate>,
    #[yaserde(rename = "PtsOfPutAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "PtsOfPutAmt"))]
...
pub struct Trade7 {
    ...
    #[yaserde(rename = "ContraCcy")]
    #[cfg_attr(feature = "serde", serde(rename = "ContraCcy"))]
    pub contra_ccy: ActiveCurrencyCode,

    #[yaserde(rename = "DealTcktId")]
    #[cfg_attr(feature = "serde", serde(rename = "DealTcktId"))]
    pub deal_tckt_id: Max30Text,

    #[yaserde(rename = "CmbntnDealTcktId")]
    #[cfg_attr(feature = "serde", serde(rename = "CmbntnDealTcktId"))]
    pub cmbntn_deal_tckt_id: Max35Text,

    #[yaserde(rename = "BaseCcyOrAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "BaseCcyOrAmt"))]
    pub base_ccy_or_amt: AmountAndCurrency2,

    #[yaserde(rename = "TrgtCcyOrAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "TrgtCcyOrAmt"))]
    pub trgt_ccy_or_amt: AmountAndCurrency2,

    #[yaserde(rename = "DtConfd")]
    #[cfg_attr(feature = "serde", serde(rename = "DtConfd"))]
    pub dt_confd: Isodate,
}

impl Validate for Trade7 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "fxtr.031.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:fxtr.031.001.02";
}
