...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.04")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.04")]
...
pub struct Document {
    ...
    pub fx_trad_sts_and_dtls_ntfctn: ForeignExchangeTradeStatusAndDetailsNotificationV04,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.04")]
pub struct ForeignExchangeTradeStatusAndDetailsNotificationV04 {
...
impl Validate for ForeignExchangeTradeStatusAndDetailsNotificationV04 {}
...
impl Validate for SplitTradeDetails3 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "fxtr.017.001.04";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:fxtr.017.001.04";
}
