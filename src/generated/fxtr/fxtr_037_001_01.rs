...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:fxtr.037.001.01")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:fxtr.037.001.01")]
...
pub struct Confirmation1 {
    ...
    #[yaserde(rename = "ConfTm")]
    #[cfg_attr(feature = "serde", serde(rename = "ConfTm"))]
    pub conf_tm: IsodateTime,

    #[yaserde(rename = "TradPtyConfTm")]
    #[cfg_attr(feature = "serde", serde(rename = "TradPtyConfTm"))]
    pub trad_pty_conf_tm: IsodateTime,

    #[yaserde(rename = "InitgPtyConfTm")]
    #[cfg_attr(feature = "serde", serde(rename = "InitgPtyConfTm"))]
    pub initg_pty_conf_tm: IsodateTime,
    ...
    #[yaserde(rename = "QryPgNb")]
    #[cfg_attr(feature = "serde", serde(rename = "QryPgNb"))]
    pub qry_pg_nb: Max35NumericText,

    #[yaserde(rename = "MsgNbOfCurPg")]
    #[cfg_attr(feature = "serde", serde(rename = "MsgNbOfCurPg"))]
    pub msg_nb_of_cur_pg: Number,

    #[yaserde(rename = "ListOrdrNb")]
    #[cfg_attr(feature = "serde", serde(rename = "ListOrdrNb"))]
...
impl Validate for Confirmation1 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:fxtr.037.001.01")]
pub struct Document {
    #[yaserde(rename = "FXTradConfStsAdvc")]
    #[cfg_attr(feature = "serde", serde(rename = "FXTradConfStsAdvc"))]
    pub fx_trad_conf_sts_advc: ForeignExchangeTradeConfirmationStatusAdviceV01,
}
...
pub struct ForeignExchangeTradeConfirmationStatusAdviceV01 {
    ...
    #[yaserde(rename = "AdvcId")]
    #[cfg_attr(feature = "serde", serde(rename = "AdvcId"))]
    pub advc_id: MessageIdentification1,
...
impl Validate for ForeignExchangeTradeConfirmationStatusAdviceV01 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "fxtr.037.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:fxtr.037.001.01";
}
