...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:fxtr.015.001.04")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:fxtr.015.001.04")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:fxtr.015.001.04")]
pub struct Document {
    #[yaserde(rename = "FXTradInstrAmdmnt")]
    #[cfg_attr(feature = "serde", serde(rename = "FXTradInstrAmdmnt"))]
    pub fx_trad_instr_amdmnt: ForeignExchangeTradeInstructionAmendmentV04,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:fxtr.015.001.04")]
pub struct ForeignExchangeTradeInstructionAmendmentV04 {
...
impl Validate for ForeignExchangeTradeInstructionAmendmentV04 {}
...
pub enum MatchingSystemReference1ChoiceChoice {
    MtchgSysUnqRef(Max35Text),
    RltdRef(Max35Text),
    __Unknown__(String),
}

impl Default for MatchingSystemReference1ChoiceChoice {
    fn default() -> MatchingSystemReference1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for MatchingSystemReference1ChoiceChoice {}
...
pub struct MatchingSystemReference1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub matching_system_reference_1_choice_choice: MatchingSystemReference1ChoiceChoice,
}
...
pub enum NdfopeningFixing1ChoiceChoice {
    OpngConds(OpeningConditions1),
    OpngConfRef(Max35Text),
    __Unknown__(String),
}

impl Default for NdfopeningFixing1ChoiceChoice {
    fn default() -> NdfopeningFixing1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for NdfopeningFixing1ChoiceChoice {}
...
pub struct NdfopeningFixing1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub ndf_opening_fixing_1_choice_choice: NdfopeningFixing1ChoiceChoice,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "fxtr.015.001.04";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:fxtr.015.001.04";
}
