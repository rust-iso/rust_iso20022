...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:fxtr.037.001.02")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:fxtr.037.001.02")]
...
pub enum DeliveryType4Code {
    #[yaserde(rename = "TRIP")]
    #[cfg_attr(feature = "serde", serde(rename = "TRIP"))]
    Trip,
    #[yaserde(rename = "PVSP")]
    #[cfg_attr(feature = "serde", serde(rename = "PVSP"))]
    Pvsp,
    #[yaserde(rename = "HOIC")]
    ...
    Free,
    #[yaserde(rename = "AGPM")]
    #[cfg_attr(feature = "serde", serde(rename = "AGPM"))]
    Agpm,
    __Unknown__(String),
}

impl Default for DeliveryType4Code {
    fn default() -> DeliveryType4Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for DeliveryType4Code {}
...
pub struct Document {
    ...
    pub fx_trad_conf_sts_advc: ForeignExchangeTradeConfirmationStatusAdviceV02,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:fxtr.037.001.02")]
pub struct ForeignExchangeTradeConfirmationStatusAdviceV02 {
    #[yaserde(rename = "Hdr")]
    ...
    pub ctr_pty_sd_id: TradePartyIdentification10,
...
impl Validate for ForeignExchangeTradeConfirmationStatusAdviceV02 {}
...
pub struct Trade8 {
    ...
    pub dlvry_tp: DeliveryType4Code,
}

impl Validate for Trade8 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:fxtr.037.001.02")]
pub struct TradePartyIdentification10 {
    ...
    #[yaserde(rename = "TradPtyId")]
    #[cfg_attr(feature = "serde", serde(rename = "TradPtyId"))]
    pub trad_pty_id: PartyIdentification265,
...
impl Validate for TradePartyIdentification10 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "fxtr.037.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:fxtr.037.001.02";
}
