...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:fxtr.035.001.01")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:fxtr.035.001.01")]
...
pub struct Document {
    ...
    pub fx_trad_conf_req_amdmnt_req: ForeignExchangeTradeConfirmationRequestAmendmentRequestV01,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:fxtr.035.001.01")]
pub struct ForeignExchangeTradeConfirmationRequestAmendmentRequestV01 {
    #[yaserde(rename = "Hdr")]
...
impl Validate for ForeignExchangeTradeConfirmationRequestAmendmentRequestV01 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "fxtr.035.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:fxtr.035.001.01";
}
