...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:fxtr.030.001.06")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:fxtr.030.001.06")]
...
pub struct Document {
    ...
    pub fx_trad_blk_sts_ntfctn: ForeignExchangeTradeBulkStatusNotificationV06,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:fxtr.030.001.06")]
pub struct ForeignExchangeTradeBulkStatusNotificationV06 {
    #[yaserde(rename = "StsDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "StsDtls"))]
    pub sts_dtls: TradeData45,

    #[yaserde(rename = "TradDataRpt")]
    #[cfg_attr(feature = "serde", serde(rename = "TradDataRpt"))]
    pub trad_data_rpt: Vec<TradeDataReport2>,
...
impl Validate for ForeignExchangeTradeBulkStatusNotificationV06 {}
...
impl Validate for TradeData44 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:fxtr.030.001.06")]
pub struct TradeData45 {
...
impl Validate for TradeData45 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:fxtr.030.001.06")]
pub struct TradeDataReport2 {
    ...
    pub trad_data: Vec<TradeData44>,
}

impl Validate for TradeDataReport2 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "fxtr.030.001.06";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:fxtr.030.001.06";
}
