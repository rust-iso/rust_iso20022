...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.023.001.06")]
pub struct AcceptorNonFinancialResponseV06 {
    #[yaserde(rename = "Hdr")]
    ...
    pub non_fin_rspn: NonFinancialResponseComponent6,
...
impl Validate for AcceptorNonFinancialResponseV06 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.023.001.06")]
...
pub struct Document {
    ...
    pub accptr_non_fin_rspn: AcceptorNonFinancialResponseV06,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.023.001.06")]
pub struct NonFinancialResponseComponent6 {
    #[yaserde(rename = "Envt")]
    ...
    pub rspn_cntt: Vec<NonFinancialResponseContentComponent6>,
...
impl Validate for NonFinancialResponseComponent6 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.023.001.06")]
pub struct NonFinancialResponseContentComponent6 {
    #[yaserde(rename = "NonFinReqTp")]
    #[cfg_attr(feature = "serde", serde(rename = "NonFinReqTp"))]
    pub non_fin_req_tp: NonFinancialRequestType2Code,
    ...
    pub instlmt: Vec<RecurringTransaction7>,

    #[yaserde(rename = "AddtlRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "AddtlRspn"))]
    pub addtl_rspn: Vec<ExternallyDefinedData5>,
...
impl Validate for NonFinancialResponseContentComponent6 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "caaa.023.001.06";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:caaa.023.001.06";
}
