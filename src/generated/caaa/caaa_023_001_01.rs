...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.023.001.01")]
pub struct AcceptorNonFinancialResponseV01 {
    #[yaserde(rename = "Hdr")]
    #[cfg_attr(feature = "serde", serde(rename = "Hdr"))]
    pub hdr: Header59,

    #[yaserde(rename = "NonFinRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "NonFinRspn"))]
    pub non_fin_rspn: NonFinancialResponseComponent1,
...
impl Validate for AcceptorNonFinancialResponseV01 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.023.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.023.001.01")]
pub struct Document {
    #[yaserde(rename = "AccptrNonFinRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "AccptrNonFinRspn"))]
    pub accptr_non_fin_rspn: AcceptorNonFinancialResponseV01,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.023.001.01")]
pub struct NonFinancialResponseComponent1 {
    #[yaserde(rename = "Envt")]
    #[cfg_attr(feature = "serde", serde(rename = "Envt"))]
    pub envt: CardPaymentEnvironment77,

    #[yaserde(rename = "RspnCntt")]
    #[cfg_attr(feature = "serde", serde(rename = "RspnCntt"))]
    pub rspn_cntt: Vec<NonFinancialResponseContentComponent1>,
...
impl Validate for NonFinancialResponseComponent1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.023.001.01")]
pub struct NonFinancialResponseContentComponent1 {
    #[yaserde(rename = "NonFinReqTp")]
    #[cfg_attr(feature = "serde", serde(rename = "NonFinReqTp"))]
    pub non_fin_req_tp: NonFinancialRequestType1Code,

    #[yaserde(rename = "AcqrrSelctd")]
    #[cfg_attr(feature = "serde", serde(rename = "AcqrrSelctd"))]
    pub acqrr_selctd: Acquirer10,

    #[yaserde(rename = "RskMgmtRslt")]
    #[cfg_attr(feature = "serde", serde(rename = "RskMgmtRslt"))]
    pub rsk_mgmt_rslt: NonFinancialResponseRisk1Code,
...
impl Validate for NonFinancialResponseContentComponent1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.023.001.01")]

pub enum NonFinancialResponseRisk1Code {
    #[yaserde(rename = "DECL")]
    #[cfg_attr(feature = "serde", serde(rename = "DECL"))]
    Decl,
    #[yaserde(rename = "NCHG")]
    #[cfg_attr(feature = "serde", serde(rename = "NCHG"))]
    Nchg,
    #[yaserde(rename = "ONLN")]
...
impl Default for NonFinancialResponseRisk1Code {
    fn default() -> NonFinancialResponseRisk1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for NonFinancialResponseRisk1Code {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "caaa.023.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:caaa.023.001.01";
}
