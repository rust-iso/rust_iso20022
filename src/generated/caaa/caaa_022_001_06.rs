...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.022.001.06")]
pub struct AcceptorNonFinancialRequestV06 {
    #[yaserde(rename = "Hdr")]
    ...
    pub non_fin_req: NonFinancialRequestComponent6,
...
impl Validate for AcceptorNonFinancialRequestV06 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.022.001.06")]
...
pub struct Document {
    ...
    pub accptr_non_fin_req: AcceptorNonFinancialRequestV06,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.022.001.06")]
pub struct NonFinancialRequestComponent6 {
    #[yaserde(rename = "Envt")]
    ...
    pub non_fin_req_cntt: NonFinancialRequestContentComponent6,
...
impl Validate for NonFinancialRequestComponent6 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.022.001.06")]
pub struct NonFinancialRequestContentComponent6 {
    #[yaserde(rename = "NonFinReqTp")]
    #[cfg_attr(feature = "serde", serde(rename = "NonFinReqTp"))]
    pub non_fin_req_tp: Vec<NonFinancialRequestType2Code>,

    #[yaserde(rename = "Tx")]
    #[cfg_attr(feature = "serde", serde(rename = "Tx"))]
    pub tx: CardPaymentTransaction146,

    #[yaserde(rename = "AddtlReq")]
    #[cfg_attr(feature = "serde", serde(rename = "AddtlReq"))]
    pub addtl_req: Vec<ExternallyDefinedData5>,
}

impl Validate for NonFinancialRequestContentComponent6 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "caaa.022.001.06";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:caaa.022.001.06";
}
