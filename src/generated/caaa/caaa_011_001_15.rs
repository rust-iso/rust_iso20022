...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.011.001.15")]
pub struct AcceptorBatchTransferV15 {
    #[yaserde(rename = "Hdr")]
...
impl Validate for AcceptorBatchTransferV15 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.011.001.15")]
...
pub struct Document {
    ...
    pub accptr_btch_trf: AcceptorBatchTransferV15,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "caaa.011.001.15";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:caaa.011.001.15";
}
