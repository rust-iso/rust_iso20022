...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.009.001.09")]
pub struct AcceptorReconciliationRequest9 {
    #[yaserde(rename = "Envt")]
    ...
    pub tx: TransactionReconciliation5,
}

impl Validate for AcceptorReconciliationRequest9 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.009.001.09")]
pub struct AcceptorReconciliationRequestV09 {
    #[yaserde(rename = "Hdr")]
    ...
    pub rcncltn_req: AcceptorReconciliationRequest9,
...
impl Validate for AcceptorReconciliationRequestV09 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.009.001.09")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.009.001.09")]
pub struct Document {
    #[yaserde(rename = "AccptrRcncltnReq")]
    #[cfg_attr(feature = "serde", serde(rename = "AccptrRcncltnReq"))]
    pub accptr_rcncltn_req: AcceptorReconciliationRequestV09,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.009.001.09")]
pub struct TransactionReconciliation5 {
    #[yaserde(rename = "ClsPrd")]
    #[cfg_attr(feature = "serde", serde(rename = "ClsPrd"))]
    pub cls_prd: TrueFalseIndicator,

    #[yaserde(rename = "RcncltnTxId")]
    #[cfg_attr(feature = "serde", serde(rename = "RcncltnTxId"))]
    pub rcncltn_tx_id: TransactionIdentifier1,
    ...
    pub addtl_tx_data: Max70Text,
}

impl Validate for TransactionReconciliation5 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "caaa.009.001.09";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:caaa.009.001.09";
}
