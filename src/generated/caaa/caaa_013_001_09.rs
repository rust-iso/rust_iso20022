...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.013.001.09")]
pub struct AcceptorDiagnosticRequest9 {
    #[yaserde(rename = "Envt")]
    #[cfg_attr(feature = "serde", serde(rename = "Envt"))]
    pub envt: CardPaymentEnvironment77,

    #[yaserde(rename = "AcqrrAvlbtyReqd")]
    #[cfg_attr(feature = "serde", serde(rename = "AcqrrAvlbtyReqd"))]
    pub acqrr_avlbty_reqd: TrueFalseIndicator,
}

impl Validate for AcceptorDiagnosticRequest9 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.013.001.09")]
pub struct AcceptorDiagnosticRequestV09 {
    #[yaserde(rename = "Hdr")]
    #[cfg_attr(feature = "serde", serde(rename = "Hdr"))]
    pub hdr: Header59,

    #[yaserde(rename = "DgnstcReq")]
    #[cfg_attr(feature = "serde", serde(rename = "DgnstcReq"))]
    pub dgnstc_req: AcceptorDiagnosticRequest9,
...
impl Validate for AcceptorDiagnosticRequestV09 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.013.001.09")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.013.001.09")]
pub struct Document {
    #[yaserde(rename = "AccptrDgnstcReq")]
    #[cfg_attr(feature = "serde", serde(rename = "AccptrDgnstcReq"))]
    pub accptr_dgnstc_req: AcceptorDiagnosticRequestV09,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "caaa.013.001.09";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:caaa.013.001.09";
}
