...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.024.001.01")]
pub struct AcceptorTransactionLogReportRequestV01 {
    #[yaserde(rename = "Hdr")]
...
impl Validate for AcceptorTransactionLogReportRequestV01 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.024.001.01")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.024.001.01")]
pub struct CriteriaOrder1 {
    #[yaserde(rename = "Trgt")]
    #[cfg_attr(feature = "serde", serde(rename = "Trgt"))]
    pub trgt: Max500Text,
}

impl Validate for CriteriaOrder1 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.024.001.01")]
pub struct Document {
    #[yaserde(rename = "AccptrTxLgRptReq")]
    #[cfg_attr(feature = "serde", serde(rename = "AccptrTxLgRptReq"))]
    pub accptr_tx_lg_rpt_req: AcceptorTransactionLogReportRequestV01,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.024.001.01")]
pub struct ReportGetTotalsRequest1 {
    #[yaserde(rename = "TtlDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "TtlDtls"))]
    pub ttl_dtls: TotalDetails1Code,

    #[yaserde(rename = "TtlFltr")]
    #[cfg_attr(feature = "serde", serde(rename = "TtlFltr"))]
    pub ttl_fltr: TotalFilter1,
}

impl Validate for ReportGetTotalsRequest1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.024.001.01")]
pub struct ReportRequest4 {
    #[yaserde(rename = "Envt")]
    ...
    pub svc_cntt: RetailerService6Code,

    #[yaserde(rename = "RptTxReq")]
    #[cfg_attr(feature = "serde", serde(rename = "RptTxReq"))]
    pub rpt_tx_req: ReportTransactionRequest1,

    #[yaserde(rename = "RptGetTtlsReq")]
    #[cfg_attr(feature = "serde", serde(rename = "RptGetTtlsReq"))]
    pub rpt_get_ttls_req: ReportGetTotalsRequest1,
...
impl Validate for ReportRequest4 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.024.001.01")]
pub struct ReportTransactionRequest1 {
    #[yaserde(rename = "SchCrit")]
    #[cfg_attr(feature = "serde", serde(rename = "SchCrit"))]
    pub sch_crit: Vec<SearchCriteria1>,

    #[yaserde(rename = "SchOutptOrdr")]
    #[cfg_attr(feature = "serde", serde(rename = "SchOutptOrdr"))]
    pub sch_outpt_ordr: SearchOutputOrder1,

    #[yaserde(rename = "DscndgOrdr")]
    #[cfg_attr(feature = "serde", serde(rename = "DscndgOrdr"))]
    pub dscndg_ordr: TrueFalseIndicator,
...
impl Validate for ReportTransactionRequest1 {}
...
impl Default for RetailerService6Code {
    fn default() -> RetailerService6Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for RetailerService6Code {}
...
impl Validate for SearchAnd1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.024.001.01")]
pub struct SearchCriteria1 {
    #[yaserde(rename = "SchOr")]
    #[cfg_attr(feature = "serde", serde(rename = "SchOr"))]
    pub sch_or: Vec<SearchOr1>,
}

impl Validate for SearchCriteria1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.024.001.01")]
pub struct SearchOr1 {
    #[yaserde(rename = "SchAnd")]
    #[cfg_attr(feature = "serde", serde(rename = "SchAnd"))]
    pub sch_and: Vec<SearchAnd1>,
}

impl Validate for SearchOr1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.024.001.01")]
pub struct SearchOutputOrder1 {
    #[yaserde(rename = "CritOrdr")]
    #[cfg_attr(feature = "serde", serde(rename = "CritOrdr"))]
    pub crit_ordr: Vec<CriteriaOrder1>,
}

impl Validate for SearchOutputOrder1 {}
...
pub enum TotalDetails1Code {
    #[yaserde(rename = "OPID")]
    #[cfg_attr(feature = "serde", serde(rename = "OPID"))]
    Opid,
    #[yaserde(rename = "PIID")]
    #[cfg_attr(feature = "serde", serde(rename = "PIID"))]
    Piid,
    #[yaserde(rename = "TGID")]
    #[cfg_attr(feature = "serde", serde(rename = "TGID"))]
    Tgid,
    #[yaserde(rename = "SNID")]
    #[cfg_attr(feature = "serde", serde(rename = "SNID"))]
    Snid,
    #[yaserde(rename = "SAID")]
...
impl Default for TotalDetails1Code {
    fn default() -> TotalDetails1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for TotalDetails1Code {}
...
impl Validate for TotalFilter1 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "caaa.024.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:caaa.024.001.01";
}
