...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.012.001.09")]
pub struct AcceptorBatchTransferResponseV09 {
    #[yaserde(rename = "Hdr")]
    ...
    pub btch_trf_rspn: CardPaymentBatchTransferResponse8,
...
impl Validate for AcceptorBatchTransferResponseV09 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.012.001.09")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.012.001.09")]
pub struct CardPaymentBatchTransferResponse8 {
    ...
    pub data_set: Vec<CardPaymentDataSet27>,
}

impl Validate for CardPaymentBatchTransferResponse8 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.012.001.09")]
pub struct CardPaymentDataSet27 {
    ...
    pub rjctd_tx: Vec<CardPaymentDataSet28>,

    #[yaserde(rename = "SspdTx")]
    #[cfg_attr(feature = "serde", serde(rename = "SspdTx"))]
    pub sspd_tx: Vec<CardPaymentDataSet28>,

    #[yaserde(rename = "RsmdApprvl")]
    #[cfg_attr(feature = "serde", serde(rename = "RsmdApprvl"))]
    pub rsmd_apprvl: Vec<CardPaymentDataSet28>,

    #[yaserde(rename = "RsmdRjctn")]
    #[cfg_attr(feature = "serde", serde(rename = "RsmdRjctn"))]
    pub rsmd_rjctn: Vec<CardPaymentDataSet28>,
}

impl Validate for CardPaymentDataSet27 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.012.001.09")]
pub struct CardPaymentDataSet28 {
...
impl Validate for CardPaymentDataSet28 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.012.001.09")]
pub struct Document {
    #[yaserde(rename = "AccptrBtchTrfRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "AccptrBtchTrfRspn"))]
    pub accptr_btch_trf_rspn: AcceptorBatchTransferResponseV09,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "caaa.012.001.09";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:caaa.012.001.09";
}
