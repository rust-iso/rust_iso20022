...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.012.001.14")]
pub struct AcceptorBatchTransferResponseV14 {
    #[yaserde(rename = "Hdr")]
...
impl Validate for AcceptorBatchTransferResponseV14 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.012.001.14")]
...
pub struct Document {
    ...
    pub accptr_btch_trf_rspn: AcceptorBatchTransferResponseV14,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "caaa.012.001.14";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:caaa.012.001.14";
}
