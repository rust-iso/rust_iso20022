...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.027.001.03")]
pub struct AcceptorCancellationAdviceResponse14 {
    #[yaserde(rename = "Envt")]
    ...
    pub tx: CardPaymentTransactionAdviceResponse8,
...
impl Validate for AcceptorCancellationAdviceResponse14 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.027.001.03")]
pub struct AcceptorCompletionAdviceResponse14 {
    #[yaserde(rename = "Envt")]
    #[cfg_attr(feature = "serde", serde(rename = "Envt"))]
    pub envt: CardPaymentEnvironment82,
...
impl Validate for AcceptorCompletionAdviceResponse14 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.027.001.03")]
pub struct AcquirerToAcceptorBatchFileExchangeV03 {
    #[yaserde(rename = "Hdr")]
    ...
    pub body_elmt: Vec<AcquirerToAcceptorFileBody3>,
...
impl Validate for AcquirerToAcceptorBatchFileExchangeV03 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.027.001.03")]
pub struct AcquirerToAcceptorFileBody3 {
    #[yaserde(rename = "CmpltnAdvcRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "CmpltnAdvcRspn"))]
    pub cmpltn_advc_rspn: AcceptorCompletionAdviceResponse14,

    #[yaserde(rename = "CxlRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "CxlRspn"))]
    pub cxl_rspn: AcceptorCancellationAdviceResponse14,

    #[yaserde(rename = "BtchTrfRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "BtchTrfRspn"))]
    pub btch_trf_rspn: CardPaymentBatchTransferResponse13,
}

impl Validate for AcquirerToAcceptorFileBody3 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.027.001.03")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.027.001.03")]
pub struct CardPaymentBatchTransferResponse13 {
    ...
    pub data_set: Vec<CardPaymentDataSet42>,
}

impl Validate for CardPaymentBatchTransferResponse13 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.027.001.03")]
pub struct CardPaymentDataSet41 {
    ...
    #[yaserde(rename = "Tx")]
    #[cfg_attr(feature = "serde", serde(rename = "Tx"))]
    pub tx: CardPaymentTransactionAdviceResponse5,
}

impl Validate for CardPaymentDataSet41 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.027.001.03")]
pub struct CardPaymentDataSet42 {
    #[yaserde(rename = "DataSetId")]
    #[cfg_attr(feature = "serde", serde(rename = "DataSetId"))]
    pub data_set_id: DataSetIdentification5,

    #[yaserde(rename = "DataSetRslt")]
    #[cfg_attr(feature = "serde", serde(rename = "DataSetRslt"))]
    pub data_set_rslt: ResponseType10,

    #[yaserde(rename = "RmvDataSet")]
    #[cfg_attr(feature = "serde", serde(rename = "RmvDataSet"))]
    pub rmv_data_set: TrueFalseIndicator,
    ...
    #[yaserde(rename = "RjctdTx")]
    #[cfg_attr(feature = "serde", serde(rename = "RjctdTx"))]
    pub rjctd_tx: Vec<CardPaymentDataSet41>,

    #[yaserde(rename = "SspdTx")]
    #[cfg_attr(feature = "serde", serde(rename = "SspdTx"))]
    pub sspd_tx: Vec<CardPaymentDataSet41>,

    #[yaserde(rename = "RsmdApprvl")]
    #[cfg_attr(feature = "serde", serde(rename = "RsmdApprvl"))]
    pub rsmd_apprvl: Vec<CardPaymentDataSet41>,

    #[yaserde(rename = "RsmdRjctn")]
    #[cfg_attr(feature = "serde", serde(rename = "RsmdRjctn"))]
    pub rsmd_rjctn: Vec<CardPaymentDataSet41>,
}

impl Validate for CardPaymentDataSet42 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.027.001.03")]
pub struct CardPaymentTransactionAdviceResponse5 {
    ...
    #[yaserde(rename = "Rspn")]
    #[cfg_attr(feature = "serde", serde(rename = "Rspn"))]
    pub rspn: Response1Code,
}

impl Validate for CardPaymentTransactionAdviceResponse5 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.027.001.03")]
pub struct CardPaymentTransactionAdviceResponse8 {
    #[yaserde(rename = "SaleRefId")]
    #[cfg_attr(feature = "serde", serde(rename = "SaleRefId"))]
    pub sale_ref_id: Max35Text,
...
impl Validate for CardPaymentTransactionAdviceResponse8 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:caaa.027.001.03")]
pub struct Document {
    #[yaserde(rename = "AcqrrToAccptrBtchFileXchg")]
    #[cfg_attr(feature = "serde", serde(rename = "AcqrrToAccptrBtchFileXchg"))]
    pub acqrr_to_accptr_btch_file_xchg: AcquirerToAcceptorBatchFileExchangeV03,
}
...
impl Default for Response1Code {
    fn default() -> Response1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for Response1Code {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "caaa.027.001.03";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:caaa.027.001.03";
}
