...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.006.001.08")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.006.001.08")]
...
pub struct DataSetRequest7 {
    ...
    pub ssn_key: CryptographicKey19,
...
impl Validate for DataSetRequest7 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.006.001.08")]
pub struct DeviceDisplayResponse3 {
    #[yaserde(rename = "OutptRslt")]
    #[cfg_attr(feature = "serde", serde(rename = "OutptRslt"))]
    pub outpt_rslt: Vec<OutputResult3>,
}

impl Validate for DeviceDisplayResponse3 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.006.001.08")]
pub struct DeviceInputResponse7 {
    #[yaserde(rename = "OutptRslt")]
    #[cfg_attr(feature = "serde", serde(rename = "OutptRslt"))]
    pub outpt_rslt: OutputResult3,

    #[yaserde(rename = "InptRslt")]
    #[cfg_attr(feature = "serde", serde(rename = "InptRslt"))]
    pub inpt_rslt: InputResult6,
}

impl Validate for DeviceInputResponse7 {}
...
pub struct DeviceResponse9 {
    ...
    pub disp_rspn: DeviceDisplayResponse3,

    #[yaserde(rename = "InptRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "InptRspn"))]
    pub inpt_rspn: DeviceInputResponse7,
    ...
    pub scr_inpt_rspn: DeviceSecureInputResponse6,
...
impl Validate for DeviceResponse9 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.006.001.08")]
pub struct DeviceSecureInputResponse6 {
    #[yaserde(rename = "CrdhldrPIN")]
    #[cfg_attr(feature = "serde", serde(rename = "CrdhldrPIN"))]
    pub crdhldr_pin: OnLinePIN11,
}

impl Validate for DeviceSecureInputResponse6 {}
...
pub struct DiagnosisResponse8 {
    ...
    pub poi_sts: StatusReportContent15,
...
impl Validate for DiagnosisResponse8 {}
...
pub struct Document {
    ...
    pub sale_to_poi_ssn_mgmt_rspn: SaleToPOISessionManagementResponseV08,
}
...
pub struct InputResult6 {
    ...
    pub inpt_rslt_data: InputResultData6,
}

impl Validate for InputResult6 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.006.001.08")]
pub struct InputResultData6 {
    ...
    pub pwd: ContentInformationType39,
...
impl Validate for InputResultData6 {}
...
pub struct LoginResponse8 {
    ...
    pub poi_sftwr: Vec<PointOfInteractionComponent18>,
    ...
    pub outpt_disp: ActionMessage12,
}

impl Validate for LoginResponse8 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.006.001.08")]
pub struct OutputResult3 {
    #[yaserde(rename = "DvcTp")]
    #[cfg_attr(feature = "serde", serde(rename = "DvcTp"))]
    pub dvc_tp: UserInterface9Code,
...
impl Validate for OutputResult3 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.006.001.08")]
pub struct SaleToPOISessionManagementResponseV08 {
    #[yaserde(rename = "Hdr")]
    ...
    pub ssn_mgmt_rspn: SessionManagementResponse9,
...
impl Validate for SaleToPOISessionManagementResponseV08 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.006.001.08")]
pub struct SessionManagementResponse9 {
    #[yaserde(rename = "Envt")]
    #[cfg_attr(feature = "serde", serde(rename = "Envt"))]
    pub envt: CardPaymentEnvironment82,
...
impl Validate for SessionManagementResponse9 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.006.001.08")]
pub struct StatusReportContent15 {
    #[yaserde(rename = "POICpblties")]
    #[cfg_attr(feature = "serde", serde(rename = "POICpblties"))]
    pub poi_cpblties: PointOfInteractionCapabilities11,

    #[yaserde(rename = "POICmpnt")]
    #[cfg_attr(feature = "serde", serde(rename = "POICmpnt"))]
    pub poi_cmpnt: Vec<PointOfInteractionComponent18>,
    ...
    pub data_set_reqrd: Vec<DataSetRequest7>,

    #[yaserde(rename = "Evt")]
    #[cfg_attr(feature = "serde", serde(rename = "Evt"))]
    pub evt: Vec<Tmsevent13>,
...
impl Validate for StatusReportContent15 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.006.001.08")]
pub struct TmsactionIdentification10 {
...
impl Validate for TmsactionIdentification10 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.006.001.08")]
pub struct Tmsevent13 {
    ...
    pub actn_id: TmsactionIdentification10,
    ...
    pub dvc_rspn: DeviceResponse9,
}

impl Validate for Tmsevent13 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "casp.006.001.08";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:casp.006.001.08";
}
