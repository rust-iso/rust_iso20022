...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.001.001.08")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.001.001.08")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.001.001.08")]
pub struct BalanceInquiryRequest9 {
    ...
    pub llty_acct_req: LoyaltyAccountRequest3,

    #[yaserde(rename = "StordValAcctReq")]
    #[cfg_attr(feature = "serde", serde(rename = "StordValAcctReq"))]
    pub stord_val_acct_req: StoredValueRequest9,
}

impl Validate for BalanceInquiryRequest9 {}
...
pub struct BatchRequest8 {
    ...
    pub tx_to_prfrm: Vec<TransactionToPerform8Choice>,
}

impl Validate for BatchRequest8 {}
...
impl Validate for CardAcquisitionRequest3 {}
...
pub struct Document {
    ...
    pub sale_to_poi_svc_req: SaleToPOIServiceRequestV08,
}
...
impl Validate for EnableServiceRequest7 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.001.001.08")]
pub struct LoyaltyAccountRequest3 {
...
impl Validate for LoyaltyAccountRequest3 {}
...
pub struct LoyaltyRequest8 {
    ...
    pub tx: LoyaltyTransaction8,

    #[yaserde(rename = "Data")]
    #[cfg_attr(feature = "serde", serde(rename = "Data"))]
    pub data: Vec<LoyaltyRequestData3>,
}

impl Validate for LoyaltyRequest8 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.001.001.08")]
pub struct LoyaltyRequestData3 {
    #[yaserde(rename = "CstmrOrdr")]
    #[cfg_attr(feature = "serde", serde(rename = "CstmrOrdr"))]
    pub cstmr_ordr: CustomerOrder1,
...
impl Validate for LoyaltyRequestData3 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.001.001.08")]
pub struct LoyaltyTransaction8 {
    #[yaserde(rename = "SaleTxId")]
    #[cfg_attr(feature = "serde", serde(rename = "SaleTxId"))]
    pub sale_tx_id: TransactionIdentifier1,
...
impl Validate for LoyaltyTransaction8 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.001.001.08")]
pub struct PaymentRequest8 {
    #[yaserde(rename = "PmtTx")]
    #[cfg_attr(feature = "serde", serde(rename = "PmtTx"))]
    pub pmt_tx: PaymentTransaction183,

    #[yaserde(rename = "LltyData")]
    #[cfg_attr(feature = "serde", serde(rename = "LltyData"))]
    pub llty_data: Vec<LoyaltyRequestData3>,
}

impl Validate for PaymentRequest8 {}
...
impl Validate for ReversalRequest8 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.001.001.08")]
pub struct SaleToPOIServiceRequestV08 {
    #[yaserde(rename = "Hdr")]
...
impl Validate for SaleToPOIServiceRequestV08 {}
...
impl Validate for ServiceRequest9 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.001.001.08")]
pub struct StoredValueRequest9 {
    #[yaserde(rename = "SaleTxId")]
    #[cfg_attr(feature = "serde", serde(rename = "SaleTxId"))]
    pub sale_tx_id: TransactionIdentifier1,
    ...
    #[yaserde(rename = "Data")]
    #[cfg_attr(feature = "serde", serde(rename = "Data"))]
    pub data: Vec<StoredValueData9>,
}

impl Validate for StoredValueRequest9 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.001.001.08")]
pub struct TransactionToPerform8Choice {
    #[yaserde(rename = "PmtReq")]
    #[cfg_attr(feature = "serde", serde(rename = "PmtReq"))]
    pub pmt_req: Option<PaymentRequest8>,
    #[yaserde(rename = "LltyReq")]
    #[cfg_attr(feature = "serde", serde(rename = "LltyReq"))]
    pub llty_req: Option<LoyaltyRequest8>,
    #[yaserde(rename = "RvslReq")]
    #[cfg_attr(feature = "serde", serde(rename = "RvslReq"))]
    pub rvsl_req: Option<ReversalRequest8>,
}

impl Validate for TransactionToPerform8Choice {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "casp.001.001.08";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:casp.001.001.08";
}
