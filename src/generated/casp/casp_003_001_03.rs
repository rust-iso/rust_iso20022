...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.003.001.03")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.003.001.03")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.003.001.03")]
pub struct Document {
    #[yaserde(rename = "SaleToPOIRcncltnReq")]
    #[cfg_attr(feature = "serde", serde(rename = "SaleToPOIRcncltnReq"))]
    pub sale_to_poi_rcncltn_req: SaleToPOIReconciliationRequestV03,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.003.001.03")]
pub struct ReconciliationRequest4 {
    #[yaserde(rename = "Envt")]
    ...
    #[yaserde(rename = "RcncltnReqData")]
    #[cfg_attr(feature = "serde", serde(rename = "RcncltnReqData"))]
    pub rcncltn_req_data: ReconciliationRequestData1,
...
impl Validate for ReconciliationRequest4 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.003.001.03")]
pub struct ReconciliationRequestData1 {
    #[yaserde(rename = "RcncltnTp")]
    #[cfg_attr(feature = "serde", serde(rename = "RcncltnTp"))]
    pub rcncltn_tp: ReconciliationType1Code,
...
impl Validate for ReconciliationRequestData1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.003.001.03")]

pub enum ReconciliationType1Code {
    #[yaserde(rename = "AREC")]
    #[cfg_attr(feature = "serde", serde(rename = "AREC"))]
    Arec,
    #[yaserde(rename = "ASYN")]
    #[cfg_attr(feature = "serde", serde(rename = "ASYN"))]
    Asyn,
    #[yaserde(rename = "PREC")]
    #[cfg_attr(feature = "serde", serde(rename = "PREC"))]
    Prec,
    #[yaserde(rename = "SREC")]
    #[cfg_attr(feature = "serde", serde(rename = "SREC"))]
    Srec,
    __Unknown__(String),
}

impl Default for ReconciliationType1Code {
    fn default() -> ReconciliationType1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ReconciliationType1Code {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.003.001.03")]
pub struct SaleToPOIReconciliationRequestV03 {
    #[yaserde(rename = "Hdr")]
    #[cfg_attr(feature = "serde", serde(rename = "Hdr"))]
    pub hdr: Header41,

    #[yaserde(rename = "RcncltnReq")]
    #[cfg_attr(feature = "serde", serde(rename = "RcncltnReq"))]
    pub rcncltn_req: ReconciliationRequest4,
...
impl Validate for SaleToPOIReconciliationRequestV03 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "casp.003.001.03";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:casp.003.001.03";
}
