...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.005.001.03")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.005.001.03")]
...
pub enum CustomerOrderRequest1Code {
    #[yaserde(rename = "BOTH")]
...
impl Default for CustomerOrderRequest1Code {
    fn default() -> CustomerOrderRequest1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for CustomerOrderRequest1Code {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.005.001.03")]
pub struct DiagnosisRequest1 {
    #[yaserde(rename = "HstDgnssFlg")]
    #[cfg_attr(feature = "serde", serde(rename = "HstDgnssFlg"))]
    pub hst_dgnss_flg: TrueFalseIndicator,

    #[yaserde(rename = "AcqrrId")]
    #[cfg_attr(feature = "serde", serde(rename = "AcqrrId"))]
    pub acqrr_id: Vec<Max35Text>,
}

impl Validate for DiagnosisRequest1 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.005.001.03")]
pub struct Document {
    #[yaserde(rename = "SaleToPOISsnMgmtReq")]
    #[cfg_attr(feature = "serde", serde(rename = "SaleToPOISsnMgmtReq"))]
    pub sale_to_poi_ssn_mgmt_req: SaleToPOISessionManagementRequestV03,
}
...
pub struct LoginRequest3 {
    #[yaserde(rename = "LgnDtTm")]
    #[cfg_attr(feature = "serde", serde(rename = "LgnDtTm"))]
    pub lgn_dt_tm: IsodateTime,

    #[yaserde(rename = "SaleSftwr")]
    #[cfg_attr(feature = "serde", serde(rename = "SaleSftwr"))]
    pub sale_sftwr: Vec<PointOfInteractionComponent11>,

    #[yaserde(rename = "SaleTermnlData")]
    #[cfg_attr(feature = "serde", serde(rename = "SaleTermnlData"))]
    pub sale_termnl_data: SaleTerminalData1,

    #[yaserde(rename = "TrngMdFlg")]
    #[cfg_attr(feature = "serde", serde(rename = "TrngMdFlg"))]
    pub trng_md_flg: TrueFalseIndicator,
    ...
    pub cshr_lang: LanguageCode,

    #[yaserde(rename = "ShftNb")]
    #[cfg_attr(feature = "serde", serde(rename = "ShftNb"))]
    pub shft_nb: Max2NumericText,

    #[yaserde(rename = "TknReqdTp")]
    #[cfg_attr(feature = "serde", serde(rename = "TknReqdTp"))]
    pub tkn_reqd_tp: SaleTokenScope1Code,

    #[yaserde(rename = "CstmrOrdrReq")]
    #[cfg_attr(feature = "serde", serde(rename = "CstmrOrdrReq"))]
    pub cstmr_ordr_req: CustomerOrderRequest1Code,

    #[yaserde(rename = "POIId")]
    #[cfg_attr(feature = "serde", serde(rename = "POIId"))]
    pub poi_id: PointOfInteractionComponentIdentification2,

    #[yaserde(rename = "TtlsGrpId")]
    #[cfg_attr(feature = "serde", serde(rename = "TtlsGrpId"))]
    pub ttls_grp_id: Max35Text,
...
impl Validate for LoginRequest3 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.005.001.03")]
pub struct LogoutRequest1 {
    #[yaserde(rename = "MntncAllwd")]
    #[cfg_attr(feature = "serde", serde(rename = "MntncAllwd"))]
    pub mntnc_allwd: TrueFalseIndicator,
}

impl Validate for LogoutRequest1 {}
...
impl Default for RetailerService4Code {
    fn default() -> RetailerService4Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for RetailerService4Code {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.005.001.03")]
pub struct SaleTerminalData1 {
    #[yaserde(rename = "TermnlEnvt")]
    #[cfg_attr(feature = "serde", serde(rename = "TermnlEnvt"))]
    pub termnl_envt: AttendanceContext1Code,
...
impl Validate for SaleTerminalData1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.005.001.03")]
pub struct SaleToPOISessionManagementRequestV03 {
    #[yaserde(rename = "Hdr")]
    #[cfg_attr(feature = "serde", serde(rename = "Hdr"))]
    pub hdr: Header41,

    #[yaserde(rename = "SsnMgmtReq")]
    #[cfg_attr(feature = "serde", serde(rename = "SsnMgmtReq"))]
    pub ssn_mgmt_req: SessionManagementRequest4,
...
impl Validate for SaleToPOISessionManagementRequestV03 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.005.001.03")]
pub struct SessionManagementRequest4 {
    #[yaserde(rename = "Envt")]
    ...
    pub svc_cntt: RetailerService4Code,

    #[yaserde(rename = "LgnReq")]
    #[cfg_attr(feature = "serde", serde(rename = "LgnReq"))]
    pub lgn_req: LoginRequest3,

    #[yaserde(rename = "LgtReq")]
    #[cfg_attr(feature = "serde", serde(rename = "LgtReq"))]
    pub lgt_req: LogoutRequest1,

    #[yaserde(rename = "DgnssReq")]
    #[cfg_attr(feature = "serde", serde(rename = "DgnssReq"))]
    pub dgnss_req: DiagnosisRequest1,
...
impl Validate for SessionManagementRequest4 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "casp.005.001.03";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:casp.005.001.03";
}
