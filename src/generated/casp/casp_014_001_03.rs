...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.014.001.03")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.014.001.03")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.014.001.03")]
pub struct Document {
    #[yaserde(rename = "SaleToPOIMsgStsReq")]
    #[cfg_attr(feature = "serde", serde(rename = "SaleToPOIMsgStsReq"))]
    pub sale_to_poi_msg_sts_req: SaleToPOIMessageStatusRequestV03,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.014.001.03")]
pub struct MessageStatusRequest4 {
    #[yaserde(rename = "Envt")]
    ...
    #[yaserde(rename = "MsgStsReqData")]
    #[cfg_attr(feature = "serde", serde(rename = "MsgStsReqData"))]
    pub msg_sts_req_data: MessageStatusRequestData2,
...
impl Validate for MessageStatusRequest4 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.014.001.03")]
pub struct MessageStatusRequestData2 {
    #[yaserde(rename = "XchgId")]
    #[cfg_attr(feature = "serde", serde(rename = "XchgId"))]
    pub xchg_id: Max35Text,
    ...
    #[yaserde(rename = "RctRprntFlg")]
    #[cfg_attr(feature = "serde", serde(rename = "RctRprntFlg"))]
    pub rct_rprnt_flg: TrueFalseIndicator,

    #[yaserde(rename = "DocQlfr")]
    #[cfg_attr(feature = "serde", serde(rename = "DocQlfr"))]
    pub doc_qlfr: Vec<DocumentType7Code>,
}

impl Validate for MessageStatusRequestData2 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.014.001.03")]
pub struct SaleToPOIMessageStatusRequestV03 {
    #[yaserde(rename = "Hdr")]
    #[cfg_attr(feature = "serde", serde(rename = "Hdr"))]
    pub hdr: Header41,

    #[yaserde(rename = "StsReq")]
    #[cfg_attr(feature = "serde", serde(rename = "StsReq"))]
    pub sts_req: MessageStatusRequest4,
...
impl Validate for SaleToPOIMessageStatusRequestV03 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "casp.014.001.03";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:casp.014.001.03";
}
