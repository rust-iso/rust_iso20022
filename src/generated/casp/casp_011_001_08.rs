...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.011.001.08")]
pub struct AbortData7 {
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.011.001.08")]
...
pub struct Document {
    ...
    pub sale_to_poi_abrt: SaleToPOIAbortV08,
}
...
impl Validate for SaleToPOIAbortV08 {}
...
impl Validate for SystemAbort9 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "casp.011.001.08";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:casp.011.001.08";
}
