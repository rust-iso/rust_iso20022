...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.012.001.03")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.012.001.03")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.012.001.03")]
pub struct Document {
    #[yaserde(rename = "SaleToPOIEvtNtfctn")]
    #[cfg_attr(feature = "serde", serde(rename = "SaleToPOIEvtNtfctn"))]
    pub sale_to_poi_evt_ntfctn: SaleToPOIEventNotificationV03,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.012.001.03")]
pub struct EventContext3 {
    #[yaserde(rename = "SvcTp")]
    #[cfg_attr(feature = "serde", serde(rename = "SvcTp"))]
    pub svc_tp: RetailerService1Code,

    #[yaserde(rename = "CmpntId")]
    #[cfg_attr(feature = "serde", serde(rename = "CmpntId"))]
    pub cmpnt_id: PointOfInteractionComponent11,
...
impl Validate for EventContext3 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.012.001.03")]
pub struct EventNotificationData3 {
    #[yaserde(rename = "RtlrEvt")]
    #[cfg_attr(feature = "serde", serde(rename = "RtlrEvt"))]
    pub rtlr_evt: RetailerEvent3,

    #[yaserde(rename = "MntncReqrdFlg")]
    #[cfg_attr(feature = "serde", serde(rename = "MntncReqrdFlg"))]
    pub mntnc_reqrd_flg: TrueFalseIndicator,
...
impl Validate for EventNotificationData3 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.012.001.03")]

pub enum EventToNotify2Code {
    #[yaserde(rename = "ABRT")]
    #[cfg_attr(feature = "serde", serde(rename = "ABRT"))]
    Abrt,
    #[yaserde(rename = "MAIB")]
    #[cfg_attr(feature = "serde", serde(rename = "MAIB"))]
    Maib,
    #[yaserde(rename = "CRDI")]
    ...
    Crdr,
    #[yaserde(rename = "CUSL")]
    #[cfg_attr(feature = "serde", serde(rename = "CUSL"))]
    Cusl,
    #[yaserde(rename = "MAIE")]
    #[cfg_attr(feature = "serde", serde(rename = "MAIE"))]
    Maie,
    #[yaserde(rename = "INIT")]
    #[cfg_attr(feature = "serde", serde(rename = "INIT"))]
    Init,
    #[yaserde(rename = "KEYP")]
    #[cfg_attr(feature = "serde", serde(rename = "KEYP"))]
    Keyp,
    #[yaserde(rename = "MAIR")]
    #[cfg_attr(feature = "serde", serde(rename = "MAIR"))]
    Mair,
    #[yaserde(rename = "OODR")]
    #[cfg_attr(feature = "serde", serde(rename = "OODR"))]
    Oodr,
    #[yaserde(rename = "SADM")]
    #[cfg_attr(feature = "serde", serde(rename = "SADM"))]
    Sadm,
    #[yaserde(rename = "SWUP")]
    #[cfg_attr(feature = "serde", serde(rename = "SWUP"))]
    Swup,
    #[yaserde(rename = "SECA")]
    #[cfg_attr(feature = "serde", serde(rename = "SECA"))]
    Seca,
    #[yaserde(rename = "SHUT")]
    #[cfg_attr(feature = "serde", serde(rename = "SHUT"))]
    Shut,
    #[yaserde(rename = "SASS")]
    #[cfg_attr(feature = "serde", serde(rename = "SASS"))]
    Sass,
    #[yaserde(rename = "DISC")]
    #[cfg_attr(feature = "serde", serde(rename = "DISC"))]
    Disc,
    #[yaserde(rename = "CNTN")]
    #[cfg_attr(feature = "serde", serde(rename = "CNTN"))]
    Cntn,
    #[yaserde(rename = "TNOK")]
    #[cfg_attr(feature = "serde", serde(rename = "TNOK"))]
    Tnok,
    #[yaserde(rename = "TNKO")]
    #[cfg_attr(feature = "serde", serde(rename = "TNKO"))]
    Tnko,
    __Unknown__(String),
}

impl Default for EventToNotify2Code {
    fn default() -> EventToNotify2Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for EventToNotify2Code {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.012.001.03")]
pub struct RetailerEvent3 {
    #[yaserde(rename = "EvtTmStmp")]
    #[cfg_attr(feature = "serde", serde(rename = "EvtTmStmp"))]
    pub evt_tm_stmp: IsodateTime,

    #[yaserde(rename = "EvtToNtfy")]
    #[cfg_attr(feature = "serde", serde(rename = "EvtToNtfy"))]
    pub evt_to_ntfy: EventToNotify2Code,

    #[yaserde(rename = "EvtCntxt")]
    #[cfg_attr(feature = "serde", serde(rename = "EvtCntxt"))]
    pub evt_cntxt: EventContext3,

    #[yaserde(rename = "AddtlEvtInf")]
    #[cfg_attr(feature = "serde", serde(rename = "AddtlEvtInf"))]
    pub addtl_evt_inf: Max1025Text,
}

impl Validate for RetailerEvent3 {}
...
pub enum RetailerService1Code {
    #[yaserde(rename = "DCAQ")]
    #[cfg_attr(feature = "serde", serde(rename = "DCAQ"))]
    Dcaq,
    #[yaserde(rename = "ADAQ")]
    #[cfg_attr(feature = "serde", serde(rename = "ADAQ"))]
    Adaq,
    #[yaserde(rename = "ADAP")]
    #[cfg_attr(feature = "serde", serde(rename = "ADAP"))]
    Adap,
    #[yaserde(rename = "RPAP")]
    #[cfg_attr(feature = "serde", serde(rename = "RPAP"))]
    Rpap,
    #[yaserde(rename = "RPAQ")]
    #[cfg_attr(feature = "serde", serde(rename = "RPAQ"))]
    Rpaq,
    #[yaserde(rename = "RPTQ")]
    #[cfg_attr(feature = "serde", serde(rename = "RPTQ"))]
    Rptq,
    #[yaserde(rename = "RPTP")]
    #[cfg_attr(feature = "serde", serde(rename = "RPTP"))]
    Rptp,
    #[yaserde(rename = "SMDQ")]
    #[cfg_attr(feature = "serde", serde(rename = "SMDQ"))]
    Smdq,
    #[yaserde(rename = "SMDP")]
    #[cfg_attr(feature = "serde", serde(rename = "SMDP"))]
    Smdp,
    #[yaserde(rename = "SMIQ")]
    #[cfg_attr(feature = "serde", serde(rename = "SMIQ"))]
    Smiq,
    #[yaserde(rename = "SMIP")]
    #[cfg_attr(feature = "serde", serde(rename = "SMIP"))]
    Smip,
    #[yaserde(rename = "SMOQ")]
    #[cfg_attr(feature = "serde", serde(rename = "SMOQ"))]
    Smoq,
    #[yaserde(rename = "SMOP")]
    ...
    Ssen,
    #[yaserde(rename = "SSRR")]
    #[cfg_attr(feature = "serde", serde(rename = "SSRR"))]
    Ssrr,
    #[yaserde(rename = "SSSQ")]
    #[cfg_attr(feature = "serde", serde(rename = "SSSQ"))]
    Sssq,
    #[yaserde(rename = "SSSP")]
    #[cfg_attr(feature = "serde", serde(rename = "SSSP"))]
    Sssp,
    __Unknown__(String),
}

impl Default for RetailerService1Code {
    fn default() -> RetailerService1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for RetailerService1Code {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.012.001.03")]
pub struct SaleToPOIEventNotificationV03 {
    #[yaserde(rename = "Hdr")]
    #[cfg_attr(feature = "serde", serde(rename = "Hdr"))]
    pub hdr: Header41,

    #[yaserde(rename = "EvtNtfctn")]
    #[cfg_attr(feature = "serde", serde(rename = "EvtNtfctn"))]
    pub evt_ntfctn: SystemEventNotification4,
...
impl Validate for SaleToPOIEventNotificationV03 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:casp.012.001.03")]
pub struct SystemEventNotification4 {
    #[yaserde(rename = "Envt")]
    ...
    #[yaserde(rename = "EvtNtfctn")]
    #[cfg_attr(feature = "serde", serde(rename = "EvtNtfctn"))]
    pub evt_ntfctn: EventNotificationData3,
...
impl Validate for SystemEventNotification4 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "casp.012.001.03";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:casp.012.001.03";
}
