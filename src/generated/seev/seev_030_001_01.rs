...
pub struct AgentCADeactivationStatusAdviceV01 {
    #[yaserde(rename = "Id")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.030.001.01")]
pub struct CorporateActionDeactivationCancellationProcessingStatus1 {
    #[yaserde(rename = "Sts")]
...
impl Validate for CorporateActionDeactivationCancellationProcessingStatus1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.030.001.01")]
pub struct CorporateActionDeactivationCancellationRejectionStatus1 {
    #[yaserde(rename = "Rsn")]
    #[cfg_attr(feature = "serde", serde(rename = "Rsn"))]
    pub rsn: Vec<RejectionReason7FormatChoice>,
...
impl Validate for CorporateActionDeactivationCancellationRejectionStatus1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.030.001.01")]

pub enum CorporateActionDeactivationCancellationStatus1ChoiceChoice {
    PrcdSts(CorporateActionDeactivationCancellationProcessingStatus1),
    RjctdSts(CorporateActionDeactivationCancellationRejectionStatus1),
    __Unknown__(String),
}

impl Default for CorporateActionDeactivationCancellationStatus1ChoiceChoice {
    fn default() -> CorporateActionDeactivationCancellationStatus1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for CorporateActionDeactivationCancellationStatus1ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.030.001.01")]
pub struct CorporateActionDeactivationCancellationStatus1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub corporate_action_deactivation_cancellation_status_1_choice_choice: CorporateActionDeactivationCancellationStatus1ChoiceChoice,
}

impl Validate for CorporateActionDeactivationCancellationStatus1Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.030.001.01")]
pub struct CorporateActionDeactivationInstructionProcessingStatus1 {
    #[yaserde(rename = "Sts")]
    #[cfg_attr(feature = "serde", serde(rename = "Sts"))]
    pub sts: ProcessedStatus6FormatChoice,
...
impl Validate for CorporateActionDeactivationInstructionProcessingStatus1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.030.001.01")]
pub struct CorporateActionDeactivationInstructionRejectionStatus1 {
    #[yaserde(rename = "Rsn")]
    #[cfg_attr(feature = "serde", serde(rename = "Rsn"))]
    pub rsn: Vec<RejectionReason12FormatChoice>,
...
impl Validate for CorporateActionDeactivationInstructionRejectionStatus1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.030.001.01")]
pub struct CorporateActionDeactivationInstructionStatus1 {
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.030.001.01")]
pub struct Document {
    #[yaserde(rename = "AgtCADeactvtnStsAdvc")]
    #[cfg_attr(feature = "serde", serde(rename = "AgtCADeactvtnStsAdvc"))]
    pub agt_ca_deactvtn_sts_advc: AgentCADeactivationStatusAdviceV01,
}
...
impl Default for ProcessedStatus6Code {
    fn default() -> ProcessedStatus6Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ProcessedStatus6Code {}
...
pub enum ProcessedStatus6FormatChoiceChoice {
    Cd(ProcessedStatus6Code),
    Prtry(GenericIdentification13),
    __Unknown__(String),
}

impl Default for ProcessedStatus6FormatChoiceChoice {
    fn default() -> ProcessedStatus6FormatChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ProcessedStatus6FormatChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.030.001.01")]
pub struct ProcessedStatus6FormatChoice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub processed_status_6_format_choice_choice: ProcessedStatus6FormatChoiceChoice,
}

impl Validate for ProcessedStatus6FormatChoice {}
...
pub enum RejectionReason12Code {
    #[yaserde(rename = "DEAC")]
    #[cfg_attr(feature = "serde", serde(rename = "DEAC"))]
    Deac,
    #[yaserde(rename = "FAIL")]
    ...
    Agin,
    #[yaserde(rename = "MAIN")]
    #[cfg_attr(feature = "serde", serde(rename = "MAIN"))]
    Main,
    #[yaserde(rename = "OPTI")]
    ...
    Peda,
    #[yaserde(rename = "NORO")]
    #[cfg_attr(feature = "serde", serde(rename = "NORO"))]
    Noro,
    #[yaserde(rename = "INET")]
...
impl Default for RejectionReason12Code {
    fn default() -> RejectionReason12Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for RejectionReason12Code {}
...
pub enum RejectionReason12FormatChoiceChoice {
    Cd(RejectionReason12Code),
    Prtry(GenericIdentification13),
    __Unknown__(String),
}

impl Default for RejectionReason12FormatChoiceChoice {
    fn default() -> RejectionReason12FormatChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for RejectionReason12FormatChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.030.001.01")]
pub struct RejectionReason12FormatChoice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub rejection_reason_12_format_choice_choice: RejectionReason12FormatChoiceChoice,
}

impl Validate for RejectionReason12FormatChoice {}
...
pub enum RejectionReason7Code {
    ...
    Fail,
    #[yaserde(rename = "PDEA")]
    #[cfg_attr(feature = "serde", serde(rename = "PDEA"))]
    Pdea,
    #[yaserde(rename = "INID")]
    ...
    Said,
    #[yaserde(rename = "DEAO")]
    #[cfg_attr(feature = "serde", serde(rename = "DEAO"))]
    Deao,
    #[yaserde(rename = "INET")]
    #[cfg_attr(feature = "serde", serde(rename = "INET"))]
    Inet,
...
impl Default for RejectionReason7Code {
    fn default() -> RejectionReason7Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for RejectionReason7Code {}
...
pub enum RejectionReason7FormatChoiceChoice {
    Cd(RejectionReason7Code),
    Prtry(GenericIdentification13),
    __Unknown__(String),
}

impl Default for RejectionReason7FormatChoiceChoice {
    fn default() -> RejectionReason7FormatChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for RejectionReason7FormatChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.030.001.01")]
pub struct RejectionReason7FormatChoice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub rejection_reason_7_format_choice_choice: RejectionReason7FormatChoiceChoice,
}

impl Validate for RejectionReason7FormatChoice {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "seev.030.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:seev.030.001.01";
}
