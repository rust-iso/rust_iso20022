...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.065.001.01")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.065.001.01")]

pub enum AllegementRemovalReason1Code {
    #[yaserde(rename = "CANC")]
...
impl Default for AllegementRemovalReason1Code {
    fn default() -> AllegementRemovalReason1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for AllegementRemovalReason1Code {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.065.001.01")]
pub struct BuyerProtectionInstructionAllegementRemovalAdviceV01 {
    #[yaserde(rename = "PrcrTxId")]
    #[cfg_attr(feature = "serde", serde(rename = "PrcrTxId"))]
    pub prcr_tx_id: Max35Text,

    #[yaserde(rename = "AllgmtRmvlRsn")]
    #[cfg_attr(feature = "serde", serde(rename = "AllgmtRmvlRsn"))]
    pub allgmt_rmvl_rsn: AllegementRemovalReason1Code,
...
impl Validate for BuyerProtectionInstructionAllegementRemovalAdviceV01 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.065.001.01")]
pub struct Document {
    #[yaserde(rename = "BuyrPrtcnInstrAllgmtRmvlAdvc")]
    #[cfg_attr(feature = "serde", serde(rename = "BuyrPrtcnInstrAllgmtRmvlAdvc"))]
    pub buyr_prtcn_instr_allgmt_rmvl_advc: BuyerProtectionInstructionAllegementRemovalAdviceV01,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "seev.065.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:seev.065.001.01";
}
