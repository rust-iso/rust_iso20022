...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.008.001.10")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.008.001.10")]
...
pub struct Document {
    ...
    pub mtg_rslt_dssmntn: MeetingResultDisseminationV10,
}
...
impl Validate for EligiblePosition20 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.008.001.10")]
pub struct MeetingResultDisseminationV10 {
    #[yaserde(rename = "Pgntn")]
    #[cfg_attr(feature = "serde", serde(rename = "Pgntn"))]
    pub pgntn: Pagination1,

    #[yaserde(rename = "MtgRsltDssmntnId")]
    #[cfg_attr(feature = "serde", serde(rename = "MtgRsltDssmntnId"))]
    pub mtg_rslt_dssmntn_id: Max35Text,
...
impl Validate for MeetingResultDisseminationV10 {}
...
pub struct Participation6 {
    ...
    pub pctg_of_vtng_rghts: Percentage14Rate,
...
impl Validate for Participation6 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.008.001.10")]
...
pub struct SecurityPosition22 {
    ...
    pub pos: Vec<EligiblePosition20>,
}

impl Validate for SecurityPosition22 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "seev.008.001.10";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:seev.008.001.10";
}
