...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.012.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.012.001.01")]
...
pub struct AgentCAElectionAdviceV01 {
    ...
    #[yaserde(rename = "ElctnAdvcTpAndLkg")]
    #[cfg_attr(feature = "serde", serde(rename = "ElctnAdvcTpAndLkg"))]
    ...
    #[yaserde(rename = "ElctnDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "ElctnDtls"))]
    pub elctn_dtls: CorporateActionElection3,

    #[yaserde(rename = "AddtlInf")]
    #[cfg_attr(feature = "serde", serde(rename = "AddtlInf"))]
    pub addtl_inf: CorporateActionAdditionalInformation1,
...
impl Validate for AgentCAElectionAdviceV01 {}
...
pub struct CorporateActionCashMovements2 {
    #[yaserde(rename = "PstngId")]
    #[cfg_attr(feature = "serde", serde(rename = "PstngId"))]
    pub pstng_id: Max35Text,
...
impl Validate for CorporateActionCashMovements2 {}
...
pub struct CorporateActionElection3 {
    ...
    #[yaserde(rename = "InstdUndrlygSctiesQty")]
    #[cfg_attr(feature = "serde", serde(rename = "InstdUndrlygSctiesQty"))]
    pub instd_undrlyg_scties_qty: UnitOrFaceAmount1Choice,

    #[yaserde(rename = "InstdSctiesQtyToRcv")]
    #[cfg_attr(feature = "serde", serde(rename = "InstdSctiesQtyToRcv"))]
    pub instd_scties_qty_to_rcv: UnitOrFaceAmount1Choice,
...
impl Validate for CorporateActionElection3 {}
...
impl Validate for CorporateActionSecuritiesMovement2 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.012.001.01")]
pub struct Document {
    #[yaserde(rename = "AgtCAElctnAdvc")]
    #[cfg_attr(feature = "serde", serde(rename = "AgtCAElctnAdvc"))]
...
pub struct ElectionAdviceFunction1 {
    ...
    #[yaserde(rename = "PrvsAgtCAElctnAdvcId")]
    #[cfg_attr(feature = "serde", serde(rename = "PrvsAgtCAElctnAdvcId"))]
    pub prvs_agt_ca_elctn_advc_id: DocumentIdentification8,

    #[yaserde(rename = "AgtCAElctnStsAdvcId")]
    #[cfg_attr(feature = "serde", serde(rename = "AgtCAElctnStsAdvcId"))]
    pub agt_ca_elctn_sts_advc_id: DocumentIdentification8,

    #[yaserde(rename = "AgtCAElctnAmdmntReqId")]
    #[cfg_attr(feature = "serde", serde(rename = "AgtCAElctnAmdmntReqId"))]
    pub agt_ca_elctn_amdmnt_req_id: DocumentIdentification8,
}

impl Validate for ElectionAdviceFunction1 {}
...
impl Default for ElectionType1Code {
    fn default() -> ElectionType1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ElectionType1Code {}
...
impl Validate for SecuritiesAccount9 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "seev.012.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:seev.012.001.01";
}
