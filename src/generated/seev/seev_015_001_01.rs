...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.015.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.015.001.01")]
pub struct AgentCAElectionStatusAdviceV01 {
    #[yaserde(rename = "Id")]
    ...
    pub agent_ca_election_status_advice_v01_choice: agent_ca_election_status_advice_v01::AgentCAElectionStatusAdviceV01Choice,
    ...
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub agent_ca_election_status_advice_v01_choice_2: agent_ca_election_status_advice_v01::AgentCAElectionStatusAdviceV01Choice2,
}

impl Validate for AgentCAElectionStatusAdviceV01 {}

pub mod agent_ca_election_status_advice_v01 {
    use super::*;
    
    #[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
    #[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.015.001.01")]

    pub enum AgentCAElectionStatusAdviceV01Choice {
        AgtCAElctnAdvcId(DocumentIdentification8),
        AgtCAElctnCxlReqId(DocumentIdentification8),
        AgtCAElctnAmdmntReqId(DocumentIdentification8),
        __Unknown__(String),
    }

    impl Default for AgentCAElectionStatusAdviceV01Choice {
        fn default() -> AgentCAElectionStatusAdviceV01Choice {
            Self::__Unknown__("No valid variants".into())
        }
    }

    impl Validate for AgentCAElectionStatusAdviceV01Choice {}

    #[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
    #[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.015.001.01")]

    pub enum AgentCAElectionStatusAdviceV01Choice2 {
        ElctnAdvcSts(ElectionAdviceStatus1Choice),
        ElctnCxlReqSts(ElectionCancellationStatus1Choice),
        ElctnAmdmntReqSts(ElectionAmendmentStatus1Choice),
        __Unknown__(String),
    }

    impl Default for AgentCAElectionStatusAdviceV01Choice2 {
        fn default() -> AgentCAElectionStatusAdviceV01Choice2 {
            Self::__Unknown__("No valid variants".into())
        }
    }

    impl Validate for AgentCAElectionStatusAdviceV01Choice2 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.015.001.01")]
pub struct CorporateActionAmendmentProcessingStatus1 {
    #[yaserde(rename = "Sts")]
...
impl Validate for CorporateActionAmendmentProcessingStatus1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.015.001.01")]
pub struct CorporateActionAmendmentRejectionStatus1 {
    #[yaserde(rename = "Rsn")]
    #[cfg_attr(feature = "serde", serde(rename = "Rsn"))]
    pub rsn: Vec<RejectionReason8FormatChoice>,
...
impl Validate for CorporateActionAmendmentRejectionStatus1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.015.001.01")]
pub struct CorporateActionCancellationProcessingStatus1 {
    #[yaserde(rename = "Sts")]
    #[cfg_attr(feature = "serde", serde(rename = "Sts"))]
    pub sts: ProcessedStatus5FormatChoice,
...
impl Validate for CorporateActionCancellationProcessingStatus1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.015.001.01")]
pub struct CorporateActionCancellationRejectionStatus1 {
    #[yaserde(rename = "Rsn")]
    #[cfg_attr(feature = "serde", serde(rename = "Rsn"))]
    pub rsn: Vec<RejectionReason9FormatChoice>,
...
impl Validate for CorporateActionCancellationRejectionStatus1 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.015.001.01")]
pub struct CorporateActionInstructionProcessingStatus1 {
    #[yaserde(rename = "Sts")]
    #[cfg_attr(feature = "serde", serde(rename = "Sts"))]
...
impl Validate for CorporateActionInstructionProcessingStatus1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.015.001.01")]
pub struct CorporateActionInstructionRejectionStatus1 {
    #[yaserde(rename = "Rsn")]
    #[cfg_attr(feature = "serde", serde(rename = "Rsn"))]
    pub rsn: Vec<RejectionReason18FormatChoice>,
...
impl Validate for CorporateActionInstructionRejectionStatus1 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.015.001.01")]
pub struct Document {
    #[yaserde(rename = "AgtCAElctnStsAdvc")]
    #[cfg_attr(feature = "serde", serde(rename = "AgtCAElctnStsAdvc"))]
    pub agt_ca_elctn_sts_advc: AgentCAElectionStatusAdviceV01,
}
...
pub enum ElectionAdviceStatus1ChoiceChoice {
    PrcdSts(CorporateActionInstructionProcessingStatus1),
    RjctdSts(CorporateActionInstructionRejectionStatus1),
    __Unknown__(String),
}

impl Default for ElectionAdviceStatus1ChoiceChoice {
    fn default() -> ElectionAdviceStatus1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ElectionAdviceStatus1ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.015.001.01")]
pub struct ElectionAdviceStatus1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub election_advice_status_1_choice_choice: ElectionAdviceStatus1ChoiceChoice,
}

impl Validate for ElectionAdviceStatus1Choice {}
...
pub enum ElectionAmendmentStatus1ChoiceChoice {
    PrcdSts(CorporateActionAmendmentProcessingStatus1),
    RjctdSts(CorporateActionAmendmentRejectionStatus1),
    __Unknown__(String),
}

impl Default for ElectionAmendmentStatus1ChoiceChoice {
    fn default() -> ElectionAmendmentStatus1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ElectionAmendmentStatus1ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.015.001.01")]
pub struct ElectionAmendmentStatus1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub election_amendment_status_1_choice_choice: ElectionAmendmentStatus1ChoiceChoice,
}

impl Validate for ElectionAmendmentStatus1Choice {}
...
pub enum ElectionCancellationStatus1ChoiceChoice {
    PrcdSts(CorporateActionCancellationProcessingStatus1),
    RjctdSts(CorporateActionCancellationRejectionStatus1),
    __Unknown__(String),
}

impl Default for ElectionCancellationStatus1ChoiceChoice {
    fn default() -> ElectionCancellationStatus1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ElectionCancellationStatus1ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.015.001.01")]
pub struct ElectionCancellationStatus1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub election_cancellation_status_1_choice_choice: ElectionCancellationStatus1ChoiceChoice,
}

impl Validate for ElectionCancellationStatus1Choice {}
...
pub enum RejectionReason18Code {
    #[yaserde(rename = "FAIL")]
...
impl Default for RejectionReason18Code {
    fn default() -> RejectionReason18Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for RejectionReason18Code {}
...
pub enum RejectionReason18FormatChoiceChoice {
    Cd(RejectionReason18Code),
    Prtry(GenericIdentification13),
    __Unknown__(String),
}

impl Default for RejectionReason18FormatChoiceChoice {
    fn default() -> RejectionReason18FormatChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for RejectionReason18FormatChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.015.001.01")]
pub struct RejectionReason18FormatChoice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub rejection_reason_18_format_choice_choice: RejectionReason18FormatChoiceChoice,
}

impl Validate for RejectionReason18FormatChoice {}
...
pub enum RejectionReason8Code {
    #[yaserde(rename = "NAMD")]
    #[cfg_attr(feature = "serde", serde(rename = "NAMD"))]
    Namd,
    #[yaserde(rename = "LATT")]
    #[cfg_attr(feature = "serde", serde(rename = "LATT"))]
    Latt,
...
impl Default for RejectionReason8Code {
    fn default() -> RejectionReason8Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for RejectionReason8Code {}
...
pub enum RejectionReason8FormatChoiceChoice {
    Cd(RejectionReason8Code),
    Prtry(GenericIdentification13),
    __Unknown__(String),
}

impl Default for RejectionReason8FormatChoiceChoice {
    fn default() -> RejectionReason8FormatChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for RejectionReason8FormatChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.015.001.01")]
pub struct RejectionReason8FormatChoice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub rejection_reason_8_format_choice_choice: RejectionReason8FormatChoiceChoice,
}

impl Validate for RejectionReason8FormatChoice {}
...
pub enum RejectionReason9Code {
    #[yaserde(rename = "NCAN")]
    #[cfg_attr(feature = "serde", serde(rename = "NCAN"))]
    Ncan,
    #[yaserde(rename = "LATT")]
    #[cfg_attr(feature = "serde", serde(rename = "LATT"))]
    Latt,
...
impl Default for RejectionReason9Code {
    fn default() -> RejectionReason9Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for RejectionReason9Code {}
...
pub enum RejectionReason9FormatChoiceChoice {
    Cd(RejectionReason9Code),
    Prtry(GenericIdentification13),
    __Unknown__(String),
}

impl Default for RejectionReason9FormatChoiceChoice {
    fn default() -> RejectionReason9FormatChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for RejectionReason9FormatChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.015.001.01")]
pub struct RejectionReason9FormatChoice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub rejection_reason_9_format_choice_choice: RejectionReason9FormatChoiceChoice,
}

impl Validate for RejectionReason9FormatChoice {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "seev.015.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:seev.015.001.01";
}
