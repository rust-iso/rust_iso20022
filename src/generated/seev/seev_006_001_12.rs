...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.006.001.12")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.006.001.12")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.006.001.12")]
pub struct CancellationStatus34Choice {
    #[yaserde(rename = "GblCxlSts")]
    #[cfg_attr(feature = "serde", serde(rename = "GblCxlSts"))]
    pub gbl_cxl_sts: Option<CancellationStatus35Choice>,
    #[yaserde(rename = "DtldCxlSts")]
    #[cfg_attr(feature = "serde", serde(rename = "DtldCxlSts"))]
    pub dtld_cxl_sts: Vec<DetailedInstructionCancellationStatus16>,
}

impl Validate for CancellationStatus34Choice {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.006.001.12")]
pub struct CancellationStatus35Choice {
    ...
    pub pdg_cxl: Option<PendingCancellationStatus19Choice>,
}

impl Validate for CancellationStatus35Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.006.001.12")]
pub struct DetailedInstructionCancellationStatus16 {
    ...
    pub instr_cxl_sts: CancellationStatus35Choice,
}

impl Validate for DetailedInstructionCancellationStatus16 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.006.001.12")]
pub struct DetailedInstructionStatus23 {
    ...
    pub instr_sts: InstructionStatus14Choice,
}

impl Validate for DetailedInstructionStatus23 {}
...
pub struct Document {
    ...
    pub mtg_instr_sts: MeetingInstructionStatusV12,
}
...
pub struct EligiblePosition17 {
    ...
    pub hldg_bal: Vec<HoldingBalance13>,
}

impl Validate for EligiblePosition17 {}
...
pub struct HoldingBalance13 {
    ...
    pub bal_tp: SecuritiesEntryType3Code,
}

impl Validate for HoldingBalance13 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.006.001.12")]
pub struct InstructionProcessingStatus6 {
    #[yaserde(rename = "Sts")]
    #[cfg_attr(feature = "serde", serde(rename = "Sts"))]
    pub sts: Status11Code,
...
impl Validate for InstructionProcessingStatus6 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.006.001.12")]
pub struct InstructionStatus14Choice {
    #[yaserde(rename = "PrcgSts")]
    #[cfg_attr(feature = "serde", serde(rename = "PrcgSts"))]
    pub prcg_sts: Option<InstructionProcessingStatus6>,
    #[yaserde(rename = "Rjctd")]
    #[cfg_attr(feature = "serde", serde(rename = "Rjctd"))]
    pub rjctd: Option<RejectedStatus66Choice>,
    #[yaserde(rename = "Pdg")]
    #[cfg_attr(feature = "serde", serde(rename = "Pdg"))]
    pub pdg: Option<PendingStatus84Choice>,
}

impl Validate for InstructionStatus14Choice {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.006.001.12")]
pub struct InstructionType2Choice {
    ...
    #[yaserde(rename = "InstrCxlId")]
    #[cfg_attr(feature = "serde", serde(rename = "InstrCxlId"))]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.006.001.12")]
pub struct InstructionTypeStatus8Choice {
    #[yaserde(rename = "InstrSts")]
    #[cfg_attr(feature = "serde", serde(rename = "InstrSts"))]
    pub instr_sts: Vec<DetailedInstructionStatus23>,
    #[yaserde(rename = "CxlSts")]
    #[cfg_attr(feature = "serde", serde(rename = "CxlSts"))]
    pub cxl_sts: Option<CancellationStatus34Choice>,
}

impl Validate for InstructionTypeStatus8Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.006.001.12")]
pub struct MeetingInstructionStatusV12 {
    ...
    pub instr_tp_sts: InstructionTypeStatus8Choice,

    #[yaserde(rename = "Pos")]
    #[cfg_attr(feature = "serde", serde(rename = "Pos"))]
    pub pos: EligiblePosition17,
...
impl Validate for MeetingInstructionStatusV12 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.006.001.12")]
pub struct PendingCancellationStatus19Choice {
    #[yaserde(rename = "NoSpcfdRsn")]
    #[cfg_attr(feature = "serde", serde(rename = "NoSpcfdRsn"))]
    pub no_spcfd_rsn: Option<NoReasonCode>,
    #[yaserde(rename = "Rsn")]
    #[cfg_attr(feature = "serde", serde(rename = "Rsn"))]
    pub rsn: Vec<PendingCancellationStatusReason14>,
}

impl Validate for PendingCancellationStatus19Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.006.001.12")]
pub struct PendingCancellationStatusReason14 {
...
impl Validate for PendingCancellationStatusReason14 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.006.001.12")]

pub enum PendingReason41Code {
    #[yaserde(rename = "ADEA")]
    #[cfg_attr(feature = "serde", serde(rename = "ADEA"))]
    Adea,
    #[yaserde(rename = "ADDM")]
...
impl Default for PendingReason41Code {
    fn default() -> PendingReason41Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for PendingReason41Code {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.006.001.12")]
pub struct PendingReason81Choice {
    #[yaserde(rename = "Cd")]
    #[cfg_attr(feature = "serde", serde(rename = "Cd"))]
    pub cd: Option<PendingReason41Code>,
    #[yaserde(rename = "Prtry")]
    #[cfg_attr(feature = "serde", serde(rename = "Prtry"))]
    pub prtry: Option<GenericIdentification30>,
}

impl Validate for PendingReason81Choice {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.006.001.12")]
pub struct PendingStatus84Choice {
    #[yaserde(rename = "NoSpcfdRsn")]
    #[cfg_attr(feature = "serde", serde(rename = "NoSpcfdRsn"))]
    pub no_spcfd_rsn: Option<NoReasonCode>,
    #[yaserde(rename = "Rsn")]
    #[cfg_attr(feature = "serde", serde(rename = "Rsn"))]
    pub rsn: Vec<PendingStatusReason34>,
}

impl Validate for PendingStatus84Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.006.001.12")]
pub struct PendingStatusReason34 {
    #[yaserde(rename = "RsnCd")]
    #[cfg_attr(feature = "serde", serde(rename = "RsnCd"))]
    pub rsn_cd: PendingReason81Choice,
...
impl Validate for PendingStatusReason34 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.006.001.12")]
pub struct RejectedReason70Choice {
    #[yaserde(rename = "Cd")]
    #[cfg_attr(feature = "serde", serde(rename = "Cd"))]
    pub cd: Option<RejectionReason91Code>,
    #[yaserde(rename = "Prtry")]
    #[cfg_attr(feature = "serde", serde(rename = "Prtry"))]
    pub prtry: Option<GenericIdentification30>,
}

impl Validate for RejectedReason70Choice {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.006.001.12")]
pub struct RejectedStatus31Choice {
    ...
    #[yaserde(rename = "Rsn")]
    #[cfg_attr(feature = "serde", serde(rename = "Rsn"))]
    pub rsn: Vec<RejectedStatusReason28>,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.006.001.12")]
pub struct RejectedStatus66Choice {
    #[yaserde(rename = "NoSpcfdRsn")]
    #[cfg_attr(feature = "serde", serde(rename = "NoSpcfdRsn"))]
    pub no_spcfd_rsn: Option<NoReasonCode>,
    #[yaserde(rename = "Rsn")]
    #[cfg_attr(feature = "serde", serde(rename = "Rsn"))]
    pub rsn: Vec<RejectedStatusReason65>,
}

impl Validate for RejectedStatus66Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.006.001.12")]
pub struct RejectedStatusReason65 {
    #[yaserde(rename = "RsnCd")]
    #[cfg_attr(feature = "serde", serde(rename = "RsnCd"))]
    pub rsn_cd: RejectedReason70Choice,
...
impl Validate for RejectedStatusReason65 {}
...
pub enum RejectionReason91Code {
    #[yaserde(rename = "ULNK")]
    #[cfg_attr(feature = "serde", serde(rename = "ULNK"))]
    Ulnk,
    #[yaserde(rename = "SAFE")]
    ...
    Nosl,
    #[yaserde(rename = "PMNS")]
    #[cfg_attr(feature = "serde", serde(rename = "PMNS"))]
    Pmns,
    #[yaserde(rename = "IPED")]
    #[cfg_attr(feature = "serde", serde(rename = "IPED"))]
    Iped,
    #[yaserde(rename = "NACD")]
    #[cfg_attr(feature = "serde", serde(rename = "NACD"))]
    Nacd,
    #[yaserde(rename = "EFDM")]
    #[cfg_attr(feature = "serde", serde(rename = "EFDM"))]
    Efdm,
    #[yaserde(rename = "ADIM")]
    #[cfg_attr(feature = "serde", serde(rename = "ADIM"))]
    Adim,
    #[yaserde(rename = "MINC")]
    #[cfg_attr(feature = "serde", serde(rename = "MINC"))]
    Minc,
    #[yaserde(rename = "DSEC")]
    #[cfg_attr(feature = "serde", serde(rename = "DSEC"))]
    Dsec,
...
impl Default for RejectionReason91Code {
    fn default() -> RejectionReason91Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for RejectionReason91Code {}
...
pub enum SecuritiesEntryType3Code {
    #[yaserde(rename = "ELIG")]
...
impl Default for SecuritiesEntryType3Code {
    fn default() -> SecuritiesEntryType3Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for SecuritiesEntryType3Code {}
...
pub enum Status11Code {
    ...
    Stin,
    #[yaserde(rename = "DREG")]
    #[cfg_attr(feature = "serde", serde(rename = "DREG"))]
    Dreg,
    __Unknown__(String),
}

impl Default for Status11Code {
    fn default() -> Status11Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for Status11Code {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "seev.006.001.12";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:seev.006.001.12";
}
