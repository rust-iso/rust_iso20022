...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.017.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.017.001.01")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.017.001.01")]
pub struct AgentCAGlobalDistributionAuthorisationRequestV01 {
    #[yaserde(rename = "Id")]
    ...
    #[yaserde(rename = "GblDstrbtnDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "GblDstrbtnDtls"))]
    pub gbl_dstrbtn_dtls: GlobalDistributionRequest1,
}

impl Validate for AgentCAGlobalDistributionAuthorisationRequestV01 {}
...
pub enum CashBalanceType1FormatTypeChoice {
    Cd(CashBalanceType1Code),
    Prtry(GenericIdentification13),
    __Unknown__(String),
}

impl Default for CashBalanceType1FormatTypeChoice {
    fn default() -> CashBalanceType1FormatTypeChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for CashBalanceType1FormatTypeChoice {}
...
pub struct CashBalanceType1FormatType {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub cash_balance_type_1_format_type_choice: CashBalanceType1FormatTypeChoice,
}
...
impl Validate for CashMovement1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.017.001.01")]

pub enum ChargeType14Code {
    #[yaserde(rename = "ADRF")]
    #[cfg_attr(feature = "serde", serde(rename = "ADRF"))]
    Adrf,
    #[yaserde(rename = "ISSC")]
...
impl Default for ChargeType14Code {
    fn default() -> ChargeType14Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ChargeType14Code {}
...
pub enum ChargeType2FormatChoiceChoice {
    Cd(ChargeType14Code),
    Prtry(GenericIdentification13),
    __Unknown__(String),
}

impl Default for ChargeType2FormatChoiceChoice {
    fn default() -> ChargeType2FormatChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ChargeType2FormatChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.017.001.01")]
pub struct ChargeType2FormatChoice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub charge_type_2_format_choice_choice: ChargeType2FormatChoiceChoice,
}

impl Validate for ChargeType2FormatChoice {}
...
pub struct Charges1 {
    ...
    pub tp: ChargeType2FormatChoice,
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.017.001.01")]
pub struct Document {
    #[yaserde(rename = "AgtCAGblDstrbtnAuthstnReq")]
    #[cfg_attr(feature = "serde", serde(rename = "AgtCAGblDstrbtnAuthstnReq"))]
    pub agt_ca_gbl_dstrbtn_authstn_req: AgentCAGlobalDistributionAuthorisationRequestV01,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.017.001.01")]
pub struct GlobalDistributionRequest1 {
    #[yaserde(rename = "PradvcInd")]
    #[cfg_attr(feature = "serde", serde(rename = "PradvcInd"))]
    pub pradvc_ind: YesNoIndicator,
    ...
    pub scties_mvmnt: Vec<SecurityMovement1>,

    #[yaserde(rename = "CshMvmnt")]
    #[cfg_attr(feature = "serde", serde(rename = "CshMvmnt"))]
    pub csh_mvmnt: Vec<CashMovement1>,
}

impl Validate for GlobalDistributionRequest1 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.017.001.01")]
pub struct SecuritiesAccount12 {
    #[yaserde(rename = "CdtDbtInd")]
    #[cfg_attr(feature = "serde", serde(rename = "CdtDbtInd"))]
    pub cdt_dbt_ind: CreditDebitCode,
    ...
    #[yaserde(rename = "BalTp")]
    #[cfg_attr(feature = "serde", serde(rename = "BalTp"))]
    pub bal_tp: SecuritiesBalanceType6FormatChoice,
...
impl Validate for SecuritiesAccount12 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.017.001.01")]

pub enum SecuritiesBalanceType6Code {
    #[yaserde(rename = "AVLB")]
    #[cfg_attr(feature = "serde", serde(rename = "AVLB"))]
    Avlb,
    #[yaserde(rename = "REST")]
    ...
    Rest,
    #[yaserde(rename = "TENT")]
    #[cfg_attr(feature = "serde", serde(rename = "TENT"))]
    Tent,
    #[yaserde(rename = "RDIS")]
...
impl Default for SecuritiesBalanceType6Code {
    fn default() -> SecuritiesBalanceType6Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for SecuritiesBalanceType6Code {}
...
pub enum SecuritiesBalanceType6FormatChoiceChoice {
    Cd(SecuritiesBalanceType6Code),
    Prtry(GenericIdentification13),
    __Unknown__(String),
}

impl Default for SecuritiesBalanceType6FormatChoiceChoice {
    fn default() -> SecuritiesBalanceType6FormatChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for SecuritiesBalanceType6FormatChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.017.001.01")]
pub struct SecuritiesBalanceType6FormatChoice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub securities_balance_type_6_format_choice_choice: SecuritiesBalanceType6FormatChoiceChoice,
}

impl Validate for SecuritiesBalanceType6FormatChoice {}
...
pub struct SecurityMovement1 {
    ...
    #[yaserde(rename = "AcctDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "AcctDtls"))]
    pub acct_dtls: Vec<SecuritiesAccount12>,
}

impl Validate for SecurityMovement1 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "seev.017.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:seev.017.001.01";
}
