...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.040.002.13")]
pub struct AccountIdentification73 {
    ...
    pub sfkpg_plc: SafekeepingPlaceFormat45Choice,
}

impl Validate for AccountIdentification73 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.040.002.13")]
pub struct CorporateActionEventType116Choice {
    #[yaserde(rename = "Cd")]
...
impl Validate for CorporateActionEventType116Choice {}




#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.040.002.13")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.040.002.13")]
pub struct CorporateActionGeneralInformation187 {
    ...
    pub evt_tp: CorporateActionEventType116Choice,
...
impl Validate for CorporateActionGeneralInformation187 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.040.002.13")]
pub struct CorporateActionInstructionCancellationRequest002V13 {
...
impl Validate for CorporateActionInstructionCancellationRequest002V13 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.040.002.13")]
pub struct CorporateActionOption202 {
...
impl Validate for CorporateActionOption202 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.040.002.13")]
...
pub struct Document {
    ...
    pub corp_actn_instr_cxl_req: CorporateActionInstructionCancellationRequest002V13,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.040.002.13")]
pub struct SafekeepingPlaceFormat45Choice {
    #[yaserde(rename = "Id")]
    #[cfg_attr(feature = "serde", serde(rename = "Id"))]
...
impl Validate for SafekeepingPlaceFormat45Choice {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "seev.040.002.13";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:seev.040.002.13";
}
