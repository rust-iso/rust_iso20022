...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.041.002.14")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.041.002.14")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.041.002.14")]
pub struct CashAccountIdentification10Choice {
    #[yaserde(rename = "IBAN")]
...
impl Validate for CashAccountIdentification10Choice {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.041.002.14")]
pub struct CorporateActionEventType115Choice {
    #[yaserde(rename = "Cd")]
    #[cfg_attr(feature = "serde", serde(rename = "Cd"))]
...
impl Validate for CorporateActionEventType115Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.041.002.14")]
pub struct CorporateActionGeneralInformation186 {
    ...
    pub evt_tp: CorporateActionEventType115Choice,
}

impl Validate for CorporateActionGeneralInformation186 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.041.002.14")]
pub struct CorporateActionInstructionCancellationRequestStatusAdvice002V14 {
    ...
    pub corp_actn_gnl_inf: CorporateActionGeneralInformation186,

    #[yaserde(rename = "InstrCxlReqSts")]
    #[cfg_attr(feature = "serde", serde(rename = "InstrCxlReqSts"))]
    pub instr_cxl_req_sts: Vec<InstructionCancellationRequestStatus18Choice>,

    #[yaserde(rename = "CorpActnInstr")]
    #[cfg_attr(feature = "serde", serde(rename = "CorpActnInstr"))]
    pub corp_actn_instr: CorporateActionOption241,
...
impl Validate for CorporateActionInstructionCancellationRequestStatusAdvice002V14 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.041.002.14")]
pub struct CorporateActionOption241 {
    ...
    pub csh_acct: CashAccountIdentification10Choice,

    #[yaserde(rename = "SfkpgPlc")]
    #[cfg_attr(feature = "serde", serde(rename = "SfkpgPlc"))]
    pub sfkpg_plc: SafekeepingPlaceFormat44Choice,
    ...
    pub prtct_bal: SignedQuantityFormat12,
...
impl Validate for CorporateActionOption241 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.041.002.14")]
...
pub struct Document {
    ...
    pub corp_actn_instr_cxl_req_sts_advc: CorporateActionInstructionCancellationRequestStatusAdvice002V14,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.041.002.14")]
pub struct InstructionCancellationRequestStatus18Choice {
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.041.002.14")]
pub struct PendingCancellationStatus15Choice {
    #[yaserde(rename = "NoSpcfdRsn")]
    #[cfg_attr(feature = "serde", serde(rename = "NoSpcfdRsn"))]
    pub no_spcfd_rsn: Option<NoReasonCode>,
    #[yaserde(rename = "Rsn")]
...
impl Validate for PendingCancellationStatus15Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.041.002.14")]
pub struct RejectedReason56Choice {
    #[yaserde(rename = "Cd")]
    #[cfg_attr(feature = "serde", serde(rename = "Cd"))]
    pub cd: Option<RejectionReason79Code>,
    #[yaserde(rename = "Prtry")]
    #[cfg_attr(feature = "serde", serde(rename = "Prtry"))]
    pub prtry: Option<GenericIdentification47>,
}

impl Validate for RejectedReason56Choice {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.041.002.14")]
pub struct RejectedStatus54Choice {
    #[yaserde(rename = "NoSpcfdRsn")]
    #[cfg_attr(feature = "serde", serde(rename = "NoSpcfdRsn"))]
    pub no_spcfd_rsn: Option<NoReasonCode>,
    #[yaserde(rename = "Rsn")]
    #[cfg_attr(feature = "serde", serde(rename = "Rsn"))]
    pub rsn: Vec<RejectedStatusReason53>,
}

impl Validate for RejectedStatus54Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.041.002.14")]
pub struct RejectedStatusReason53 {
    #[yaserde(rename = "RsnCd")]
    #[cfg_attr(feature = "serde", serde(rename = "RsnCd"))]
    pub rsn_cd: RejectedReason56Choice,
...
impl Validate for RejectedStatusReason53 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.041.002.14")]

pub enum RejectionReason79Code {
    #[yaserde(rename = "ADEA")]
    #[cfg_attr(feature = "serde", serde(rename = "ADEA"))]
    Adea,
    #[yaserde(rename = "INIR")]
...
impl Default for RejectionReason79Code {
    fn default() -> RejectionReason79Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for RejectionReason79Code {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.041.002.14")]
pub struct SafekeepingPlaceFormat44Choice {
    #[yaserde(rename = "Id")]
    #[cfg_attr(feature = "serde", serde(rename = "Id"))]
...
impl Validate for SafekeepingPlaceFormat44Choice {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "seev.041.002.14";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:seev.041.002.14";
}
