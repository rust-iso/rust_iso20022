...
pub struct AgentCAGlobalDistributionStatusAdviceV01 {
    ...
    #[yaserde(rename = "GblMvmntSts")]
    #[cfg_attr(feature = "serde", serde(rename = "GblMvmntSts"))]
    pub gbl_mvmnt_sts: Option<GlobalDistributionStatus1>,
    #[yaserde(rename = "IndvMvmntSts")]
    #[cfg_attr(feature = "serde", serde(rename = "IndvMvmntSts"))]
    pub indv_mvmnt_sts: Vec<IndividualMovementStatus1>,
}
