...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.002.001.10")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.002.001.10")]
...
pub struct Document {
    ...
    pub mtg_cxl: MeetingCancellationV10,
}
...
impl Validate for EligiblePosition21 {}
...
pub struct MeetingCancellationReason1Choice {
    #[yaserde(rename = "Cd")]
    #[cfg_attr(feature = "serde", serde(rename = "Cd"))]
    pub cd: Option<MeetingCancellationReason2Code>,
    #[yaserde(rename = "Prtry")]
    #[cfg_attr(feature = "serde", serde(rename = "Prtry"))]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.002.001.10")]
pub struct MeetingCancellationV10 {
    ...
    pub scty: Vec<SecurityPosition23>,
...
impl Validate for MeetingCancellationV10 {}
...
pub struct SecurityPosition23 {
    ...
    pub pos: Vec<EligiblePosition21>,
}

impl Validate for SecurityPosition23 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "seev.002.001.10";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:seev.002.001.10";
}
