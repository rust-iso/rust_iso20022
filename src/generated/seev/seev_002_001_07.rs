...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.002.001.07")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.002.001.07")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.002.001.07")]
pub struct Document {
    #[yaserde(rename = "MtgCxl")]
    #[cfg_attr(feature = "serde", serde(rename = "MtgCxl"))]
    pub mtg_cxl: MeetingCancellationV07,
}
...
pub enum MeetingCancellationReason1ChoiceChoice {
    Cd(MeetingCancellationReason2Code),
    Prtry(GenericIdentification13),
    __Unknown__(String),
}

impl Default for MeetingCancellationReason1ChoiceChoice {
    fn default() -> MeetingCancellationReason1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for MeetingCancellationReason1ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.002.001.07")]
pub struct MeetingCancellationReason1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub meeting_cancellation_reason_1_choice_choice: MeetingCancellationReason1ChoiceChoice,
}

impl Validate for MeetingCancellationReason1Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.002.001.07")]
pub struct MeetingCancellationReason2 {
    #[yaserde(rename = "CxlRsnCd")]
    #[cfg_attr(feature = "serde", serde(rename = "CxlRsnCd"))]
    pub cxl_rsn_cd: MeetingCancellationReason1Choice,

    #[yaserde(rename = "CxlRsn")]
    #[cfg_attr(feature = "serde", serde(rename = "CxlRsn"))]
    pub cxl_rsn: Max140Text,
}

impl Validate for MeetingCancellationReason2 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.002.001.07")]

pub enum MeetingCancellationReason2Code {
    #[yaserde(rename = "QORM")]
    #[cfg_attr(feature = "serde", serde(rename = "QORM"))]
    Qorm,
    #[yaserde(rename = "PROC")]
...
impl Default for MeetingCancellationReason2Code {
    fn default() -> MeetingCancellationReason2Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for MeetingCancellationReason2Code {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.002.001.07")]
pub struct MeetingCancellationV07 {
    ...
    pub rsn: MeetingCancellationReason2,
...
impl Validate for MeetingCancellationV07 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "seev.002.001.07";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:seev.002.001.07";
}
