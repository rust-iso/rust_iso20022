...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.063.001.01")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.063.001.01")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.063.001.01")]
pub struct BuyerProtectionInstructionCancellationRequestStatusAdviceV01 {
    ...
    pub instr_cxl_req_sts: Vec<InstructionCancellationRequestStatus20Choice>,
...
impl Validate for BuyerProtectionInstructionCancellationRequestStatusAdviceV01 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.063.001.01")]
pub struct Document {
    #[yaserde(rename = "BuyrPrtcnInstrCxlReqStsAdvc")]
    #[cfg_attr(feature = "serde", serde(rename = "BuyrPrtcnInstrCxlReqStsAdvc"))]
    pub buyr_prtcn_instr_cxl_req_sts_advc: BuyerProtectionInstructionCancellationRequestStatusAdviceV01,
}
...
pub enum PendingCancellationReason8Code {
    #[yaserde(rename = "OTHR")]
    #[cfg_attr(feature = "serde", serde(rename = "OTHR"))]
    Othr,
    #[yaserde(rename = "PCAT")]
    #[cfg_attr(feature = "serde", serde(rename = "PCAT"))]
    Pcat,
    #[yaserde(rename = "ECRD")]
...
impl Default for PendingCancellationReason8Code {
    fn default() -> PendingCancellationReason8Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for PendingCancellationReason8Code {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.063.001.01")]
pub struct PendingCancellationReason9Choice {
    #[yaserde(rename = "Cd")]
    #[cfg_attr(feature = "serde", serde(rename = "Cd"))]
    pub cd: Option<PendingCancellationReason8Code>,
    #[yaserde(rename = "Prtry")]
    #[cfg_attr(feature = "serde", serde(rename = "Prtry"))]
    pub prtry: Option<GenericIdentification30>,
}

impl Validate for PendingCancellationReason9Choice {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.063.001.01")]
pub struct PendingCancellationStatus17Choice {
    ...
    pub rsn: Vec<PendingCancellationStatusReason12>,
}

impl Validate for PendingCancellationStatus17Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.063.001.01")]
pub struct PendingCancellationStatusReason12 {
    #[yaserde(rename = "RsnCd")]
    #[cfg_attr(feature = "serde", serde(rename = "RsnCd"))]
    pub rsn_cd: PendingCancellationReason9Choice,
...
impl Validate for PendingCancellationStatusReason12 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.063.001.01")]
pub struct RejectedReason64Choice {
    #[yaserde(rename = "Cd")]
    #[cfg_attr(feature = "serde", serde(rename = "Cd"))]
    pub cd: Option<RejectionReason88Code>,
    #[yaserde(rename = "Prtry")]
    #[cfg_attr(feature = "serde", serde(rename = "Prtry"))]
    pub prtry: Option<GenericIdentification30>,
}

impl Validate for RejectedReason64Choice {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.063.001.01")]
pub struct RejectedStatus62Choice {
    #[yaserde(rename = "NoSpcfdRsn")]
    #[cfg_attr(feature = "serde", serde(rename = "NoSpcfdRsn"))]
    pub no_spcfd_rsn: Option<NoReasonCode>,
    #[yaserde(rename = "Rsn")]
    #[cfg_attr(feature = "serde", serde(rename = "Rsn"))]
    pub rsn: Vec<RejectedStatusReason61>,
}

impl Validate for RejectedStatus62Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.063.001.01")]
pub struct RejectedStatusReason61 {
    #[yaserde(rename = "RsnCd")]
    #[cfg_attr(feature = "serde", serde(rename = "RsnCd"))]
    pub rsn_cd: RejectedReason64Choice,
...
impl Validate for RejectedStatusReason61 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.063.001.01")]

pub enum RejectionReason88Code {
    #[yaserde(rename = "ULNK")]
...
impl Default for RejectionReason88Code {
    fn default() -> RejectionReason88Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for RejectionReason88Code {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "seev.063.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:seev.063.001.01";
}
