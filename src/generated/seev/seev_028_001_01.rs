...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.028.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.028.001.01")]
pub struct AgentCADeactivationInstructionV01 {
    #[yaserde(rename = "Id")]
    ...
    #[yaserde(rename = "DeactvtnDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "DeactvtnDtls"))]
    pub deactvtn_dtls: CorporateActionDeactivationInstruction1,
}

impl Validate for AgentCADeactivationInstructionV01 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.028.001.01")]
pub struct Document {
    #[yaserde(rename = "AgtCADeactvtnInstr")]
    #[cfg_attr(feature = "serde", serde(rename = "AgtCADeactvtnInstr"))]
    pub agt_ca_deactvtn_instr: AgentCADeactivationInstructionV01,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "seev.028.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:seev.028.001.01";
}
