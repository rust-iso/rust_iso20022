...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.005.001.10")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.005.001.10")]
pub struct CancelInstruction5 {
    ...
    pub instd_pos: SafekeepingAccount18,
}

impl Validate for CancelInstruction5 {}
...
pub struct Document {
    ...
    pub mtg_instr_cxl_req: MeetingInstructionCancellationRequestV10,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.005.001.10")]
pub struct MeetingInstructionCancellationRequestV10 {
    ...
    pub to_be_canc_instr: Vec<CancelInstruction5>,
...
impl Validate for MeetingInstructionCancellationRequestV10 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.005.001.10")]
pub struct SafekeepingAccount18 {
...
impl Validate for SafekeepingAccount18 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "seev.005.001.10";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:seev.005.001.10";
}
