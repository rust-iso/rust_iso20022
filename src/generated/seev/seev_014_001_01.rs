...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.014.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.014.001.01")]
...
impl Validate for AgentCAElectionCancellationRequestV01 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.014.001.01")]
pub struct Document {
    #[yaserde(rename = "AgtCAElctnCxlReq")]
    #[cfg_attr(feature = "serde", serde(rename = "AgtCAElctnCxlReq"))]
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "seev.014.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:seev.014.001.01";
}
