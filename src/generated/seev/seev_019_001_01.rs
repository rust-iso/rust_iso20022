...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.019.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.019.001.01")]
...
pub struct AgentCAMovementInstructionV01 {
    ...
    pub prcds_mvmnt_dtls: ProceedsMovement1,
}

impl Validate for AgentCAMovementInstructionV01 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.019.001.01")]
pub struct Document {
    #[yaserde(rename = "AgtCAMvmntInstr")]
    #[cfg_attr(feature = "serde", serde(rename = "AgtCAMvmntInstr"))]
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "seev.019.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:seev.019.001.01";
}
