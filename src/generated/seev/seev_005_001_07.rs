...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.005.001.07")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.005.001.07")]
pub struct CancelInstruction2 {
    #[yaserde(rename = "SnglInstrId")]
    #[cfg_attr(feature = "serde", serde(rename = "SnglInstrId"))]
    pub sngl_instr_id: Max35Text,

    #[yaserde(rename = "InstdPos")]
    #[cfg_attr(feature = "serde", serde(rename = "InstdPos"))]
    pub instd_pos: SafekeepingAccount10,
}

impl Validate for CancelInstruction2 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.005.001.07")]
pub struct Document {
    #[yaserde(rename = "MtgInstrCxlReq")]
    #[cfg_attr(feature = "serde", serde(rename = "MtgInstrCxlReq"))]
    pub mtg_instr_cxl_req: MeetingInstructionCancellationRequestV07,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.005.001.07")]
pub struct MeetingInstructionCancellationRequestV07 {
    ...
    #[yaserde(rename = "ToBeCancInstr")]
    #[cfg_attr(feature = "serde", serde(rename = "ToBeCancInstr"))]
    pub to_be_canc_instr: Vec<CancelInstruction2>,
...
impl Validate for MeetingInstructionCancellationRequestV07 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.005.001.07")]
pub struct SafekeepingAccount10 {
...
impl Validate for SafekeepingAccount10 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "seev.005.001.07";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:seev.005.001.07";
}
