...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.033.001.14")]
pub struct AccountAndBalance61 {
    ...
    pub bal: CorporateActionBalanceDetails42,
}

impl Validate for AccountAndBalance61 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.033.001.14")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.033.001.14")]
pub struct AlternatePartyIdentification12 {
    #[yaserde(rename = "IdTp")]
...
impl Validate for AlternatePartyIdentification12 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.033.001.14")]
pub struct CorporateActionBalanceDetails42 {
    ...
    pub pdg_dlvry_bal: Vec<BalanceFormat11Choice>,

    #[yaserde(rename = "PdgRctBal")]
    #[cfg_attr(feature = "serde", serde(rename = "PdgRctBal"))]
    pub pdg_rct_bal: Vec<BalanceFormat11Choice>,
    ...
    pub sttlm_pos_bal: BalanceFormat11Choice,
...
impl Validate for CorporateActionBalanceDetails42 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.033.001.14")]
pub struct CorporateActionGeneralInformation180 {
    ...
    pub undrlyg_scty: FinancialInstrumentAttributes132,
}

impl Validate for CorporateActionGeneralInformation180 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.033.001.14")]
pub struct CorporateActionInstructionV14 {
...
impl Validate for CorporateActionInstructionV14 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.033.001.14")]
pub struct CorporateActionOption237 {
    ...
    pub scties_qty_or_instd_amt: SecuritiesQuantityOrAmount6Choice,
    ...
    pub rate_and_amt_dtls: CorporateActionRate127,

    #[yaserde(rename = "PricDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "PricDtls"))]
    pub pric_dtls: CorporateActionPrice88,
...
impl Validate for CorporateActionOption237 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.033.001.14")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.033.001.14")]
pub struct CorporateActionPrice88 {
    ...
    pub isse_pric: PriceFormat77Choice,

    #[yaserde(rename = "GncCshPricRcvdPerPdct")]
    #[cfg_attr(feature = "serde", serde(rename = "GncCshPricRcvdPerPdct"))]
    pub gnc_csh_pric_rcvd_per_pdct: PriceFormat78Choice,

    #[yaserde(rename = "GncCshPricPdPerPdct")]
    #[cfg_attr(feature = "serde", serde(rename = "GncCshPricPdPerPdct"))]
    pub gnc_csh_pric_pd_per_pdct: PriceFormat77Choice,
}

impl Validate for CorporateActionPrice88 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.033.001.14")]
pub struct CorporateActionRate127 {
    ...
    pub ovrsbcpt_rate: RateAndAmountFormat59Choice,

    #[yaserde(rename = "ReqdWhldgTaxRate")]
    #[cfg_attr(feature = "serde", serde(rename = "ReqdWhldgTaxRate"))]
    pub reqd_whldg_tax_rate: Vec<RateAndAmountFormat55Choice>,

    #[yaserde(rename = "ReqdScndLvlTaxRate")]
    #[cfg_attr(feature = "serde", serde(rename = "ReqdScndLvlTaxRate"))]
    pub reqd_scnd_lvl_tax_rate: Vec<RateAndAmountFormat55Choice>,
}

impl Validate for CorporateActionRate127 {}
...
pub struct Document {
    #[yaserde(rename = "CorpActnInstr")]
    #[cfg_attr(feature = "serde", serde(rename = "CorpActnInstr"))]
    pub corp_actn_instr: CorporateActionInstructionV14,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.033.001.14")]
pub struct FinancialInstrumentAttributes132 {
...
impl Validate for FinancialInstrumentAttributes132 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.033.001.14")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.033.001.14")]
pub struct PartyIdentification263Choice {
    #[yaserde(rename = "AnyBIC")]
    #[cfg_attr(feature = "serde", serde(rename = "AnyBIC"))]
    pub any_b_i_c: Option<AnyBICDec2014Identifier>,
    #[yaserde(rename = "PrtryId")]
...
impl Validate for PartyIdentification263Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.033.001.14")]
pub struct PartyIdentification340 {
    #[yaserde(rename = "OwnrId")]
    #[cfg_attr(feature = "serde", serde(rename = "OwnrId"))]
    pub ownr_id: PartyIdentification263Choice,

    #[yaserde(rename = "AltrnId")]
    #[cfg_attr(feature = "serde", serde(rename = "AltrnId"))]
    pub altrn_id: Vec<AlternatePartyIdentification12>,
    ...
    pub ownd_scties_qty: FinancialInstrumentQuantity33Choice,
    ...
    pub whldg_tax_rate: RateAndAmountFormat57Choice,
...
impl Validate for PartyIdentification340 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.033.001.14")]
pub struct PriceFormat78Choice {
    #[yaserde(rename = "PctgPric")]
    #[cfg_attr(feature = "serde", serde(rename = "PctgPric"))]
    pub pctg_pric: Option<PercentagePrice2>,
    #[yaserde(rename = "AmtPric")]
...
impl Validate for PriceFormat78Choice {}
...
pub struct SecuritiesOption79 {
    ...
    pub addtl_rnd_up_qty: FinancialInstrumentQuantity33Choice,
}

impl Validate for SecuritiesOption79 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.033.001.14")]
pub struct SecuritiesQuantityOrAmount6Choice {
    #[yaserde(rename = "SctiesQty")]
    #[cfg_attr(feature = "serde", serde(rename = "SctiesQty"))]
    pub scties_qty: Option<SecuritiesOption79>,
    #[yaserde(rename = "InstdAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "InstdAmt"))]
    pub instd_amt: Option<ActiveCurrencyAndAmount>,
}

impl Validate for SecuritiesQuantityOrAmount6Choice {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "seev.033.001.14";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:seev.033.001.14";
}
