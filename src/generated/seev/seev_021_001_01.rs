...
pub struct AgentCAMovementConfirmationV01 {
    ...
    #[yaserde(rename = "AgentCAMovementConfirmationV01Choice")]
    #[cfg_attr(feature = "serde", serde(rename = "AgentCAMovementConfirmationV01Choice"))]
    pub agent_ca_movement_confirmation_v01_choice: agent_ca_movement_confirmation_v01::AgentCAMovementConfirmationV01Choice,
...
pub mod agent_ca_movement_confirmation_v01 {
    ...
    pub enum AgentCAMovementConfirmationV01Choice {
    ...
    impl Default for AgentCAMovementConfirmationV01Choice {
        fn default() -> AgentCAMovementConfirmationV01Choice {
            Self::__Unknown__("No valid variants".into())
        }
    }

    impl Validate for AgentCAMovementConfirmationV01Choice {}
