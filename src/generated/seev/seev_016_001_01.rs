...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.016.001.01")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.016.001.01")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.016.001.01")]
pub struct AgentCADistributionBreakdownAdviceV01 {
    #[yaserde(rename = "Id")]
    ...
    #[yaserde(rename = "CorpActnDstrbtnDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "CorpActnDstrbtnDtls"))]
    pub corp_actn_dstrbtn_dtls: EntitlementAdvice1,
}

impl Validate for AgentCADistributionBreakdownAdviceV01 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.016.001.01")]
pub struct Document {
    #[yaserde(rename = "AgtCADstrbtnBrkdwnAdvc")]
    #[cfg_attr(feature = "serde", serde(rename = "AgtCADstrbtnBrkdwnAdvc"))]
    pub agt_ca_dstrbtn_brkdwn_advc: AgentCADistributionBreakdownAdviceV01,
}
...
pub struct Entitlement1 {
    ...
    #[yaserde(rename = "SctiesDstrbtnDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "SctiesDstrbtnDtls"))]
    pub scties_dstrbtn_dtls: Vec<SecuritiesEntitlement1>,

    #[yaserde(rename = "CshDstrbtnDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "CshDstrbtnDtls"))]
    pub csh_dstrbtn_dtls: Vec<CashEntitlement1>,
}

impl Validate for Entitlement1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.016.001.01")]
pub struct EntitlementAdvice1 {
    ...
    #[yaserde(rename = "AcctAndDstrbtnDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "AcctAndDstrbtnDtls"))]
    pub acct_and_dstrbtn_dtls: Vec<Entitlement1>,
}

impl Validate for EntitlementAdvice1 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.016.001.01")]
pub struct SecuritiesEntitlement1 {
    #[yaserde(rename = "SctyId")]
    #[cfg_attr(feature = "serde", serde(rename = "SctyId"))]
    pub scty_id: SecurityIdentification7,

    #[yaserde(rename = "EntitldSctiesQty")]
    #[cfg_attr(feature = "serde", serde(rename = "EntitldSctiesQty"))]
    pub entitld_scties_qty: UnitOrFaceAmount1Choice,
}

impl Validate for SecuritiesEntitlement1 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "seev.016.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:seev.016.001.01";
}
