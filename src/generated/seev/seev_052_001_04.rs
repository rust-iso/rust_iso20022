...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.052.001.04")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.052.001.04")]
...
pub struct Document {
    ...
    pub mkt_clm_sts_advc: MarketClaimStatusAdviceV04,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.052.001.04")]
pub struct MarketClaimProcessingStatus2Choice {
    #[yaserde(rename = "Canc")]
    ...
    pub pdg: Option<PendingStatus86Choice>,
...
impl Validate for MarketClaimProcessingStatus2Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.052.001.04")]
pub struct MarketClaimStatusAdviceV04 {
    ...
    pub mkt_clm_prcg_sts: MarketClaimProcessingStatus2Choice,
...
impl Validate for MarketClaimStatusAdviceV04 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.052.001.04")]
...
impl Default for PendingReason39Code {
    fn default() -> PendingReason39Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for PendingReason39Code {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.052.001.04")]
pub struct PendingReason83Choice {
    #[yaserde(rename = "Cd")]
    #[cfg_attr(feature = "serde", serde(rename = "Cd"))]
    pub cd: Option<PendingReason39Code>,
    #[yaserde(rename = "Prtry")]
    #[cfg_attr(feature = "serde", serde(rename = "Prtry"))]
    pub prtry: Option<GenericIdentification30>,
}

impl Validate for PendingReason83Choice {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.052.001.04")]
pub struct PendingStatus86Choice {
    #[yaserde(rename = "NoSpcfdRsn")]
    #[cfg_attr(feature = "serde", serde(rename = "NoSpcfdRsn"))]
    pub no_spcfd_rsn: Option<NoReasonCode>,
    #[yaserde(rename = "Rsn")]
    #[cfg_attr(feature = "serde", serde(rename = "Rsn"))]
    pub rsn: Vec<PendingStatusReason36>,
}

impl Validate for PendingStatus86Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:seev.052.001.04")]
pub struct PendingStatusReason36 {
    #[yaserde(rename = "RsnCd")]
    #[cfg_attr(feature = "serde", serde(rename = "RsnCd"))]
    pub rsn_cd: PendingReason83Choice,
...
impl Validate for PendingStatusReason36 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "seev.052.001.04";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:seev.052.001.04";
}
