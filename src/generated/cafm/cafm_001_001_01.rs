...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cafm.001.001.01")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cafm.001.001.01")]
...
pub struct Document {
    ...
    pub file_actn_initn: FileActionInitiationV01,
}
...
impl Validate for FileActionDetails1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cafm.001.001.01")]
pub struct FileActionInitiation1 {
    #[yaserde(rename = "Envt")]
...
impl Validate for FileActionInitiation1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cafm.001.001.01")]
pub struct FileActionInitiationV01 {
    #[yaserde(rename = "Hdr")]
    ...
    pub body: FileActionInitiation1,
...
impl Validate for FileActionInitiationV01 {}
...
pub enum FileActionResult1Code {
    #[yaserde(rename = "DUPR")]
    #[cfg_attr(feature = "serde", serde(rename = "DUPR"))]
    Dupr,
    #[yaserde(rename = "FERD")]
    #[cfg_attr(feature = "serde", serde(rename = "FERD"))]
    Ferd,
    #[yaserde(rename = "INFD")]
    #[cfg_attr(feature = "serde", serde(rename = "INFD"))]
    Infd,
    #[yaserde(rename = "FLCK")]
    #[cfg_attr(feature = "serde", serde(rename = "FLCK"))]
    Flck,
    #[yaserde(rename = "FTER")]
    #[cfg_attr(feature = "serde", serde(rename = "FTER"))]
    Fter,
    #[yaserde(rename = "NSUP")]
    ...
    Succ,
    #[yaserde(rename = "UTLR")]
    #[cfg_attr(feature = "serde", serde(rename = "UTLR"))]
    Utlr,
    #[yaserde(rename = "UNKF")]
    #[cfg_attr(feature = "serde", serde(rename = "UNKF"))]
    Unkf,
    #[yaserde(rename = "USUC")]
    #[cfg_attr(feature = "serde", serde(rename = "USUC"))]
    Usuc,
    __Unknown__(String),
}

impl Default for FileActionResult1Code {
    fn default() -> FileActionResult1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for FileActionResult1Code {}
...
impl Default for FileActionScope1Code {
    fn default() -> FileActionScope1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for FileActionScope1Code {}
...
pub enum FileActionType1Code {
    ...
    Delt,
    #[yaserde(rename = "ENQR")]
    #[cfg_attr(feature = "serde", serde(rename = "ENQR"))]
    Enqr,
    #[yaserde(rename = "OTHN")]
    #[cfg_attr(feature = "serde", serde(rename = "OTHN"))]
    Othn,
    ...
    Updt,
    #[yaserde(rename = "BRPT")]
    #[cfg_attr(feature = "serde", serde(rename = "BRPT"))]
    Brpt,
    #[yaserde(rename = "DLSP")]
    #[cfg_attr(feature = "serde", serde(rename = "DLSP"))]
    Dlsp,
    __Unknown__(String),
}

impl Default for FileActionType1Code {
    fn default() -> FileActionType1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for FileActionType1Code {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cafm.001.001.01")]
pub struct ResultData4 {
    #[yaserde(rename = "Rslt")]
    #[cfg_attr(feature = "serde", serde(rename = "Rslt"))]
    pub rslt: FileActionResult1Code,
...
pub struct Transaction98 {
    ...
    #[yaserde(rename = "FileActnScp")]
    #[cfg_attr(feature = "serde", serde(rename = "FileActnScp"))]
    pub file_actn_scp: FileActionScope1Code,

    #[yaserde(rename = "FileActnTp")]
    #[cfg_attr(feature = "serde", serde(rename = "FileActnTp"))]
    pub file_actn_tp: FileActionType1Code,

    #[yaserde(rename = "OthrFileActnTp")]
    #[cfg_attr(feature = "serde", serde(rename = "OthrFileActnTp"))]
    pub othr_file_actn_tp: Max35Text,

    #[yaserde(rename = "FileActnDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "FileActnDtls"))]
    pub file_actn_dtls: FileActionDetails1,
...
impl Validate for Transaction98 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "cafm.001.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:cafm.001.001.01";
}
