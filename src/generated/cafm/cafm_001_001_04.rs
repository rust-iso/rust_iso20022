...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cafm.001.001.04")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cafm.001.001.04")]
...
pub struct Document {
    ...
    pub file_actn_initn: FileActionInitiationV04,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cafm.001.001.04")]
pub struct FileActionInitiationV04 {
    #[yaserde(rename = "Hdr")]
    ...
    pub file_actn_tp: FileActionType3Code,
...
impl Validate for FileActionInitiationV04 {}
...
impl Default for FileActionType3Code {
    fn default() -> FileActionType3Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for FileActionType3Code {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "cafm.001.001.04";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:cafm.001.001.04";
}
