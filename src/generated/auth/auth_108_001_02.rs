...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.108.001.02")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.108.001.02")]
...
impl Validate for DerivativesTradeMarginDataReportV02 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.108.001.02")]
pub struct Document {
    #[yaserde(rename = "DerivsTradMrgnDataRpt")]
    #[cfg_attr(feature = "serde", serde(rename = "DerivsTradMrgnDataRpt"))]
    pub derivs_trad_mrgn_data_rpt: DerivativesTradeMarginDataReportV02,
}
...
impl Validate for MarginReportData9 {}
...
pub struct TradeData61Choice {
    ...
    pub rpt: Vec<TradeReport34Choice>,
}

impl Validate for TradeData61Choice {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.108.001.02")]
pub struct TradeReport34Choice {
    ...
    #[yaserde(rename = "MrgnUpd")]
    #[cfg_attr(feature = "serde", serde(rename = "MrgnUpd"))]
...
impl Validate for TradeReport34Choice {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "auth.108.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:auth.108.001.02";
}
