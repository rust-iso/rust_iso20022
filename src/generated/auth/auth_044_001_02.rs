...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.044.001.02")]
...
pub struct Document {
    ...
    pub fin_instrm_rptg_eqty_tradg_actvty_rslt: FinancialInstrumentReportingEquityTradingActivityResultV02,
}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.044.001.02")]
...
impl Validate for FinancialInstrumentReportingEquityTradingActivityResultV02 {}
...
impl Validate for TransparencyDataReport17 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "auth.044.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:auth.044.001.02";
}
