...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.036.001.03")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.036.001.03")]
...
pub struct Document {
    ...
    pub fin_instrm_rptg_ref_data_dlta_rpt: FinancialInstrumentReportingReferenceDataDeltaReportV03,
}
...
pub struct FinancialInstrumentReportingReferenceDataDeltaReportV03 {
    ...
    pub fin_instrm: Vec<SecuritiesReferenceDeltaStatusReport5Choice>,
...
impl Validate for FinancialInstrumentReportingReferenceDataDeltaReportV03 {}
...
pub struct SecuritiesReferenceDeltaStatusReport5Choice {
    ...
    #[yaserde(rename = "CancRcrd")]
    #[cfg_attr(feature = "serde", serde(rename = "CancRcrd"))]
    pub canc_rcrd: Option<SecuritiesReferenceDataReport7>,
}

impl Validate for SecuritiesReferenceDeltaStatusReport5Choice {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "auth.036.001.03";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:auth.036.001.03";
}
