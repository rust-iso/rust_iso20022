...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.057.001.02")]
...
impl Validate for CcpportfolioStressTestingDefinitionReportV02 {}
...
pub struct Document {
    ...
    pub ccp_prtfl_strss_tstg_def_rpt: CcpportfolioStressTestingDefinitionReportV02,
}
...
impl Validate for ScenarioDefinition2 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.057.001.02")]
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "auth.057.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:auth.057.001.02";
}
