...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.033.001.03")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.033.001.03")]
...
pub struct Document {
    ...
    pub fin_instrm_rptg_non_eqty_trnsprncy_data_rpt: FinancialInstrumentReportingNonEquityTransparencyDataReportV03,
}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct ExternalEmissionAllowanceSubProductType1Code (pub String);
crate::simple_type!(ExternalEmissionAllowanceSubProductType1Code);

impl Validate for ExternalEmissionAllowanceSubProductType1Code {
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct ExternalProductType1Code (pub String);
crate::simple_type!(ExternalProductType1Code);

impl Validate for ExternalProductType1Code {
    fn validate(&self) -> Result<(), String> { 
        #[allow(clippy::len_zero)]
        if self.0.len() < 1 {
            return Err(format!("MinLength validation error. \nExpected: 0 length >= 1 \nActual: 0 length == {}", self.0.len()));
...
impl Validate for FinancialInstrumentReportingNonEquityTransparencyDataReportV03 {}
...
pub struct TransparencyDataReport21 {
    ...
    pub undrlyg_instrm_asst_clss: ExternalProductType1Code,
    ...
    pub emssn_allwnc_tp: ExternalEmissionAllowanceSubProductType1Code,
...
impl Validate for TransparencyDataReport21 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "auth.033.001.03";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:auth.033.001.03";
}
