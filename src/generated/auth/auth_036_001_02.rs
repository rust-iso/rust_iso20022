...
pub enum SecuritiesReferenceDeltaStatusReport3ChoiceChoice {
    ModfdRcrd(SecuritiesReferenceDataReport6),
    NewRcrd(SecuritiesReferenceDataReport6),
    TermntdRcrd(SecuritiesReferenceDataReport6),
    __Unknown__(String),
}

impl Default for SecuritiesReferenceDeltaStatusReport3ChoiceChoice {
    fn default() -> SecuritiesReferenceDeltaStatusReport3ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for SecuritiesReferenceDeltaStatusReport3ChoiceChoice {}
...
pub struct SecuritiesReferenceDeltaStatusReport3Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub securities_reference_delta_status_report_3_choice_choice: SecuritiesReferenceDeltaStatusReport3ChoiceChoice,
}
