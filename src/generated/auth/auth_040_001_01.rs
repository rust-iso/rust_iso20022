...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.040.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.040.001.01")]
pub struct Document {
    #[yaserde(rename = "FinInstrmRptgEqtyTradgActvtyRpt")]
    #[cfg_attr(feature = "serde", serde(rename = "FinInstrmRptgEqtyTradgActvtyRpt"))]
    pub fin_instrm_rptg_eqty_tradg_actvty_rpt: FinancialInstrumentReportingEquityTradingActivityReportV01,
}
...
impl Validate for FinancialInstrumentReportingEquityTradingActivityReportV01 {}
...
impl Validate for NumberAndVolume2 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.040.001.01")]
...
pub struct TransparencyDataReport13 {
    ...
    #[yaserde(rename = "TxsExctd")]
    #[cfg_attr(feature = "serde", serde(rename = "TxsExctd"))]
    pub txs_exctd: NumberAndVolume2,

    #[yaserde(rename = "TxsExctdExclgPreTradWvr")]
    #[cfg_attr(feature = "serde", serde(rename = "TxsExctdExclgPreTradWvr"))]
    pub txs_exctd_exclg_pre_trad_wvr: NumberAndVolume2,

    #[yaserde(rename = "TxsExctdExclgPstTradLrgInScaleWvr")]
    #[cfg_attr(feature = "serde", serde(rename = "TxsExctdExclgPstTradLrgInScaleWvr"))]
    pub txs_exctd_exclg_pst_trad_lrg_in_scale_wvr: NumberAndVolume2,
}

impl Validate for TransparencyDataReport13 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "auth.040.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:auth.040.001.01";
}
