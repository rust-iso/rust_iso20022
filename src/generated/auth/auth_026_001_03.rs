...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.026.001.03")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.026.001.03")]
...
pub struct CurrencyControlRequestOrLetterV03 {
    ...
    pub req_or_lttr: Vec<SupportingDocumentRequestOrLetter3>,
...
impl Validate for CurrencyControlRequestOrLetterV03 {}
...
pub struct Document {
    ...
    pub ccy_ctrl_req_or_lttr: CurrencyControlRequestOrLetterV03,
}
...
impl Validate for OriginalMessage4 {}
...
pub enum SupportLetterType1ChoiceChoice {
    Cd(ExternalLetterType1Code),
    Prtry(Max35Text),
    __Unknown__(String),
}

impl Default for SupportLetterType1ChoiceChoice {
    fn default() -> SupportLetterType1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for SupportLetterType1ChoiceChoice {}
...
pub struct SupportLetterType1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub support_letter_type_1_choice_choice: SupportLetterType1ChoiceChoice,
}
...
pub struct SupportingDocumentRequestOrLetter3 {
    ...
    pub sndr: Party40Choice,

    #[yaserde(rename = "Rcvr")]
    #[cfg_attr(feature = "serde", serde(rename = "Rcvr"))]
    pub rcvr: Party40Choice,
...
impl Validate for SupportingDocumentRequestOrLetter3 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "auth.026.001.03";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:auth.026.001.03";
}
