...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.023.001.03")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.023.001.03")]
...
pub struct ContractRegistrationStatementCriteria1 {
    ...
    pub tx_jrnl: TrueFalseIndicator,

    #[yaserde(rename = "SpprtgDocJrnl")]
    #[cfg_attr(feature = "serde", serde(rename = "SpprtgDocJrnl"))]
    pub spprtg_doc_jrnl: TrueFalseIndicator,

    #[yaserde(rename = "AddtlSpprtgDocJrnl")]
    #[cfg_attr(feature = "serde", serde(rename = "AddtlSpprtgDocJrnl"))]
    pub addtl_spprtg_doc_jrnl: TrueFalseIndicator,

    #[yaserde(rename = "RgltryRuleVldtn")]
    #[cfg_attr(feature = "serde", serde(rename = "RgltryRuleVldtn"))]
    pub rgltry_rule_vldtn: TrueFalseIndicator,
}

impl Validate for ContractRegistrationStatementCriteria1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.023.001.03")]
pub struct ContractRegistrationStatementRequest2 {
    #[yaserde(rename = "StmtReqId")]
    #[cfg_attr(feature = "serde", serde(rename = "StmtReqId"))]
    ...
    pub rtr_crit: ContractRegistrationStatementCriteria1,
...
impl Validate for ContractRegistrationStatementRequest2 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.023.001.03")]
pub struct ContractRegistrationStatementRequestV03 {
    #[yaserde(rename = "GrpHdr")]
    #[cfg_attr(feature = "serde", serde(rename = "GrpHdr"))]
    pub grp_hdr: CurrencyControlHeader4,

    #[yaserde(rename = "StmtReq")]
    #[cfg_attr(feature = "serde", serde(rename = "StmtReq"))]
    pub stmt_req: Vec<ContractRegistrationStatementRequest2>,
...
impl Validate for ContractRegistrationStatementRequestV03 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.023.001.03")]
pub struct Document {
    #[yaserde(rename = "CtrctRegnStmtReq")]
    #[cfg_attr(feature = "serde", serde(rename = "CtrctRegnStmtReq"))]
    pub ctrct_regn_stmt_req: ContractRegistrationStatementRequestV03,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "auth.023.001.03";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:auth.023.001.03";
}
