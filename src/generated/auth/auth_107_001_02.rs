...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.107.001.02")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.107.001.02")]
...
pub struct CommonTradeDataReport72 {
    ...
    pub ctrct_mod: ContractModification9,
}

impl Validate for CommonTradeDataReport72 {}
...
impl Validate for ContractModification9 {}
...
impl Validate for DerivativesTradeStateReportV02 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.107.001.02")]
pub struct Document {
    #[yaserde(rename = "DerivsTradStatRpt")]
    #[cfg_attr(feature = "serde", serde(rename = "DerivsTradStatRpt"))]
    pub derivs_trad_stat_rpt: DerivativesTradeStateReportV02,
}
...
pub struct TradeData60Choice {
    ...
    pub stat: Vec<TradeStateReport23>,
}

impl Validate for TradeData60Choice {}
...
impl Validate for TradeStateReport23 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "auth.107.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:auth.107.001.02";
}
