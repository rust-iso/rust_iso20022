...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.018.001.04")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.018.001.04")]
...
impl Validate for ContractRegistration7 {}
...
impl Validate for ContractRegistration8 {}
...
impl Validate for ContractRegistrationRequestV04 {}
...
pub struct Document {
    ...
    pub ctrct_regn_req: ContractRegistrationRequestV04,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "auth.018.001.04";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:auth.018.001.04";
}
