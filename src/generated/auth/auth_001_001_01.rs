...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.001.001.01")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.001.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.001.001.01")]
pub struct Document {
    #[yaserde(rename = "InfReqOpng")]
    #[cfg_attr(feature = "serde", serde(rename = "InfReqOpng"))]
    pub inf_req_opng: InformationRequestOpeningV01,
}
...
pub struct InformationRequestOpeningV01 {
    ...
    #[yaserde(rename = "LglMndtBsis")]
    #[cfg_attr(feature = "serde", serde(rename = "LglMndtBsis"))]
    ...
    #[yaserde(rename = "InvstgtnPrd")]
    #[cfg_attr(feature = "serde", serde(rename = "InvstgtnPrd"))]
...
impl Validate for InformationRequestOpeningV01 {}
...
pub struct LegalMandate1 {
    #[yaserde(rename = "Prgrph")]
    #[cfg_attr(feature = "serde", serde(rename = "Prgrph"))]
...
impl Validate for LegalMandate1 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "auth.001.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:auth.001.001.01";
}
