...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.023.001.04")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.023.001.04")]
...
impl Validate for ContractRegistrationStatementRequest3 {}
...
impl Validate for ContractRegistrationStatementRequestV04 {}
...
pub struct Document {
    ...
    pub ctrct_regn_stmt_req: ContractRegistrationStatementRequestV04,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "auth.023.001.04";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:auth.023.001.04";
}
