...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.021.001.04")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.021.001.04")]
...
impl Validate for ContractRegistrationAmendmentRequestV04 {}
...
pub struct Document {
    ...
    pub ctrct_regn_amdmnt_req: ContractRegistrationAmendmentRequestV04,
}
...
impl Validate for RegisteredContract16 {}
...
impl Validate for RegisteredContract17 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "auth.021.001.04";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:auth.021.001.04";
}
