...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.112.001.01")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.112.001.01")]
...
impl Validate for AssetHolding3 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.112.001.01")]
pub struct AssetHolding3Choice {
    ...
    #[yaserde(rename = "Trpty")]
    #[cfg_attr(feature = "serde", serde(rename = "Trpty"))]
...
impl Validate for AssetHolding3Choice {}
...
pub struct CcpinteroperabilityReportV01 {
    #[yaserde(rename = "IntrprbltyCCP")]
    #[cfg_attr(feature = "serde", serde(rename = "IntrprbltyCCP"))]
...
impl Validate for CcpinteroperabilityReportV01 {}
...
impl Validate for CollateralType22Choice {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:auth.112.001.01")]
pub struct Document {
    #[yaserde(rename = "CCPIntrprbltyRpt")]
    #[cfg_attr(feature = "serde", serde(rename = "CCPIntrprbltyRpt"))]
    pub ccp_intrprblty_rpt: CcpinteroperabilityReportV01,
}
...
impl Validate for FinancialInstrument104 {}
...
pub struct GeneralCollateral4 {
    ...
    pub fin_instrm_id: Vec<FinancialInstrument104>,
...
impl Validate for GeneralCollateral4 {}
...
impl Validate for InteroperabilityCCP1 {}
...
impl Validate for SpecificCollateral3 {}
...
impl Validate for TripartyCollateralAndAmount1 {}

impl crate::MxMessage for Document {
    const BUSINESS_AREA: crate::BusinessArea = crate::BusinessArea::auth;
    const FUNCTIONALITY: &'static str = "112";
    const VARIANT: &'static str = "001";
    const VERSION: &'static str = "01";
    const MESSAGE_NAME: &'static str = "auth.112.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:auth.112.001.01";
}
