...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pacs.009.001.13")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pacs.009.001.13")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pacs.009.001.13")]
pub struct CreditTransferTransaction79 {
    #[yaserde(rename = "PmtId")]
    #[cfg_attr(feature = "serde", serde(rename = "PmtId"))]
    pub pmt_id: PaymentIdentification13,
    ...
    pub undrlyg_fi_cdt_trf: CreditTransferTransaction80,
...
impl Validate for CreditTransferTransaction79 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pacs.009.001.13")]
pub struct CreditTransferTransaction80 {
    #[yaserde(rename = "PmtId")]
    #[cfg_attr(feature = "serde", serde(rename = "PmtId"))]
    pub pmt_id: PaymentIdentification13,
...
impl Validate for CreditTransferTransaction80 {}
...
pub struct Document {
    ...
    pub fi_cdt_trf: FinancialInstitutionCreditTransferV13,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pacs.009.001.13")]
pub struct FinancialInstitutionCreditTransferV13 {
    ...
    pub cdt_trf_tx_inf: Vec<CreditTransferTransaction79>,
...
impl Validate for FinancialInstitutionCreditTransferV13 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "pacs.009.001.13";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:pacs.009.001.13";
}
