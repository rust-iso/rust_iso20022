...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pacs.008.001.08")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pacs.008.001.08")]
...
impl Validate for CreditTransferTransaction39 {}
...
pub struct Document {
    ...
    pub fi_to_fi_cstmr_cdt_trf: FitoFICustomerCreditTransferV08,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "pacs.008.001.08";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:pacs.008.001.08";
}
