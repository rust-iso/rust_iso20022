...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pacs.010.001.06")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pacs.010.001.06")]
...
impl Validate for CreditTransferTransaction66 {}
...
impl Validate for DirectDebitTransactionInformation33 {}
...
pub struct Document {
    ...
    pub fi_drct_dbt: FinancialInstitutionDirectDebitV06,
}
...
impl Validate for FinancialInstitutionDirectDebitV06 {}
...
impl Validate for GroupHeader119 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "pacs.010.001.06";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:pacs.010.001.06";
}
