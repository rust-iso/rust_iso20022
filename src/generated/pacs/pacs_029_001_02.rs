...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pacs.029.001.02")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pacs.029.001.02")]
...
pub struct Document {
    ...
    pub mul_sttlm_req: MultilateralSettlementRequestV02,
}
...
pub struct MovementRecord2 {
    ...
    pub sttlm_agt: PartyIdentification272,
    ...
    pub ptcpt: PartyIdentification272,
...
impl Validate for MovementRecord2 {}
...
impl Validate for MultilateralSettlementRequest3 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pacs.029.001.02")]
pub struct MultilateralSettlementRequestV02 {
    ...
    pub sttlm_req: Vec<MultilateralSettlementRequest3>,
...
impl Validate for MultilateralSettlementRequestV02 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "pacs.029.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:pacs.029.001.02";
}
