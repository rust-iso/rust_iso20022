...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pacs.007.001.11")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pacs.007.001.11")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pacs.007.001.11")]
pub struct Document {
    #[yaserde(rename = "FIToFIPmtRvsl")]
    #[cfg_attr(feature = "serde", serde(rename = "FIToFIPmtRvsl"))]
    pub fi_to_fi_pmt_rvsl: FitoFIPaymentReversalV11,
}
...
pub struct FitoFIPaymentReversalV11 {
    ...
    pub tx_inf: Vec<PaymentTransaction135>,
...
impl Validate for FitoFIPaymentReversalV11 {}
...
pub struct GroupHeader97 {
    ...
    #[yaserde(rename = "TtlRvsdIntrBkSttlmAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "TtlRvsdIntrBkSttlmAmt"))]
    pub ttl_rvsd_intr_bk_sttlm_amt: ActiveCurrencyAndAmount,
...
impl Validate for GroupHeader97 {}
...
pub struct PaymentTransaction135 {
    ...
    #[yaserde(rename = "RvsdIntrBkSttlmAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "RvsdIntrBkSttlmAmt"))]
...
impl Validate for PaymentTransaction135 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "pacs.007.001.11";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:pacs.007.001.11";
}
