...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pacs.007.001.14")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pacs.007.001.14")]
...
pub struct Document {
    ...
    pub fi_to_fi_pmt_rvsl: FitoFIPaymentReversalV14,
}
...
impl Validate for FitoFIPaymentReversalV14 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pacs.007.001.14")]
...
impl Validate for GroupHeader127 {}
...
pub struct OriginalGroupHeader20 {
    ...
    pub rvsl_rsn_inf: Vec<PaymentReversalReason10>,
}

impl Validate for OriginalGroupHeader20 {}
...
impl Validate for PaymentReversalReason10 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pacs.007.001.14")]
pub struct PaymentTransaction182 {
...
impl Validate for PaymentTransaction182 {}
...
pub struct ReversalReason4Choice {
    #[yaserde(rename = "Cd")]
    #[cfg_attr(feature = "serde", serde(rename = "Cd"))]
    pub cd: Option<ExternalReversalReason1Code>,
    #[yaserde(rename = "Prtry")]
    #[cfg_attr(feature = "serde", serde(rename = "Prtry"))]
    pub prtry: Option<Max35Text>,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "pacs.007.001.14";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:pacs.007.001.14";
}
