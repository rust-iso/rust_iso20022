...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pacs.003.001.09")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pacs.003.001.09")]
...
impl Validate for DirectDebitTransactionInformation29 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:pacs.003.001.09")]
pub struct Document {
    #[yaserde(rename = "FIToFICstmrDrctDbt")]
    #[cfg_attr(feature = "serde", serde(rename = "FIToFICstmrDrctDbt"))]
    pub fi_to_fi_cstmr_drct_dbt: FitoFICustomerDirectDebitV09,
}
...
pub struct FitoFICustomerDirectDebitV09 {
    ...
    pub grp_hdr: GroupHeader98,

    #[yaserde(rename = "DrctDbtTxInf")]
    #[cfg_attr(feature = "serde", serde(rename = "DrctDbtTxInf"))]
    pub drct_dbt_tx_inf: Vec<DirectDebitTransactionInformation29>,
...
impl Validate for FitoFICustomerDirectDebitV09 {}
...
impl Validate for GroupHeader98 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "pacs.003.001.09";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:pacs.003.001.09";
}
