...
pub enum Frequency34ChoiceChoice {
    Cd(EventFrequency7Code),
    Prtry(GenericIdentification47),
    __Unknown__(String),
}

impl Default for Frequency34ChoiceChoice {
    fn default() -> Frequency34ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for Frequency34ChoiceChoice {}
...
pub struct Frequency34Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub frequency_34_choice_choice: Frequency34ChoiceChoice,
}
