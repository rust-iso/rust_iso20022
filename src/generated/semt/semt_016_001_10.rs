...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.016.001.10")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.016.001.10")]
...
pub struct Document {
    ...
    pub intra_pos_mvmnt_pstng_rpt: IntraPositionMovementPostingReportV10,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.016.001.10")]
pub struct FinancialInstrumentDetails47 {
    ...
    pub sub_bal: Vec<IntraPositionDetails66>,
}

impl Validate for FinancialInstrumentDetails47 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.016.001.10")]
pub struct IntraPositionDetails66 {
    ...
    pub bal_fr: SecuritiesBalanceType6Choice,

    #[yaserde(rename = "IntraPosMvmnt")]
    #[cfg_attr(feature = "serde", serde(rename = "IntraPosMvmnt"))]
    pub intra_pos_mvmnt: Vec<IntraPositionMovementDetails21>,
}

impl Validate for IntraPositionDetails66 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.016.001.10")]
pub struct IntraPositionMovementDetails21 {
    #[yaserde(rename = "Id")]
    #[cfg_attr(feature = "serde", serde(rename = "Id"))]
    pub id: References72Choice,
    ...
    pub bal_to: SecuritiesBalanceType6Choice,
    ...
    pub corp_actn_evt_tp: CorporateActionEventType110Choice,
...
impl Validate for IntraPositionMovementDetails21 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.016.001.10")]
pub struct IntraPositionMovementPostingReportV10 {
    ...
    pub fin_instrm: Vec<FinancialInstrumentDetails47>,
}

impl Validate for IntraPositionMovementPostingReportV10 {}
...
pub enum References72ChoiceChoice {
...
impl Default for References72ChoiceChoice {
    fn default() -> References72ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for References72ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.016.001.10")]
pub struct References72Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub references_72_choice_choice: References72ChoiceChoice,
}

impl Validate for References72Choice {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "semt.016.001.10";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:semt.016.001.10";
}
