...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.003.002.11")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.003.002.11")]
pub struct AdditionalBalanceInformation23 {
...
impl Validate for AdditionalBalanceInformation23 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.003.002.11")]
pub struct AggregateBalanceInformation43 {
    ...
    pub addtl_deriv_attrbts: DerivativeBasicAttributes2,
...
impl Validate for AggregateBalanceInformation43 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.003.002.11")]
pub struct AggregateBalancePerSafekeepingPlace40 {
    #[yaserde(rename = "SfkpgPlc")]
    #[cfg_attr(feature = "serde", serde(rename = "SfkpgPlc"))]
    pub sfkpg_plc: SafeKeepingPlace4,
...
impl Validate for AggregateBalancePerSafekeepingPlace40 {}
...
pub struct BalanceAmounts5 {
    ...
    pub urlsd_gn_loss: AmountAndDirection14,
...
impl Validate for BalanceAmounts5 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.003.002.11")]
pub struct BalanceAmounts6 {
    #[yaserde(rename = "HldgVal")]
    #[cfg_attr(feature = "serde", serde(rename = "HldgVal"))]
    pub hldg_val: AmountAndDirection14,
...
impl Validate for BalanceAmounts6 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.003.002.11")]

pub enum BalanceQuantity15ChoiceChoice {
    Qty(Quantity54Choice),
    Prtry(GenericIdentification144),
    __Unknown__(String),
}

impl Default for BalanceQuantity15ChoiceChoice {
    fn default() -> BalanceQuantity15ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for BalanceQuantity15ChoiceChoice {}
...
pub struct BalanceQuantity15Choice {
    ...
    pub balance_quantity_15_choice_choice: BalanceQuantity15ChoiceChoice,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.003.002.11")]
pub struct DerivativeBasicAttributes2 {
    #[yaserde(rename = "NtnlCcyAndAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "NtnlCcyAndAmt"))]
    pub ntnl_ccy_and_amt: RestrictedFINActiveOrHistoricCurrencyAndAmount,
...
impl Validate for DerivativeBasicAttributes2 {}
...
pub struct Document {
    ...
    pub scties_bal_acctg_rpt: SecuritiesBalanceAccountingReport002V11,
}
...
pub enum PledgeeFormat6ChoiceChoice {
    TpAndId(PledgeeTypeAndAnyBICIdentifier2),
    Id(PledgeeTypeAndText2),
    Prtry(GenericIdentification85),
    __Unknown__(String),
}

impl Default for PledgeeFormat6ChoiceChoice {
    fn default() -> PledgeeFormat6ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for PledgeeFormat6ChoiceChoice {}
...
pub struct PledgeeFormat6Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub pledgee_format_6_choice_choice: PledgeeFormat6ChoiceChoice,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.003.002.11")]
pub struct QuantityBreakdown70 {
    ...
    #[yaserde(rename = "AcctBaseCcyAmts")]
    #[cfg_attr(feature = "serde", serde(rename = "AcctBaseCcyAmts"))]
    pub acct_base_ccy_amts: BalanceAmounts6,

    #[yaserde(rename = "InstrmCcyAmts")]
    #[cfg_attr(feature = "serde", serde(rename = "InstrmCcyAmts"))]
    pub instrm_ccy_amts: BalanceAmounts6,

    #[yaserde(rename = "AltrnRptgCcyAmts")]
    #[cfg_attr(feature = "serde", serde(rename = "AltrnRptgCcyAmts"))]
    pub altrn_rptg_ccy_amts: BalanceAmounts6,
}

impl Validate for QuantityBreakdown70 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.003.002.11")]
pub struct SecuritiesBalanceAccountingReport002V11 {
    ...
    pub bal_for_acct: Vec<AggregateBalanceInformation43>,

    #[yaserde(rename = "SubAcctDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "SubAcctDtls"))]
    pub sub_acct_dtls: Vec<SubAccountIdentification68>,

    #[yaserde(rename = "AcctBaseCcyTtlAmts")]
    #[cfg_attr(feature = "serde", serde(rename = "AcctBaseCcyTtlAmts"))]
    pub acct_base_ccy_ttl_amts: TotalValueInPageAndStatement4,

    #[yaserde(rename = "AltrnRptgCcyTtlAmts")]
    #[cfg_attr(feature = "serde", serde(rename = "AltrnRptgCcyTtlAmts"))]
    pub altrn_rptg_ccy_ttl_amts: TotalValueInPageAndStatement4,
}

impl Validate for SecuritiesBalanceAccountingReport002V11 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.003.002.11")]
pub struct SubAccountIdentification68 {
    #[yaserde(rename = "AcctOwnr")]
    #[cfg_attr(feature = "serde", serde(rename = "AcctOwnr"))]
    pub acct_ownr: PartyIdentification156,
    ...
    pub bal_for_sub_acct: Vec<AggregateBalanceInformation43>,
}

impl Validate for SubAccountIdentification68 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.003.002.11")]
pub struct SubBalanceInformation23 {
    #[yaserde(rename = "SubBalTp")]
    #[cfg_attr(feature = "serde", serde(rename = "SubBalTp"))]
    ...
    pub addtl_bal_brkdwn_dtls: Vec<AdditionalBalanceInformation23>,
}

impl Validate for SubBalanceInformation23 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.003.002.11")]

pub enum SubBalanceQuantity9ChoiceChoice {
    Qty(FinancialInstrumentQuantity36Choice),
    Prtry(GenericIdentification144),
    QtyAndAvlbty(QuantityAndAvailability4),
    __Unknown__(String),
}

impl Default for SubBalanceQuantity9ChoiceChoice {
    fn default() -> SubBalanceQuantity9ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for SubBalanceQuantity9ChoiceChoice {}
...
pub struct SubBalanceQuantity9Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub sub_balance_quantity_9_choice_choice: SubBalanceQuantity9ChoiceChoice,
}
...
pub enum SubBalanceType13ChoiceChoice {
    Cd(SecuritiesBalanceType12Code),
    Prtry(GenericIdentification47),
    __Unknown__(String),
}

impl Default for SubBalanceType13ChoiceChoice {
    fn default() -> SubBalanceType13ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for SubBalanceType13ChoiceChoice {}
...
pub struct SubBalanceType13Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub sub_balance_type_13_choice_choice: SubBalanceType13ChoiceChoice,
}
...
pub enum SubBalanceType14ChoiceChoice {
    Cd(SecuritiesBalanceType7Code),
    Prtry(GenericIdentification47),
    __Unknown__(String),
}

impl Default for SubBalanceType14ChoiceChoice {
    fn default() -> SubBalanceType14ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for SubBalanceType14ChoiceChoice {}
...
pub struct SubBalanceType14Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub sub_balance_type_14_choice_choice: SubBalanceType14ChoiceChoice,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.003.002.11")]
pub struct TotalValueInPageAndStatement4 {
...
impl Validate for TotalValueInPageAndStatement4 {}
...
pub enum TypeOfPrice33ChoiceChoice {
    Cd(TypeOfPrice11Code),
    Prtry(GenericIdentification47),
    __Unknown__(String),
}

impl Default for TypeOfPrice33ChoiceChoice {
    fn default() -> TypeOfPrice33ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for TypeOfPrice33ChoiceChoice {}
...
pub struct TypeOfPrice33Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub type_of_price_33_choice_choice: TypeOfPrice33ChoiceChoice,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "semt.003.002.11";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:semt.003.002.11";
}
