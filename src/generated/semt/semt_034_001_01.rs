...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.034.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.034.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.034.001.01")]
pub struct Document {
    #[yaserde(rename = "IntraPosMvmntPdgRpt")]
    #[cfg_attr(feature = "serde", serde(rename = "IntraPosMvmntPdgRpt"))]
    pub intra_pos_mvmnt_pdg_rpt: IntraPositionMovementPendingReportV01,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.034.001.01")]
pub struct IntraPositionMovementPendingReportV01 {
    ...
    pub rpt_gnl_dtls: IntraPositionReport7,
    ...
    pub mvmnts: Vec<IntraPositionPending11>,
}

impl Validate for IntraPositionMovementPendingReportV01 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.034.001.01")]
pub struct IntraPositionPending11 {
    #[yaserde(rename = "StsAndRsn")]
    #[cfg_attr(feature = "serde", serde(rename = "StsAndRsn"))]
    pub sts_and_rsn: PendingStatusAndReason4,

    #[yaserde(rename = "Mvmnt")]
    #[cfg_attr(feature = "serde", serde(rename = "Mvmnt"))]
    pub mvmnt: Vec<IntraPositionPending12>,
}

impl Validate for IntraPositionPending11 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.034.001.01")]
pub struct IntraPositionPending12 {
    #[yaserde(rename = "StsAndRsn")]
    #[cfg_attr(feature = "serde", serde(rename = "StsAndRsn"))]
    pub sts_and_rsn: PendingStatusAndReason4,
...
impl Validate for IntraPositionPending12 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.034.001.01")]
pub struct IntraPositionReport7 {
...
impl Validate for IntraPositionReport7 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.034.001.01")]
pub struct PendingStatusAndReason4 {
    #[yaserde(rename = "PrcgSts")]
    #[cfg_attr(feature = "serde", serde(rename = "PrcgSts"))]
    pub prcg_sts: Vec<ProcessingStatus100Choice>,
...
impl Validate for PendingStatusAndReason4 {}
...
pub enum ProcessingStatus100ChoiceChoice {
...
impl Default for ProcessingStatus100ChoiceChoice {
    fn default() -> ProcessingStatus100ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ProcessingStatus100ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.034.001.01")]
pub struct ProcessingStatus100Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub processing_status_100_choice_choice: ProcessingStatus100ChoiceChoice,
}

impl Validate for ProcessingStatus100Choice {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "semt.034.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:semt.034.001.01";
}
