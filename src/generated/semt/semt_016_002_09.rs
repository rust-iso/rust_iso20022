...
pub enum References75ChoiceChoice {
    AcctOwnrTxId(RestrictedFINXMax16Text),
    ...
    PrcrTxId(RestrictedFINXMax16Text),
    __Unknown__(String),
}

impl Default for References75ChoiceChoice {
    fn default() -> References75ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for References75ChoiceChoice {}
...
pub struct References75Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub references_75_choice_choice: References75ChoiceChoice,
}
...
pub enum SecuritiesBalanceType8ChoiceChoice {
    Cd(SecuritiesBalanceType11Code),
    Prtry(GenericIdentification47),
    __Unknown__(String),
}

impl Default for SecuritiesBalanceType8ChoiceChoice {
    fn default() -> SecuritiesBalanceType8ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for SecuritiesBalanceType8ChoiceChoice {}
...
pub struct SecuritiesBalanceType8Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub securities_balance_type_8_choice_choice: SecuritiesBalanceType8ChoiceChoice,
}
