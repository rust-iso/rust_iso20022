...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.002.001.12")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.002.001.12")]
pub struct AdditionalBalanceInformation20 {
    ...
    pub qty_brkdwn: Vec<QuantityBreakdown57>,
}

impl Validate for AdditionalBalanceInformation20 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.002.001.12")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.002.001.12")]
pub struct AggregateBalanceInformation46 {
    ...
    pub bal_brkdwn: Vec<SubBalanceInformation20>,

    #[yaserde(rename = "AddtlBalBrkdwn")]
    #[cfg_attr(feature = "serde", serde(rename = "AddtlBalBrkdwn"))]
    pub addtl_bal_brkdwn: Vec<AdditionalBalanceInformation20>,

    #[yaserde(rename = "BalAtSfkpgPlc")]
    #[cfg_attr(feature = "serde", serde(rename = "BalAtSfkpgPlc"))]
    pub bal_at_sfkpg_plc: Vec<AggregateBalancePerSafekeepingPlace43>,
...
impl Validate for AggregateBalanceInformation46 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.002.001.12")]
pub struct AggregateBalancePerSafekeepingPlace43 {
    #[yaserde(rename = "SfkpgPlc")]
    #[cfg_attr(feature = "serde", serde(rename = "SfkpgPlc"))]
    pub sfkpg_plc: SafeKeepingPlace5,
...
impl Validate for AggregateBalancePerSafekeepingPlace43 {}
...
pub struct Balance18 {
    ...
    #[yaserde(rename = "Qty")]
    #[cfg_attr(feature = "serde", serde(rename = "Qty"))]
    pub qty: BalanceQuantity14Choice,
}

impl Validate for Balance18 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.002.001.12")]
pub struct Balance21 {
    #[yaserde(rename = "ShrtLngInd")]
    #[cfg_attr(feature = "serde", serde(rename = "ShrtLngInd"))]
    pub shrt_lng_ind: ShortLong1Code,
...
pub struct Document {
    ...
    pub scties_bal_ctdy_rpt: SecuritiesBalanceCustodyReportV12,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.002.001.12")]
pub struct QuantityBreakdown57 {
...
impl Validate for QuantityBreakdown57 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.002.001.12")]
pub struct SecuritiesBalanceCustodyReportV12 {
    ...
    pub bal_for_acct: Vec<AggregateBalanceInformation46>,

    #[yaserde(rename = "SubAcctDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "SubAcctDtls"))]
    pub sub_acct_dtls: Vec<SubAccountIdentification71>,
...
impl Validate for SecuritiesBalanceCustodyReportV12 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.002.001.12")]
pub struct SubAccountIdentification71 {
    #[yaserde(rename = "AcctOwnr")]
    #[cfg_attr(feature = "serde", serde(rename = "AcctOwnr"))]
    pub acct_ownr: PartyIdentification144,
    ...
    pub bal_for_sub_acct: Vec<AggregateBalanceInformation46>,
}

impl Validate for SubAccountIdentification71 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.002.001.12")]
pub struct SubBalanceInformation20 {
    #[yaserde(rename = "SubBalTp")]
    #[cfg_attr(feature = "serde", serde(rename = "SubBalTp"))]
    ...
    pub addtl_bal_brkdwn_dtls: Vec<AdditionalBalanceInformation20>,
}

impl Validate for SubBalanceInformation20 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:semt.002.001.12")]

pub enum SubBalanceQuantity8ChoiceChoice {
    Qty(FinancialInstrumentQuantity33Choice),
    Prtry(GenericIdentification56),
    QtyAndAvlbty(QuantityAndAvailability3),
    __Unknown__(String),
}

impl Default for SubBalanceQuantity8ChoiceChoice {
    fn default() -> SubBalanceQuantity8ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for SubBalanceQuantity8ChoiceChoice {}
...
pub struct SubBalanceQuantity8Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub sub_balance_quantity_8_choice_choice: SubBalanceQuantity8ChoiceChoice,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "semt.002.001.12";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:semt.002.001.12";
}
