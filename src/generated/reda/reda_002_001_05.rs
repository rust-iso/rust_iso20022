...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.002.001.05")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.002.001.05")]
...
pub struct Document {
    ...
    pub pric_rpt_cxl: PriceReportCancellationV05,
}
...
pub struct PriceReportCancellationV05 {
    ...
    pub canc_pric_valtn_dtls: Vec<PriceReport4>,
...
impl Validate for PriceReportCancellationV05 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "reda.002.001.05";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:reda.002.001.05";
}
