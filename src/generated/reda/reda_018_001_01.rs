...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.018.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.018.001.01")]
pub struct Document {
    #[yaserde(rename = "SctiesAcctCreReq")]
    #[cfg_attr(feature = "serde", serde(rename = "SctiesAcctCreReq"))]
    pub scties_acct_cre_req: SecuritiesAccountCreationRequestV01,
}
...
impl Validate for SecuritiesAccountCreationRequestV01 {}
...
impl Validate for SystemSecuritiesAccount7 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "reda.018.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:reda.018.001.01";
}
