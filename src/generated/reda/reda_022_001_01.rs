...
pub struct Document {
    ...
    pub pty_mod_req: PartyModificationRequestV01,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.022.001.01")]
pub struct PartyModificationRequestV01 {
    ...
    pub _mod: Vec<SystemPartyModification2>,
...
impl Validate for PartyModificationRequestV01 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.022.001.01")]
pub struct SystemPartyModification2 {
    ...
    pub reqd_mod: SystemPartyModification2Choice,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "reda.022.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:reda.022.001.01";
}
