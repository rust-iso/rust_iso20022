...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.045.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.045.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.045.001.01")]
pub struct Document {
    #[yaserde(rename = "SctyCSDLkCreReq")]
    #[cfg_attr(feature = "serde", serde(rename = "SctyCSDLkCreReq"))]
    pub scty_csd_lk_cre_req: SecurityCSDLinkCreationRequestV01,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.045.001.01")]
pub struct IssuanceAccount3 {
    #[yaserde(rename = "IssncAcct")]
    #[cfg_attr(feature = "serde", serde(rename = "IssncAcct"))]
    pub issnc_acct: SecuritiesAccount19,

    #[yaserde(rename = "IssncBlckChainAdrOrWllt")]
    #[cfg_attr(feature = "serde", serde(rename = "IssncBlckChainAdrOrWllt"))]
    pub issnc_blck_chain_adr_or_wllt: BlockChainAddressWallet3,
...
impl Validate for IssuanceAccount3 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.045.001.01")]
...
pub struct SecurityCSDLink12 {
    ...
    pub scty_mntnc: TrueFalseIndicator,

    #[yaserde(rename = "IssncAcct")]
    #[cfg_attr(feature = "serde", serde(rename = "IssncAcct"))]
    pub issnc_acct: Vec<IssuanceAccount3>,
...
impl Validate for SecurityCSDLink12 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.045.001.01")]
pub struct SecurityCSDLinkCreationRequestV01 {
    ...
    pub scty_csd_lk: Vec<SecurityCSDLink12>,
...
impl Validate for SecurityCSDLinkCreationRequestV01 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "reda.045.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:reda.045.001.01";
}
