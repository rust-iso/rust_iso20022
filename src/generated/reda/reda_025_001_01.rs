...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.025.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.025.001.01")]
pub struct Document {
    #[yaserde(rename = "ElgblSctiesCreReq")]
    #[cfg_attr(feature = "serde", serde(rename = "ElgblSctiesCreReq"))]
    pub elgbl_scties_cre_req: EligibleSecuritiesCreationRequestV01,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.025.001.01")]
pub struct EligibleSecuritiesCreationRequestV01 {
...
impl Validate for EligibleSecuritiesCreationRequestV01 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "reda.025.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:reda.025.001.01";
}
