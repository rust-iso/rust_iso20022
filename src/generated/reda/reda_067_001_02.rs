...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.067.001.02")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.067.001.02")]
...
impl Validate for CreditorEnrolment6 {}
...
pub struct CreditorEnrolmentAmendment5 {
    ...
    pub amdmnt_rsn: CreditorEnrolmentAmendmentReason3,
...
impl Validate for CreditorEnrolmentAmendment5 {}
...
pub struct CreditorEnrolmentAmendment6 {
    ...
    pub cdtr_enrlmnt: CreditorEnrolment6,

    #[yaserde(rename = "ActvtnData")]
    #[cfg_attr(feature = "serde", serde(rename = "ActvtnData"))]
    pub actvtn_data: CreditorInvoice5,
}

impl Validate for CreditorEnrolmentAmendment6 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.067.001.02")]
pub struct CreditorEnrolmentAmendmentReason1Choice {
    #[yaserde(rename = "Cd")]
    #[cfg_attr(feature = "serde", serde(rename = "Cd"))]
    pub cd: Option<ExternalCreditorEnrolmentAmendmentReason1Code>,
    #[yaserde(rename = "Prtry")]
    #[cfg_attr(feature = "serde", serde(rename = "Prtry"))]
    pub prtry: Option<Max35Text>,
}

impl Validate for CreditorEnrolmentAmendmentReason1Choice {}
...
impl Validate for CreditorEnrolmentAmendmentReason3 {}
...
impl Validate for CreditorInvoice5 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.067.001.02")]
pub struct Document {
    #[yaserde(rename = "ReqToPayCdtrEnrlmntAmdmntReq")]
    #[cfg_attr(feature = "serde", serde(rename = "ReqToPayCdtrEnrlmntAmdmntReq"))]
    pub req_to_pay_cdtr_enrlmnt_amdmnt_req: RequestToPayCreditorEnrolmentAmendmentRequestV02,
}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct ExternalCreditorEnrolmentAmendmentReason1Code (pub String);
crate::simple_type!(ExternalCreditorEnrolmentAmendmentReason1Code);

impl Validate for ExternalCreditorEnrolmentAmendmentReason1Code {
...
pub struct RequestToPayCreditorEnrolmentAmendmentRequestV02 {
    ...
    #[yaserde(rename = "AmdmntData")]
    #[cfg_attr(feature = "serde", serde(rename = "AmdmntData"))]
...
impl Validate for RequestToPayCreditorEnrolmentAmendmentRequestV02 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "reda.067.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:reda.067.001.02";
}
