...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.016.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.016.001.01")]
pub struct Document {
    #[yaserde(rename = "PtyStsAdvc")]
    #[cfg_attr(feature = "serde", serde(rename = "PtyStsAdvc"))]
    pub pty_sts_advc: PartyStatusAdviceV01,
}
...
impl Validate for PartyStatus2 {}
...
pub struct PartyStatusAdviceV01 {
    ...
    #[yaserde(rename = "PtySts")]
    #[cfg_attr(feature = "serde", serde(rename = "PtySts"))]
...
impl Validate for PartyStatusAdviceV01 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "reda.016.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:reda.016.001.01";
}
