...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.032.001.01")]
pub struct Document {
    #[yaserde(rename = "SctiesAcctDeltnReq")]
    #[cfg_attr(feature = "serde", serde(rename = "SctiesAcctDeltnReq"))]
    pub scties_acct_deltn_req: SecuritiesAccountDeletionRequestV01,
}
...
impl Validate for SecuritiesAccountDeletionRequestV01 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "reda.032.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:reda.032.001.01";
}
