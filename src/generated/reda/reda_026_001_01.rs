...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.026.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.026.001.01")]
pub struct Document {
    #[yaserde(rename = "ElgblCntrptCSDCreReq")]
    #[cfg_attr(feature = "serde", serde(rename = "ElgblCntrptCSDCreReq"))]
    pub elgbl_cntrpt_csd_cre_req: EligibleCounterpartCSDCreationRequestV01,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.026.001.01")]
pub struct EligibilityIdentification3Choice {
    #[yaserde(rename = "Ctry")]
    #[cfg_attr(feature = "serde", serde(rename = "Ctry"))]
    pub ctry: Option<CountryCode>,
    #[yaserde(rename = "FinInstrmId")]
    #[cfg_attr(feature = "serde", serde(rename = "FinInstrmId"))]
    pub fin_instrm_id: Option<Isinoct2015Identifier>,
    #[yaserde(rename = "IssrCSDId")]
    #[cfg_attr(feature = "serde", serde(rename = "IssrCSDId"))]
    pub issr_c_s_d_id: Option<SystemPartyIdentification2Choice>,
}

impl Validate for EligibilityIdentification3Choice {}
...
pub enum EligibilityType1Code {
    #[yaserde(rename = "SECU")]
    #[cfg_attr(feature = "serde", serde(rename = "SECU"))]
    Secu,
    #[yaserde(rename = "ISCS")]
    #[cfg_attr(feature = "serde", serde(rename = "ISCS"))]
    Iscs,
    #[yaserde(rename = "CTRY")]
    #[cfg_attr(feature = "serde", serde(rename = "CTRY"))]
    Ctry,
...
impl Default for EligibilityType1Code {
    fn default() -> EligibilityType1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for EligibilityType1Code {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.026.001.01")]
pub struct EligibleCounterpart3 {
    #[yaserde(rename = "IssrId")]
    #[cfg_attr(feature = "serde", serde(rename = "IssrId"))]
    pub issr_id: SystemPartyIdentification2Choice,

    #[yaserde(rename = "ElgblCntrptId")]
    #[cfg_attr(feature = "serde", serde(rename = "ElgblCntrptId"))]
    pub elgbl_cntrpt_id: SystemPartyIdentification2Choice,
    ...
    #[yaserde(rename = "ElgbltyTp")]
    #[cfg_attr(feature = "serde", serde(rename = "ElgbltyTp"))]
    pub elgblty_tp: EligibilityType1Code,

    #[yaserde(rename = "ElgbltyId")]
    #[cfg_attr(feature = "serde", serde(rename = "ElgbltyId"))]
    pub elgblty_id: EligibilityIdentification3Choice,
}

impl Validate for EligibleCounterpart3 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.026.001.01")]
pub struct EligibleCounterpartCSDCreationRequestV01 {
    #[yaserde(rename = "MsgHdr")]
    #[cfg_attr(feature = "serde", serde(rename = "MsgHdr"))]
    pub msg_hdr: MessageHeader1,

    #[yaserde(rename = "ElgblCntrptCSD")]
    #[cfg_attr(feature = "serde", serde(rename = "ElgblCntrptCSD"))]
    pub elgbl_cntrpt_csd: EligibleCounterpart3,
...
impl Validate for EligibleCounterpartCSDCreationRequestV01 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "reda.026.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:reda.026.001.01";
}
