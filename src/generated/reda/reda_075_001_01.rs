...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.075.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.075.001.01")]
pub struct Document {
    #[yaserde(rename = "ElgblSctiesDeltnReq")]
    #[cfg_attr(feature = "serde", serde(rename = "ElgblSctiesDeltnReq"))]
    pub elgbl_scties_deltn_req: EligibleSecuritiesDeletionRequestV01,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.075.001.01")]
pub struct EligibleSecuritiesDeletionRequestV01 {
    #[yaserde(rename = "MsgHdr")]
    #[cfg_attr(feature = "serde", serde(rename = "MsgHdr"))]
    pub msg_hdr: MessageHeader1,

    #[yaserde(rename = "ElgblScty")]
    #[cfg_attr(feature = "serde", serde(rename = "ElgblScty"))]
    pub elgbl_scty: Vec<EligibleSecurity5>,
...
impl Validate for EligibleSecuritiesDeletionRequestV01 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.075.001.01")]
pub struct EligibleSecurity5 {
    #[yaserde(rename = "SctyId")]
    #[cfg_attr(feature = "serde", serde(rename = "SctyId"))]
    pub scty_id: Vec<SecurityIdentification19>,

    #[yaserde(rename = "CollstnCcy")]
    #[cfg_attr(feature = "serde", serde(rename = "CollstnCcy"))]
    pub collstn_ccy: ActiveOrHistoricCurrencyCode,
...
impl Validate for EligibleSecurity5 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "reda.075.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:reda.075.001.01";
}
