...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.050.001.01")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.050.001.01")]
pub struct AccountLinkMaintenanceRequestV01 {
...
impl Validate for AccountLinkMaintenanceRequestV01 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.050.001.01")]
pub struct AccountLinkUpdate2 {
    #[yaserde(rename = "VldTo")]
    #[cfg_attr(feature = "serde", serde(rename = "VldTo"))]
    pub vld_to: DateAndDateTime2Choice,
}

impl Validate for AccountLinkUpdate2 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.050.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.050.001.01")]
pub struct Document {
    #[yaserde(rename = "AcctLkMntncReq")]
    #[cfg_attr(feature = "serde", serde(rename = "AcctLkMntncReq"))]
    pub acct_lk_mntnc_req: AccountLinkMaintenanceRequestV01,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "reda.050.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:reda.050.001.01";
}
