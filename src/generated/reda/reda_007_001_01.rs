...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.007.001.01")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.007.001.01")]
...
impl Validate for CommonFinancialInstrumentAttributes12 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.007.001.01")]
pub struct Document {
    #[yaserde(rename = "SctyMntncReq")]
    #[cfg_attr(feature = "serde", serde(rename = "SctyMntncReq"))]
    pub scty_mntnc_req: SecurityMaintenanceRequestV01,
}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct ExternalSecuritiesUpdateReason1Code (pub String);
crate::simple_type!(ExternalSecuritiesUpdateReason1Code);

impl Validate for ExternalSecuritiesUpdateReason1Code {
    fn validate(&self) -> Result<(), String> { 
        #[allow(clippy::len_zero)]
        if self.0.len() < 1 {
            return Err(format!("MinLength validation error. \nExpected: 0 length >= 1 \nActual: 0 length == {}", self.0.len()));
...
pub enum SecuritiesUpdateReason1ChoiceChoice {
    Cd(ExternalSecuritiesUpdateReason1Code),
    Prtry(GenericIdentification30),
    __Unknown__(String),
}

impl Default for SecuritiesUpdateReason1ChoiceChoice {
    fn default() -> SecuritiesUpdateReason1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for SecuritiesUpdateReason1ChoiceChoice {}
...
pub struct SecuritiesUpdateReason1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub securities_update_reason_1_choice_choice: SecuritiesUpdateReason1ChoiceChoice,
}

impl Validate for SecuritiesUpdateReason1Choice {}
...
pub struct SecurityAttributes12 {
    ...
    pub fin_instrm_attrbts: Vec<CommonFinancialInstrumentAttributes12>,
...
impl Validate for SecurityAttributes12 {}
...
pub struct SecurityMaintenanceRequestV01 {
    ...
    #[yaserde(rename = "UpdRsn")]
    #[cfg_attr(feature = "serde", serde(rename = "UpdRsn"))]
    pub upd_rsn: SecuritiesUpdateReason1Choice,
...
impl Validate for SecurityMaintenanceRequestV01 {}
...
pub enum UpdateType35ChoiceChoice {
    Add(SecurityAttributes12),
    Del(SecurityAttributes12),
    Modfy(SecurityAttributes12),
    __Unknown__(String),
}

impl Default for UpdateType35ChoiceChoice {
    fn default() -> UpdateType35ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for UpdateType35ChoiceChoice {}
...
pub struct UpdateType35Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub update_type_35_choice_choice: UpdateType35ChoiceChoice,
}

impl Validate for UpdateType35Choice {}
...
pub enum UpdateType36ChoiceChoice {
    UpdTp(Vec<UpdateType35Choice>),
    Rplc(SecurityAttributes12),
    __Unknown__(String),
}

impl Default for UpdateType36ChoiceChoice {
    fn default() -> UpdateType36ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for UpdateType36ChoiceChoice {}
...
pub struct UpdateType36Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub update_type_36_choice_choice: UpdateType36ChoiceChoice,
}

impl Validate for UpdateType36Choice {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "reda.007.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:reda.007.001.01";
}
