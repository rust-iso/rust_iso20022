...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.036.001.01")]
pub struct Document {
    #[yaserde(rename = "SctiesAcctAudtTrlQry")]
    #[cfg_attr(feature = "serde", serde(rename = "SctiesAcctAudtTrlQry"))]
    pub scties_acct_audt_trl_qry: SecuritiesAccountAuditTrailQueryV01,
}
...
impl Validate for SecuritiesAccountAuditTrailQueryV01 {}
...
impl Validate for SecuritiesAccountAuditTrailSearchCriteria3 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "reda.036.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:reda.036.001.01";
}
