...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.060.001.02")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.060.001.02")]
...
pub struct Document {
    ...
    pub netg_cut_off_ref_data_upd_req: NettingCutOffReferenceDataUpdateRequestV02,
}
...
impl Validate for NettingCutOffReferenceDataUpdateRequestV02 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.060.001.02")]
...
pub struct RequestData2 {
    ...
    pub req_svcr: PartyIdentification242Choice,
...
impl Validate for RequestData2 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "reda.060.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:reda.060.001.02";
}
