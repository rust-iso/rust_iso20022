...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.077.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.077.001.01")]
pub struct CloseLink5 {
    ...
    #[yaserde(rename = "CdtPrvdrId")]
    #[cfg_attr(feature = "serde", serde(rename = "CdtPrvdrId"))]
    pub cdt_prvdr_id: SystemPartyIdentification2Choice,
}

impl Validate for CloseLink5 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.077.001.01")]
pub struct CloseLinkDeletionRequestV01 {
    #[yaserde(rename = "MsgHdr")]
    #[cfg_attr(feature = "serde", serde(rename = "MsgHdr"))]
    pub msg_hdr: MessageHeader1,

    #[yaserde(rename = "ClsLk")]
    #[cfg_attr(feature = "serde", serde(rename = "ClsLk"))]
    pub cls_lk: Vec<CloseLink5>,
...
impl Validate for CloseLinkDeletionRequestV01 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.077.001.01")]
pub struct Document {
    #[yaserde(rename = "ClsLkDeltnReq")]
    #[cfg_attr(feature = "serde", serde(rename = "ClsLkDeltnReq"))]
    pub cls_lk_deltn_req: CloseLinkDeletionRequestV01,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "reda.077.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:reda.077.001.01";
}
