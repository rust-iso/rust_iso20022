...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.041.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.041.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.041.001.01")]
pub struct Document {
    #[yaserde(rename = "PtyActvtyAdvc")]
    #[cfg_attr(feature = "serde", serde(rename = "PtyActvtyAdvc"))]
    pub pty_actvty_advc: PartyActivityAdviceV01,
}
...
pub struct PartyActivityAdviceV01 {
    ...
    #[yaserde(rename = "PtyActvty")]
    #[cfg_attr(feature = "serde", serde(rename = "PtyActvty"))]
...
impl Validate for PartyActivityAdviceV01 {}
...
impl Validate for PartyReferenceDataChange2 {}
...
impl Validate for PartyStatement2 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "reda.041.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:reda.041.001.01";
}
