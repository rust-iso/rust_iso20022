...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.009.001.01")]
pub struct Document {
    #[yaserde(rename = "SctyActvtyAdvc")]
    #[cfg_attr(feature = "serde", serde(rename = "SctyActvtyAdvc"))]
    pub scty_actvty_advc: SecurityActivityAdviceV01,
}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.009.001.01")]
...
impl Validate for SecuritiesReferenceDataChange3 {}
...
pub struct SecurityActivityAdviceV01 {
    ...
    #[yaserde(rename = "SctyActvty")]
    #[cfg_attr(feature = "serde", serde(rename = "SctyActvty"))]
...
impl Validate for SecurityActivityAdviceV01 {}
...
pub struct SecurityStatement3 {
    ...
    pub chng: Vec<SecuritiesReferenceDataChange3>,
}

impl Validate for SecurityStatement3 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "reda.009.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:reda.009.001.01";
}
