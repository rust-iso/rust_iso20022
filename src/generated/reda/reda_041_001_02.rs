...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.041.001.02")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.041.001.02")]
...
pub struct Document {
    ...
    pub pty_actvty_advc: PartyActivityAdviceV02,
}
...
impl Validate for PartyActivityAdviceV02 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.041.001.02")]
...
impl Validate for PartyReferenceDataChange3 {}
...
pub struct PartyStatement3 {
    ...
    pub chng: Vec<PartyReferenceDataChange3>,
}

impl Validate for PartyStatement3 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "reda.041.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:reda.041.001.02";
}
