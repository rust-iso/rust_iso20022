...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.019.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.019.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.019.001.01")]
pub struct Document {
    #[yaserde(rename = "SctiesAcctQry")]
    #[cfg_attr(feature = "serde", serde(rename = "SctiesAcctQry"))]
    pub scties_acct_qry: SecuritiesAccountQueryV01,
}
...
pub struct SecuritiesAccountQueryV01 {
    ...
    pub rtr_crit: SecuritiesAccountReturnCriteria1,
...
impl Validate for SecuritiesAccountQueryV01 {}
...
pub struct SecuritiesAccountReturnCriteria1 {
    ...
    pub acct_id: RequestedIndicator,
    ...
    pub end_invstr_flg: RequestedIndicator,

    #[yaserde(rename = "PricgSchme")]
    #[cfg_attr(feature = "serde", serde(rename = "PricgSchme"))]
    pub pricg_schme: RequestedIndicator,
}

impl Validate for SecuritiesAccountReturnCriteria1 {}
...
pub struct SecuritiesAccountSearchCriteria2 {
    ...
    #[yaserde(rename = "AcctTp")]
    #[cfg_attr(feature = "serde", serde(rename = "AcctTp"))]
    pub acct_tp: SystemSecuritiesAccountType1Choice,
...
impl Validate for SecuritiesAccountSearchCriteria2 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "reda.019.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:reda.019.001.01";
}
