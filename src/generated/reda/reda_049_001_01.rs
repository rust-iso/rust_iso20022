...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.049.001.01")]
...
pub struct AccountLink7 {
    ...
    #[yaserde(rename = "DfltInd")]
    #[cfg_attr(feature = "serde", serde(rename = "DfltInd"))]
    pub dflt_ind: YesNoIndicator,

    #[yaserde(rename = "CollstnInd")]
    #[cfg_attr(feature = "serde", serde(rename = "CollstnInd"))]
    pub collstn_ind: YesNoIndicator,

    #[yaserde(rename = "CshSttlmInd")]
    #[cfg_attr(feature = "serde", serde(rename = "CshSttlmInd"))]
    pub csh_sttlm_ind: YesNoIndicator,
}

impl Validate for AccountLink7 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.049.001.01")]
pub struct AccountLinkCreationRequestV01 {
    #[yaserde(rename = "MsgHdr")]
    #[cfg_attr(feature = "serde", serde(rename = "MsgHdr"))]
    pub msg_hdr: MessageHeader1,

    #[yaserde(rename = "AcctLk")]
    #[cfg_attr(feature = "serde", serde(rename = "AcctLk"))]
    pub acct_lk: Vec<AccountLink7>,
...
impl Validate for AccountLinkCreationRequestV01 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.049.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.049.001.01")]
pub struct Document {
    #[yaserde(rename = "AcctLkCreReq")]
    #[cfg_attr(feature = "serde", serde(rename = "AcctLkCreReq"))]
    pub acct_lk_cre_req: AccountLinkCreationRequestV01,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "reda.049.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:reda.049.001.01";
}
