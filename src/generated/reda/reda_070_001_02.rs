...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.070.001.02")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.070.001.02")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.070.001.02")]
pub struct Document {
    #[yaserde(rename = "ReqToPayDbtrActvtnReq")]
    #[cfg_attr(feature = "serde", serde(rename = "ReqToPayDbtrActvtnReq"))]
    pub req_to_pay_dbtr_actvtn_req: RequestToPayDebtorActivationRequestV02,
}
...
impl Validate for RequestToPayDebtorActivationRequestV02 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "reda.070.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:reda.070.001.02";
}
