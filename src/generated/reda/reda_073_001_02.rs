...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.073.001.02")]
...
pub struct ActivationStatus3 {
    ...
    pub sts_rsn: DebtorActivationStatusReason3,

    #[yaserde(rename = "OrgnlActvtnRef")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlActvtnRef"))]
    pub orgnl_actvtn_ref: OriginalActivation3Choice,

    #[yaserde(rename = "FctvActvtnDt")]
    #[cfg_attr(feature = "serde", serde(rename = "FctvActvtnDt"))]
    pub fctv_actvtn_dt: DateAndDateTime2Choice,
...
impl Validate for ActivationStatus3 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.073.001.02")]
...
pub struct DebtorActivationStatusReason1Choice {
    #[yaserde(rename = "Cd")]
    #[cfg_attr(feature = "serde", serde(rename = "Cd"))]
    pub cd: Option<ExternalDebtorActivationStatusReason1Code>,
    #[yaserde(rename = "Prtry")]
    #[cfg_attr(feature = "serde", serde(rename = "Prtry"))]
    pub prtry: Option<Max35Text>,
}

impl Validate for DebtorActivationStatusReason1Choice {}
...
impl Validate for DebtorActivationStatusReason3 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.073.001.02")]
pub struct Document {
    #[yaserde(rename = "ReqToPayDbtrActvtnStsRpt")]
    #[cfg_attr(feature = "serde", serde(rename = "ReqToPayDbtrActvtnStsRpt"))]
    pub req_to_pay_dbtr_actvtn_sts_rpt: RequestToPayDebtorActivationStatusReportV02,
}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct ExternalDebtorActivationStatusReason1Code (pub String);
crate::simple_type!(ExternalDebtorActivationStatusReason1Code);

impl Validate for ExternalDebtorActivationStatusReason1Code {
...
pub struct RequestToPayDebtorActivationStatusReportV02 {
    ...
    #[yaserde(rename = "OrgnlActvtnAndSts")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlActvtnAndSts"))]
...
impl Validate for RequestToPayDebtorActivationStatusReportV02 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "reda.073.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:reda.073.001.02";
}
