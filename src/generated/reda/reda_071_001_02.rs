...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.071.001.02")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.071.001.02")]
...
impl Validate for DebtorActivation6 {}
...
pub struct DebtorActivationAmendment5 {
    ...
    pub amdmnt_rsn: DebtorActivationAmendmentReason3,
...
impl Validate for DebtorActivationAmendment5 {}
...
pub struct DebtorActivationAmendment6 {
    #[yaserde(rename = "DbtrActvtn")]
    #[cfg_attr(feature = "serde", serde(rename = "DbtrActvtn"))]
    pub dbtr_actvtn: DebtorActivation6,

    #[yaserde(rename = "ElctrncInvcData")]
    #[cfg_attr(feature = "serde", serde(rename = "ElctrncInvcData"))]
    pub elctrnc_invc_data: ElectronicInvoice1,
}

impl Validate for DebtorActivationAmendment6 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.071.001.02")]
...
impl Validate for DebtorActivationAmendmentReason1Choice {}
...
impl Validate for DebtorActivationAmendmentReason3 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.071.001.02")]
pub struct Document {
    #[yaserde(rename = "ReqToPayDbtrActvtnAmdmntReq")]
    #[cfg_attr(feature = "serde", serde(rename = "ReqToPayDbtrActvtnAmdmntReq"))]
    pub req_to_pay_dbtr_actvtn_amdmnt_req: RequestToPayDebtorActivationAmendmentRequestV02,
}
...
pub struct ElectronicInvoice1 {
    #[yaserde(rename = "PresntmntTp")]
    #[cfg_attr(feature = "serde", serde(rename = "PresntmntTp"))]
    pub presntmnt_tp: PresentmentType1Code,
}

impl Validate for ElectronicInvoice1 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct ExternalDebtorActivationAmendmentReason1Code (pub String);
crate::simple_type!(ExternalDebtorActivationAmendmentReason1Code);

impl Validate for ExternalDebtorActivationAmendmentReason1Code {
...
impl Default for PresentmentType1Code {
    fn default() -> PresentmentType1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for PresentmentType1Code {}
...
impl Validate for RequestToPayDebtorActivationAmendmentRequestV02 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "reda.071.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:reda.071.001.02";
}
