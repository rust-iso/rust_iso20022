...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.030.001.01")]
pub struct Document {
    #[yaserde(rename = "SctyDeltnStsAdvc")]
    #[cfg_attr(feature = "serde", serde(rename = "SctyDeltnStsAdvc"))]
    pub scty_deltn_sts_advc: SecurityDeletionStatusAdviceV01,
}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:reda.030.001.01")]
...
impl Validate for SecurityDeletionStatusAdviceV01 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "reda.030.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:reda.030.001.01";
}
