...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.046.001.06")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.046.001.06")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.046.001.06")]
pub struct Document {
    #[yaserde(rename = "GetRsvatn")]
    #[cfg_attr(feature = "serde", serde(rename = "GetRsvatn"))]
    pub get_rsvatn: GetReservationV06,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.046.001.06")]
pub struct GetReservationV06 {
    #[yaserde(rename = "MsgHdr")]
    #[cfg_attr(feature = "serde", serde(rename = "MsgHdr"))]
    pub msg_hdr: MessageHeader9,

    #[yaserde(rename = "RsvatnQryDef")]
    #[cfg_attr(feature = "serde", serde(rename = "RsvatnQryDef"))]
    pub rsvatn_qry_def: ReservationQuery4,
...
impl Validate for GetReservationV06 {}
...
pub enum ReservationCriteria4ChoiceChoice {
    QryNm(Max35Text),
    NewCrit(ReservationCriteria5),
    __Unknown__(String),
}

impl Default for ReservationCriteria4ChoiceChoice {
    fn default() -> ReservationCriteria4ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ReservationCriteria4ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.046.001.06")]
pub struct ReservationCriteria4Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub reservation_criteria_4_choice_choice: ReservationCriteria4ChoiceChoice,
}

impl Validate for ReservationCriteria4Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.046.001.06")]
pub struct ReservationCriteria5 {
    ...
    pub sch_crit: Vec<ReservationSearchCriteria4>,

    #[yaserde(rename = "RtrCrit")]
    #[cfg_attr(feature = "serde", serde(rename = "RtrCrit"))]
    pub rtr_crit: ReservationReturnCriteria1,
}

impl Validate for ReservationCriteria5 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.046.001.06")]
pub struct ReservationQuery4 {
    #[yaserde(rename = "QryTp")]
    #[cfg_attr(feature = "serde", serde(rename = "QryTp"))]
    pub qry_tp: QueryType2Code,

    #[yaserde(rename = "RsvatnCrit")]
    #[cfg_attr(feature = "serde", serde(rename = "RsvatnCrit"))]
    pub rsvatn_crit: ReservationCriteria4Choice,
}

impl Validate for ReservationQuery4 {}
...
impl Validate for ReservationReturnCriteria1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.046.001.06")]
pub struct ReservationSearchCriteria4 {
    #[yaserde(rename = "SysId")]
    #[cfg_attr(feature = "serde", serde(rename = "SysId"))]
    pub sys_id: SystemIdentification2Choice,

    #[yaserde(rename = "DfltRsvatnTp")]
    #[cfg_attr(feature = "serde", serde(rename = "DfltRsvatnTp"))]
    pub dflt_rsvatn_tp: Vec<ReservationType2Choice>,

    #[yaserde(rename = "CurRsvatnTp")]
    #[cfg_attr(feature = "serde", serde(rename = "CurRsvatnTp"))]
    pub cur_rsvatn_tp: Vec<ReservationType2Choice>,
...
impl Validate for ReservationSearchCriteria4 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.046.001.06";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.046.001.06";
}
