...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.055.001.13")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.055.001.13")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.055.001.13")]
pub struct CustomerPaymentCancellationRequestV13 {
    ...
    pub undrlyg: Vec<UnderlyingTransaction37>,
...
impl Validate for CustomerPaymentCancellationRequestV13 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.055.001.13")]
...
pub struct Document {
    ...
    pub cstmr_pmt_cxl_req: CustomerPaymentCancellationRequestV13,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.055.001.13")]
pub struct OriginalPaymentInstruction55 {
    ...
    pub tx_inf: Vec<PaymentTransaction176>,
}

impl Validate for OriginalPaymentInstruction55 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.055.001.13")]
pub struct PaymentTransaction176 {
...
impl Validate for PaymentTransaction176 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.055.001.13")]
pub struct UnderlyingTransaction37 {
    ...
    pub orgnl_pmt_inf_and_cxl: Vec<OriginalPaymentInstruction55>,
}

impl Validate for UnderlyingTransaction37 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.055.001.13";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.055.001.13";
}
