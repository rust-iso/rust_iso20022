...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.081.001.02")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.081.001.02")]
...
pub struct Document {
    ...
    pub intra_bal_mvmnt_mod_rpt: IntraBalanceMovementModificationReportV02,
}
...
pub struct IntraBalanceModification7 {
    ...
    pub _mod: Vec<IntraBalanceModification8>,
}

impl Validate for IntraBalanceModification7 {}
...
impl Validate for IntraBalanceModification8 {}
...
pub struct IntraBalanceMovementModificationReportV02 {
    ...
    pub rpt_or_err: IntraBalanceOrOperationalError12Choice,
...
impl Validate for IntraBalanceMovementModificationReportV02 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.081.001.02")]
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.081.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.081.001.02";
}
