...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.029.001.11")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.029.001.11")]
...
impl Validate for Compensation4 {}
...
impl Validate for CorrectiveInterbankTransaction3 {}
...
impl Validate for CorrectivePaymentInitiation5 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.029.001.11")]

pub enum CorrectiveTransaction5ChoiceChoice {
    Initn(CorrectivePaymentInitiation5),
    IntrBk(CorrectiveInterbankTransaction3),
    __Unknown__(String),
}

impl Default for CorrectiveTransaction5ChoiceChoice {
    fn default() -> CorrectiveTransaction5ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for CorrectiveTransaction5ChoiceChoice {}
...
pub struct CorrectiveTransaction5Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub corrective_transaction_5_choice_choice: CorrectiveTransaction5ChoiceChoice,
}

impl Validate for CorrectiveTransaction5Choice {}
...
pub struct Document {
    ...
    pub rsltn_of_invstgtn: ResolutionOfInvestigationV11,
}
...
impl Validate for OriginalPaymentInstruction43 {}
...
impl Validate for PaymentTransaction132 {}
...
impl Validate for PaymentTransaction138 {}
...
impl Validate for PaymentTransaction139 {}
...
impl Validate for ResolutionData3 {}
...
impl Validate for ResolutionOfInvestigationV11 {}
...
impl Validate for UnderlyingTransaction29 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.029.001.11";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.029.001.11";
}
