...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.030.001.05")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.030.001.05")]
...
impl Validate for CaseForwardingNotification3 {}
...
pub enum CaseForwardingNotification3Code {
    #[yaserde(rename = "FTHI")]
    #[cfg_attr(feature = "serde", serde(rename = "FTHI"))]
    Fthi,
    #[yaserde(rename = "CANC")]
    ...
    Modi,
    #[yaserde(rename = "DTAU")]
    #[cfg_attr(feature = "serde", serde(rename = "DTAU"))]
    Dtau,
    #[yaserde(rename = "SAIN")]
    #[cfg_attr(feature = "serde", serde(rename = "SAIN"))]
    Sain,
    #[yaserde(rename = "MINE")]
...
impl Default for CaseForwardingNotification3Code {
    fn default() -> CaseForwardingNotification3Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for CaseForwardingNotification3Code {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.030.001.05")]
pub struct Document {
    #[yaserde(rename = "NtfctnOfCaseAssgnmt")]
    #[cfg_attr(feature = "serde", serde(rename = "NtfctnOfCaseAssgnmt"))]
    pub ntfctn_of_case_assgnmt: NotificationOfCaseAssignmentV05,
}
...
impl Validate for NotificationOfCaseAssignmentV05 {}
...
impl Validate for ReportHeader5 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.030.001.05";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.030.001.05";
}
