...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.058.001.10")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.058.001.10")]
...
pub struct Document {
    ...
    pub ntfctn_to_rcv_cxl_advc: NotificationToReceiveCancellationAdviceV10,
}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct ExternalNotificationCancellationReason1Code (pub String);
crate::simple_type!(ExternalNotificationCancellationReason1Code);

impl Validate for ExternalNotificationCancellationReason1Code {
    fn validate(&self) -> Result<(), String> { 
        #[allow(clippy::len_zero)]
        if self.0.len() < 1 {
            return Err(format!("MinLength validation error. \nExpected: 0 length >= 1 \nActual: 0 length == {}", self.0.len()));
...
pub struct GroupHeader117 {
    ...
    pub msg_sndr: Party50Choice,
}

impl Validate for GroupHeader117 {}
...
pub struct NotificationCancellationReason1Choice {
    #[yaserde(rename = "Cd")]
    #[cfg_attr(feature = "serde", serde(rename = "Cd"))]
    pub cd: Option<ExternalNotificationCancellationReason1Code>,
    #[yaserde(rename = "Prtry")]
    #[cfg_attr(feature = "serde", serde(rename = "Prtry"))]
    pub prtry: Option<Max35Text>,
}

impl Validate for NotificationCancellationReason1Choice {}
...
pub struct NotificationCancellationReason2 {
    ...
    #[yaserde(rename = "Rsn")]
    #[cfg_attr(feature = "serde", serde(rename = "Rsn"))]
    pub rsn: NotificationCancellationReason1Choice,
...
impl Validate for NotificationCancellationReason2 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.058.001.10")]
pub struct NotificationToReceiveCancellationAdviceV10 {
    #[yaserde(rename = "GrpHdr")]
    #[cfg_attr(feature = "serde", serde(rename = "GrpHdr"))]
    pub grp_hdr: GroupHeader117,

    #[yaserde(rename = "OrgnlNtfctn")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlNtfctn"))]
    pub orgnl_ntfctn: OriginalNotification18,

    #[yaserde(rename = "CxlRsn")]
    #[cfg_attr(feature = "serde", serde(rename = "CxlRsn"))]
    pub cxl_rsn: NotificationCancellationReason2,
...
impl Validate for NotificationToReceiveCancellationAdviceV10 {}
...
impl Validate for OriginalItem9 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.058.001.10")]
pub struct OriginalNotification18 {
    ...
    pub orgnl_ntfctn_ref: Vec<OriginalNotificationReference16>,
}

impl Validate for OriginalNotification18 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.058.001.10")]
pub struct OriginalNotificationReference16 {
    #[yaserde(rename = "Acct")]
    #[cfg_attr(feature = "serde", serde(rename = "Acct"))]
    pub acct: CashAccount40,
    ...
    pub orgnl_itm: Vec<OriginalItem9>,
}

impl Validate for OriginalNotificationReference16 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.058.001.10";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.058.001.10";
}
