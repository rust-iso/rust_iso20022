...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.057.001.09")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.057.001.09")]
pub struct AccountNotification26 {
    #[yaserde(rename = "Id")]
    ...
    pub itm: Vec<NotificationItem10>,
}

impl Validate for AccountNotification26 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.057.001.09")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.057.001.09")]
...
pub struct Document {
    ...
    pub ntfctn_to_rcv: NotificationToReceiveV09,
}
...
impl Validate for NotificationItem10 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.057.001.09")]
pub struct NotificationToReceiveV09 {
    ...
    pub ntfctn: AccountNotification26,
...
impl Validate for NotificationToReceiveV09 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.057.001.09";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.057.001.09";
}
