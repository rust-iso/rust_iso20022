...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.024.001.08")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.024.001.08")]
...
pub struct Document {
    ...
    pub modfy_stg_ordr: ModifyStandingOrderV08,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.024.001.08")]
pub struct ModifyStandingOrderV08 {
    ...
    pub new_stg_ordr_val_set: StandingOrder10,
...
impl Validate for ModifyStandingOrderV08 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.024.001.08";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.024.001.08";
}
