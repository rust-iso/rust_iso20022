...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.076.001.01")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.076.001.01")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.076.001.01")]
pub struct BillingReportRequestV01 {
    ...
    pub sch_crit: Vec<BillingSearchCriteria3>,
...
impl Validate for BillingReportRequestV01 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.076.001.01")]
pub struct BillingSearchCriteria3 {
    #[yaserde(rename = "Svc")]
...
impl Validate for BillingSearchCriteria3 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.076.001.01")]
pub struct Document {
    #[yaserde(rename = "BllgRptReq")]
    #[cfg_attr(feature = "serde", serde(rename = "BllgRptReq"))]
    pub bllg_rpt_req: BillingReportRequestV01,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.076.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.076.001.01";
}
