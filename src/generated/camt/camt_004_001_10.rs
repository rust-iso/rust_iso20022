...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.004.001.10")]
...
impl Validate for AccountOrBusinessError6Choice {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.004.001.10")]
...
impl Validate for AccountReport35 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.004.001.10")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.004.001.10")]
...
impl Validate for BilateralLimit4 {}
...
pub struct CashAccountData1 {
    ...
    pub cur_bil_lmt: Vec<BilateralLimit4>,

    #[yaserde(rename = "StgOrdr")]
    #[cfg_attr(feature = "serde", serde(rename = "StgOrdr"))]
    pub stg_ordr: Vec<StandingOrder11>,
}

impl Validate for CashAccountData1 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.004.001.10")]
...
impl Validate for ReturnAccountV10 {}
...
pub struct StandingOrder11 {
    ...
    pub sys_mmb: BranchAndFinancialInstitutionIdentification8,

    #[yaserde(rename = "RspnsblPty")]
    #[cfg_attr(feature = "serde", serde(rename = "RspnsblPty"))]
    pub rspnsbl_pty: BranchAndFinancialInstitutionIdentification8,
...
impl Validate for StandingOrder11 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.004.001.10";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.004.001.10";
}
