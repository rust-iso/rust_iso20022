...
pub enum IntraBalanceOrOperationalError9ChoiceChoice {
    Cxls(Vec<IntraBalanceCancellation5>),
    OprlErr(Vec<ErrorHandling5>),
    __Unknown__(String),
}

impl Default for IntraBalanceOrOperationalError9ChoiceChoice {
    fn default() -> IntraBalanceOrOperationalError9ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for IntraBalanceOrOperationalError9ChoiceChoice {}
...
pub struct IntraBalanceOrOperationalError9Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub intra_balance_or_operational_error_9_choice_choice: IntraBalanceOrOperationalError9ChoiceChoice,
}
