...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.036.001.05")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.036.001.05")]
...
impl Validate for DebitAuthorisationConfirmation2 {}
...
impl Validate for DebitAuthorisationResponseV05 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.036.001.05")]
pub struct Document {
    #[yaserde(rename = "DbtAuthstnRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "DbtAuthstnRspn"))]
    pub dbt_authstn_rspn: DebitAuthorisationResponseV05,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.036.001.05";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.036.001.05";
}
