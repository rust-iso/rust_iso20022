...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.003.001.07")]

pub enum AccountCriteria3ChoiceChoice {
    QryNm(Max35Text),
    NewCrit(AccountCriteria7),
    __Unknown__(String),
}

impl Default for AccountCriteria3ChoiceChoice {
    fn default() -> AccountCriteria3ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for AccountCriteria3ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.003.001.07")]
pub struct AccountCriteria3Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub account_criteria_3_choice_choice: AccountCriteria3ChoiceChoice,
}

impl Validate for AccountCriteria3Choice {}
...
pub struct AccountCriteria7 {
    ...
    pub sch_crit: Vec<CashAccountSearchCriteria7>,

    #[yaserde(rename = "RtrCrit")]
    #[cfg_attr(feature = "serde", serde(rename = "RtrCrit"))]
    pub rtr_crit: CashAccountReturnCriteria5,
}

impl Validate for AccountCriteria7 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.003.001.07")]
pub struct AccountQuery3 {
    #[yaserde(rename = "QryTp")]
    #[cfg_attr(feature = "serde", serde(rename = "QryTp"))]
    pub qry_tp: QueryType2Code,

    #[yaserde(rename = "AcctCrit")]
    #[cfg_attr(feature = "serde", serde(rename = "AcctCrit"))]
    pub acct_crit: AccountCriteria3Choice,
}

impl Validate for AccountQuery3 {}
...
pub struct CashAccountReturnCriteria5 {
    ...
    #[yaserde(rename = "MulLmtInd")]
    #[cfg_attr(feature = "serde", serde(rename = "MulLmtInd"))]
    pub mul_lmt_ind: RequestedIndicator,

    #[yaserde(rename = "MulBalRtrCrit")]
    #[cfg_attr(feature = "serde", serde(rename = "MulBalRtrCrit"))]
    pub mul_bal_rtr_crit: CashBalanceReturnCriteria2,

    #[yaserde(rename = "BilLmtInd")]
    #[cfg_attr(feature = "serde", serde(rename = "BilLmtInd"))]
    pub bil_lmt_ind: RequestedIndicator,

    #[yaserde(rename = "BilBalRtrCrit")]
    #[cfg_attr(feature = "serde", serde(rename = "BilBalRtrCrit"))]
    pub bil_bal_rtr_crit: CashBalanceReturnCriteria2,

    #[yaserde(rename = "StgOrdrInd")]
    #[cfg_attr(feature = "serde", serde(rename = "StgOrdrInd"))]
    pub stg_ordr_ind: RequestedIndicator,
...
impl Validate for CashAccountReturnCriteria5 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.003.001.07")]
pub struct CashAccountSearchCriteria7 {
    ...
    pub tp: Vec<CashAccountType2Choice>,
...
impl Validate for CashAccountSearchCriteria7 {}
...
pub struct CashBalanceReturnCriteria2 {
    ...
    #[yaserde(rename = "ValDtInd")]
    #[cfg_attr(feature = "serde", serde(rename = "ValDtInd"))]
    pub val_dt_ind: RequestedIndicator,

    #[yaserde(rename = "PrcgDtInd")]
    #[cfg_attr(feature = "serde", serde(rename = "PrcgDtInd"))]
    pub prcg_dt_ind: RequestedIndicator,

    #[yaserde(rename = "NbOfPmtsInd")]
    #[cfg_attr(feature = "serde", serde(rename = "NbOfPmtsInd"))]
    pub nb_of_pmts_ind: RequestedIndicator,
}

impl Validate for CashBalanceReturnCriteria2 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.003.001.07")]
pub struct Document {
    #[yaserde(rename = "GetAcct")]
    #[cfg_attr(feature = "serde", serde(rename = "GetAcct"))]
    pub get_acct: GetAccountV07,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.003.001.07")]
pub struct GetAccountV07 {
    #[yaserde(rename = "MsgHdr")]
    #[cfg_attr(feature = "serde", serde(rename = "MsgHdr"))]
    pub msg_hdr: MessageHeader9,

    #[yaserde(rename = "AcctQryDef")]
    #[cfg_attr(feature = "serde", serde(rename = "AcctQryDef"))]
    pub acct_qry_def: AccountQuery3,
...
impl Validate for GetAccountV07 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.003.001.07";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.003.001.07";
}
