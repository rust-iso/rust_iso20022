...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.039.001.05")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.039.001.05")]
...
pub struct CaseStatus2 {
    ...
    #[yaserde(rename = "CaseSts")]
    #[cfg_attr(feature = "serde", serde(rename = "CaseSts"))]
...
pub enum CaseStatus2Code {
    ...
    Uknw,
    #[yaserde(rename = "ODUE")]
    #[cfg_attr(feature = "serde", serde(rename = "ODUE"))]
    Odue,
    __Unknown__(String),
}

impl Default for CaseStatus2Code {
    fn default() -> CaseStatus2Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for CaseStatus2Code {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.039.001.05")]
pub struct CaseStatusReportV05 {
    #[yaserde(rename = "Hdr")]
    ...
    #[yaserde(rename = "NewAssgnmt")]
    #[cfg_attr(feature = "serde", serde(rename = "NewAssgnmt"))]
    pub new_assgnmt: CaseAssignment5,
...
impl Validate for CaseStatusReportV05 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.039.001.05")]
pub struct Document {
    #[yaserde(rename = "CaseStsRpt")]
    #[cfg_attr(feature = "serde", serde(rename = "CaseStsRpt"))]
    pub case_sts_rpt: CaseStatusReportV05,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.039.001.05";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.039.001.05";
}
