...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.110.001.02")]
...
pub struct AdditionalRequestData1Choice {
    #[yaserde(rename = "ReqdDbtAuthstn")]
    #[cfg_attr(feature = "serde", serde(rename = "ReqdDbtAuthstn"))]
    pub reqd_dbt_authstn: Option<DebitAuthorisation3>,
    #[yaserde(rename = "ReqdCompstn")]
    #[cfg_attr(feature = "serde", serde(rename = "ReqdCompstn"))]
    pub reqd_compstn: Option<CompensationRequest1>,
    #[yaserde(rename = "ReqdValtn")]
    #[cfg_attr(feature = "serde", serde(rename = "ReqdValtn"))]
    pub reqd_valtn: Option<AdjustmentRequest1>,
    #[yaserde(rename = "ReqNrrtv")]
    #[cfg_attr(feature = "serde", serde(rename = "ReqNrrtv"))]
    pub req_nrrtv: Option<Max500Text>,
}

impl Validate for AdditionalRequestData1Choice {}




#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.110.001.02")]
...
impl Validate for AdjustmentRequest1 {}
...
pub struct CompensationRequest1 {
    ...
    pub rsn: Vec<Max140Text>,
}

impl Validate for CompensationRequest1 {}
...
pub struct DebitAuthorisation3 {
    ...
    pub addtl_cxl_rsn_inf: Vec<Max140Text>,
}

impl Validate for DebitAuthorisation3 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.110.001.02")]
pub struct Document {
    #[yaserde(rename = "InvstgtnReq")]
    #[cfg_attr(feature = "serde", serde(rename = "InvstgtnReq"))]
    pub invstgtn_req: InvestigationRequestV02,
}
...
pub struct InvestigationReason2 {
    ...
    #[yaserde(rename = "RsnSubTp")]
    #[cfg_attr(feature = "serde", serde(rename = "RsnSubTp"))]
    pub rsn_sub_tp: InvestigationReasonSubType1Choice,

    #[yaserde(rename = "AddtlReqData")]
    #[cfg_attr(feature = "serde", serde(rename = "AddtlReqData"))]
    pub addtl_req_data: AdditionalRequestData1Choice,
...
impl Validate for InvestigationReason2 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.110.001.02")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.110.001.02")]
pub struct InvestigationRequest51 {
...
impl Validate for InvestigationRequest51 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.110.001.02")]
pub struct InvestigationRequestV02 {
    #[yaserde(rename = "InvstgtnReq")]
    #[cfg_attr(feature = "serde", serde(rename = "InvstgtnReq"))]
    pub invstgtn_req: InvestigationRequest51,
...
impl Validate for InvestigationRequestV02 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.110.001.02")]
...
impl crate::MxMessage for Document {
    ...
    const FUNCTIONALITY: &'static str = "110";
    const VARIANT: &'static str = "001";
    const VERSION: &'static str = "02";
    const MESSAGE_NAME: &'static str = "camt.110.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.110.001.02";
}
