...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.030.001.06")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.030.001.06")]
...
pub struct Document {
    ...
    pub ntfctn_of_case_assgnmt: NotificationOfCaseAssignmentV06,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.030.001.06")]
pub struct NotificationOfCaseAssignmentV06 {
    #[yaserde(rename = "Hdr")]
    #[cfg_attr(feature = "serde", serde(rename = "Hdr"))]
    pub hdr: ReportHeader7,
...
impl Validate for NotificationOfCaseAssignmentV06 {}
...
impl Validate for ReportHeader7 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.030.001.06";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.030.001.06";
}
