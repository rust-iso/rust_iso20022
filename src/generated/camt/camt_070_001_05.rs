...
pub enum StandingOrderOrError7ChoiceChoice {
    Rpt(Vec<StandingOrderReport2>),
    OprlErr(Vec<ErrorHandling5>),
    __Unknown__(String),
}

impl Default for StandingOrderOrError7ChoiceChoice {
    fn default() -> StandingOrderOrError7ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for StandingOrderOrError7ChoiceChoice {}
...
pub struct StandingOrderOrError7Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub standing_order_or_error_7_choice_choice: StandingOrderOrError7ChoiceChoice,
}
...
pub enum StandingOrderOrError8ChoiceChoice {
    StgOrdr(StandingOrder9),
    BizErr(Vec<ErrorHandling5>),
    __Unknown__(String),
}

impl Default for StandingOrderOrError8ChoiceChoice {
    fn default() -> StandingOrderOrError8ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for StandingOrderOrError8ChoiceChoice {}
...
pub struct StandingOrderOrError8Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub standing_order_or_error_8_choice_choice: StandingOrderOrError8ChoiceChoice,
}
