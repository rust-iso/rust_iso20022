...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.111.001.03")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.111.001.03")]
...
pub struct AdjustmentCompensation1 {
    ...
    pub initl_amt: ActiveCurrencyAndAmount,

    #[yaserde(rename = "DueChrgs")]
    #[cfg_attr(feature = "serde", serde(rename = "DueChrgs"))]
    pub due_chrgs: ActiveCurrencyAndAmount,

    #[yaserde(rename = "AmtDue")]
    #[cfg_attr(feature = "serde", serde(rename = "AmtDue"))]
    pub amt_due: ActiveCurrencyAndAmount,

    #[yaserde(rename = "CompstnAgt")]
    #[cfg_attr(feature = "serde", serde(rename = "CompstnAgt"))]
    pub compstn_agt: BranchAndFinancialInstitutionIdentification6,

    #[yaserde(rename = "CompstnAcct")]
    #[cfg_attr(feature = "serde", serde(rename = "CompstnAcct"))]
    pub compstn_acct: CashAccount40,
...
impl Validate for AdjustmentCompensation1 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.111.001.03")]
pub struct BookingConfirmation8 {
    #[yaserde(rename = "Amt")]
...
impl Validate for BookingConfirmation8 {}
...
pub struct CompensationResponse1 {
    #[yaserde(rename = "Grantd")]
    #[cfg_attr(feature = "serde", serde(rename = "Grantd"))]
    pub grantd: TrueFalseIndicator,

    #[yaserde(rename = "InitlAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "InitlAmt"))]
    pub initl_amt: ActiveCurrencyAndAmount,

    #[yaserde(rename = "PdChrgs")]
    #[cfg_attr(feature = "serde", serde(rename = "PdChrgs"))]
    pub pd_chrgs: ActiveCurrencyAndAmount,
...
impl Validate for CompensationResponse1 {}
...
pub struct DatePeriod5 {
    #[yaserde(rename = "CurValDt")]
    #[cfg_attr(feature = "serde", serde(rename = "CurValDt"))]
    pub cur_val_dt: Isodate,

    #[yaserde(rename = "ReqdValDt")]
    #[cfg_attr(feature = "serde", serde(rename = "ReqdValDt"))]
    pub reqd_val_dt: Isodate,
}

impl Validate for DatePeriod5 {}
...
pub struct DebitAuthorisationConfirmation3 {
    #[yaserde(rename = "DbtAuthstn")]
    #[cfg_attr(feature = "serde", serde(rename = "DbtAuthstn"))]
    pub dbt_authstn: TrueFalseIndicator,

    #[yaserde(rename = "AmtToDbt")]
    #[cfg_attr(feature = "serde", serde(rename = "AmtToDbt"))]
    pub amt_to_dbt: ActiveCurrencyAndAmount,
...
impl Validate for DebitAuthorisationConfirmation3 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.111.001.03")]
pub struct Document {
    #[yaserde(rename = "InvstgtnRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "InvstgtnRspn"))]
    pub invstgtn_rspn: InvestigationResponseV03,
}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct ExternalInvestigationAction1Code (pub String);
crate::simple_type!(ExternalInvestigationAction1Code);

impl Validate for ExternalInvestigationAction1Code {
    fn validate(&self) -> Result<(), String> { 
        #[allow(clippy::len_zero)]
        if self.0.len() < 1 {
            return Err(format!("MinLength validation error. \nExpected: 0 length >= 1 \nActual: 0 length == {}", self.0.len()));
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct ExternalInvestigationActionReason1Code (pub String);
crate::simple_type!(ExternalInvestigationActionReason1Code);

impl Validate for ExternalInvestigationActionReason1Code {
    fn validate(&self) -> Result<(), String> { 
        #[allow(clippy::len_zero)]
        if self.0.len() < 1 {
            return Err(format!("MinLength validation error. \nExpected: 0 length >= 1 \nActual: 0 length == {}", self.0.len()));
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct ExternalInvestigationInstrument1Code (pub String);
crate::simple_type!(ExternalInvestigationInstrument1Code);

impl Validate for ExternalInvestigationInstrument1Code {
    fn validate(&self) -> Result<(), String> { 
        #[allow(clippy::len_zero)]
        if self.0.len() < 1 {
            return Err(format!("MinLength validation error. \nExpected: 0 length >= 1 \nActual: 0 length == {}", self.0.len()));
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct ExternalInvestigationReason1Code (pub String);
crate::simple_type!(ExternalInvestigationReason1Code);

impl Validate for ExternalInvestigationReason1Code {
    fn validate(&self) -> Result<(), String> { 
        #[allow(clippy::len_zero)]
        if self.0.len() < 1 {
            return Err(format!("MinLength validation error. \nExpected: 0 length >= 1 \nActual: 0 length == {}", self.0.len()));
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct ExternalInvestigationReasonSubType1Code (pub String);
crate::simple_type!(ExternalInvestigationReasonSubType1Code);

impl Validate for ExternalInvestigationReasonSubType1Code {
    fn validate(&self) -> Result<(), String> { 
        #[allow(clippy::len_zero)]
        if self.0.len() < 1 {
            return Err(format!("MinLength validation error. \nExpected: 0 length >= 1 \nActual: 0 length == {}", self.0.len()));
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct ExternalInvestigationServiceLevel1Code (pub String);
crate::simple_type!(ExternalInvestigationServiceLevel1Code);

impl Validate for ExternalInvestigationServiceLevel1Code {
    fn validate(&self) -> Result<(), String> { 
        #[allow(clippy::len_zero)]
        if self.0.len() < 1 {
            return Err(format!("MinLength validation error. \nExpected: 0 length >= 1 \nActual: 0 length == {}", self.0.len()));
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct ExternalInvestigationStatus1Code (pub String);
crate::simple_type!(ExternalInvestigationStatus1Code);

impl Validate for ExternalInvestigationStatus1Code {
    fn validate(&self) -> Result<(), String> { 
        #[allow(clippy::len_zero)]
        if self.0.len() < 1 {
            return Err(format!("MinLength validation error. \nExpected: 0 length >= 1 \nActual: 0 length == {}", self.0.len()));
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct ExternalInvestigationStatusReason1Code (pub String);
crate::simple_type!(ExternalInvestigationStatusReason1Code);

impl Validate for ExternalInvestigationStatusReason1Code {
    fn validate(&self) -> Result<(), String> { 
        #[allow(clippy::len_zero)]
        if self.0.len() < 1 {
            return Err(format!("MinLength validation error. \nExpected: 0 length >= 1 \nActual: 0 length == {}", self.0.len()));
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct ExternalInvestigationSubType1Code (pub String);
crate::simple_type!(ExternalInvestigationSubType1Code);

impl Validate for ExternalInvestigationSubType1Code {
    fn validate(&self) -> Result<(), String> { 
        #[allow(clippy::len_zero)]
        if self.0.len() < 1 {
            return Err(format!("MinLength validation error. \nExpected: 0 length >= 1 \nActual: 0 length == {}", self.0.len()));
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct ExternalInvestigationType1Code (pub String);
crate::simple_type!(ExternalInvestigationType1Code);

impl Validate for ExternalInvestigationType1Code {
    fn validate(&self) -> Result<(), String> { 
        #[allow(clippy::len_zero)]
        if self.0.len() < 1 {
            return Err(format!("MinLength validation error. \nExpected: 0 length >= 1 \nActual: 0 length == {}", self.0.len()));
...
pub struct FileData1 {
    ...
    #[yaserde(rename = "NtwkRef")]
    #[cfg_attr(feature = "serde", serde(rename = "NtwkRef"))]
    pub ntwk_ref: Max140Text,

    #[yaserde(rename = "FileLctnElctrncAdr")]
    #[cfg_attr(feature = "serde", serde(rename = "FileLctnElctrncAdr"))]
    pub file_lctn_elctrnc_adr: Max2048Text,
}

impl Validate for FileData1 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.111.001.03")]
...
impl Validate for InvestigationActionReason1 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.111.001.03")]
...
impl Validate for InvestigationActionReason1Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.111.001.03")]
pub struct InvestigationData18 {
    #[yaserde(rename = "OrgnlInvstgtnSeq")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlInvstgtnSeq"))]
    pub orgnl_invstgtn_seq: Max3Number,

    #[yaserde(rename = "OrgnlInvstgtnRsn")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlInvstgtnRsn"))]
    pub orgnl_invstgtn_rsn: InvestigationReason1Choice,

    #[yaserde(rename = "OrgnlInvstgtnRsnSubTp")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlInvstgtnRsnSubTp"))]
    pub orgnl_invstgtn_rsn_sub_tp: InvestigationReasonSubType1Choice,

    #[yaserde(rename = "RspnData")]
    #[cfg_attr(feature = "serde", serde(rename = "RspnData"))]
    pub rspn_data: InvestigationDataRecord12Choice,

    #[yaserde(rename = "RltdInvstgtnData")]
    #[cfg_attr(feature = "serde", serde(rename = "RltdInvstgtnData"))]
    pub rltd_invstgtn_data: RelatedInvestigationData1,

    #[yaserde(rename = "NclsdFile")]
    #[cfg_attr(feature = "serde", serde(rename = "NclsdFile"))]
    pub nclsd_file: Vec<Document12>,

    #[yaserde(rename = "RltdFileData")]
    #[cfg_attr(feature = "serde", serde(rename = "RltdFileData"))]
    pub rltd_file_data: Vec<FileData1>,

    #[yaserde(rename = "RspnOrgtr")]
    #[cfg_attr(feature = "serde", serde(rename = "RspnOrgtr"))]
    pub rspn_orgtr: Party40Choice,
}

impl Validate for InvestigationData18 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.111.001.03")]
pub struct InvestigationDataRecord12Choice {
    #[yaserde(rename = "DbtAuthstn")]
    #[cfg_attr(feature = "serde", serde(rename = "DbtAuthstn"))]
    ...
    pub conf: Option<BookingConfirmation8>,
    ...
    pub tx_data: Vec<TransactionAmendment1>,
    #[yaserde(rename = "RspnNrrtv")]
    #[cfg_attr(feature = "serde", serde(rename = "RspnNrrtv"))]
    pub rspn_nrrtv: Option<Max500Text>,
}

impl Validate for InvestigationDataRecord12Choice {}
...
impl Validate for InvestigationLocationData1 {}
...
impl Default for InvestigationLocationMethod1Code {
    fn default() -> InvestigationLocationMethod1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for InvestigationLocationMethod1Code {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.111.001.03")]
...
impl Validate for InvestigationReason1Choice {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.111.001.03")]
...
impl Validate for InvestigationReasonSubType1Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.111.001.03")]
pub struct InvestigationRequest50 {
    #[yaserde(rename = "MsgId")]
    #[cfg_attr(feature = "serde", serde(rename = "MsgId"))]
    pub msg_id: Max35Text,

    #[yaserde(rename = "RqstrInvstgtnId")]
    #[cfg_attr(feature = "serde", serde(rename = "RqstrInvstgtnId"))]
    pub rqstr_invstgtn_id: Max35Text,

    #[yaserde(rename = "RspndrInvstgtnId")]
    #[cfg_attr(feature = "serde", serde(rename = "RspndrInvstgtnId"))]
    pub rspndr_invstgtn_id: Max35Text,

    #[yaserde(rename = "EIR")]
    #[cfg_attr(feature = "serde", serde(rename = "EIR"))]
    pub eir: Uuidv4Identifier,

    #[yaserde(rename = "ReqActn")]
    #[cfg_attr(feature = "serde", serde(rename = "ReqActn"))]
    pub req_actn: InvestigationRequestAction1,

    #[yaserde(rename = "InvstgtnTp")]
    #[cfg_attr(feature = "serde", serde(rename = "InvstgtnTp"))]
    pub invstgtn_tp: InvestigationType1Choice,

    #[yaserde(rename = "InvstgtnSubTp")]
    #[cfg_attr(feature = "serde", serde(rename = "InvstgtnSubTp"))]
    pub invstgtn_sub_tp: InvestigationSubType1Choice,

    #[yaserde(rename = "UndrlygInstrm")]
    #[cfg_attr(feature = "serde", serde(rename = "UndrlygInstrm"))]
    pub undrlyg_instrm: UnderlyingInvestigationInstrument1Choice,

    #[yaserde(rename = "Undrlyg")]
    #[cfg_attr(feature = "serde", serde(rename = "Undrlyg"))]
    pub undrlyg: UnderlyingData13Choice,

    #[yaserde(rename = "Rqstr")]
    #[cfg_attr(feature = "serde", serde(rename = "Rqstr"))]
    pub rqstr: Party40Choice,

    #[yaserde(rename = "Rspndr")]
    #[cfg_attr(feature = "serde", serde(rename = "Rspndr"))]
    pub rspndr: Party40Choice,

    #[yaserde(rename = "ReqOrgtr")]
    #[cfg_attr(feature = "serde", serde(rename = "ReqOrgtr"))]
    pub req_orgtr: Party40Choice,

    #[yaserde(rename = "XpctdRspndr")]
    #[cfg_attr(feature = "serde", serde(rename = "XpctdRspndr"))]
    pub xpctd_rspndr: Party40Choice,

    #[yaserde(rename = "SvcLvl")]
    #[cfg_attr(feature = "serde", serde(rename = "SvcLvl"))]
    pub svc_lvl: Vec<InvestigationServiceLevel1Choice>,
}

impl Validate for InvestigationRequest50 {}
...
pub struct InvestigationRequestAction1 {
    ...
    #[yaserde(rename = "ActnRsn")]
    #[cfg_attr(feature = "serde", serde(rename = "ActnRsn"))]
    pub actn_rsn: InvestigationActionReason1,
}

impl Validate for InvestigationRequestAction1 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.111.001.03")]
...
impl Validate for InvestigationRequestAction1Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.111.001.03")]
pub struct InvestigationResponse23 {
    #[yaserde(rename = "MsgId")]
    #[cfg_attr(feature = "serde", serde(rename = "MsgId"))]
    pub msg_id: Max35Text,
    ...
    #[yaserde(rename = "NxtRspndr")]
    #[cfg_attr(feature = "serde", serde(rename = "NxtRspndr"))]
    pub nxt_rspndr: Party40Choice,

    #[yaserde(rename = "InvstgtnData")]
    #[cfg_attr(feature = "serde", serde(rename = "InvstgtnData"))]
    pub invstgtn_data: Vec<InvestigationData18>,
}

impl Validate for InvestigationResponse23 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.111.001.03")]
pub struct InvestigationResponseV03 {
    #[yaserde(rename = "InvstgtnRspn")]
    #[cfg_attr(feature = "serde", serde(rename = "InvstgtnRspn"))]
    pub invstgtn_rspn: InvestigationResponse23,

    #[yaserde(rename = "OrgnlInvstgtnReq")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlInvstgtnReq"))]
    pub orgnl_invstgtn_req: InvestigationRequest50,
...
impl Validate for InvestigationResponseV03 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.111.001.03")]
...
impl Validate for InvestigationServiceLevel1Choice {}
...
pub struct InvestigationStatus2 {
    ...
    pub sts_rsn: InvestigationStatusReason1Choice,
}

impl Validate for InvestigationStatus2 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.111.001.03")]
...
impl Validate for InvestigationStatusReason1Choice {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.111.001.03")]
...
impl Validate for InvestigationSubType1Choice {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.111.001.03")]
...
impl Validate for InvestigationType1Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.111.001.03")]
pub struct MandateRelatedData4Choice {
...
impl Validate for MandateRelatedData4Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.111.001.03")]
pub struct OriginalTransactionReference48 {
    ...
    pub mndt_rltd_inf: MandateRelatedData4Choice,
...
impl Validate for OriginalTransactionReference48 {}
...
impl Validate for PaymentTransactionStatus1 {}
...
pub struct RelatedInvestigationData1 {
    ...
    pub lctn: Vec<InvestigationLocationData1>,
}

impl Validate for RelatedInvestigationData1 {}
...
pub struct Remittance1 {
    ...
    #[yaserde(rename = "Rltd")]
    #[cfg_attr(feature = "serde", serde(rename = "Rltd"))]
    pub rltd: Vec<RemittanceLocation7>,
}

impl Validate for Remittance1 {}
...
impl Validate for TransactionAmendment1 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.111.001.03")]
pub struct TransactionAmendment1Choice {
    ...
    pub pty: Option<PartyIdentification135>,
    #[yaserde(rename = "Rmt")]
    #[cfg_attr(feature = "serde", serde(rename = "Rmt"))]
...
impl Validate for TransactionAmendment1Choice {}
...
impl Validate for TransactionStatus1Choice {}
...
impl Validate for UnderlyingData13Choice {}
...
impl Validate for UnderlyingInvestigationInstrument1Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.111.001.03")]
pub struct UnderlyingPaymentInstruction11 {
    ...
    pub orgnl_tx_ref: OriginalTransactionReference48,

    #[yaserde(rename = "OrgnlSvcLvl")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlSvcLvl"))]
    pub orgnl_svc_lvl: ServiceLevel8Choice,
}

impl Validate for UnderlyingPaymentInstruction11 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.111.001.03")]
pub struct UnderlyingPaymentTransaction11 {
    #[yaserde(rename = "OrgnlGrpInf")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlGrpInf"))]
    pub orgnl_grp_inf: UnderlyingGroupInformation1,
...
impl Validate for UnderlyingPaymentTransaction11 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.111.001.03")]
pub struct UnderlyingStatementEntry11 {
    #[yaserde(rename = "OrgnlAcct")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlAcct"))]
    pub orgnl_acct: CashAccount40,
    ...
    #[yaserde(rename = "OrgnlNtryRef")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlNtryRef"))]
    pub orgnl_ntry_ref: Max35Text,

    #[yaserde(rename = "OrgnlUETR")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlUETR"))]
    pub orgnl_uetr: Uuidv4Identifier,

    #[yaserde(rename = "OrgnlNtryAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlNtryAmt"))]
    pub orgnl_ntry_amt: ActiveOrHistoricCurrencyAndAmount,

    #[yaserde(rename = "OrgnlNtryValDt")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlNtryValDt"))]
    pub orgnl_ntry_val_dt: DateAndDateTime2Choice,
}

impl Validate for UnderlyingStatementEntry11 {}

impl crate::MxMessage for Document {
    const BUSINESS_AREA: crate::BusinessArea = crate::BusinessArea::camt;
    const FUNCTIONALITY: &'static str = "111";
    const VARIANT: &'static str = "001";
    const VERSION: &'static str = "03";
    const MESSAGE_NAME: &'static str = "camt.111.001.03";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.111.001.03";
}
