...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.079.001.02")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.079.001.02")]
...
pub struct Document {
    ...
    pub intra_bal_mvmnt_qry_rspn: IntraBalanceMovementQueryResponseV02,
}
...
impl Validate for IntraBalanceMovement7 {}
...
pub struct IntraBalanceMovementQueryResponseV02 {
    ...
    pub rpt_or_err: IntraBalanceOrOperationalError11Choice,
}

impl Validate for IntraBalanceMovementQueryResponseV02 {}
...
impl Validate for IntraBalanceMovements4 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.079.001.02")]
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.079.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.079.001.02";
}
