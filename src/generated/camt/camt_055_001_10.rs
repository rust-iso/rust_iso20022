...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.055.001.10")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.055.001.10")]
...
pub enum CancellationReason33ChoiceChoice {
    Cd(ExternalCancellationReason1Code),
    Prtry(Max35Text),
    __Unknown__(String),
}

impl Default for CancellationReason33ChoiceChoice {
    fn default() -> CancellationReason33ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for CancellationReason33ChoiceChoice {}
...
pub struct CancellationReason33Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub cancellation_reason_33_choice_choice: CancellationReason33ChoiceChoice,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.055.001.10")]
pub struct CustomerPaymentCancellationRequestV10 {
    ...
    pub undrlyg: Vec<UnderlyingTransaction30>,
...
impl Validate for CustomerPaymentCancellationRequestV10 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.055.001.10")]
pub struct Document {
    #[yaserde(rename = "CstmrPmtCxlReq")]
    #[cfg_attr(feature = "serde", serde(rename = "CstmrPmtCxlReq"))]
    pub cstmr_pmt_cxl_req: CustomerPaymentCancellationRequestV10,
}
...
impl Validate for OriginalGroupHeader15 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.055.001.10")]
pub struct OriginalPaymentInstruction44 {
    #[yaserde(rename = "PmtCxlId")]
    #[cfg_attr(feature = "serde", serde(rename = "PmtCxlId"))]
    pub pmt_cxl_id: Max35Text,
    ...
    #[yaserde(rename = "PmtInfCxl")]
    #[cfg_attr(feature = "serde", serde(rename = "PmtInfCxl"))]
    pub pmt_inf_cxl: GroupCancellationIndicator,
    ...
    pub tx_inf: Vec<PaymentTransaction140>,
}

impl Validate for OriginalPaymentInstruction44 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.055.001.10")]
pub struct PaymentTransaction140 {
...
impl Validate for PaymentTransaction140 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.055.001.10")]
pub struct UnderlyingTransaction30 {
    ...
    #[yaserde(rename = "OrgnlPmtInfAndCxl")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlPmtInfAndCxl"))]
    pub orgnl_pmt_inf_and_cxl: Vec<OriginalPaymentInstruction44>,
}

impl Validate for UnderlyingTransaction30 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.055.001.10";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.055.001.10";
}
