...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.087.001.07")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.087.001.07")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.087.001.07")]
pub struct Document {
    #[yaserde(rename = "ReqToModfyPmt")]
    #[cfg_attr(feature = "serde", serde(rename = "ReqToModfyPmt"))]
    pub req_to_modfy_pmt: RequestToModifyPaymentV07,
}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct ExternalAgentInstruction1Code (pub String);
crate::simple_type!(ExternalAgentInstruction1Code);

impl Validate for ExternalAgentInstruction1Code {
    fn validate(&self) -> Result<(), String> { 
        #[allow(clippy::len_zero)]
        if self.0.len() < 1 {
            return Err(format!("MinLength validation error. \nExpected: 0 length >= 1 \nActual: 0 length == {}", self.0.len()));
...
pub struct InstructionForAssignee1 {
    ...
    pub cd: ExternalAgentInstruction1Code,
...
impl Validate for InstructionForAssignee1 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.087.001.07")]
pub struct RequestToModifyPaymentV07 {
    ...
    pub _mod: RequestedModification9,

    #[yaserde(rename = "InstrForAssgne")]
    #[cfg_attr(feature = "serde", serde(rename = "InstrForAssgne"))]
...
impl Validate for RequestToModifyPaymentV07 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.087.001.07")]
pub struct RequestedModification9 {
    ...
    #[yaserde(rename = "SttlmInf")]
    #[cfg_attr(feature = "serde", serde(rename = "SttlmInf"))]
    pub sttlm_inf: SettlementInstruction6,
...
impl Validate for RequestedModification9 {}
...
impl Validate for SettlementInstruction6 {}
...
impl crate::MxMessage for Document {
    ...
    const FUNCTIONALITY: &'static str = "087";
    const VARIANT: &'static str = "001";
    const VERSION: &'static str = "07";
    const MESSAGE_NAME: &'static str = "camt.087.001.07";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.087.001.07";
}
