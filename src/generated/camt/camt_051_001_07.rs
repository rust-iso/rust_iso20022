...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.051.001.07")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.051.001.07")]
...
pub struct Document {
    ...
    pub lqdty_dbt_trf: LiquidityDebitTransferV07,
}
...
impl Validate for LiquidityDebitTransfer4 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.051.001.07")]
pub struct LiquidityDebitTransferV07 {
    ...
    #[yaserde(rename = "LqdtyDbtTrf")]
    #[cfg_attr(feature = "serde", serde(rename = "LqdtyDbtTrf"))]
    pub lqdty_dbt_trf: LiquidityDebitTransfer4,
...
impl Validate for LiquidityDebitTransferV07 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.051.001.07";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.051.001.07";
}
