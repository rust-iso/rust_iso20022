...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.060.001.06")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.060.001.06")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.060.001.06")]
pub struct AccountReportingRequestV06 {
    #[yaserde(rename = "GrpHdr")]
    #[cfg_attr(feature = "serde", serde(rename = "GrpHdr"))]
    pub grp_hdr: GroupHeader77,

    #[yaserde(rename = "RptgReq")]
    #[cfg_attr(feature = "serde", serde(rename = "RptgReq"))]
    pub rptg_req: Vec<ReportingRequest6>,
...
impl Validate for AccountReportingRequestV06 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.060.001.06")]
pub struct Document {
    #[yaserde(rename = "AcctRptgReq")]
    #[cfg_attr(feature = "serde", serde(rename = "AcctRptgReq"))]
    pub acct_rptg_req: AccountReportingRequestV06,
}
...
impl Default for FloorLimitType1Code {
    fn default() -> FloorLimitType1Code {
        Self::__Unknown__("No valid variants".into())
    }
}
...
impl Validate for ReportingPeriod5 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.060.001.06")]
pub struct ReportingRequest6 {
    #[yaserde(rename = "Id")]
    #[cfg_attr(feature = "serde", serde(rename = "Id"))]
    pub id: Max35Text,

    #[yaserde(rename = "ReqdMsgNmId")]
    #[cfg_attr(feature = "serde", serde(rename = "ReqdMsgNmId"))]
    pub reqd_msg_nm_id: Max35Text,
    ...
    pub rptg_prd: ReportingPeriod5,

    #[yaserde(rename = "RptgSeq")]
    #[cfg_attr(feature = "serde", serde(rename = "RptgSeq"))]
    pub rptg_seq: SequenceRange1Choice,

    #[yaserde(rename = "ReqdTxTp")]
    #[cfg_attr(feature = "serde", serde(rename = "ReqdTxTp"))]
    pub reqd_tx_tp: TransactionType2,

    #[yaserde(rename = "ReqdBalTp")]
    #[cfg_attr(feature = "serde", serde(rename = "ReqdBalTp"))]
    pub reqd_bal_tp: Vec<BalanceType13>,
}

impl Validate for ReportingRequest6 {}
...
pub struct TransactionType2 {
    ...
    #[yaserde(rename = "FlrLmt")]
    #[cfg_attr(feature = "serde", serde(rename = "FlrLmt"))]
    pub flr_lmt: Vec<Limit2>,
}

impl Validate for TransactionType2 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.060.001.06";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.060.001.06";
}
