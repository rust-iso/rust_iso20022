...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.025.001.05")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.025.001.05")]
...
pub struct OriginalMessageAndIssuer1 {
    ...
    #[yaserde(rename = "OrgtrNm")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgtrNm"))]
    pub orgtr_nm: Max70Text,
}

impl Validate for OriginalMessageAndIssuer1 {}
...
pub struct Receipt3 {
    ...
    #[yaserde(rename = "OrgnlPmtId")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlPmtId"))]
    pub orgnl_pmt_id: PaymentIdentification6Choice,

    #[yaserde(rename = "ReqHdlg")]
    #[cfg_attr(feature = "serde", serde(rename = "ReqHdlg"))]
    pub req_hdlg: Vec<RequestHandling1>,
}

impl Validate for Receipt3 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.025.001.05")]
pub struct ReceiptV05 {
    #[yaserde(rename = "MsgHdr")]
    #[cfg_attr(feature = "serde", serde(rename = "MsgHdr"))]
    pub msg_hdr: MessageHeader9,

    #[yaserde(rename = "RctDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "RctDtls"))]
    pub rct_dtls: Vec<Receipt3>,
...
impl Validate for ReceiptV05 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.025.001.05")]
pub struct RequestHandling1 {
...
impl Validate for RequestHandling1 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.025.001.05";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.025.001.05";
}
