...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.105.001.03")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.105.001.03")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.105.001.03")]
pub struct ChargesPaymentNotificationV03 {
...
impl Validate for ChargesPaymentNotificationV03 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.105.001.03")]
pub struct ChargesPerTransaction5 {
    ...
    #[yaserde(rename = "ChrgsAcctOwnr")]
    #[cfg_attr(feature = "serde", serde(rename = "ChrgsAcctOwnr"))]
    pub chrgs_acct_ownr: BranchAndFinancialInstitutionIdentification8,

    #[yaserde(rename = "Rcrd")]
    #[cfg_attr(feature = "serde", serde(rename = "Rcrd"))]
    pub rcrd: Vec<ChargesPerTransactionRecord5>,
...
impl Validate for ChargesPerTransaction5 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.105.001.03")]
pub struct ChargesPerTransactionRecord5 {
...
impl Validate for ChargesPerTransactionRecord5 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.105.001.03")]
pub struct ChargesPerType5 {
    #[yaserde(rename = "ChrgsId")]
    #[cfg_attr(feature = "serde", serde(rename = "ChrgsId"))]
    pub chrgs_id: Max35Text,
    ...
    #[yaserde(rename = "Rcrd")]
    #[cfg_attr(feature = "serde", serde(rename = "Rcrd"))]
    pub rcrd: Vec<ChargesPerTypeRecord5>,
...
impl Validate for ChargesPerType5 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.105.001.03")]
pub struct ChargesPerTypeRecord5 {
    #[yaserde(rename = "RcrdId")]
    #[cfg_attr(feature = "serde", serde(rename = "RcrdId"))]
    pub rcrd_id: Max35Text,
...
impl Validate for ChargesPerTypeRecord5 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.105.001.03")]
pub struct ChargesRecord11 {
    #[yaserde(rename = "ChrgsId")]
    #[cfg_attr(feature = "serde", serde(rename = "ChrgsId"))]
    pub chrgs_id: Max35Text,
...
impl Validate for ChargesRecord11 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.105.001.03")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.105.001.03")]
pub struct Document {
    #[yaserde(rename = "ChrgsPmtNtfctn")]
    #[cfg_attr(feature = "serde", serde(rename = "ChrgsPmtNtfctn"))]
    pub chrgs_pmt_ntfctn: ChargesPaymentNotificationV03,
}
...
impl Validate for GroupHeader126 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.105.001.03";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.105.001.03";
}
