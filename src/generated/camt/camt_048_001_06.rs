...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.048.001.06")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.048.001.06")]
...
pub enum CurrentOrDefaultReservation3ChoiceChoice {
    Cur(ReservationIdentification3),
    Dflt(ReservationIdentification3),
    __Unknown__(String),
}

impl Default for CurrentOrDefaultReservation3ChoiceChoice {
    fn default() -> CurrentOrDefaultReservation3ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for CurrentOrDefaultReservation3ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.048.001.06")]
pub struct CurrentOrDefaultReservation3Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub current_or_default_reservation_3_choice_choice: CurrentOrDefaultReservation3ChoiceChoice,
}

impl Validate for CurrentOrDefaultReservation3Choice {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.048.001.06")]
pub struct Document {
    #[yaserde(rename = "ModfyRsvatn")]
    #[cfg_attr(feature = "serde", serde(rename = "ModfyRsvatn"))]
    pub modfy_rsvatn: ModifyReservationV06,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.048.001.06")]
pub struct ModifyReservationV06 {
    ...
    pub rsvatn_id: CurrentOrDefaultReservation3Choice,

    #[yaserde(rename = "NewRsvatnValSet")]
    #[cfg_attr(feature = "serde", serde(rename = "NewRsvatnValSet"))]
...
impl Validate for ModifyReservationV06 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.048.001.06";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.048.001.06";
}
