...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.025.001.09")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.025.001.09")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct ExternalRequestStatus1Code (pub String);
crate::simple_type!(ExternalRequestStatus1Code);

impl Validate for ExternalRequestStatus1Code {
    fn validate(&self) -> Result<(), String> { 
        #[allow(clippy::len_zero)]
        if self.0.len() < 1 {
            return Err(format!("MinLength validation error. \nExpected: 0 length >= 1 \nActual: 0 length == {}", self.0.len()));
...
pub struct Receipt7 {
    ...
    pub orgnl_pmt_id: PaymentIdentification8Choice,

    #[yaserde(rename = "ReqHdlg")]
    #[cfg_attr(feature = "serde", serde(rename = "ReqHdlg"))]
    pub req_hdlg: Vec<RequestHandling4>,
}

impl Validate for Receipt7 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.025.001.09")]
pub struct ReceiptV09 {
...
impl Validate for ReceiptV09 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.025.001.09")]
pub struct RequestHandling4 {
    #[yaserde(rename = "Sts")]
    ...
    pub sts_rsn: StatusReasonInformation14,
...
impl Validate for RequestHandling4 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.025.001.09")]
pub struct RequestStatus1Choice {
    #[yaserde(rename = "Cd")]
    #[cfg_attr(feature = "serde", serde(rename = "Cd"))]
    pub cd: Option<ExternalRequestStatus1Code>,
    #[yaserde(rename = "Prtry")]
    #[cfg_attr(feature = "serde", serde(rename = "Prtry"))]
    pub prtry: Option<Max35Text>,
}

impl Validate for RequestStatus1Choice {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.025.001.09")]
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.025.001.09";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.025.001.09";
}
