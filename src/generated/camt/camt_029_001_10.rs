...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.029.001.10")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.029.001.10")]
...
pub enum CancellationIndividualStatus1Code {
    #[yaserde(rename = "RJCR")]
    #[cfg_attr(feature = "serde", serde(rename = "RJCR"))]
    Rjcr,
    #[yaserde(rename = "ACCR")]
    #[cfg_attr(feature = "serde", serde(rename = "ACCR"))]
    Accr,
    #[yaserde(rename = "PDCR")]
    #[cfg_attr(feature = "serde", serde(rename = "PDCR"))]
    Pdcr,
    __Unknown__(String),
}

impl Default for CancellationIndividualStatus1Code {
    fn default() -> CancellationIndividualStatus1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for CancellationIndividualStatus1Code {}
...
pub enum CancellationStatusReason3ChoiceChoice {
    Cd(ExternalPaymentCancellationRejection1Code),
    Prtry(Max35Text),
    __Unknown__(String),
}

impl Default for CancellationStatusReason3ChoiceChoice {
    fn default() -> CancellationStatusReason3ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for CancellationStatusReason3ChoiceChoice {}
...
pub struct CancellationStatusReason3Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub cancellation_status_reason_3_choice_choice: CancellationStatusReason3ChoiceChoice,
}

impl Validate for CancellationStatusReason3Choice {}
...
impl Validate for CancellationStatusReason4 {}
...
pub struct Charges8 {
    ...
    #[yaserde(rename = "AgtAcct")]
    #[cfg_attr(feature = "serde", serde(rename = "AgtAcct"))]
    pub agt_acct: CashAccount38,
}

impl Validate for Charges8 {}
...
pub struct ClaimNonReceipt2 {
    #[yaserde(rename = "DtPrcd")]
    #[cfg_attr(feature = "serde", serde(rename = "DtPrcd"))]
    pub dt_prcd: Isodate,

    #[yaserde(rename = "OrgnlNxtAgt")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlNxtAgt"))]
    pub orgnl_nxt_agt: BranchAndFinancialInstitutionIdentification6,
}

impl Validate for ClaimNonReceipt2 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.029.001.10")]

pub enum ClaimNonReceipt2ChoiceChoice {
    Accptd(ClaimNonReceipt2),
    Rjctd(ClaimNonReceiptRejectReason1Choice),
    __Unknown__(String),
}

impl Default for ClaimNonReceipt2ChoiceChoice {
    fn default() -> ClaimNonReceipt2ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ClaimNonReceipt2ChoiceChoice {}
...
pub struct ClaimNonReceipt2Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub claim_non_receipt_2_choice_choice: ClaimNonReceipt2ChoiceChoice,
}

impl Validate for ClaimNonReceipt2Choice {}
...
pub enum ClaimNonReceiptRejectReason1ChoiceChoice {
    Cd(ExternalClaimNonReceiptRejection1Code),
    Prtry(Max35Text),
    __Unknown__(String),
}

impl Default for ClaimNonReceiptRejectReason1ChoiceChoice {
    fn default() -> ClaimNonReceiptRejectReason1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ClaimNonReceiptRejectReason1ChoiceChoice {}
...
pub struct ClaimNonReceiptRejectReason1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub claim_non_receipt_reject_reason_1_choice_choice: ClaimNonReceiptRejectReason1ChoiceChoice,
}

impl Validate for ClaimNonReceiptRejectReason1Choice {}
...
impl Validate for Compensation3 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.029.001.10")]

pub enum CompensationReason1ChoiceChoice {
    Cd(ExternalPaymentCompensationReason1Code),
    Prtry(Max35Text),
    __Unknown__(String),
}

impl Default for CompensationReason1ChoiceChoice {
    fn default() -> CompensationReason1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for CompensationReason1ChoiceChoice {}
...
pub struct CompensationReason1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub compensation_reason_1_choice_choice: CompensationReason1ChoiceChoice,
}

impl Validate for CompensationReason1Choice {}
...
impl Validate for CorrectiveGroupInformation1 {}
...
impl Validate for CorrectiveInterbankTransaction2 {}
...
impl Validate for CorrectivePaymentInitiation4 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.029.001.10")]

pub enum CorrectiveTransaction4ChoiceChoice {
    Initn(CorrectivePaymentInitiation4),
    IntrBk(CorrectiveInterbankTransaction2),
    __Unknown__(String),
}

impl Default for CorrectiveTransaction4ChoiceChoice {
    fn default() -> CorrectiveTransaction4ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for CorrectiveTransaction4ChoiceChoice {}
...
pub struct CorrectiveTransaction4Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub corrective_transaction_4_choice_choice: CorrectiveTransaction4ChoiceChoice,
}

impl Validate for CorrectiveTransaction4Choice {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.029.001.10")]
pub struct Document {
    #[yaserde(rename = "RsltnOfInvstgtn")]
    #[cfg_attr(feature = "serde", serde(rename = "RsltnOfInvstgtn"))]
    pub rsltn_of_invstgtn: ResolutionOfInvestigationV10,
}
...
crate::simple_type!(ExternalClaimNonReceiptRejection1Code);

impl Validate for ExternalClaimNonReceiptRejection1Code {
    fn validate(&self) -> Result<(), String> { 
        #[allow(clippy::len_zero)]
        if self.0.len() < 1 {
            return Err(format!("MinLength validation error. \nExpected: 0 length >= 1 \nActual: 0 length == {}", self.0.len()));
...
crate::simple_type!(ExternalInvestigationExecutionConfirmation1Code);

impl Validate for ExternalInvestigationExecutionConfirmation1Code {
    fn validate(&self) -> Result<(), String> { 
        #[allow(clippy::len_zero)]
        if self.0.len() < 1 {
            return Err(format!("MinLength validation error. \nExpected: 0 length >= 1 \nActual: 0 length == {}", self.0.len()));
...
crate::simple_type!(ExternalPaymentCancellationRejection1Code);

impl Validate for ExternalPaymentCancellationRejection1Code {
    fn validate(&self) -> Result<(), String> { 
        #[allow(clippy::len_zero)]
        if self.0.len() < 1 {
            return Err(format!("MinLength validation error. \nExpected: 0 length >= 1 \nActual: 0 length == {}", self.0.len()));
...
crate::simple_type!(ExternalPaymentCompensationReason1Code);

impl Validate for ExternalPaymentCompensationReason1Code {
    fn validate(&self) -> Result<(), String> { 
        #[allow(clippy::len_zero)]
        if self.0.len() < 1 {
            return Err(format!("MinLength validation error. \nExpected: 0 length >= 1 \nActual: 0 length == {}", self.0.len()));
...
crate::simple_type!(ExternalPaymentModificationRejection1Code);

impl Validate for ExternalPaymentModificationRejection1Code {
    fn validate(&self) -> Result<(), String> { 
        #[allow(clippy::len_zero)]
        if self.0.len() < 1 {
            return Err(format!("MinLength validation error. \nExpected: 0 length >= 1 \nActual: 0 length == {}", self.0.len()));
...
pub enum GroupCancellationStatus1Code {
    #[yaserde(rename = "PACR")]
    #[cfg_attr(feature = "serde", serde(rename = "PACR"))]
    Pacr,
    #[yaserde(rename = "RJCR")]
    #[cfg_attr(feature = "serde", serde(rename = "RJCR"))]
    Rjcr,
...
impl Default for GroupCancellationStatus1Code {
    fn default() -> GroupCancellationStatus1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for GroupCancellationStatus1Code {}
...
pub enum InvestigationStatus5ChoiceChoice {
    Conf(ExternalInvestigationExecutionConfirmation1Code),
    RjctdMod(Vec<ModificationStatusReason1Choice>),
    DplctOf(Case5),
    AssgnmtCxlConf(YesNoIndicator),
    __Unknown__(String),
}

impl Default for InvestigationStatus5ChoiceChoice {
    fn default() -> InvestigationStatus5ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for InvestigationStatus5ChoiceChoice {}
...
pub struct InvestigationStatus5Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub investigation_status_5_choice_choice: InvestigationStatus5ChoiceChoice,
}

impl Validate for InvestigationStatus5Choice {}
...
pub enum MandateRelatedData1ChoiceChoice {
    DrctDbtMndt(MandateRelatedInformation14),
    CdtTrfMndt(CreditTransferMandateData1),
    __Unknown__(String),
}

impl Default for MandateRelatedData1ChoiceChoice {
    fn default() -> MandateRelatedData1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for MandateRelatedData1ChoiceChoice {}
...
pub struct MandateRelatedData1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub mandate_related_data_1_choice_choice: MandateRelatedData1ChoiceChoice,
}

impl Validate for MandateRelatedData1Choice {}
...
pub enum ModificationStatusReason1ChoiceChoice {
    Cd(ExternalPaymentModificationRejection1Code),
    Prtry(Max35Text),
    __Unknown__(String),
}

impl Default for ModificationStatusReason1ChoiceChoice {
    fn default() -> ModificationStatusReason1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ModificationStatusReason1ChoiceChoice {}
...
pub struct ModificationStatusReason1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub modification_status_reason_1_choice_choice: ModificationStatusReason1ChoiceChoice,
}

impl Validate for ModificationStatusReason1Choice {}
...
impl Validate for ModificationStatusReason2 {}
...
impl Validate for NumberOfCancellationsPerStatus1 {}
...
impl Validate for NumberOfTransactionsPerStatus1 {}
...
pub struct OriginalGroupHeader14 {
    #[yaserde(rename = "OrgnlGrpCxlId")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlGrpCxlId"))]
    pub orgnl_grp_cxl_id: Max35Text,

    #[yaserde(rename = "RslvdCase")]
    #[cfg_attr(feature = "serde", serde(rename = "RslvdCase"))]
    ...
    #[yaserde(rename = "GrpCxlSts")]
    #[cfg_attr(feature = "serde", serde(rename = "GrpCxlSts"))]
    pub grp_cxl_sts: GroupCancellationStatus1Code,

    #[yaserde(rename = "CxlStsRsnInf")]
    #[cfg_attr(feature = "serde", serde(rename = "CxlStsRsnInf"))]
    pub cxl_sts_rsn_inf: Vec<CancellationStatusReason4>,

    #[yaserde(rename = "NbOfTxsPerCxlSts")]
    #[cfg_attr(feature = "serde", serde(rename = "NbOfTxsPerCxlSts"))]
    pub nb_of_txs_per_cxl_sts: Vec<NumberOfTransactionsPerStatus1>,
}

impl Validate for OriginalGroupHeader14 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.029.001.10")]
pub struct OriginalPaymentInstruction35 {
    #[yaserde(rename = "OrgnlPmtInfCxlId")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlPmtInfCxlId"))]
    pub orgnl_pmt_inf_cxl_id: Max35Text,
    ...
    #[yaserde(rename = "PmtInfCxlSts")]
    #[cfg_attr(feature = "serde", serde(rename = "PmtInfCxlSts"))]
    pub pmt_inf_cxl_sts: GroupCancellationStatus1Code,
    ...
    pub tx_inf_and_sts: Vec<PaymentTransaction122>,
}

impl Validate for OriginalPaymentInstruction35 {}
...
impl Validate for OriginalTransactionReference31 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.029.001.10")]
pub struct PaymentTransaction116 {
    #[yaserde(rename = "ModStsId")]
    #[cfg_attr(feature = "serde", serde(rename = "ModStsId"))]
    pub mod_sts_id: Max35Text,
    ...
    #[yaserde(rename = "ModStsRsnInf")]
    #[cfg_attr(feature = "serde", serde(rename = "ModStsRsnInf"))]
    pub mod_sts_rsn_inf: Vec<ModificationStatusReason2>,

    #[yaserde(rename = "RsltnRltdInf")]
    #[cfg_attr(feature = "serde", serde(rename = "RsltnRltdInf"))]
    pub rsltn_rltd_inf: ResolutionData2,
...
impl Validate for PaymentTransaction116 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.029.001.10")]
pub struct PaymentTransaction122 {
    #[yaserde(rename = "CxlStsId")]
    #[cfg_attr(feature = "serde", serde(rename = "CxlStsId"))]
    pub cxl_sts_id: Max35Text,
    ...
    #[yaserde(rename = "TxCxlSts")]
    #[cfg_attr(feature = "serde", serde(rename = "TxCxlSts"))]
    pub tx_cxl_sts: CancellationIndividualStatus1Code,
    ...
    #[yaserde(rename = "OrgnlReqdExctnDt")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlReqdExctnDt"))]
    pub orgnl_reqd_exctn_dt: DateAndDateTime2Choice,

    #[yaserde(rename = "OrgnlReqdColltnDt")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlReqdColltnDt"))]
    pub orgnl_reqd_colltn_dt: Isodate,
...
impl Validate for PaymentTransaction122 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.029.001.10")]
pub struct PaymentTransaction127 {
    #[yaserde(rename = "CxlStsId")]
    #[cfg_attr(feature = "serde", serde(rename = "CxlStsId"))]
    pub cxl_sts_id: Max35Text,
...
impl Validate for PaymentTransaction127 {}
...
pub struct ResolutionData2 {
    ...
    pub compstn: Compensation3,

    #[yaserde(rename = "Chrgs")]
    #[cfg_attr(feature = "serde", serde(rename = "Chrgs"))]
    pub chrgs: Vec<Charges8>,
}

impl Validate for ResolutionData2 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.029.001.10")]
pub struct ResolutionOfInvestigationV10 {
    ...
    #[yaserde(rename = "CxlDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "CxlDtls"))]
    pub cxl_dtls: Vec<UnderlyingTransaction25>,

    #[yaserde(rename = "ModDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "ModDtls"))]
    pub mod_dtls: PaymentTransaction116,

    #[yaserde(rename = "ClmNonRctDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "ClmNonRctDtls"))]
    pub clm_non_rct_dtls: ClaimNonReceipt2Choice,

    #[yaserde(rename = "StmtDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "StmtDtls"))]
    pub stmt_dtls: StatementResolutionEntry4,

    #[yaserde(rename = "CrrctnTx")]
    #[cfg_attr(feature = "serde", serde(rename = "CrrctnTx"))]
    pub crrctn_tx: CorrectiveTransaction4Choice,
...
impl Validate for ResolutionOfInvestigationV10 {}
...
pub struct StatementResolutionEntry4 {
    ...
    #[yaserde(rename = "CrrctdAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "CrrctdAmt"))]
...
impl Validate for StatementResolutionEntry4 {}
...
pub enum TransactionIndividualStatus1Code {
    ...
    Accp,
    #[yaserde(rename = "ACSP")]
    #[cfg_attr(feature = "serde", serde(rename = "ACSP"))]
    Acsp,
    #[yaserde(rename = "ACSC")]
    #[cfg_attr(feature = "serde", serde(rename = "ACSC"))]
    Acsc,
    #[yaserde(rename = "ACCR")]
    #[cfg_attr(feature = "serde", serde(rename = "ACCR"))]
    Accr,
    #[yaserde(rename = "ACWC")]
    #[cfg_attr(feature = "serde", serde(rename = "ACWC"))]
    Acwc,
    __Unknown__(String),
}

impl Default for TransactionIndividualStatus1Code {
    fn default() -> TransactionIndividualStatus1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for TransactionIndividualStatus1Code {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.029.001.10")]
pub struct UnderlyingTransaction25 {
    ...
    #[yaserde(rename = "OrgnlPmtInfAndSts")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlPmtInfAndSts"))]
    pub orgnl_pmt_inf_and_sts: Vec<OriginalPaymentInstruction35>,

    #[yaserde(rename = "TxInfAndSts")]
    #[cfg_attr(feature = "serde", serde(rename = "TxInfAndSts"))]
    pub tx_inf_and_sts: Vec<PaymentTransaction127>,
}

impl Validate for UnderlyingTransaction25 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.029.001.10";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.029.001.10";
}
