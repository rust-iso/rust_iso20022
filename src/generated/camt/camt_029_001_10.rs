...
pub struct InvestigationStatus5Choice {
    ...
    #[yaserde(rename = "RjctdMod")]
    #[cfg_attr(feature = "serde", serde(rename = "RjctdMod"))]
    pub rjctd_mod: Vec<ModificationStatusReason1Choice>,
    #[yaserde(rename = "DplctOf")]
    #[cfg_attr(feature = "serde", serde(rename = "DplctOf"))]
    pub dplct_of: Option<Case5>,
    #[yaserde(rename = "AssgnmtCxlConf")]
    #[cfg_attr(feature = "serde", serde(rename = "AssgnmtCxlConf"))]
