...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.078.001.02")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.078.001.02")]
...
pub struct Document {
    ...
    pub intra_bal_mvmnt_qry: IntraBalanceMovementQueryV02,
}
...
impl Validate for IntraBalanceMovementQueryV02 {}
...
impl Validate for IntraBalanceQueryCriteria11 {}
...
impl Validate for IntraBalanceQueryDefinition11 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.078.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.078.001.02";
}
