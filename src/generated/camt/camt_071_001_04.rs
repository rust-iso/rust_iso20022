...
pub struct StandingOrderOrAll3Choice {
    ...
    pub stg_ordr: Vec<StandingOrderIdentification6>,
    #[yaserde(rename = "AllStgOrdrs")]
    #[cfg_attr(feature = "serde", serde(rename = "AllStgOrdrs"))]
    pub all_stg_ordrs: Vec<StandingOrderIdentification7>,
}
