...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.071.001.04")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.071.001.04")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.071.001.04")]
pub struct DeleteStandingOrderV04 {
    #[yaserde(rename = "MsgHdr")]
    #[cfg_attr(feature = "serde", serde(rename = "MsgHdr"))]
    pub msg_hdr: MessageHeader1,

    #[yaserde(rename = "StgOrdrDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "StgOrdrDtls"))]
    pub stg_ordr_dtls: StandingOrderOrAll3Choice,
...
impl Validate for DeleteStandingOrderV04 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.071.001.04")]
pub struct Document {
    #[yaserde(rename = "DelStgOrdr")]
    #[cfg_attr(feature = "serde", serde(rename = "DelStgOrdr"))]
    pub del_stg_ordr: DeleteStandingOrderV04,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.071.001.04")]
pub struct StandingOrderIdentification7 {
    #[yaserde(rename = "Acct")]
    #[cfg_attr(feature = "serde", serde(rename = "Acct"))]
    pub acct: CashAccount40,
...
impl Validate for StandingOrderIdentification7 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.071.001.04")]

pub enum StandingOrderOrAll3ChoiceChoice {
    StgOrdr(Vec<StandingOrderIdentification6>),
    AllStgOrdrs(Vec<StandingOrderIdentification7>),
    __Unknown__(String),
}

impl Default for StandingOrderOrAll3ChoiceChoice {
    fn default() -> StandingOrderOrAll3ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for StandingOrderOrAll3ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.071.001.04")]
pub struct StandingOrderOrAll3Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub standing_order_or_all_3_choice_choice: StandingOrderOrAll3ChoiceChoice,
}

impl Validate for StandingOrderOrAll3Choice {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.071.001.04";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.071.001.04";
}
