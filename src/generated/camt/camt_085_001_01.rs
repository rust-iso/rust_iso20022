...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.085.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.085.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.085.001.01")]
pub struct Document {
    #[yaserde(rename = "IntraBalMvmntPdgRpt")]
    #[cfg_attr(feature = "serde", serde(rename = "IntraBalMvmntPdgRpt"))]
    pub intra_bal_mvmnt_pdg_rpt: IntraBalanceMovementPendingReportV01,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.085.001.01")]
pub struct IntraBalanceMovementPendingReportV01 {
    #[yaserde(rename = "Id")]
    #[cfg_attr(feature = "serde", serde(rename = "Id"))]
    ...
    pub mvmnts: Vec<IntraBalancePending5>,
}

impl Validate for IntraBalanceMovementPendingReportV01 {}
...
pub struct IntraBalancePending5 {
    ...
    pub sts_and_rsn: PendingStatusAndReason2,
...
impl Validate for IntraBalancePending5 {}
...
impl Validate for IntraBalancePending6 {}
...
pub struct PendingStatusAndReason2 {
    ...
    pub prcg_sts: Vec<ProcessingStatus66Choice>,
...
impl Validate for PendingStatusAndReason2 {}
...
pub enum ProcessingStatus66ChoiceChoice {
...
impl Default for ProcessingStatus66ChoiceChoice {
    fn default() -> ProcessingStatus66ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ProcessingStatus66ChoiceChoice {}
...
pub struct ProcessingStatus66Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub processing_status_66_choice_choice: ProcessingStatus66ChoiceChoice,
}

impl Validate for ProcessingStatus66Choice {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.085.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.085.001.01";
}
