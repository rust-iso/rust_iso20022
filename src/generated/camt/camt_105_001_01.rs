...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.105.001.01")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.105.001.01")]
...
impl Validate for ChargesPaymentNotificationV01 {}
...
pub struct ChargesRecord4 {
    ...
    pub chrgs_acct_ownr: BranchAndFinancialInstitutionIdentification6,
...
impl Validate for ChargesRecord4 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.105.001.01")]
...
pub struct Document {
    ...
    pub chrgs_pmt_ntfctn: ChargesPaymentNotificationV01,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.105.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.105.001.01";
}
