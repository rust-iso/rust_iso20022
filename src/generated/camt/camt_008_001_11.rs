...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.008.001.11")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.008.001.11")]
...
pub struct CancelTransactionV11 {
    ...
    pub cxl_rsn: PaymentCancellationReason6,
...
impl Validate for CancelTransactionV11 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.008.001.11")]
...
pub struct Document {
    ...
    pub ccl_tx: CancelTransactionV11,
}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.008.001.11";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.008.001.11";
}
