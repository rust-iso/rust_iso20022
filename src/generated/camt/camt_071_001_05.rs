...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.071.001.05")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.071.001.05")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.071.001.05")]
pub struct DeleteStandingOrderV05 {
    ...
    pub stg_ordr_dtls: StandingOrderOrAll4Choice,
...
impl Validate for DeleteStandingOrderV05 {}
...
pub struct Document {
    ...
    pub del_stg_ordr: DeleteStandingOrderV05,
}
...
impl Validate for StandingOrderIdentification9 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.071.001.05")]
pub struct StandingOrderOrAll4Choice {
    ...
    pub stg_ordr: Vec<StandingOrderIdentification8>,
    #[yaserde(rename = "AllStgOrdrs")]
    #[cfg_attr(feature = "serde", serde(rename = "AllStgOrdrs"))]
    pub all_stg_ordrs: Vec<StandingOrderIdentification9>,
}

impl Validate for StandingOrderOrAll4Choice {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.071.001.05";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.071.001.05";
}
