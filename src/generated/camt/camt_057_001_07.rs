...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.057.001.07")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.057.001.07")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.057.001.07")]
pub struct AccountNotification18 {
    #[yaserde(rename = "Id")]
    ...
    pub itm: Vec<NotificationItem8>,
}

impl Validate for AccountNotification18 {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.057.001.07")]
pub struct Document {
    #[yaserde(rename = "NtfctnToRcv")]
    #[cfg_attr(feature = "serde", serde(rename = "NtfctnToRcv"))]
    pub ntfctn_to_rcv: NotificationToReceiveV07,
}
...
impl Validate for NotificationItem8 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.057.001.07")]
pub struct NotificationToReceiveV07 {
    ...
    pub ntfctn: AccountNotification18,
...
impl Validate for NotificationToReceiveV07 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.057.001.07";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.057.001.07";
}
