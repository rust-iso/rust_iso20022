...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.042.001.04")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.042.001.04")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.042.001.04")]
pub struct Document {
    #[yaserde(rename = "FndDtldEstmtdCshFcstRpt")]
    #[cfg_attr(feature = "serde", serde(rename = "FndDtldEstmtdCshFcstRpt"))]
...
pub struct EstimatedFundCashForecast5 {
    ...
    #[yaserde(rename = "EstmtdTtlNAV")]
    #[cfg_attr(feature = "serde", serde(rename = "EstmtdTtlNAV"))]
    ...
    #[yaserde(rename = "EstmtdTtlUnitsNb")]
    #[cfg_attr(feature = "serde", serde(rename = "EstmtdTtlUnitsNb"))]
    pub estmtd_ttl_units_nb: FinancialInstrumentQuantity1,
    ...
    #[yaserde(rename = "EstmtdTtlNAVChngRate")]
    #[cfg_attr(feature = "serde", serde(rename = "EstmtdTtlNAVChngRate"))]
    pub estmtd_ttl_nav_chng_rate: PercentageRate,
    ...
    #[yaserde(rename = "EstmtdPctgOfShrClssTtlNAV")]
    #[cfg_attr(feature = "serde", serde(rename = "EstmtdPctgOfShrClssTtlNAV"))]
    pub estmtd_pctg_of_shr_clss_ttl_nav: PercentageRate,
    ...
    #[yaserde(rename = "EstmtdNetCshFcstDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "EstmtdNetCshFcstDtls"))]
    pub estmtd_net_csh_fcst_dtls: Vec<NetCashForecast4>,
}

impl Validate for EstimatedFundCashForecast5 {}
...
pub struct Fund3 {
    ...
    #[yaserde(rename = "EstmtdTtlNAV")]
    #[cfg_attr(feature = "serde", serde(rename = "EstmtdTtlNAV"))]
    pub estmtd_ttl_nav: ActiveOrHistoricCurrencyAndAmount,
    ...
    #[yaserde(rename = "EstmtdPctgOfFndTtlNAV")]
    #[cfg_attr(feature = "serde", serde(rename = "EstmtdPctgOfFndTtlNAV"))]
    pub estmtd_pctg_of_fnd_ttl_nav: PercentageRate,
}

impl Validate for Fund3 {}
...
pub struct FundDetailedEstimatedCashForecastReportV04 {
    ...
    pub fnd_or_sub_fnd_dtls: Fund3,

    #[yaserde(rename = "EstmtdFndCshFcstDtls")]
    #[cfg_attr(feature = "serde", serde(rename = "EstmtdFndCshFcstDtls"))]
...
impl Validate for FundDetailedEstimatedCashForecastReportV04 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.042.001.04";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.042.001.04";
}
