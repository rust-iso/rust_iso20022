...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.029.001.14")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.029.001.14")]
...
impl Validate for CancellationStatusReason5 {}
...
impl Validate for Compensation5 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.029.001.14")]
...
pub struct Document {
    ...
    pub rsltn_of_invstgtn: ResolutionOfInvestigationV14,
}
...
impl Validate for InvestigationStatus6Choice {}
...
pub struct OriginalGroupHeader23 {
    ...
    pub cxl_sts_rsn_inf: Vec<CancellationStatusReason5>,
...
impl Validate for OriginalGroupHeader23 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.029.001.14")]
pub struct OriginalPaymentInstruction54 {
    ...
    pub tx_inf_and_sts: Vec<PaymentTransaction175>,
}

impl Validate for OriginalPaymentInstruction54 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.029.001.14")]
pub struct PaymentTransaction170 {
    ...
    pub rsltn_rltd_inf: ResolutionData5,
...
impl Validate for PaymentTransaction170 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.029.001.14")]
pub struct PaymentTransaction175 {
    #[yaserde(rename = "CxlStsId")]
    #[cfg_attr(feature = "serde", serde(rename = "CxlStsId"))]
    pub cxl_sts_id: Max35Text,
...
impl Validate for PaymentTransaction175 {}
...
pub struct ResolutionData5 {
    ...
    pub compstn: Compensation5,

    #[yaserde(rename = "ChrgsInf")]
    #[cfg_attr(feature = "serde", serde(rename = "ChrgsInf"))]
    pub chrgs_inf: Vec<Charges14>,
}

impl Validate for ResolutionData5 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.029.001.14")]
pub struct ResolutionOfInvestigationV14 {
    ...
    pub cxl_dtls: Vec<UnderlyingTransaction35>,
...
impl Validate for ResolutionOfInvestigationV14 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.029.001.14")]
pub struct UnderlyingTransaction35 {
    #[yaserde(rename = "OrgnlGrpInfAndSts")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlGrpInfAndSts"))]
    pub orgnl_grp_inf_and_sts: OriginalGroupHeader23,

    #[yaserde(rename = "OrgnlPmtInfAndSts")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlPmtInfAndSts"))]
    pub orgnl_pmt_inf_and_sts: Vec<OriginalPaymentInstruction54>,

    #[yaserde(rename = "TxInfAndSts")]
    #[cfg_attr(feature = "serde", serde(rename = "TxInfAndSts"))]
    pub tx_inf_and_sts: Vec<PaymentTransaction170>,
}

impl Validate for UnderlyingTransaction35 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.029.001.14";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.029.001.14";
}
