...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.031.001.07")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.031.001.07")]
...
pub struct Document {
    ...
    pub rjct_invstgtn: RejectInvestigationV07,
}
...
impl Validate for RejectInvestigationV07 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.031.001.07";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.031.001.07";
}
