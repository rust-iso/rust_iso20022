...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.027.001.10")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.027.001.10")]
...
impl Validate for ClaimNonReceiptV10 {}
...
pub struct Document {
    ...
    pub clm_non_rct: ClaimNonReceiptV10,
}
...
pub struct MissingCover6 {
    ...
    pub cover_crrctn: SettlementInstruction16,
}

impl Validate for MissingCover6 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.027.001.10";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.027.001.10";
}
