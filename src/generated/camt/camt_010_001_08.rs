...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.010.001.08")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.010.001.08")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.010.001.08")]
pub struct Document {
    #[yaserde(rename = "RtrLmt")]
    #[cfg_attr(feature = "serde", serde(rename = "RtrLmt"))]
    pub rtr_lmt: ReturnLimitV08,
}
...
pub struct Limit7 {
    ...
    pub usd_amt: Amount2Choice,

    #[yaserde(rename = "UsdAmtCdtDbtInd")]
    #[cfg_attr(feature = "serde", serde(rename = "UsdAmtCdtDbtInd"))]
    pub usd_amt_cdt_dbt_ind: CreditDebitCode,

    #[yaserde(rename = "UsdPctg")]
    #[cfg_attr(feature = "serde", serde(rename = "UsdPctg"))]
    pub usd_pctg: PercentageRate,

    #[yaserde(rename = "RmngAmt")]
    #[cfg_attr(feature = "serde", serde(rename = "RmngAmt"))]
    pub rmng_amt: Amount2Choice,
}

impl Validate for Limit7 {}
...
pub enum LimitOrError4ChoiceChoice {
    Lmt(Limit7),
    BizErr(Vec<ErrorHandling5>),
    __Unknown__(String),
}

impl Default for LimitOrError4ChoiceChoice {
    fn default() -> LimitOrError4ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for LimitOrError4ChoiceChoice {}
...
pub struct LimitOrError4Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub limit_or_error_4_choice_choice: LimitOrError4ChoiceChoice,
}

impl Validate for LimitOrError4Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.010.001.08")]
pub struct LimitReport7 {
    #[yaserde(rename = "LmtId")]
    #[cfg_attr(feature = "serde", serde(rename = "LmtId"))]
    pub lmt_id: LimitIdentification5,

    #[yaserde(rename = "LmtOrErr")]
    #[cfg_attr(feature = "serde", serde(rename = "LmtOrErr"))]
    pub lmt_or_err: LimitOrError4Choice,
}

impl Validate for LimitReport7 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.010.001.08")]

pub enum LimitReportOrError4ChoiceChoice {
    BizRpt(Limits7),
    OprlErr(Vec<ErrorHandling5>),
    __Unknown__(String),
}

impl Default for LimitReportOrError4ChoiceChoice {
    fn default() -> LimitReportOrError4ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for LimitReportOrError4ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.010.001.08")]
pub struct LimitReportOrError4Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub limit_report_or_error_4_choice_choice: LimitReportOrError4ChoiceChoice,
}

impl Validate for LimitReportOrError4Choice {}
...
impl Default for LimitStatus1Code {
    fn default() -> LimitStatus1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for LimitStatus1Code {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.010.001.08")]
pub struct Limits7 {
    #[yaserde(rename = "CurLmt")]
    #[cfg_attr(feature = "serde", serde(rename = "CurLmt"))]
    pub cur_lmt: Vec<LimitReport7>,

    #[yaserde(rename = "DfltLmt")]
    #[cfg_attr(feature = "serde", serde(rename = "DfltLmt"))]
    pub dflt_lmt: Vec<LimitReport7>,
}

impl Validate for Limits7 {}
...
pub struct ReturnLimitV08 {
    ...
    pub rpt_or_err: LimitReportOrError4Choice,
...
impl Validate for ReturnLimitV08 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.010.001.08";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.010.001.08";
}
