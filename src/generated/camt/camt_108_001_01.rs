...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.108.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.108.001.01")]
...
pub struct Cheque15 {
    ...
    #[yaserde(rename = "ChqCxlOrStopRsn")]
    #[cfg_attr(feature = "serde", serde(rename = "ChqCxlOrStopRsn"))]
    pub chq_cxl_or_stop_rsn: ChequeCancellationReason1,
}

impl Validate for Cheque15 {}
...
pub struct ChequeCancellationReason1 {
    ...
    pub orgtr: ChequePartyRole1Code,
...
impl Validate for ChequeCancellationReason1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.108.001.01")]

pub enum ChequeCancellationReason1ChoiceChoice {
    Cd(ExternalChequeCancellationReason1Code),
    Prtry(Max35Text),
    __Unknown__(String),
}

impl Default for ChequeCancellationReason1ChoiceChoice {
    fn default() -> ChequeCancellationReason1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ChequeCancellationReason1ChoiceChoice {}
...
pub struct ChequeCancellationReason1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub cheque_cancellation_reason_1_choice_choice: ChequeCancellationReason1ChoiceChoice,
}

impl Validate for ChequeCancellationReason1Choice {}
...
pub enum ChequePartyRole1Code {
    #[yaserde(rename = "DWEA")]
    #[cfg_attr(feature = "serde", serde(rename = "DWEA"))]
    Dwea,
    #[yaserde(rename = "DWRA")]
    #[cfg_attr(feature = "serde", serde(rename = "DWRA"))]
    Dwra,
    #[yaserde(rename = "PAYE")]
    #[cfg_attr(feature = "serde", serde(rename = "PAYE"))]
    Paye,
    #[yaserde(rename = "PAYR")]
...
impl Default for ChequePartyRole1Code {
    fn default() -> ChequePartyRole1Code {
        Self::__Unknown__("No valid variants".into())
    }
}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.108.001.01")]
pub struct Document {
    #[yaserde(rename = "ChqCxlOrStopReq")]
    #[cfg_attr(feature = "serde", serde(rename = "ChqCxlOrStopReq"))]
    pub chq_cxl_or_stop_req: ChequeCancellationOrStopRequestV01,
}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct ExternalChequeCancellationReason1Code (pub String);
crate::simple_type!(ExternalChequeCancellationReason1Code);

impl Validate for ExternalChequeCancellationReason1Code {
    fn validate(&self) -> Result<(), String> { 
        #[allow(clippy::len_zero)]
        if self.0.len() < 1 {
            return Err(format!("MinLength validation error. \nExpected: 0 length >= 1 \nActual: 0 length == {}", self.0.len()));
...
impl crate::MxMessage for Document {
    ...
    const FUNCTIONALITY: &'static str = "108";
    const VARIANT: &'static str = "001";
    const VERSION: &'static str = "01";
    const MESSAGE_NAME: &'static str = "camt.108.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.108.001.01";
}
