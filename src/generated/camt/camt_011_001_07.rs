...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.011.001.07")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.011.001.07")]
...
pub enum LimitIdentification2ChoiceChoice {
...
impl Default for LimitIdentification2ChoiceChoice {
    fn default() -> LimitIdentification2ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for LimitIdentification2ChoiceChoice {}

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.011.001.07")]
pub struct LimitIdentification2Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub limit_identification_2_choice_choice: LimitIdentification2ChoiceChoice,
}

impl Validate for LimitIdentification2Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.011.001.07")]
pub struct LimitStructure3 {
    #[yaserde(rename = "LmtId")]
    #[cfg_attr(feature = "serde", serde(rename = "LmtId"))]
    pub lmt_id: LimitIdentification2Choice,
...
impl Validate for LimitStructure3 {}
...
pub struct ModifyLimitV07 {
    ...
    pub lmt_dtls: Vec<LimitStructure3>,
...
impl Validate for ModifyLimitV07 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.011.001.07";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.011.001.07";
}
