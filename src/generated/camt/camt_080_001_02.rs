...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.080.001.02")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.080.001.02")]
...
pub struct Document {
    ...
    pub intra_bal_mvmnt_mod_qry: IntraBalanceMovementModificationQueryV02,
}
...
impl Validate for IntraBalanceMovementModificationQueryV02 {}
...
impl Validate for IntraBalanceQueryCriteria12 {}
...
impl Validate for IntraBalanceQueryDefinition12 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.080.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.080.001.02";
}
