...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.109.001.01")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.109.001.01")]
...
pub struct Cheque14 {
    ...
    #[yaserde(rename = "ChqCxlOrStopSts")]
    #[cfg_attr(feature = "serde", serde(rename = "ChqCxlOrStopSts"))]
    pub chq_cxl_or_stop_sts: ChequeCancellationStatus1,
}

impl Validate for Cheque14 {}
...
impl Validate for ChequeCancellationStatus1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.109.001.01")]

pub enum ChequeCancellationStatus1ChoiceChoice {
    Cd(ExternalChequeCancellationStatus1Code),
    Prtry(Max35Text),
    __Unknown__(String),
}

impl Default for ChequeCancellationStatus1ChoiceChoice {
    fn default() -> ChequeCancellationStatus1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ChequeCancellationStatus1ChoiceChoice {}
...
pub struct ChequeCancellationStatus1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub cheque_cancellation_status_1_choice_choice: ChequeCancellationStatus1ChoiceChoice,
}

impl Validate for ChequeCancellationStatus1Choice {}
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.109.001.01")]
pub struct Document {
    #[yaserde(rename = "ChqCxlOrStopRpt")]
    #[cfg_attr(feature = "serde", serde(rename = "ChqCxlOrStopRpt"))]
    pub chq_cxl_or_stop_rpt: ChequeCancellationOrStopReportV01,
}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug)]
pub struct ExternalChequeCancellationStatus1Code (pub String);
crate::simple_type!(ExternalChequeCancellationStatus1Code);

impl Validate for ExternalChequeCancellationStatus1Code {
    fn validate(&self) -> Result<(), String> { 
        #[allow(clippy::len_zero)]
        if self.0.len() < 1 {
            return Err(format!("MinLength validation error. \nExpected: 0 length >= 1 \nActual: 0 length == {}", self.0.len()));
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.109.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.109.001.01";
}
