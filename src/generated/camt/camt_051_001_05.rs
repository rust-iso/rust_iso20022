...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.051.001.05")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.051.001.05")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.051.001.05")]
pub struct Document {
    #[yaserde(rename = "LqdtyDbtTrf")]
    #[cfg_attr(feature = "serde", serde(rename = "LqdtyDbtTrf"))]
    pub lqdty_dbt_trf: LiquidityDebitTransferV05,
}
...
impl Validate for LiquidityDebitTransfer2 {}
...
impl Validate for LiquidityDebitTransferV05 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.051.001.05";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.051.001.05";
}
