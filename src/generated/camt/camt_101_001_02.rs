...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.101.001.02")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.101.001.02")]
...
pub struct CreateLimitV02 {
    ...
    pub lmt_data: Vec<LimitStructure6>,
...
impl Validate for CreateLimitV02 {}
...
impl Validate for LimitStructure6 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.101.001.02")]
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.101.001.02";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.101.001.02";
}
