...
pub enum CancellationProcessingStatus9ChoiceChoice {
    Cd(CancellationProcessingStatus3Code),
    Prtry(GenericIdentification30),
    __Unknown__(String),
}

impl Default for CancellationProcessingStatus9ChoiceChoice {
    fn default() -> CancellationProcessingStatus9ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for CancellationProcessingStatus9ChoiceChoice {}
...
pub struct CancellationProcessingStatus9Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub cancellation_processing_status_9_choice_choice: CancellationProcessingStatus9ChoiceChoice,
}
