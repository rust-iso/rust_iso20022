...
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.031.001.06")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.031.001.06")]
...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.031.001.06")]
pub struct Document {
    #[yaserde(rename = "RjctInvstgtn")]
    #[cfg_attr(feature = "serde", serde(rename = "RjctInvstgtn"))]
    pub rjct_invstgtn: RejectInvestigationV06,
}
...
pub enum InvestigationRejection1Code {
    #[yaserde(rename = "NFND")]
    #[cfg_attr(feature = "serde", serde(rename = "NFND"))]
    Nfnd,
    #[yaserde(rename = "NAUT")]
    ...
    Uknw,
    #[yaserde(rename = "PCOR")]
    #[cfg_attr(feature = "serde", serde(rename = "PCOR"))]
    Pcor,
    #[yaserde(rename = "WMSG")]
    #[cfg_attr(feature = "serde", serde(rename = "WMSG"))]
    Wmsg,
    #[yaserde(rename = "RNCR")]
    #[cfg_attr(feature = "serde", serde(rename = "RNCR"))]
    Rncr,
    #[yaserde(rename = "MROI")]
    #[cfg_attr(feature = "serde", serde(rename = "MROI"))]
    Mroi,
    __Unknown__(String),
}

impl Default for InvestigationRejection1Code {
    fn default() -> InvestigationRejection1Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for InvestigationRejection1Code {}
...
impl Validate for InvestigationRejectionJustification1 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.031.001.06")]
pub struct RejectInvestigationV06 {
...
impl Validate for RejectInvestigationV06 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.031.001.06";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.031.001.06";
}
