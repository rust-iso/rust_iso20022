...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.010.001.09")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.010.001.09")]
...
impl Validate for LimitReport8 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.010.001.09")]
...
impl Validate for LimitReportOrError5Choice {}
...
pub struct Limits8 {
    ...
    pub cur_lmt: Vec<LimitReport8>,

    #[yaserde(rename = "DfltLmt")]
    #[cfg_attr(feature = "serde", serde(rename = "DfltLmt"))]
    pub dflt_lmt: Vec<LimitReport8>,
}

impl Validate for Limits8 {}
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:camt.010.001.09")]
...
pub struct ReturnLimitV09 {
    ...
    pub rpt_or_err: LimitReportOrError5Choice,
...
impl Validate for ReturnLimitV09 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "camt.010.001.09";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:camt.010.001.09";
}
