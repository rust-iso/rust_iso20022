...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.017.001.04")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.017.001.04")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.017.001.04")]
pub struct AccountStatementData3 {
    #[yaserde(rename = "Dt")]
    ...
    pub dtls: Vec<AccountStatementDetails3>,
}

impl Validate for AccountStatementData3 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.017.001.04")]
pub struct AccountStatementDetails3 {
    #[yaserde(rename = "TxDt")]
    ...
    #[yaserde(rename = "ShrtDesc")]
    #[cfg_attr(feature = "serde", serde(rename = "ShrtDesc"))]
    pub shrt_desc: Max70Text,

    #[yaserde(rename = "LngDesc")]
    #[cfg_attr(feature = "serde", serde(rename = "LngDesc"))]
    pub lng_desc: Max256Text,
}

impl Validate for AccountStatementDetails3 {}
...
pub struct Document {
    ...
    pub nqry_vrfctn_rspn: InquiryVerificationResponseV04,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.017.001.04")]
pub struct InquiryVerificationResponseV04 {
    #[yaserde(rename = "Hdr")]
    ...
    pub card_prgrmm: Vec<ProgrammeMode6>,
    ...
    pub acct_stmt_data: Vec<AccountStatementData3>,
...
impl Validate for InquiryVerificationResponseV04 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "cain.017.001.04";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:cain.017.001.04";
}
