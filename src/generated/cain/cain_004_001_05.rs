...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.004.001.05")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.004.001.05")]
...
pub struct Document {
    ...
    pub fin_rspn: FinancialResponseV05,
}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.004.001.05")]
pub struct FinancialResponseV05 {
    #[yaserde(rename = "Hdr")]
    ...
    pub adddm_data: TransactionSpecificData2,
...
impl Validate for FinancialResponseV05 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "cain.004.001.05";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:cain.004.001.05";
}
