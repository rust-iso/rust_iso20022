...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.020.001.01")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.020.001.01")]
...
impl Validate for Amendment10 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.020.001.01")]
pub struct AmendmentV01 {
    #[yaserde(rename = "Hdr")]
...
impl Validate for AmendmentV01 {}
...
impl Validate for DetailedError1 {}
...
impl Default for MessageFunction27Code {
    fn default() -> MessageFunction27Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for MessageFunction27Code {}
...
impl Validate for Transaction102 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "cain.020.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:cain.020.001.01";
}
