...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.017.001.01")]
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.017.001.01")]
pub struct AccountStatementData1 {
    #[yaserde(rename = "StmtDt")]
    #[cfg_attr(feature = "serde", serde(rename = "StmtDt"))]
    pub stmt_dt: Isodate,

    #[yaserde(rename = "StmtTm")]
    #[cfg_attr(feature = "serde", serde(rename = "StmtTm"))]
    pub stmt_tm: Isotime,

    #[yaserde(rename = "AcctStmt")]
    #[cfg_attr(feature = "serde", serde(rename = "AcctStmt"))]
    pub acct_stmt: Vec<AccountStatementDetails1>,
}

impl Validate for AccountStatementData1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.017.001.01")]
pub struct AccountStatementDetails1 {
    #[yaserde(rename = "TxDt")]
    #[cfg_attr(feature = "serde", serde(rename = "TxDt"))]
    pub tx_dt: Isodate,

    #[yaserde(rename = "PdgInd")]
    #[cfg_attr(feature = "serde", serde(rename = "PdgInd"))]
    pub pdg_ind: TrueFalseIndicator,

    #[yaserde(rename = "TxPstngDt")]
    #[cfg_attr(feature = "serde", serde(rename = "TxPstngDt"))]
    pub tx_pstng_dt: Isodate,
    ...
    pub crdhldr_bllg_amt: Amount7,

    #[yaserde(rename = "CdtInd")]
    #[cfg_attr(feature = "serde", serde(rename = "CdtInd"))]
    pub cdt_ind: TrueFalseIndicator,

    #[yaserde(rename = "AccptrNmAndLctn")]
    #[cfg_attr(feature = "serde", serde(rename = "AccptrNmAndLctn"))]
    pub accptr_nm_and_lctn: Max99Text,

    #[yaserde(rename = "ShrtTxDesc")]
    #[cfg_attr(feature = "serde", serde(rename = "ShrtTxDesc"))]
    pub shrt_tx_desc: Max70Text,

    #[yaserde(rename = "LngTxDesc")]
    #[cfg_attr(feature = "serde", serde(rename = "LngTxDesc"))]
    pub lng_tx_desc: Max256Text,
}

impl Validate for AccountStatementDetails1 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.017.001.01")]
...
pub struct Document {
    ...
    pub nqry_rspn: InquiryResponseV01,
}
...
impl Validate for Environment15 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.017.001.01")]
pub struct InquiryResponse1 {
    #[yaserde(rename = "Envt")]
    #[cfg_attr(feature = "serde", serde(rename = "Envt"))]
    pub envt: Environment15,
...
impl Validate for InquiryResponse1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.017.001.01")]
pub struct InquiryResponseV01 {
    #[yaserde(rename = "Hdr")]
...
impl Validate for InquiryResponseV01 {}
...
pub struct Transaction87 {
    ...
    pub acct_stmt_data: Vec<AccountStatementData1>,
...
impl Validate for Transaction87 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "cain.017.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:cain.017.001.01";
}
