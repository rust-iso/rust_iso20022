...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.021.001.01")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.021.001.01")]
...
pub struct Context4 {
    #[yaserde(rename = "PtOfSvcCntxt")]
    #[cfg_attr(feature = "serde", serde(rename = "PtOfSvcCntxt"))]
    pub pt_of_svc_cntxt: PointOfServiceContext2,
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.021.001.01")]
pub struct DeliveryInformation2 {
    #[yaserde(rename = "Ctct")]
    ...
    pub pstl_adr: Address1,
}

impl Validate for DeliveryInformation2 {}
...
pub struct Document {
    ...
    pub rtrvl_initn: RetrievalInitiationV01,
}
...
impl Validate for Environment13 {}
...
pub struct Environment6 {
    #[yaserde(rename = "Acqrr")]
    #[cfg_attr(feature = "serde", serde(rename = "Acqrr"))]
    pub acqrr: PartyIdentification198,

    #[yaserde(rename = "Sndr")]
    #[cfg_attr(feature = "serde", serde(rename = "Sndr"))]
    pub sndr: PartyIdentification198,

    #[yaserde(rename = "Rcvr")]
    #[cfg_attr(feature = "serde", serde(rename = "Rcvr"))]
    pub rcvr: PartyIdentification198,

    #[yaserde(rename = "Accptr")]
    #[cfg_attr(feature = "serde", serde(rename = "Accptr"))]
    pub accptr: PartyIdentification199,
...
impl Validate for Environment6 {}
...
pub struct Header55 {
    ...
    pub msg_fctn: MessageFunction37Code,
...
pub enum MessageFunction37Code {
    #[yaserde(rename = "ADVC")]
    ...
    Stno,
    #[yaserde(rename = "STRQ")]
    #[cfg_attr(feature = "serde", serde(rename = "STRQ"))]
    Strq,
    #[yaserde(rename = "STAD")]
...
impl Default for MessageFunction37Code {
    fn default() -> MessageFunction37Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for MessageFunction37Code {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.021.001.01")]
pub struct OriginalTransaction1 {
    #[yaserde(rename = "Envt")]
    #[cfg_attr(feature = "serde", serde(rename = "Envt"))]
    pub envt: Environment6,
...
impl Validate for OriginalTransaction1 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.021.001.01")]
pub struct PartyIdentification198 {
    #[yaserde(rename = "Id")]
    #[cfg_attr(feature = "serde", serde(rename = "Id"))]
    pub id: Max35Text,
...
impl Validate for PartyIdentification198 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.021.001.01")]
pub struct PartyIdentification199 {
    #[yaserde(rename = "Id")]
    #[cfg_attr(feature = "serde", serde(rename = "Id"))]
    pub id: Max35Text,
...
impl Validate for PartyIdentification199 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.021.001.01")]
pub struct PointOfServiceContext2 {
    #[yaserde(rename = "CardPres")]
    #[cfg_attr(feature = "serde", serde(rename = "CardPres"))]
    pub card_pres: TrueFalseIndicator,
...
impl Validate for PointOfServiceContext2 {}
...
pub enum RetrievalDeliveryMethod1ChoiceChoice {
    ReqdMtd(Vec<Max35Text>),
    EstblishdMtd(Vec<Max35Text>),
    ActlDlvryMtd(Max35Text),
    __Unknown__(String),
}

impl Default for RetrievalDeliveryMethod1ChoiceChoice {
    fn default() -> RetrievalDeliveryMethod1ChoiceChoice {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for RetrievalDeliveryMethod1ChoiceChoice {}
...
pub struct RetrievalDeliveryMethod1Choice {
    #[yaserde(flatten)]
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub retrieval_delivery_method_1_choice_choice: RetrievalDeliveryMethod1ChoiceChoice,
}

impl Validate for RetrievalDeliveryMethod1Choice {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.021.001.01")]
pub struct RetrievalFulfilmentInstructions1 {
    #[yaserde(rename = "Mtd")]
    #[cfg_attr(feature = "serde", serde(rename = "Mtd"))]
    pub mtd: RetrievalDeliveryMethod1Choice,

    #[yaserde(rename = "DlvryInf")]
    #[cfg_attr(feature = "serde", serde(rename = "DlvryInf"))]
    pub dlvry_inf: DeliveryInformation2,

    #[yaserde(rename = "AddtlInf")]
    #[cfg_attr(feature = "serde", serde(rename = "AddtlInf"))]
    pub addtl_inf: AdditionalInformation22,
}

impl Validate for RetrievalFulfilmentInstructions1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.021.001.01")]
pub struct RetrievalInitiation1 {
    #[yaserde(rename = "Envt")]
    #[cfg_attr(feature = "serde", serde(rename = "Envt"))]
    pub envt: Environment13,
    ...
    #[yaserde(rename = "Tx")]
    #[cfg_attr(feature = "serde", serde(rename = "Tx"))]
    pub tx: Transaction89,

    #[yaserde(rename = "OrgnlTx")]
    #[cfg_attr(feature = "serde", serde(rename = "OrgnlTx"))]
    pub orgnl_tx: OriginalTransaction1,

    #[yaserde(rename = "PrtctdData")]
    #[cfg_attr(feature = "serde", serde(rename = "PrtctdData"))]
    pub prtctd_data: Vec<ProtectedData1>,

    #[yaserde(rename = "RtrvlFlfmtDstn")]
    #[cfg_attr(feature = "serde", serde(rename = "RtrvlFlfmtDstn"))]
    pub rtrvl_flfmt_dstn: PartyIdentification197,
...
impl Validate for RetrievalInitiation1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.021.001.01")]
pub struct RetrievalInitiationV01 {
    #[yaserde(rename = "Hdr")]
...
impl Validate for RetrievalInitiationV01 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.021.001.01")]
pub struct Terminal3 {
    #[yaserde(rename = "TermnlId")]
    #[cfg_attr(feature = "serde", serde(rename = "TermnlId"))]
    pub termnl_id: TerminalIdentification2,
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.021.001.01")]
pub struct TerminalIdentification2 {
    #[yaserde(rename = "Id")]
    #[cfg_attr(feature = "serde", serde(rename = "Id"))]
    pub id: Max16Text,
...
impl Validate for TerminalIdentification2 {}
...
impl Validate for Transaction85 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.021.001.01")]
pub struct Transaction89 {
    #[yaserde(rename = "MsgRsn")]
    #[cfg_attr(feature = "serde", serde(rename = "MsgRsn"))]
    pub msg_rsn: Vec<Exact4NumericText>,
    ...
    pub rtrvl_flfmt_instrs: Vec<RetrievalFulfilmentInstructions1>,
...
impl Validate for Transaction89 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "cain.021.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:cain.021.001.01";
}
