...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.026.001.01")]
pub struct AddendumResponse1 {
    #[yaserde(rename = "Envt")]
...
impl Validate for AddendumResponse1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.026.001.01")]
pub struct AddendumResponseV01 {
    #[yaserde(rename = "Hdr")]
...
impl Validate for AddendumResponseV01 {}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.026.001.01")]
...
pub struct Document {
    ...
    pub adddm_rspn: AddendumResponseV01,
}
...
impl Validate for Transaction92 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "cain.026.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:cain.026.001.01";
}
