...
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.018.001.01")]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(PartialEq, Debug, Clone, YaSerialize, YaDeserialize)]#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.018.001.01")]
...
pub struct Document {
    ...
    pub vrfctn_initn: VerificationInitiationV01,
}
...
pub enum MessageReason2Code {
    #[yaserde(rename = "ASTD")]
    #[cfg_attr(feature = "serde", serde(rename = "ASTD"))]
    Astd,
    #[yaserde(rename = "FLRL")]
    #[cfg_attr(feature = "serde", serde(rename = "FLRL"))]
    Flrl,
    #[yaserde(rename = "COFF")]
    #[cfg_attr(feature = "serde", serde(rename = "COFF"))]
    Coff,
    #[yaserde(rename = "ASPC")]
    #[cfg_attr(feature = "serde", serde(rename = "ASPC"))]
    Aspc,
    #[yaserde(rename = "CUNB")]
    #[cfg_attr(feature = "serde", serde(rename = "CUNB"))]
    Cunb,
    #[yaserde(rename = "CRND")]
    #[cfg_attr(feature = "serde", serde(rename = "CRND"))]
    Crnd,
    #[yaserde(rename = "FORC")]
    #[cfg_attr(feature = "serde", serde(rename = "FORC"))]
    Forc,
    #[yaserde(rename = "ISGN")]
    #[cfg_attr(feature = "serde", serde(rename = "ISGN"))]
    Isgn,
    #[yaserde(rename = "ITIM")]
    #[cfg_attr(feature = "serde", serde(rename = "ITIM"))]
    Itim,
    #[yaserde(rename = "IUNV")]
    #[cfg_attr(feature = "serde", serde(rename = "IUNV"))]
    Iunv,
    #[yaserde(rename = "OTHN")]
    #[cfg_attr(feature = "serde", serde(rename = "OTHN"))]
    Othn,
    ...
    Othp,
    #[yaserde(rename = "TRND")]
    #[cfg_attr(feature = "serde", serde(rename = "TRND"))]
    Trnd,
    #[yaserde(rename = "TUNB")]
    #[cfg_attr(feature = "serde", serde(rename = "TUNB"))]
    Tunb,
    #[yaserde(rename = "RSTD")]
    #[cfg_attr(feature = "serde", serde(rename = "RSTD"))]
    Rstd,
    #[yaserde(rename = "RTIM")]
    #[cfg_attr(feature = "serde", serde(rename = "RTIM"))]
    Rtim,
    #[yaserde(rename = "RSGN")]
    #[cfg_attr(feature = "serde", serde(rename = "RSGN"))]
    Rsgn,
    #[yaserde(rename = "RUNV")]
    #[cfg_attr(feature = "serde", serde(rename = "RUNV"))]
    Runv,
    #[yaserde(rename = "TOFF")]
...
impl Default for MessageReason2Code {
    fn default() -> MessageReason2Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for MessageReason2Code {}
...
impl Validate for ProcessingResult6 {}
...
impl Default for Response10Code {
    fn default() -> Response10Code {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for Response10Code {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.018.001.01")]
pub struct ResultData6 {
    #[yaserde(rename = "Rslt")]
    #[cfg_attr(feature = "serde", serde(rename = "Rslt"))]
    pub rslt: Response10Code,
...
pub struct Transaction83 {
    ...
    pub msg_rsn: Vec<MessageReason2Code>,
...
impl Validate for Transaction83 {}
...
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.018.001.01")]
pub struct VerificationInitiation1 {
    #[yaserde(rename = "Envt")]
...
impl Validate for VerificationInitiation1 {}


#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Default, Clone, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "n", default_namespace = "n", namespace = "n: urn:iso:std:iso:20022:tech:xsd:cain.018.001.01")]
pub struct VerificationInitiationV01 {
    #[yaserde(rename = "Hdr")]
    ...
    pub body: VerificationInitiation1,
...
impl Validate for VerificationInitiationV01 {}
...
impl crate::MxMessage for Document {
    ...
    const MESSAGE_NAME: &'static str = "cain.018.001.01";
    const NAMESPACE: &'static str = "urn:iso:std:iso:20022:tech:xsd:cain.018.001.01";
}
