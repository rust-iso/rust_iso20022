...
**Coverage:** a typed model is generated for **all 502** message schemas across
25 business areas (`acmt`, `admi`, `auth`, `caaa`, `caad`, `caam`, `cafc`,
`cafm`, `cafr`, `cain`, `camt`, `canm`, `casp`, `casr`, `catm`, `catp`, `colr`,
`fxtr`, `head`, `pacs`, `pain`, `reda`, `remt`, `secl`, `seev`).
